...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("10.8.120.91"), 12124)}, "C:\\Users\\Sarah\\Documents\\Fuse\\HackPrinceton2017_Matchr\\matchr_signup\\matchr_signup.unoproj", GetBundle, new string[] { })
{
...
{
return Uno.IO.Bundle.Get("matchr_signup");
}
}
}

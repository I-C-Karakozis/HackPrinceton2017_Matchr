...
public partial class SignUpPage: Fuse.Controls.Page
{
    ...
    void InitializeUX()
    {
        ...
        temp17.Text = "Sign Up";
        global::Fuse.Gestures.Clicked.AddHandler(temp17, temp_eb5.OnEvent);
        temp17.Bindings.Add(temp_eb5);
        temp18.Children.Add(temp19);
        temp19.Text = "Back";
        global::Fuse.Gestures.Clicked.AddHandler(temp19, temp_eb6.OnEvent);
        temp19.Bindings.Add(temp_eb6);

...
public partial class matchPage: Fuse.Controls.Page
{
    ...
    void InitializeUX()
    {
        ...
        temp_eb4 = new Fuse.Reactive.EventBinding("clicked");
        var temp12 = new Fuse.Controls.Image();
        temp_eb5 = new Fuse.Reactive.EventBinding("clicked");
        var temp13 = new Fuse.Controls.Image();
        temp_eb6 = new Fuse.Reactive.EventBinding("clicked");
        var temp14 = new Fuse.Controls.Image();
        temp_eb7 = new Fuse.Reactive.EventBinding("clicked");
        ...
        temp_eb9 = new Fuse.Reactive.EventBinding("clicked");
        var temp22 = new Fuse.Controls.Image();
        temp_eb10 = new Fuse.Reactive.EventBinding("clicked");
        ...
        global::Fuse.Gestures.Clicked.AddHandler(temp11, temp_eb4.OnEvent);

...
public partial class SignInPage: Fuse.Controls.Page
{
    ...
    void InitializeUX()
    {
        ...
        var temp8 = new Fuse.Reactive.DataBinding<string>(temp_Value_inst, "email");
        var temp9 = new Fuse.Reactive.DataBinding<string>(temp1_Value_inst, "passwd");
        var temp10 = new Fuse.Reactive.DataBinding<string>(temp2_Value_inst, "loginerr");
        var temp11 = new Fuse.Controls.NativeViewHost();
        var temp12 = new Fuse.Controls.Button();
        temp_eb3 = new Fuse.Reactive.EventBinding("signin");
        var temp13 = new Fuse.Controls.NativeViewHost();
        ...
        temp14.Text = "Back";
        global::Fuse.Gestures.Clicked.AddHandler(temp14, temp_eb4.OnEvent);
        temp14.Bindings.Add(temp_eb4);

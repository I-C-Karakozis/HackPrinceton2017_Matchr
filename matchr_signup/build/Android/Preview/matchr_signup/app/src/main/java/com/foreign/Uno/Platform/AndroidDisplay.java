...
public class AndroidDisplay
{
    ...
    public static void JavaEnableTicks52(final UnoObject _this)
    {
        ...
        if (ExternedBlockHost.callUno_Uno_Platform_AndroidDisplay__initializedGet53()) return;
        ExternedBlockHost.callUno_Uno_Platform_AndroidDisplay__initializedSet53(true);
        ...
        if (android.os.Build.VERSION.SDK_INT >= 16)
        {
            android.view.Choreographer.getInstance().postFrameCallback(new android.view.Choreographer.FrameCallback()
            {
                ...
                {
                    if (ExternedBlockHost.callUno_Uno_Platform_AndroidDisplay__initializedGet53())
                    ...
                    ExternedBlockHost.callUno_Uno_Platform_AndroidDisplay_OnFrameCallback54((UnoObject)display,(double)currentTime,(double)deltaTime);
        ...
        else
        {
            ...
            timeAnimator.setTimeListener(new android.animation.TimeAnimator.TimeListener()
            {
                ...
                {
                    ExternedBlockHost.callUno_Uno_Platform_AndroidDisplay_OnFrameCallback54((UnoObject)display,(double)totalTime / 1000.0,(double)deltaTime / 1000.0);
                }
            });
            timeAnimator.start();
        }

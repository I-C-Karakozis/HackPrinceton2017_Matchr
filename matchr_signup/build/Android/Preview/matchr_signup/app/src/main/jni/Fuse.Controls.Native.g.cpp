...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Controls.Native/0.46.1/$.uno
// -------------------------------------------------------------------------------------------
...
{
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Download1249", "(Ljava/lang/String;)Ljava/lang/Object;");
        uString* _uurl=url;
...
::g::Java::Object* ImageLoader::LoadFile(uString* filePath)
{
    ImageLoader_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "LoadFile250", "(Ljava/lang/String;)Ljava/lang/Object;");
...
::g::Java::Object* ImageLoader::LoadUri(uString* uri)
{
    ImageLoader_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "LoadUri251", "(Ljava/lang/String;)Ljava/lang/Object;");
        uString* _uuri=uri;
...
void ImageLoader::Release(::g::Java::Object* bitmap)
{
    ImageLoader_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Release252", "(Ljava/lang/Object;)V");
...
// public abstract interface IRangeViewHost :424
// {
...
// public abstract interface IToggleViewHost :414
// {

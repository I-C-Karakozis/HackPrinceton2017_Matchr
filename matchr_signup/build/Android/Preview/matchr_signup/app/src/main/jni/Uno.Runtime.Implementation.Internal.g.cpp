...
// /Users/hdc/Library/Application Support/Fusetools/Packages/UnoCore/0.46.1/source/uno/runtime/implementation/internal/$.uno
// -------------------------------------------------------------------------------------------------------------------------
...
// public ArrayList(T[] source) :137
void ArrayList__ctor__fn(ArrayList* __this, uArray* source)
{
    __this->ctor_(source);
}

// public void Add(T item) :181
...
// public void Clear() :176
void ArrayList__Clear_fn(ArrayList* __this)
{
    __this->Clear();
}

// public bool Contains(T item) :155
...
// public T get_Item(int index) :151
...
// public void set_Item(int index, T value) :152
...
// public ArrayList(T[] source) [instance] :137
void ArrayList::ctor_(uArray* source)
{
    _source = source;
}

// public void Clear() [instance] :176
...
// public int get_Count() [instance] :147
int ArrayList::Count()
{
...
// public Uno.Collections.IEnumerator<T> GetEnumerator() [instance] :142
...
// public ArrayList New(T[] source) [static] :137
...
// public static Uno.Buffer ToBuffer(float4[] data) [static] :479
...
// public static Uno.Buffer ToBuffer(uint[] data) [static] :519
...
// public float2 ReadFloat2([bool littleEndian]) :607
...
// public BufferReader(Uno.Buffer buffer) [instance] :561
void BufferReader::ctor_(::g::Uno::Buffer* buffer)
{
    _buffer = buffer;
}

// public byte ReadByte() [instance] :577
...
// public byte[] ReadBytes(int count) [instance] :721
...
// public int ReadCompressedInt() [instance] :731
...
// public float ReadFloat([bool littleEndian]) [instance] :601
...
// public float2 ReadFloat2([bool littleEndian]) [instance] :607
...
// public string ReadString() [instance] :749
...
// public uint ReadUInt([bool littleEndian]) [instance] :697
...
// public BufferReader New(Uno.Buffer buffer) [static] :561
...
// public static extern void Quit() :36
void Unsafe__Quit_fn()
{
    Unsafe::Quit();
}

// public static extern void Quit() [static] :36
void Unsafe::Quit()
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Quit55", "()V");

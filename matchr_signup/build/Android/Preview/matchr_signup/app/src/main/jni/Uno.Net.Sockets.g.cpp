...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Uno.Net.Sockets/0.46.1/$.uno
// --------------------------------------------------------------------------------------
...
void NetworkStream__Write_fn(NetworkStream* __this, uArray* src, int* byteOffset, int* byteCount)
{
    ...
    int byteOffset_ = *byteOffset;
    int byteCount_ = *byteCount;
    int sent = uPtr(__this->_socket)->Send2(src, byteOffset_, byteCount_, 0);
...
static void Socket_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(11,
        ...
        new uFunction("Send", NULL, (void*)Socket__Send2_fn, 0, false, ::g::Uno::Int_typeof(), 4, ::g::Uno::Byte_typeof()->Array(), ::g::Uno::Int_typeof(), ::g::Uno::Int_typeof(), ::g::Uno::Net::Sockets::SocketFlags_typeof()),
...
// public bool Poll(int milliseconds, Uno.Net.Sockets.SelectMode mode) :1062
void Socket__Poll_fn(Socket* __this, int* milliseconds, int* mode, bool* __retval)
{
    *__retval = __this->Poll(*milliseconds, *mode);
}

// public int Receive(byte[] buffer, int offset, int length, Uno.Net.Sockets.SocketFlags flags) :997
...
{
    *__retval = __this->Send2(buffer, *offset, *length, *flags);
}

// public void Shutdown(Uno.Net.Sockets.SocketShutdown how) :1075
...
// public Uno.Net.Sockets.Socket Accept() [instance] :1091
...
// public void Bind(Uno.Net.EndPoint endPoint) [instance] :1024
...
// public void Close() [instance] :1104
void Socket::Close()
{
...
// public void Dispose() [instance] :1128
void Socket::Dispose()
{
...
// protected void Dispose(bool disposing) [instance] :1109
...
// public void Listen(int backlog) [instance] :1051
...
// public bool Poll(int milliseconds, Uno.Net.Sockets.SelectMode mode) [instance] :1062
...
// public int Receive(byte[] buffer, int offset, int length, Uno.Net.Sockets.SocketFlags flags) [instance] :997
...
int Socket::Send2(uArray* buffer, int offset, int length, int flags)
{
...
// public void Shutdown(Uno.Net.Sockets.SocketShutdown how) [instance] :1075
...
// public sealed class SocketException :1140
// {

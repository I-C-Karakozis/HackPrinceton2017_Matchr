...
// {
// static matchesPage() :144
static void matchesPage__cctor_4_fn(uType* __type)
{
    matchesPage::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 3, ::STRINGS[0/*"router"*/], ::STRINGS[1/*"navBar"*/], ::STRINGS[2/*"backButton"*/]);
    matchesPage::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[3/*"Opacity"*/]);
    matchesPage::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"router"*/]);
    matchesPage::__selector2_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[1/*"navBar"*/]);
    matchesPage::__selector3_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[2/*"backButton"*/]);
}

static void matchesPage_build(uType* type)
{
    ::STRINGS[0] = uString::Const("router");
    ::STRINGS[1] = uString::Const("navBar");
    ::STRINGS[2] = uString::Const("backButton");
    ::STRINGS[3] = uString::Const("Opacity");
    ::STRINGS[4] = uString::Const("Pages/matchesPage.ux");
    ...
    type->SetFields(102,
        ::g::Uno::UX::NameTable_typeof(), offsetof(::g::matchesPage, __g_nametable1), 0,
        ::g::Fuse::Controls::Panel_typeof(), offsetof(::g::matchesPage, backButton), 0,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float_typeof(), NULL), offsetof(::g::matchesPage, backButton_Opacity_inst), 0,
        ::g::Fuse::Controls::Panel_typeof(), offsetof(::g::matchesPage, navBar), 0,
        ::g::Fuse::Navigation::Router_typeof(), offsetof(::g::matchesPage, router), 0,
        ::TYPES[0/*string[]*/], (uintptr_t)&::g::matchesPage::__g_static_nametable1_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::matchesPage::__selector0_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::matchesPage::__selector1_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::matchesPage::__selector2_, uFieldFlagsStatic,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::matchesPage::__selector3_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)matchesPage__New5_fn, 0, true, type, 0));
}
...
::g::Fuse::Controls::Control_type* matchesPage_typeof()
{
    ...
    options.ObjectSize = sizeof(matchesPage);
    options.TypeSize = sizeof(::g::Fuse::Controls::Control_type);
    type = (::g::Fuse::Controls::Control_type*)uClassType::New("matchesPage", options);
    type->fp_build_ = matchesPage_build;
    type->fp_ctor_ = (void*)matchesPage__New5_fn;
    type->fp_cctor_ = matchesPage__cctor_4_fn;
...
// public matchesPage() :148
void matchesPage__ctor_8_fn(matchesPage* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :152
void matchesPage__InitializeUX_fn(matchesPage* __this)
{
    __this->InitializeUX();
}

// public matchesPage New() :148
void matchesPage__New5_fn(matchesPage** __retval)
{
    *__retval = matchesPage::New5();
}

uSStrong<uArray*> matchesPage::__g_static_nametable1_;
::g::Uno::UX::Selector matchesPage::__selector0_;
::g::Uno::UX::Selector matchesPage::__selector1_;
::g::Uno::UX::Selector matchesPage::__selector2_;
::g::Uno::UX::Selector matchesPage::__selector3_;

// public matchesPage() [instance] :148
void matchesPage::ctor_8()
{
    uStackFrame __("matchesPage", ".ctor()");
    ctor_7();
    InitializeUX();
}

// private void InitializeUX() [instance] :152
void matchesPage::InitializeUX()
{
    uStackFrame __("matchesPage", "InitializeUX()");
    __g_nametable1 = ::g::Uno::UX::NameTable::New1(NULL, matchesPage::__g_static_nametable1());
    backButton = ::g::Fuse::Controls::Panel::New3();
    backButton_Opacity_inst = ::g::matchr_signup_FuseElementsElement_Opacity_Property::New1(backButton, matchesPage::__selector0());
    ...
    matchesPage__Template* mainPage = matchesPage__Template::New2(this, this);
    matchesPage__Template1* subPage = matchesPage__Template1::New2(this, this);
    uPtr(router)->Name(matchesPage::__selector1());
    ...
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::matchr_signup_bundle::matchesPage9ac98513()));
    ...
    temp4->Style(1);
    uPtr(navBar)->Color(::g::Uno::Float4__New2(0.4235294f, 0.4784314f, 0.5372549f, 1.0f));
    uPtr(navBar)->Height(::g::Uno::UX::Size__New1(50.0f, 1));
    uPtr(navBar)->Name(matchesPage::__selector2());
    ...
    uPtr(backButton)->Name(matchesPage::__selector3());
    ...
    temp7->File(::g::Uno::UX::BundleFileSource::New1(::g::matchr_signup_bundle::arrowleftwhiteb2e831a8()));
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp16->Templates()), ::TYPES[5/*Uno.Collections.ICollection<Uno.UX.Template>*/]), subPage);
...
// public matchesPage New() [static] :148
matchesPage* matchesPage::New5()
{
    matchesPage* obj1 = (matchesPage*)uNew(matchesPage_typeof());
    obj1->ctor_8();
    return obj1;
}
// }

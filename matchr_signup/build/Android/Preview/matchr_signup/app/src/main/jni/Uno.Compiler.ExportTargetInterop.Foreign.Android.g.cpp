...
jboolean JNICALL callUno_Fuse_Controls_Native_Android_InputDispatch_OnTouch138(JNIEnv *env,jclass clazz,jobject view,jobject motionEvent,jlong viewPtr,jlong motionEventPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
jboolean JNICALL callUno_Fuse_Controls_Native_Android_TextInput_OnEditorAction206(JNIEnv *env,jclass clazz,jobject jthis,jint actionCode)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
jboolean JNICALL callUno_Fuse_Platform_SystemUI_firstSizingGet100(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jboolean __jresult;
...
jboolean JNICALL callUno_Fuse_Platform_SystemUI_hasCachedStatusBarSizeGet83(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jboolean __jresult;
...
jboolean JNICALL callUno_Uno_Platform_AndroidDisplay__initializedGet53(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jboolean __jresult;
...
jint JNICALL callUno_Fuse_Platform_SystemUI__systemUIStateGet76(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
jint JNICALL callUno_Fuse_Platform_SystemUI_cachedOpenSizeGet84(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
jint JNICALL callUno_Fuse_Platform_SystemUI_GetRealDisplayHeight72(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
jint JNICALL callUno_Fuse_Platform_SystemUI_GetRealDisplayWidth91(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
jint JNICALL callUno_Fuse_Platform_SystemUI_lastKeyboardHeightGet99(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
jint JNICALL callUno_Fuse_Platform_SystemUI_realHeightGet66(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
jint JNICALL callUno_Fuse_Platform_SystemUI_realWidthGet65(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jint __jresult;
...
jobject JNICALL callUno_Fuse_Platform_SystemUI__keyboardListenerGet63(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jobject __jresult;
...
jobject JNICALL callUno_Fuse_Platform_SystemUI_layoutAttachedToGet62(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jobject __jresult;
...
jobject JNICALL callUno_Fuse_Platform_SystemUI_RootLayoutGet69(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jobject __jresult;
...
jobject JNICALL callUno_Fuse_Platform_SystemUI_SuperLayoutGet67(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    jobject __jresult;
...
jobject JNICALL callUno_Neovisionaries_WebSocketClient__webSocketGet345(JNIEnv *env,jclass clazz,jobject jthis)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
jobject JNICALL callUno_Uno_IO_BundleFile_BundlePathGet287(JNIEnv *env,jclass clazz,jobject jthis)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Android_AppRoot_OnTouchEvent__305(JNIEnv *env,jclass clazz,jobject motionEvent,jlong motionEventPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Java::Object* uno_motionEvent = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(motionEvent, true);
...
void JNICALL callUno_Fuse_Android_StatusBarConfig_UpdateStatusBar328(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Fuse_Controls_Native_Android_FocusChangedListener_OnFocusChange121(JNIEnv *env,jclass clazz,jobject jthis,jboolean hasFocus)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Controls_Native_Android_Slider_OnSeekBarChanged181(JNIEnv *env,jclass clazz,jobject jthis,jdouble newProgress)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceChanged188(JNIEnv *env,jclass clazz,jobject jthis,jobject holder,jint f,jint w,jint h,jlong holderPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceCreated189(JNIEnv *env,jclass clazz,jobject jthis,jobject holder,jlong holderPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::Native::Android::SurfaceView* uno_jthis = uCast<::g::Fuse::Controls::Native::Android::SurfaceView*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::Native::Android::SurfaceView_typeof());
...
void JNICALL callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceDestroyed190(JNIEnv *env,jclass clazz,jobject jthis,jobject holder,jlong holderPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::Native::Android::SurfaceView* uno_jthis = uCast<::g::Fuse::Controls::Native::Android::SurfaceView*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::Native::Android::SurfaceView_typeof());
...
void JNICALL callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceRedrawNeeded187(JNIEnv *env,jclass clazz,jobject jthis,jobject holder,jlong holderPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::Native::Android::SurfaceView* uno_jthis = uCast<::g::Fuse::Controls::Native::Android::SurfaceView*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::Native::Android::SurfaceView_typeof());
...
void JNICALL callUno_Fuse_Controls_Native_Android_Switch_OnToggleChanged194(JNIEnv *env,jclass clazz,jobject jthis,jboolean value)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Controls_Native_Android_TextInput_OnTextChanged208(JNIEnv *env,jclass clazz,jobject jthis,jobject value)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::Native::Android::TextInput* uno_jthis = uCast<::g::Fuse::Controls::Native::Android::TextInput*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::Native::Android::TextInput_typeof());
...
void JNICALL callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnBuffer257(JNIEnv *env,jclass clazz,jobject jthis,jint percent)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnCompletion255(JNIEnv *env,jclass clazz,jobject jthis)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer* uno_jthis = uCast<::g::Fuse::Controls::VideoImpl::Android::MediaPlayer*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer_typeof());
...
void JNICALL callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnError256(JNIEnv *env,jclass clazz,jobject jthis,jint what,jint extra)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer* uno_jthis = uCast<::g::Fuse::Controls::VideoImpl::Android::MediaPlayer*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer_typeof());
...
void JNICALL callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnErrorOccurred269(JNIEnv *env,jclass clazz,jobject jthis,jobject msg)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer* uno_jthis = uCast<::g::Fuse::Controls::VideoImpl::Android::MediaPlayer*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer_typeof());
...
void JNICALL callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnFrameAvailable260(JNIEnv *env,jclass clazz,jobject jthis)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer* uno_jthis = uCast<::g::Fuse::Controls::VideoImpl::Android::MediaPlayer*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer_typeof());
...
void JNICALL callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnPrepared254(JNIEnv *env,jclass clazz,jobject jthis)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer* uno_jthis = uCast<::g::Fuse::Controls::VideoImpl::Android::MediaPlayer*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Fuse::Controls::VideoImpl::Android::MediaPlayer_typeof());
...
void JNICALL callUno_Fuse_Internal_AndroidSystemFont_AddAlias106(JNIEnv *env,jclass clazz,jobject name,jobject to,jint weight)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Internal_AndroidSystemFont_AddFamily104(JNIEnv *env,jclass clazz,jobject name,jobject language,jobject variant)
{
    uAutoReleasePool pool;
    INIT_JNI;
    uString* uno_name = JniHelper::JavaToUnoString((jstring)name);
...
void JNICALL callUno_Fuse_Internal_AndroidSystemFont_AddFont105(JNIEnv *env,jclass clazz,jobject path,jint index,jint weight,jboolean isItalic)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Internal_AndroidSystemFont_ThrowUno107(JNIEnv *env,jclass clazz,jobject message)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Platform_SystemUI__keyboardListenerSet63(JNIEnv *env,jclass clazz,jobject setVal,jlong setValPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Platform_SystemUI__systemUIStateSet76(JNIEnv *env,jclass clazz,jint setVal)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Platform_SystemUI_cachedOpenSizeSet84(JNIEnv *env,jclass clazz,jint setVal)
{
    uAutoReleasePool pool;
    INIT_JNI;
    int uno_setVal = (int)setVal;
...
void JNICALL callUno_Fuse_Platform_SystemUI_CompensateRootLayoutForSystemUI73(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Fuse_Platform_SystemUI_cppOnConfigChanged92(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Fuse_Platform_SystemUI_cppOnTopFrameChanged79(JNIEnv *env,jclass clazz,jint height)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Platform_SystemUI_firstSizingSet100(JNIEnv *env,jclass clazz,jboolean setVal)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Platform_SystemUI_hasCachedStatusBarSizeSet83(JNIEnv *env,jclass clazz,jboolean setVal)
{
    uAutoReleasePool pool;
    INIT_JNI;
    bool uno_setVal = (bool)setVal;
...
void JNICALL callUno_Fuse_Platform_SystemUI_layoutAttachedToSet62(JNIEnv *env,jclass clazz,jobject setVal,jlong setValPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Java::Object* uno_setVal = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(setVal, true);
...
void JNICALL callUno_Fuse_Platform_SystemUI_OnConfigChanged90(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Fuse_Platform_SystemUI_OnDestroy89(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Fuse_Platform_SystemUI_onHideKeyboard101(JNIEnv *env,jclass clazz,jint keyboardHeight,jboolean force)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Fuse_Platform_SystemUI_onShowKeyboard102(JNIEnv *env,jclass clazz,jint keyboardHeight,jboolean force)
{
    uAutoReleasePool pool;
    INIT_JNI;
    int uno_keyboardHeight = (int)keyboardHeight;
...
void JNICALL callUno_Fuse_Platform_SystemUI_realHeightSet66(JNIEnv *env,jclass clazz,jint setVal)
{
    uAutoReleasePool pool;
    INIT_JNI;
    int uno_setVal = (int)setVal;
...
void JNICALL callUno_Fuse_Platform_SystemUI_realWidthSet65(JNIEnv *env,jclass clazz,jint setVal)
{
    uAutoReleasePool pool;
    INIT_JNI;
    int uno_setVal = (int)setVal;
...
void JNICALL callUno_Fuse_Platform_SystemUI_ResendFrameSizes93(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Fuse_Platform_SystemUI_RootLayoutSet69(JNIEnv *env,jclass clazz,jobject setVal,jlong setValPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Java::Object* uno_setVal = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(setVal, true);
...
void JNICALL callUno_Fuse_Platform_SystemUI_SuperLayoutSet67(JNIEnv *env,jclass clazz,jobject setVal,jlong setValPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Java::Object* uno_setVal = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(setVal, true);
...
void JNICALL callUno_Fuse_Platform_SystemUI_UpdateStatusBar96(JNIEnv *env,jclass clazz)
{
    uAutoReleasePool pool;
    INIT_JNI;
    JTRY
...
void JNICALL callUno_Neovisionaries_WebSocketClient__webSocketSet345(JNIEnv *env,jclass clazz,jobject jthis,jobject setVal,jlong setValPtr)
{
    uAutoReleasePool pool;
    INIT_JNI;
    ::g::Neovisionaries::WebSocketClient* uno_jthis = uCast<::g::Neovisionaries::WebSocketClient*>(::g::Uno::Compiler::ExportTargetInterop::Foreign::Android::JavaUnoObject::UnBox(jthis), ::g::Neovisionaries::WebSocketClient_typeof());
...
void JNICALL callUno_Uno_Collections_List_lt_string_gt__Add57(JNIEnv *env,jclass clazz,jobject jthis,jobject item)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
void JNICALL callUno_Uno_Platform_AndroidDisplay__initializedSet53(JNIEnv *env,jclass clazz,jboolean setVal)
{
    uAutoReleasePool pool;
    INIT_JNI;
    bool uno_setVal = (bool)setVal;
...
void JNICALL callUno_Uno_Platform_AndroidDisplay_OnFrameCallback54(JNIEnv *env,jclass clazz,jobject jthis,jdouble currentTime,jdouble deltaTime)
{
    uAutoReleasePool pool;
    INIT_JNI;
...
// /Users/hdc/Library/Application Support/Fusetools/Packages/UnoCore/0.46.1/source/uno/compiler/exporttargetinterop/foreign/android/$.uno
// --------------------------------------------------------------------------------------------------------------------------------------
...
void ExternBlockHost::RegisterFunctions()
{
    ...
    {(char* const)"callUno_Uno_Platform_AndroidDisplay__initializedGet53", (char* const)"()Z", (void *)&callUno_Uno_Platform_AndroidDisplay__initializedGet53},
    {(char* const)"callUno_Uno_Platform_AndroidDisplay__initializedSet53", (char* const)"(Z)V", (void *)&callUno_Uno_Platform_AndroidDisplay__initializedSet53},
    {(char* const)"callUno_Uno_Platform_AndroidDisplay_OnFrameCallback54", (char* const)"(Lcom/uno/UnoObject;DD)V", (void *)&callUno_Uno_Platform_AndroidDisplay_OnFrameCallback54},
    {(char* const)"callUno_Uno_Collections_List_lt_string_gt__Add57", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/String;)V", (void *)&callUno_Uno_Collections_List_lt_string_gt__Add57},
    {(char* const)"callUno_Fuse_Platform_SystemUI_layoutAttachedToGet62", (char* const)"()Ljava/lang/Object;", (void *)&callUno_Fuse_Platform_SystemUI_layoutAttachedToGet62},
    {(char* const)"callUno_Fuse_Platform_SystemUI_layoutAttachedToSet62", (char* const)"(Ljava/lang/Object;J)V", (void *)&callUno_Fuse_Platform_SystemUI_layoutAttachedToSet62},
    {(char* const)"callUno_Fuse_Platform_SystemUI__keyboardListenerGet63", (char* const)"()Ljava/lang/Object;", (void *)&callUno_Fuse_Platform_SystemUI__keyboardListenerGet63},
    {(char* const)"callUno_Fuse_Platform_SystemUI_realWidthSet65", (char* const)"(I)V", (void *)&callUno_Fuse_Platform_SystemUI_realWidthSet65},
    {(char* const)"callUno_Fuse_Platform_SystemUI_realHeightSet66", (char* const)"(I)V", (void *)&callUno_Fuse_Platform_SystemUI_realHeightSet66},
    {(char* const)"callUno_Fuse_Platform_SystemUI_SuperLayoutGet67", (char* const)"()Ljava/lang/Object;", (void *)&callUno_Fuse_Platform_SystemUI_SuperLayoutGet67},
    {(char* const)"callUno_Fuse_Platform_SystemUI_realHeightGet66", (char* const)"()I", (void *)&callUno_Fuse_Platform_SystemUI_realHeightGet66},
    {(char* const)"callUno_Fuse_Platform_SystemUI_realWidthGet65", (char* const)"()I", (void *)&callUno_Fuse_Platform_SystemUI_realWidthGet65},
    {(char* const)"callUno_Fuse_Platform_SystemUI_SuperLayoutSet67", (char* const)"(Ljava/lang/Object;J)V", (void *)&callUno_Fuse_Platform_SystemUI_SuperLayoutSet67},
    {(char* const)"callUno_Fuse_Platform_SystemUI_RootLayoutSet69", (char* const)"(Ljava/lang/Object;J)V", (void *)&callUno_Fuse_Platform_SystemUI_RootLayoutSet69},
    {(char* const)"callUno_Fuse_Platform_SystemUI_RootLayoutGet69", (char* const)"()Ljava/lang/Object;", (void *)&callUno_Fuse_Platform_SystemUI_RootLayoutGet69},
    {(char* const)"callUno_Fuse_Platform_SystemUI_GetRealDisplayHeight72", (char* const)"()I", (void *)&callUno_Fuse_Platform_SystemUI_GetRealDisplayHeight72},
    {(char* const)"callUno_Fuse_Platform_SystemUI_CompensateRootLayoutForSystemUI73", (char* const)"()V", (void *)&callUno_Fuse_Platform_SystemUI_CompensateRootLayoutForSystemUI73},
    {(char* const)"callUno_Fuse_Platform_SystemUI__systemUIStateSet76", (char* const)"(I)V", (void *)&callUno_Fuse_Platform_SystemUI__systemUIStateSet76},
    {(char* const)"callUno_Fuse_Platform_SystemUI_cppOnTopFrameChanged79", (char* const)"(I)V", (void *)&callUno_Fuse_Platform_SystemUI_cppOnTopFrameChanged79},
    {(char* const)"callUno_Fuse_Platform_SystemUI__systemUIStateGet76", (char* const)"()I", (void *)&callUno_Fuse_Platform_SystemUI__systemUIStateGet76},
    {(char* const)"callUno_Fuse_Platform_SystemUI_hasCachedStatusBarSizeGet83", (char* const)"()Z", (void *)&callUno_Fuse_Platform_SystemUI_hasCachedStatusBarSizeGet83},
    {(char* const)"callUno_Fuse_Platform_SystemUI_cachedOpenSizeGet84", (char* const)"()I", (void *)&callUno_Fuse_Platform_SystemUI_cachedOpenSizeGet84},
    {(char* const)"callUno_Fuse_Platform_SystemUI_hasCachedStatusBarSizeSet83", (char* const)"(Z)V", (void *)&callUno_Fuse_Platform_SystemUI_hasCachedStatusBarSizeSet83},
    {(char* const)"callUno_Fuse_Platform_SystemUI_cachedOpenSizeSet84", (char* const)"(I)V", (void *)&callUno_Fuse_Platform_SystemUI_cachedOpenSizeSet84},
    {(char* const)"callUno_Fuse_Platform_SystemUI_OnDestroy89", (char* const)"()V", (void *)&callUno_Fuse_Platform_SystemUI_OnDestroy89},
    {(char* const)"callUno_Fuse_Platform_SystemUI_OnConfigChanged90", (char* const)"()V", (void *)&callUno_Fuse_Platform_SystemUI_OnConfigChanged90},
    {(char* const)"callUno_Fuse_Platform_SystemUI_GetRealDisplayWidth91", (char* const)"()I", (void *)&callUno_Fuse_Platform_SystemUI_GetRealDisplayWidth91},
    {(char* const)"callUno_Fuse_Platform_SystemUI_cppOnConfigChanged92", (char* const)"()V", (void *)&callUno_Fuse_Platform_SystemUI_cppOnConfigChanged92},
    {(char* const)"callUno_Fuse_Platform_SystemUI_ResendFrameSizes93", (char* const)"()V", (void *)&callUno_Fuse_Platform_SystemUI_ResendFrameSizes93},
    {(char* const)"callUno_Fuse_Platform_SystemUI__keyboardListenerSet63", (char* const)"(Ljava/lang/Object;J)V", (void *)&callUno_Fuse_Platform_SystemUI__keyboardListenerSet63},
    {(char* const)"callUno_Fuse_Platform_SystemUI_UpdateStatusBar96", (char* const)"()V", (void *)&callUno_Fuse_Platform_SystemUI_UpdateStatusBar96},
    {(char* const)"callUno_Fuse_Platform_SystemUI_lastKeyboardHeightGet99", (char* const)"()I", (void *)&callUno_Fuse_Platform_SystemUI_lastKeyboardHeightGet99},
    {(char* const)"callUno_Fuse_Platform_SystemUI_firstSizingGet100", (char* const)"()Z", (void *)&callUno_Fuse_Platform_SystemUI_firstSizingGet100},
    {(char* const)"callUno_Fuse_Platform_SystemUI_onHideKeyboard101", (char* const)"(IZ)V", (void *)&callUno_Fuse_Platform_SystemUI_onHideKeyboard101},
    {(char* const)"callUno_Fuse_Platform_SystemUI_onShowKeyboard102", (char* const)"(IZ)V", (void *)&callUno_Fuse_Platform_SystemUI_onShowKeyboard102},
    {(char* const)"callUno_Fuse_Platform_SystemUI_firstSizingSet100", (char* const)"(Z)V", (void *)&callUno_Fuse_Platform_SystemUI_firstSizingSet100},
    {(char* const)"callUno_Fuse_Internal_AndroidSystemFont_AddFamily104", (char* const)"(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", (void *)&callUno_Fuse_Internal_AndroidSystemFont_AddFamily104},
    {(char* const)"callUno_Fuse_Internal_AndroidSystemFont_AddFont105", (char* const)"(Ljava/lang/String;IIZ)V", (void *)&callUno_Fuse_Internal_AndroidSystemFont_AddFont105},
    {(char* const)"callUno_Fuse_Internal_AndroidSystemFont_AddAlias106", (char* const)"(Ljava/lang/String;Ljava/lang/String;I)V", (void *)&callUno_Fuse_Internal_AndroidSystemFont_AddAlias106},
    {(char* const)"callUno_Fuse_Internal_AndroidSystemFont_ThrowUno107", (char* const)"(Ljava/lang/String;)V", (void *)&callUno_Fuse_Internal_AndroidSystemFont_ThrowUno107},
    {(char* const)"callUno_Fuse_Controls_Native_Android_FocusChangedListener_OnFocusChange121", (char* const)"(Lcom/uno/UnoObject;Z)V", (void *)&callUno_Fuse_Controls_Native_Android_FocusChangedListener_OnFocusChange121},
    ...
    {(char* const)"callUno_Fuse_Controls_Native_Android_InputDispatch_OnTouch138", (char* const)"(Ljava/lang/Object;Ljava/lang/Object;JJ)Z", (void *)&callUno_Fuse_Controls_Native_Android_InputDispatch_OnTouch138},
    ...
    {(char* const)"callUno_Fuse_Controls_Native_Android_Slider_OnSeekBarChanged181", (char* const)"(Lcom/uno/UnoObject;D)V", (void *)&callUno_Fuse_Controls_Native_Android_Slider_OnSeekBarChanged181},
    {(char* const)"callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceRedrawNeeded187", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/Object;J)V", (void *)&callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceRedrawNeeded187},
    {(char* const)"callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceChanged188", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/Object;IIIJ)V", (void *)&callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceChanged188},
    {(char* const)"callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceCreated189", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/Object;J)V", (void *)&callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceCreated189},
    {(char* const)"callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceDestroyed190", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/Object;J)V", (void *)&callUno_Fuse_Controls_Native_Android_SurfaceView_OnSurfaceDestroyed190},
    {(char* const)"callUno_Fuse_Controls_Native_Android_Switch_OnToggleChanged194", (char* const)"(Lcom/uno/UnoObject;Z)V", (void *)&callUno_Fuse_Controls_Native_Android_Switch_OnToggleChanged194},
    {(char* const)"callUno_Fuse_Controls_Native_Android_TextInput_OnEditorAction206", (char* const)"(Lcom/uno/UnoObject;I)Z", (void *)&callUno_Fuse_Controls_Native_Android_TextInput_OnEditorAction206},
    {(char* const)"callUno_Fuse_Controls_Native_Android_TextInput_OnTextChanged208", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/String;)V", (void *)&callUno_Fuse_Controls_Native_Android_TextInput_OnTextChanged208},
    {(char* const)"callUno_Func_Object", (char* const)"(Lcom/foreign/Uno/Func_Object;Ljava/lang/Object;J)Z", (void *)&callUno_Func_Object},
    {(char* const)"callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnPrepared254", (char* const)"(Lcom/uno/UnoObject;)V", (void *)&callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnPrepared254},
    {(char* const)"callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnCompletion255", (char* const)"(Lcom/uno/UnoObject;)V", (void *)&callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnCompletion255},
    {(char* const)"callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnError256", (char* const)"(Lcom/uno/UnoObject;II)V", (void *)&callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnError256},
    {(char* const)"callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnBuffer257", (char* const)"(Lcom/uno/UnoObject;I)V", (void *)&callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnBuffer257},
    {(char* const)"callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnFrameAvailable260", (char* const)"(Lcom/uno/UnoObject;)V", (void *)&callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnFrameAvailable260},
    {(char* const)"callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnErrorOccurred269", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/String;)V", (void *)&callUno_Fuse_Controls_VideoImpl_Android_MediaPlayer_OnErrorOccurred269},
    {(char* const)"callUno_Uno_IO_BundleFile_BundlePathGet287", (char* const)"(Lcom/uno/UnoObject;)Ljava/lang/String;", (void *)&callUno_Uno_IO_BundleFile_BundlePathGet287},
    ...
    {(char* const)"callUno_Fuse_Android_AppRoot_OnTouchEvent__305", (char* const)"(Ljava/lang/Object;J)V", (void *)&callUno_Fuse_Android_AppRoot_OnTouchEvent__305},
    {(char* const)"callUno_Fuse_Android_StatusBarConfig_UpdateStatusBar328", (char* const)"()V", (void *)&callUno_Fuse_Android_StatusBarConfig_UpdateStatusBar328},
    {(char* const)"callUno_Neovisionaries_WebSocketClient__webSocketGet345", (char* const)"(Lcom/uno/UnoObject;)Ljava/lang/Object;", (void *)&callUno_Neovisionaries_WebSocketClient__webSocketGet345},
    ...
    {(char* const)"callUno_Neovisionaries_WebSocketClient__webSocketSet345", (char* const)"(Lcom/uno/UnoObject;Ljava/lang/Object;J)V", (void *)&callUno_Neovisionaries_WebSocketClient__webSocketSet345},
    };
    int funcCount = 118;
...
// public static long BoolArrayToUnoArrayPtr(Java.Object jarr) :891
...
// public static long ByteArrayToUnoArrayPtr(Java.Object jarr) :905
...
// public static long DoubleArrayToUnoArrayPtr(Java.Object jarr) :975
...
// public static long FloatArrayToUnoArrayPtr(Java.Object jarr) :961
...
// public static long IntArrayToUnoArrayPtr(Java.Object jarr) :933
...
// public static long LongArrayToUnoArrayPtr(Java.Object jarr) :947
...
// public static long ShortArrayToUnoArrayPtr(Java.Object jarr) :919
...
// public static long BoolArrayToUnoArrayPtr(Java.Object jarr) [static] :891
...
// public static long ByteArrayToUnoArrayPtr(Java.Object jarr) [static] :905
...
// public static long DoubleArrayToUnoArrayPtr(Java.Object jarr) [static] :975
...
// public static long FloatArrayToUnoArrayPtr(Java.Object jarr) [static] :961
...
// public static long IntArrayToUnoArrayPtr(Java.Object jarr) [static] :933
...
// public static long LongArrayToUnoArrayPtr(Java.Object jarr) [static] :947
...
// public static long ShortArrayToUnoArrayPtr(Java.Object jarr) [static] :919

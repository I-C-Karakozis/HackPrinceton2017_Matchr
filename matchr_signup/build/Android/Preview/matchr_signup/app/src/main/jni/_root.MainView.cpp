...
static void MainView__cctor_1_fn(uType* __type)
{
    ...
    ::g::Uno::UX::Resource::SetGlobalKey(::g::Fuse::Font::PlatformDefault(), ::STRINGS[71/*"PlatformDef...*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(::g::Fuse::ScalingModes::Identity(), ::STRINGS[72/*"Identity"*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(::g::Fuse::TranslationModes::Local(), ::STRINGS[73/*"Local"*/]);
    ...
    MainView::MainViewComfortaa_ = ::g::Fuse::Font::New2(::g::Uno::UX::BundleFileSource::New1(::g::matchr_signup_bundle::ComfortaaRegular334c2c0a()));
    MainView::MainViewComfortaaBold_ = ::g::Fuse::Font::New2(::g::Uno::UX::BundleFileSource::New1(::g::matchr_signup_bundle::ComfortaaBolde878d079()));
    ::g::Uno::UX::Resource::SetGlobalKey(MainView::MainViewComfortaa_, ::STRINGS[77/*"MainView/Co...*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(MainView::MainViewComfortaaBold_, ::STRINGS[78/*"MainView/Co...*/]);
}
...
static void MainView_build(uType* type)
{
    ...
    ::STRINGS[71] = uString::Const("PlatformDefault");
    ::STRINGS[72] = uString::Const("Identity");
    ::STRINGS[73] = uString::Const("Local");

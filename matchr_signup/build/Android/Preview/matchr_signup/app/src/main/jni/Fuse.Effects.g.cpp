...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Effects/0.46.1/$.uno
// -----------------------------------------------------------------------------------
...
// protected BasicEffect(Fuse.Effects.EffectType effectType) :11
...
// protected BasicEffect(Fuse.Effects.EffectType effectType) [instance] :11
...
// private sealed class DropShadow.Blitter :357
// {
...
// public generated Blitter() :357
void DropShadow__Blitter__ctor__fn(DropShadow__Blitter* __this)
{
    __this->ctor_();
}

// public void Blit(Fuse.DrawContext dc, Fuse.Elements.Element element, Uno.Rect elementRect, float padding, int2 tempSize, texture2D blurTexture, float spreadScale, float2 offset, float4 color) :365
...
// public generated Blitter() [instance] :357
void DropShadow__Blitter::ctor_()
{
    init_DrawCalls();
}

// public void Blit(Fuse.DrawContext dc, Fuse.Elements.Element element, Uno.Rect elementRect, float padding, int2 tempSize, texture2D blurTexture, float spreadScale, float2 offset, float4 color) [instance] :365
...
// private generated void init_DrawCalls() [instance] :357
...
// public generated Blitter New() [static] :357
...
// public static Fuse.Effects.DropShadow.Blitter get_Instance() [static] :362
...
// private generated void init_DrawCalls() :62
...
// private generated void init_DrawCalls() [instance] :62
...
// private generated void init_DrawCalls() :139
void Desaturate__init_DrawCalls_fn(Desaturate* __this)
{
    __this->init_DrawCalls();
}

// public Desaturate New() :141
...
// public Desaturate() [instance] :141
...
// private generated void init_DrawCalls() [instance] :139
...
// public Desaturate New() [static] :141
...
// public sealed class DropShadow :200
// {
...
// public float get_Angle() [instance] :228
float DropShadow::Angle()
{
    return _angle;
}

// public void set_Angle(float value) [instance] :229
...
// public float4 get_Color() [instance] :298
::g::Uno::Float4 DropShadow::Color()
{
    return _color;
}

// public void set_Color(float4 value) [instance] :302
...
// public float get_Distance() [instance] :248
float DropShadow::Distance()
{
    return _distance;
}

// public void set_Distance(float value) [instance] :249
...
// private float2 get_Offset() [instance] :266
...
// internal float get_Padding() [instance] :317
...
// private float get_Radius() [instance] :222
float DropShadow::Radius()
{
    return Size() / 2.0f;
}

// internal float get_Sigma() [instance] :316
float DropShadow::Sigma()
{
    return ::g::Uno::Math::Max1(Radius(), 1e-05f);
}

// public float get_Size() [instance] :206
float DropShadow::Size()
{
    return _size;
}

// public void set_Size(float value) [instance] :207
...
// public float get_Spread() [instance] :277
float DropShadow::Spread()
{
    return _spread;
}

// public void set_Spread(float value) [instance] :278
...
// public DropShadow New() [static] :349
...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.46.1/effects/$.uno
// --------------------------------------------------------------------------------------------
...
// protected Effect(Fuse.Effects.EffectType effectType) :22
...
// protected Effect(Fuse.Effects.EffectType effectType) [instance] :22
...
// internal partial sealed class EffectHelpers :394
// {
...
// public generated EffectHelpers() :394
void EffectHelpers__ctor__fn(EffectHelpers* __this)
{
    __this->ctor_();
}

// public framebuffer Blur(texture2D original, Fuse.DrawContext dc, float sigma) :402
...
// private framebuffer BlurHorizontal(Fuse.DrawContext dc, int2 size, texture2D tex, float sigma, int samples) :541
...
// private framebuffer BlurVertical(Fuse.DrawContext dc, int2 size, texture2D tex, float sigma, int samples) :553
...
// private void GaussianBlurSeparable(texture2D tex, float2 dir, float sigma, int samples) :565
...
// private generated void init_DrawCalls() :394
void EffectHelpers__init_DrawCalls_fn(EffectHelpers* __this)
{
    __this->init_DrawCalls();
}

// public static Fuse.Effects.EffectHelpers get_Instance() :399
void EffectHelpers__get_Instance_fn(EffectHelpers** __retval)
{
    *__retval = EffectHelpers::Instance();
}

// public generated EffectHelpers New() :394
void EffectHelpers__New1_fn(EffectHelpers** __retval)
{
    *__retval = EffectHelpers::New1();
}

// private framebuffer ResampleGaussian5tap(Fuse.DrawContext dc, texture2D tex, int2 size) :452
...
// public generated EffectHelpers() [instance] :394
void EffectHelpers::ctor_()
{
    init_DrawCalls();
}

// public framebuffer Blur(texture2D original, Fuse.DrawContext dc, float sigma) [instance] :402
...
// private framebuffer BlurHorizontal(Fuse.DrawContext dc, int2 size, texture2D tex, float sigma, int samples) [instance] :541
...
// private framebuffer BlurVertical(Fuse.DrawContext dc, int2 size, texture2D tex, float sigma, int samples) [instance] :553
...
// private void GaussianBlurSeparable(texture2D tex, float2 dir, float sigma, int samples) [instance] :565
...
// private generated void init_DrawCalls() [instance] :394
...
// private framebuffer ResampleGaussian5tap(Fuse.DrawContext dc, texture2D tex, int2 size) [instance] :452
...
// public generated EffectHelpers New() [static] :394
...
// public static Fuse.Effects.EffectHelpers get_Instance() [static] :399
...
// public sealed class Halftone :626
// {
...
// public float get_DotTint() [instance] :681
float Halftone::DotTint()
{
    return _dotTint;
}

// public void set_DotTint(float value) [instance] :682
...
// private generated void init_DrawCalls() [instance] :626
...
// public float get_Intensity() [instance] :651
float Halftone::Intensity()
{
    return _intensity;
}

// public void set_Intensity(float value) [instance] :652
...
// public float get_PaperTint() [instance] :696
float Halftone::PaperTint()
{
    return _paperTint;
}

// public void set_PaperTint(float value) [instance] :697
...
// public float get_Smoothness() [instance] :666
float Halftone::Smoothness()
{
    return _smoothness;
}

// public void set_Smoothness(float value) [instance] :667
...
// public float get_Spacing() [instance] :636
float Halftone::Spacing()
{
    return _spacing;
}

// public void set_Spacing(float value) [instance] :637
...
// public Halftone New() [static] :628
...
// public Uno.UX.FileSource get_File() :909
void Mask__get_File_fn(Mask* __this, ::g::Uno::UX::FileSource** __retval)
{
    *__retval = __this->File();
}

// public void set_File(Uno.UX.FileSource value) :910
void Mask__set_File_fn(Mask* __this, ::g::Uno::UX::FileSource* value)
{
    __this->File(value);
}

// private void Fuse.Internal.IImageContainerOwner.OnParamChanged() :787
...
// private void Fuse.Internal.IImageContainerOwner.OnSizingChanged() :792
...
// private void Fuse.Internal.IImageContainerOwner.OnSourceChanged() :782
...
// private generated void init_DrawCalls() :770
void Mask__init_DrawCalls_fn(Mask* __this)
{
    __this->init_DrawCalls();
}

// public Fuse.Effects.Mask.MaskMode get_Mode() :812
void Mask__get_Mode_fn(Mask* __this, int* __retval)
{
    *__retval = __this->Mode();
}

// public void set_Mode(Fuse.Effects.Mask.MaskMode value) :813
void Mask__set_Mode_fn(Mask* __this, int* value)
{
    __this->Mode(*value);
}

// public override sealed Fuse.VisualBounds ModifyRenderBounds(Fuse.VisualBounds inBounds) :823
...
// protected override sealed void OnRender(Fuse.DrawContext dc, Uno.Rect elementRect) :829
...
// public Uno.UX.FileSource get_File() [instance] :909
...
// public void set_File(Uno.UX.FileSource value) [instance] :910
...
// private generated void init_DrawCalls() [instance] :770
...
// public Fuse.Effects.Mask.MaskMode get_Mode() [instance] :812
int Mask::Mode()
{
    return _mode;
}

// public void set_Mode(Fuse.Effects.Mask.MaskMode value) [instance] :813
...
// public Fuse.Resources.ImageSource get_Source() [instance] :917
...
// public void set_Source(Fuse.Resources.ImageSource value) [instance] :918

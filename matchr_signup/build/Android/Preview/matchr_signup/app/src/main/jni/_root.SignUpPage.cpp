// This file was generated based on /Users/hdc/Downloads/matchr_signup/build/Android/Preview/cache/ux11/SignUpPage.g.uno.
...
void SignUpPage::InitializeUX()
{
    ...
    temp5->Opacity(0.9f);
    temp5->Layer(1);
    temp5->File(::g::Uno::UX::BundleFileSource::New1(::g::matchr_signup_bundle::balloon1a46f8ea()));
    temp6->LineNumber(5);
    temp6->FileName(::STRINGS[10/*"Pages/SignU...*/]);
    temp6->File(::g::Uno::UX::BundleFileSource::New1(::g::matchr_signup_bundle::SignUpPage6c27b680()));

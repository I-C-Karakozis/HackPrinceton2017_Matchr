...
static void GeneratedApplication_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/Users/hdc/Downloads/matchr_signup/matchr_signup.unoproj");
...
::g::Uno::IO::Bundle* GeneratedApplication::GetBundle()
{
    ...
    return ::g::Uno::IO::Bundle::Get(::STRINGS[3/*"matchr_signup"*/]);
}

...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/0.46.1/textcontrols/fusetextrenderer/$.uno
// -----------------------------------------------------------------------------------------------------------------------------

// internal sealed class AsyncMeasurer :703
// {
...
// public AsyncMeasurer(Fuse.Controls.FuseTextRenderer.CacheState state, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Action<Fuse.Controls.FuseTextRenderer.CacheState> done) :709
...
// public AsyncMeasurer New(Fuse.Controls.FuseTextRenderer.CacheState state, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Action<Fuse.Controls.FuseTextRenderer.CacheState> done) :709
...
// public AsyncMeasurer(Fuse.Controls.FuseTextRenderer.CacheState state, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Action<Fuse.Controls.FuseTextRenderer.CacheState> done) [instance] :709
...
// public AsyncMeasurer New(Fuse.Controls.FuseTextRenderer.CacheState state, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Action<Fuse.Controls.FuseTextRenderer.CacheState> done) [static] :709
...
// protected generated CacheState() :139
void CacheState__ctor__fn(CacheState* __this)
{
    __this->ctor_();
}

// public virtual void Dispose() :176
void CacheState__Dispose_fn(CacheState* __this)
{
}

// public Fuse.Controls.FuseTextRenderer.CacheState GetBounds(Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Rect& bounds) :147
...
// public Fuse.Controls.FuseTextRenderer.CacheState GetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer) :159
...
// public virtual bool TryGetMeasurements(Fuse.Controls.FuseTextRenderer.TextControlData data, float2& measurements) :142
...
// public bool TryGetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer) :170
...
// public virtual bool TryGetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer, Uno.Collections.List<Fuse.Text.PositionedRun>& positionedRuns) :164
...
// protected generated CacheState() [instance] :139
void CacheState::ctor_()
{
}

// public Fuse.Controls.FuseTextRenderer.CacheState GetBounds(Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Rect& bounds) [instance] :147
...
// public Fuse.Controls.FuseTextRenderer.CacheState GetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer) [instance] :159
...
// public bool TryGetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer) [instance] :170
...
// public override sealed void Dispose() :449
...
// public override sealed Fuse.Controls.FuseTextRenderer.CacheState GetMeasurements(Fuse.Controls.FuseTextRenderer.TextControlData data, float2& measurements) :396
...
// public override sealed Fuse.Controls.FuseTextRenderer.CacheState GetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer, Uno.Collections.List<Fuse.Text.PositionedRun>& positionedRuns) :421
...
// public override sealed bool TryGetMeasurements(Fuse.Controls.FuseTextRenderer.TextControlData data, float2& measurements) :409
...
// public override sealed bool TryGetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer, Uno.Collections.List<Fuse.Text.PositionedRun>& positionedRuns) :434
...
// public EverythingCached(Fuse.Controls.FuseTextRenderer.LogicalRunsCached previousState, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns, Fuse.Controls.FuseTextRenderer.Tolerances tolerances, float2 measurements, Fuse.Text.Renderer renderer, Uno.Collections.List<Fuse.Text.PositionedRun> positionedRuns) [instance] :379
...
// public EverythingCached New(Fuse.Controls.FuseTextRenderer.LogicalRunsCached previousState, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns, Fuse.Controls.FuseTextRenderer.Tolerances tolerances, float2 measurements, Fuse.Text.Renderer renderer, Uno.Collections.List<Fuse.Text.PositionedRun> positionedRuns) [static] :379
...
// internal static class Helpers :74
// {
...
// public static Fuse.Text.Renderer GetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns, Uno.Collections.List<Fuse.Text.PositionedRun>& positionedRuns) :112
...
// public static float2 Measure(Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns) :105
...
// public static float ToAlignmentNumber(Fuse.Controls.TextAlignment alignment) :127
void Helpers__ToAlignmentNumber_fn(int* alignment, float* __retval)
{
    *__retval = Helpers::ToAlignmentNumber(*alignment);
}

// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> Wrap(Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.Bidirectional.Run>> logicalRuns, Fuse.Controls.FuseTextRenderer.Tolerances& tolerances) :76
...
// public static Fuse.Text.Renderer GetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns, Uno.Collections.List<Fuse.Text.PositionedRun>& positionedRuns) [static] :112
...
// public static float2 Measure(Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns) [static] :105
...
// public static float ToAlignmentNumber(Fuse.Controls.TextAlignment alignment) [static] :127
...
// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> Wrap(Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.Bidirectional.Run>> logicalRuns, Fuse.Controls.FuseTextRenderer.Tolerances& tolerances) [static] :76
...
// public LogicalRunsCached(string renderValue) :210
void LogicalRunsCached__ctor_1_fn(LogicalRunsCached* __this, uString* renderValue)
{
    __this->ctor_1(renderValue);
}

// public override sealed Fuse.Controls.FuseTextRenderer.CacheState GetMeasurements(Fuse.Controls.FuseTextRenderer.TextControlData data, float2& measurements) :216
...
// public override sealed Fuse.Controls.FuseTextRenderer.CacheState GetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer, Uno.Collections.List<Fuse.Text.PositionedRun>& positionedRuns) :227
...
// public LogicalRunsCached New(string renderValue) :210
...
// public LogicalRunsCached(string renderValue) [instance] :210
...
// public LogicalRunsCached New(string renderValue) [static] :210
...
// public MeasurementsCached(Fuse.Controls.FuseTextRenderer.LogicalRunsCached previousState, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns, Fuse.Controls.FuseTextRenderer.Tolerances tolerances, float2 measurements) :247
...
// public override sealed Fuse.Controls.FuseTextRenderer.CacheState GetMeasurements(Fuse.Controls.FuseTextRenderer.TextControlData data, float2& measurements) :256
...
// public override sealed Fuse.Controls.FuseTextRenderer.CacheState GetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer, Uno.Collections.List<Fuse.Text.PositionedRun>& positionedRuns) :280
...
// public MeasurementsCached New(Fuse.Controls.FuseTextRenderer.LogicalRunsCached previousState, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns, Fuse.Controls.FuseTextRenderer.Tolerances tolerances, float2 measurements) :247
...
// public override sealed bool TryGetMeasurements(Fuse.Controls.FuseTextRenderer.TextControlData data, float2& measurements) :268
...
// public MeasurementsCached(Fuse.Controls.FuseTextRenderer.LogicalRunsCached previousState, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns, Fuse.Controls.FuseTextRenderer.Tolerances tolerances, float2 measurements) [instance] :247
...
// public generated NothingCached() :179
void NothingCached__ctor_1_fn(NothingCached* __this)
{
    __this->ctor_1();
}

// public override sealed Fuse.Controls.FuseTextRenderer.CacheState GetMeasurements(Fuse.Controls.FuseTextRenderer.TextControlData data, float2& measurements) :181
...
// public override sealed Fuse.Controls.FuseTextRenderer.CacheState GetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer, Uno.Collections.List<Fuse.Text.PositionedRun>& positionedRuns) :192
...
// public generated NothingCached New() :179
void NothingCached__New1_fn(NothingCached** __retval)
{
    *__retval = NothingCached::New1();
}

// public generated NothingCached() [instance] :179
void NothingCached::ctor_1()
{
    ctor_();
}

// public generated NothingCached New() [static] :179
...
// public RendererCached(Fuse.Controls.FuseTextRenderer.LogicalRunsCached previousState, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns, Fuse.Controls.FuseTextRenderer.Tolerances tolerances, Fuse.Text.Renderer renderer, Uno.Collections.List<Fuse.Text.PositionedRun> positionedRuns) :306
...
// public override sealed void Dispose() :364
...
// public override sealed Fuse.Controls.FuseTextRenderer.CacheState GetMeasurements(Fuse.Controls.FuseTextRenderer.TextControlData data, float2& measurements) :316
...
// public override sealed Fuse.Controls.FuseTextRenderer.CacheState GetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer, Uno.Collections.List<Fuse.Text.PositionedRun>& positionedRuns) :335
...
// public override sealed bool TryGetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer, Uno.Collections.List<Fuse.Text.PositionedRun>& positionedRuns) :348
...
// public RendererCached(Fuse.Controls.FuseTextRenderer.LogicalRunsCached previousState, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns, Fuse.Controls.FuseTextRenderer.Tolerances tolerances, Fuse.Text.Renderer renderer, Uno.Collections.List<Fuse.Text.PositionedRun> positionedRuns) [instance] :306
...
// public RendererCached New(Fuse.Controls.FuseTextRenderer.LogicalRunsCached previousState, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns, Fuse.Controls.FuseTextRenderer.Tolerances tolerances, Fuse.Text.Renderer renderer, Uno.Collections.List<Fuse.Text.PositionedRun> positionedRuns) [static] :306
...
// public bool Subsumes(Fuse.Controls.FuseTextRenderer.TextControlData other, Fuse.Controls.FuseTextRenderer.Tolerances tolerances, bool measureOnly) :31
...
// public bool Subsumes(Fuse.Controls.FuseTextRenderer.TextControlData other, Fuse.Controls.FuseTextRenderer.Tolerances tolerances, bool measureOnly) [instance] :31
...
// internal sealed class TextRenderer :472
// {
// static TextRenderer() :472
...
static void TextRenderer_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/0.46.1/textcontrols/fusetextrenderer/$.uno");
...
// public TextRenderer(Fuse.Controls.TextControl control, bool loadAsync) :542
...
// public void Arrange(float2 position, float2 size) :634
void TextRenderer__Arrange_fn(TextRenderer* __this, ::g::Uno::Float2* position, ::g::Uno::Float2* size)
{
    __this->Arrange(*position, *size);
}

// private void AsyncMeasurementsDone(Fuse.Controls.FuseTextRenderer.CacheState state) :603
...
// private Fuse.Controls.FuseTextRenderer.TextControlData CreateTextControlData() :556
...
// private Fuse.Controls.FuseTextRenderer.TextControlData CreateTextControlData(float pointWidth) :561
...
// private static Fuse.Text.FontFace GetFallbackFontFace(Uno.Collections.List<Fuse.Internal.FontFaceDescriptor> descriptors) :481
...
// private static Fuse.Text.FontFace GetFontFace(Fuse.Internal.FontFaceDescriptor descriptor) :492
...
// public void SoftDispose() :680
void TextRenderer__SoftDispose_fn(TextRenderer* __this)
{
    __this->SoftDispose();
}

// private bool UpdateFont() :646
...
// public TextRenderer(Fuse.Controls.TextControl control, bool loadAsync) [instance] :542
...
// public void Arrange(float2 position, float2 size) [instance] :634
...
// private void AsyncMeasurementsDone(Fuse.Controls.FuseTextRenderer.CacheState state) [instance] :603
void TextRenderer::AsyncMeasurementsDone(::g::Fuse::Controls::FuseTextRenderer::CacheState* state)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(_cacheState == NULL, ::STRINGS[3/*"this._cache...*/], ::STRINGS[4/*"/Users/hdc/...*/], 606, uArray::New(::TYPES[7/*object[]*/], 0));
    _cacheState = state;
    uPtr(_control)->InvalidateLayout(2);
    uPtr(_control)->InvalidateVisual();
}

// private Fuse.Controls.FuseTextRenderer.TextControlData CreateTextControlData() [instance] :556
...
// private Fuse.Controls.FuseTextRenderer.TextControlData CreateTextControlData(float pointWidth) [instance] :561
...
// public void Draw(Fuse.DrawContext dc, Fuse.Visual where) [instance] :612
...
// public Fuse.Internal.CacheItem<int, Fuse.Text.Font> get_Font() [instance] :519
::g::Fuse::Internal::CacheItem TextRenderer::Font()
{
    return _font;
}

// private void set_Font(Fuse.Internal.CacheItem<int, Fuse.Text.Font> value) [instance] :520
...
// private Fuse.Internal.CacheItem<Uno.Collections.List<Fuse.Internal.FontFaceDescriptor>, Fuse.Text.FontFace> get_FontFace() [instance] :505
::g::Fuse::Internal::CacheItem TextRenderer::FontFace()
{
    return _fontFace;
}

// private void set_FontFace(Fuse.Internal.CacheItem<Uno.Collections.List<Fuse.Internal.FontFaceDescriptor>, Fuse.Text.FontFace> value) [instance] :506
...
// public float2 GetContentSize(Fuse.LayoutParams lp) [instance] :567
...
// public Uno.Rect GetRenderBounds() [instance] :666
...
// public void Invalidate() [instance] :640
...
// public void SoftDispose() [instance] :680
...
// private bool UpdateFont() [instance] :646
...
// private static Fuse.Text.FontFace GetFallbackFontFace(Uno.Collections.List<Fuse.Internal.FontFaceDescriptor> descriptors) [static] :481
...
// private static Fuse.Text.FontFace GetFontFace(Fuse.Internal.FontFaceDescriptor descriptor) [static] :492
...
// public TextRenderer New(Fuse.Controls.TextControl control, bool loadAsync) [static] :542
...
// public Tolerances(int dummy) :65
void Tolerances__ctor__fn(Tolerances* __this, int* dummy)
{
    __this->ctor_(*dummy);
}

// public Tolerances New(int dummy) :65
...
// public Tolerances(int dummy) [instance] :65
...
// public Tolerances New(int dummy) [static] :65

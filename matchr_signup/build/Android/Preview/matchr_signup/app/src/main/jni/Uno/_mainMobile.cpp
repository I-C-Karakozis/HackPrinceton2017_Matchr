// This file was generated based on '/Users/hdc/Library/Application Support/Fusetools/Packages/UnoCore/0.46.1/backends/cplusplus/Uno/_mainMobile.cpp'.
...
namespace g{namespace Fuse{struct Node_type; ::g::Fuse::Node_type* NodeGroup_typeof();}}
...
namespace g{namespace Fuse{namespace Elements{namespace UX{struct LayoutFunction_type; ::g::Fuse::Elements::UX::LayoutFunction_type* XFunction_typeof();}}}}
namespace g{namespace Fuse{namespace Elements{namespace UX{struct LayoutFunction_type; ::g::Fuse::Elements::UX::LayoutFunction_type* YFunction_typeof();}}}}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::Fuse::Elements::UX::XFunction_typeof,
        (uType*(*)())&::g::Fuse::Elements::UX::YFunction_typeof,

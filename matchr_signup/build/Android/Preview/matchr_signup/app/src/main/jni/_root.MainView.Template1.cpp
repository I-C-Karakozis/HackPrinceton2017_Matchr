...
{
    MainView__Template1::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"signuppage"*/]);
}

static void MainView__Template1_build(uType* type)
{
    ::STRINGS[0] = uString::Const("signuppage");
    type->SetFields(2,
...
void MainView__Template1__New1_fn(MainView__Template1* __this, uObject** __retval)
{
    ...
    ::g::SignUpPage* self = ::g::SignUpPage::New5(uPtr(__this->__parent1)->router);
...
{
    ctor_(::STRINGS[0/*"signuppage"*/], false);
    __parent1 = parent;

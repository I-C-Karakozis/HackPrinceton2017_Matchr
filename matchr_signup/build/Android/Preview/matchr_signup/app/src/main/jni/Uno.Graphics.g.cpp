...
// /Users/hdc/Library/Application Support/Fusetools/Packages/UnoCore/0.46.1/source/uno/graphics/$.uno
// --------------------------------------------------------------------------------------------------
...
// public IndexBuffer(int sizeInBytes, Uno.Graphics.BufferUsage usage) :563
...
// public IndexBuffer New(int sizeInBytes, Uno.Graphics.BufferUsage usage) :563
...
// public IndexBuffer(int sizeInBytes, Uno.Graphics.BufferUsage usage) [instance] :563
...
// public IndexBuffer New(int sizeInBytes, Uno.Graphics.BufferUsage usage) [static] :563
...
// public static class IndexTypeHelpers :606
// {
static void IndexTypeHelpers_build(uType* type)
{
    ::STRINGS[3] = uString::Const("Invalid IndexType <");
    ::STRINGS[2] = uString::Const(">");
    type->Reflection.SetFunctions(1,
...
// public static int GetStrideInBytes(Uno.Graphics.IndexType type) :608
void IndexTypeHelpers__GetStrideInBytes_fn(int* type, int* __retval)
{
    *__retval = IndexTypeHelpers::GetStrideInBytes(*type);
}

// public static int GetStrideInBytes(Uno.Graphics.IndexType type) [static] :608
int IndexTypeHelpers::GetStrideInBytes(int type)
{
    ...
    switch (type)
    {
        ...
        case 4:
            return type;
        default:
            U_THROW(::g::Uno::FormatException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[3/*"Invalid Ind...*/], uBox<int>(::g::Uno::Graphics::IndexType_typeof(), type)), ::STRINGS[2/*">"*/])));
    }
}
// }
...
{
    ::STRINGS[5] = uString::Const("OpenGL ES ");
    ::STRINGS[6] = uString::Const("**** Invalid version string: ");
    ::STRINGS[7] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/UnoCore/0.46.1/source/uno/graphics/$.uno");
    ::STRINGS[8] = uString::Const("Texture2D");
    ::STRINGS[9] = uString::Const("Texture does not support mipmap");
    ::STRINGS[10] = uString::Const("Texture is immutable and cannot be updated");
    ::STRINGS[11] = uString::Const("GL_OES_texture_npot");
...
void Texture2D::Dispose()
{
    ...
    if (IsDisposed())
        U_THROW(::g::Uno::ObjectDisposedException::New4(::STRINGS[8/*"Texture2D"*/]));
    else
...
void Texture2D::GenerateMipmap()
{
    ...
    if (!IsMipmap())
        U_THROW(::g::Uno::InvalidOperationException::New5(::STRINGS[9/*"Texture doe...*/]));
    else
    {
...
void Texture2D::Update1(::g::Uno::Buffer* mip0)
{
    ...
    if (Format() == 0)
        U_THROW(::g::Uno::InvalidOperationException::New5(::STRINGS[10/*"Texture is ...*/]));
    else
    {
...
bool Texture2D::CheckGLES3Support()
{
    ...
    if (::g::Uno::String::StartsWith(uPtr(versionString), ::STRINGS[5/*"OpenGL ES "*/]))
    {
        ...
        catch (const uThrowable& __t)
        {
            if (uIs(__t.Exception, ::TYPES[1/*Uno.FormatException*/]))
            {
                ...
                ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[6/*"**** Invali...*/], versionString), 1, ::STRINGS[7/*"/Users/hdc/...*/], 975);
            }
            else throw __t;
        }
    }
...
bool Texture2D::HaveNonPow2Support()
{
    ...
    {
        Texture2D::_haveNonPow2Support_ = (Texture2D::CheckGLES3Support() || Texture2D::CheckExtensionSupport(::STRINGS[11/*"GL_OES_text...*/]));
...
{
    ::STRINGS[12] = uString::Const("TextureCube");
    type->SetInterfaces(
...
void TextureCube::Dispose()
{
    ...
    if (IsDisposed())
        U_THROW(::g::Uno::ObjectDisposedException::New4(::STRINGS[12/*"TextureCube"*/]));
    else
        ::g::OpenGL::GL::DeleteTexture(GLTextureHandle());
...
// public static class VertexAttributeTypeHelpers :1655
// {
static void VertexAttributeTypeHelpers_build(uType* type)
{
    ::STRINGS[13] = uString::Const("Invalid VertexAttributeType <");
    ::STRINGS[2] = uString::Const(">");
    type->Reflection.SetFunctions(1,
...
// public static int GetStrideInBytes(Uno.Graphics.VertexAttributeType type) :1657
...
// public static int GetStrideInBytes(Uno.Graphics.VertexAttributeType type) [static] :1657
int VertexAttributeTypeHelpers::GetStrideInBytes(int type)
{
    ...
    switch (type)
    {
        ...
        case 20:
            return 4;
        default:
            U_THROW(::g::Uno::FormatException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[13/*"Invalid Ver...*/], uBox<int>(::g::Uno::Graphics::VertexAttributeType_typeof(), type)), ::STRINGS[2/*">"*/])));
    }
}
// }
...
// public VertexBuffer(int sizeInBytes, Uno.Graphics.BufferUsage usage) :1723
...
// public VertexBuffer New(int sizeInBytes, Uno.Graphics.BufferUsage usage) :1723
...
// public VertexBuffer(int sizeInBytes, Uno.Graphics.BufferUsage usage) [instance] :1723
...
// public VertexBuffer New(int sizeInBytes, Uno.Graphics.BufferUsage usage) [static] :1723

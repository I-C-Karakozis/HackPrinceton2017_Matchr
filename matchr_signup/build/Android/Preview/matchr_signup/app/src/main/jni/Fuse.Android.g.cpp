...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Android/0.46.1/internal/$.uno
// --------------------------------------------------------------------------------------------
...
static void AppRoot__cctor__fn(uType* __type)
{
    ...
    AppRoot::_rootParent_ = AppRoot__AppRootParent::New1(uDelegate::New(::TYPES[0/*Uno.Action<Fuse.Controls.Native.Android.View, int2, int2>*/], (void*)AppRoot__UpdateChildRect_fn));
...
static void AppRoot_build(uType* type)
{
    ...
    ::TYPES[0] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Controls::Native::Android::View_typeof(), ::g::Uno::Int2_typeof(), ::g::Uno::Int2_typeof(), NULL);
...
// public static void Clear(Fuse.Controls.Native.Android.View view) [static] :737
...
// private static void ClearRootView(Java.Object handle) [static] :764
void AppRoot::ClearRootView(::g::Java::Object* handle)
{
    AppRoot_typeof()->Init();
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "ClearRootView303", "(Ljava/lang/Object;)V");
...
// private static Java.Object CreateRootView() [static] :770
::g::Java::Object* AppRoot::CreateRootView()
{
    AppRoot_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "CreateRootView304", "()Ljava/lang/Object;");
...
// private static void OnTouchEvent__(Java.Object motionEvent) [static] :751
void AppRoot::OnTouchEvent__(::g::Java::Object* motionEvent)
{
    uStackFrame __("Fuse.Android.AppRoot", "OnTouchEvent__(Java.Object)");
    AppRoot_typeof()->Init();
    ::g::Fuse::Controls::GraphicsView* root = uPtr(uCast< ::g::Fuse::App*>(::g::Uno::Application::Current1(), ::TYPES[1/*Fuse.App*/]))->RootGraphicsView();
...
// public static void Set(Fuse.Controls.Native.Android.View view) [static] :727
...
// private static void SetAppRoot(Java.Object rootView) [static] :746
...
// private static void SetRootView(Java.Object handle, Java.Object rootHandle) [static] :758
void AppRoot::SetRootView(::g::Java::Object* handle, ::g::Java::Object* rootHandle)
{
    AppRoot_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetRootView306", "(Ljava/lang/Object;Ljava/lang/Object;)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// private static void UpdateChildRect(Fuse.Controls.Native.Android.View view, int2 position, int2 size) [static] :716
void AppRoot::UpdateChildRect(::g::Fuse::Controls::Native::Android::View* view, ::g::Uno::Int2 position, ::g::Uno::Int2 size)
{
    uStackFrame __("Fuse.Android.AppRoot", "UpdateChildRect(Fuse.Controls.Native.Android.View,int2,int2)");
    AppRoot_typeof()->Init();
    AppRoot::UpdateChildRect1(uPtr(view)->Handle(), position.X, position.Y, size.X, size.Y);
}

// private static void UpdateChildRect(Java.Object handle, int x, int y, int w, int h) [static] :722
void AppRoot::UpdateChildRect1(::g::Java::Object* handle, int x, int y, int w, int h)
{
    AppRoot_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "UpdateChildRect1307", "(Ljava/lang/Object;IIII)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        int _ux=x;
        jint _x = (jint)_ux;
...
static void AppRoot__AppRootParent_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Controls::Native::Android::View_typeof(), ::g::Uno::Int2_typeof(), ::g::Uno::Int2_typeof(), NULL), offsetof(::g::Fuse::Android::AppRoot__AppRootParent, _updateChildRect), 0);
}
...
AppRoot__AppRootParent_type* AppRoot__AppRootParent_typeof()
{
    ...
    type->interface0.fp_UpdateChildRect = (void(*)(uObject*, ::g::Fuse::Controls::Native::Android::View*, ::g::Uno::Int2*, ::g::Uno::Int2*))AppRoot__AppRootParent__FuseControlsNativeAndroidIViewParentUpdateChildRect_fn;
    return type;
}

// public AppRootParent(Uno.Action<Fuse.Controls.Native.Android.View, int2, int2> updateChildRect) :694
void AppRoot__AppRootParent__ctor__fn(AppRoot__AppRootParent* __this, uDelegate* updateChildRect)
{
    __this->ctor_(updateChildRect);
}

// private void Fuse.Controls.Native.Android.IViewParent.UpdateChildRect(Fuse.Controls.Native.Android.View view, int2 position, int2 size) :699
...
{
    uStackFrame __("Fuse.Android.AppRoot.AppRootParent", "Fuse.Controls.Native.Android.IViewParent.UpdateChildRect(Fuse.Controls.Native.Android.View,int2,int2)");
    ::g::Uno::Int2 position_ = *position;
    ::g::Uno::Int2 size_ = *size;
    uPtr(__this->_updateChildRect)->Invoke(3, view, uCRef(position_), uCRef(size_));
}

// public AppRootParent New(Uno.Action<Fuse.Controls.Native.Android.View, int2, int2> updateChildRect) :694
void AppRoot__AppRootParent__New1_fn(uDelegate* updateChildRect, AppRoot__AppRootParent** __retval)
{
    *__retval = AppRoot__AppRootParent::New1(updateChildRect);
}

// public AppRootParent(Uno.Action<Fuse.Controls.Native.Android.View, int2, int2> updateChildRect) [instance] :694
void AppRoot__AppRootParent::ctor_(uDelegate* updateChildRect)
{
    _updateChildRect = updateChildRect;
}

// public AppRootParent New(Uno.Action<Fuse.Controls.Native.Android.View, int2, int2> updateChildRect) [static] :694
AppRoot__AppRootParent* AppRoot__AppRootParent::New1(uDelegate* updateChildRect)
{
    AppRoot__AppRootParent* obj1 = (AppRoot__AppRootParent*)uNew(AppRoot__AppRootParent_typeof());
    obj1->ctor_(updateChildRect);
    return obj1;
}
// }
...
// private sealed class TextRenderer.BackgroundRender :447
// {
...
// public BackgroundRender(Fuse.Android.TextRenderer textRenderer, ulong textureVersion, Fuse.Android.StaticLayout layout, Uno.Recti pixelBounds) :455
...
// private void DoneCallback() :473
void TextRenderer__BackgroundRender__DoneCallback_fn(TextRenderer__BackgroundRender* __this)
{
    __this->DoneCallback();
}

// public BackgroundRender New(Fuse.Android.TextRenderer textRenderer, ulong textureVersion, Fuse.Android.StaticLayout layout, Uno.Recti pixelBounds) :455
...
// public void UpdateTextureAsync() :463
...
// public BackgroundRender(Fuse.Android.TextRenderer textRenderer, ulong textureVersion, Fuse.Android.StaticLayout layout, Uno.Recti pixelBounds) [instance] :455
...
// private void DoneCallback() [instance] :473
...
// public void UpdateTextureAsync() [instance] :463
void TextRenderer__BackgroundRender::UpdateTextureAsync()
{
    ...
    ::g::OpenGL::GL::Finish();
    ::g::Fuse::UpdateManager::PostAction(uDelegate::New(::TYPES[2/*Uno.Action*/], (void*)TextRenderer__BackgroundRender__DoneCallback_fn, this));
}

// public BackgroundRender New(Fuse.Android.TextRenderer textRenderer, ulong textureVersion, Fuse.Android.StaticLayout layout, Uno.Recti pixelBounds) [static] :455
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "CreateBitmapARGB8888Impl308", "(II)Ljava/lang/Object;");
        int _uwidth=width;
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "EraseColor1309", "(Ljava/lang/Object;I)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        int _ucolor=color;
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Recycle1310", "(Ljava/lang/Object;)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        U_JNIVAR->CallStaticVoidMethod(__cls,__mtd,_handle);
...
// internal sealed class Blitter :517
// {
// static Blitter() :517
...
static void Blitter_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[3/*float2[]*/], offsetof(::g::Fuse::Android::Blitter, Blit_verts_67760dd9_3_3_5), 0,
...
// public generated Blitter() :517
void Blitter__ctor__fn(Blitter* __this)
{
    __this->ctor_();
}

// public void Blit(texture2D vt, float2 pos, float2 size, float4x4 localToClipTransform) :521
...
// private generated void init_DrawCalls() :517
void Blitter__init_DrawCalls_fn(Blitter* __this)
{
    __this->init_DrawCalls();
}

// public generated Blitter New() :517
...
// public generated Blitter() [instance] :517
void Blitter::ctor_()
{
    init_DrawCalls();
}

// public void Blit(texture2D vt, float2 pos, float2 size, float4x4 localToClipTransform) [instance] :521
...
// private generated void init_DrawCalls() [instance] :517
void Blitter::init_DrawCalls()
{
    uStackFrame __("Fuse.Android.Blitter", "init_DrawCalls()");
    uArray* verts_67760dd9_3_3_0 = uArray::Init< ::g::Uno::Float2>(::TYPES[3/*float2[]*/], 6, ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(0.0f, 0.0f), ::g::Uno::Float2__New2(1.0f, 1.0f), ::g::Uno::Float2__New2(0.0f, 1.0f));
...
// public generated Blitter New() [static] :517
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Create311", "(Ljava/lang/Object;)Ljava/lang/Object;");
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Translate1312", "(Ljava/lang/Object;FF)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        float _udx=dx;
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "TexImage2D313", "(IILjava/lang/Object;I)V");
        int _utarget=target;
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Create314", "(Ljava/lang/String;IILjava/lang/Object;IIFFZII)Ljava/lang/Object;");
        uString* _utext=text;
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Create1315", "(Ljava/lang/String;Ljava/lang/Object;IIFFZ)Ljava/lang/Object;");
        uString* _utext=text;
        jstring _text = JniHelper::UnoToJavaString(_utext);
        ::g::Java::Object* _upaintHandle=paintHandle;
        jobject _paintHandle = (_upaintHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_upaintHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Draw1316", "(Ljava/lang/Object;Ljava/lang/Object;)V");
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetDesiredWidthImpl317", "(Ljava/lang/String;Ljava/lang/Object;)F");
        uString* _utext=text;
        jstring _text = JniHelper::UnoToJavaString(_utext);
        ::g::Java::Object* _upaintHandle=paintHandle;
        jobject _paintHandle = (_upaintHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_upaintHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetEllipsizedWidth318", "(Ljava/lang/Object;)I");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetHeight319", "(Ljava/lang/Object;)I");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        jint __jresult = U_JNIVAR->CallStaticIntMethod(__cls,__mtd,_handle);
        int __result = (int)__jresult;
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetLineBaseline1320", "(Ljava/lang/Object;I)I");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        int _uline=line;
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetLineCount321", "(Ljava/lang/Object;)I");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        jint __jresult = U_JNIVAR->CallStaticIntMethod(__cls,__mtd,_handle);
        int __result = (int)__jresult;
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetLineEnd1322", "(Ljava/lang/Object;I)I");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        int _uline=line;
        jint _line = (jint)_uline;
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetLineLeft1323", "(Ljava/lang/Object;I)F");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        int _uline=line;
        jint _line = (jint)_uline;
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetLineStart1324", "(Ljava/lang/Object;I)I");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        int _uline=line;
        jint _line = (jint)_uline;
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetWidth325", "(Ljava/lang/Object;)I");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        jint __jresult = U_JNIVAR->CallStaticIntMethod(__cls,__mtd,_handle);
        int __result = (int)__jresult;
...
// {
// static extern StatusBarConfig() :112
...
{
    ::STRINGS[5] = uString::Const("StatusBarConfig.Color is only supported on Android API-level 21 and higher");
    ::STRINGS[6] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Android/0.46.1/$.uno");
    ::STRINGS[7] = uString::Const("set_Color");
    type->SetInterfaces(
...
// internal static extern void UpdateStatusBar() :156
...
// public generated StatusBarConfig() [instance] :110
void StatusBarConfig::ctor_3()
{
    ctor_2();
}

// public float4 get_Color() [instance] :121
...
// public void set_Color(float4 value) [instance] :128
void StatusBarConfig::Color(::g::Uno::Float4 value)
{
    if (!StatusBarConfig::SetStatusBarColor(value))
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[5/*"StatusBarCo...*/], this, ::STRINGS[6/*"/Users/hdc/...*/], 133, ::STRINGS[7/*"set_Color"*/]);
}

// public bool get_IsVisible() [instance] :142
bool StatusBarConfig::IsVisible()
{
    return StatusBarConfig::_isVisible();
}

// public void set_IsVisible(bool value) [instance] :143
...
// public generated StatusBarConfig New() [static] :110
...
// internal static extern bool SetStatusBarColor(float4 color) [static] :151
bool StatusBarConfig::SetStatusBarColor(::g::Uno::Float4 color)
{
    StatusBarConfig_typeof()->Init();
    return ::g::Fuse::Android::StatusBarHelper::SetStatusBarColor(::g::Fuse::Android::Helpers::EncodeColor(color));
}

// internal static extern void UpdateStatusBar() [static] :156
...
// public static void InstallGlobalListener() :70
void StatusBarHelper__InstallGlobalListener_fn()
{
    StatusBarHelper::InstallGlobalListener();
}

// public static bool SetStatusBarColor(int color) :54
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetStatusBarColor326", "()I");
...
// public static void InstallGlobalListener() [static] :70
void StatusBarHelper::InstallGlobalListener()
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "InstallGlobalListener327", "()V");
...
// public static bool SetStatusBarColor(int color) [static] :54
bool StatusBarHelper::SetStatusBarColor(int color)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetStatusBarColor329", "(I)Z");
        int _ucolor=color;
        jint _color = (jint)_ucolor;
...
// internal sealed extern class TextControlLayout :181
// {
static void TextControlLayout_build(uType* type)
{
    ::STRINGS[8] = uString::Const("wrapWidth");
    ::STRINGS[4] = uString::Const("");
...
// private generated void set_Layout(Fuse.Android.StaticLayout value) :183
void TextControlLayout__set_Layout_fn(TextControlLayout* __this, ::g::Fuse::Android::StaticLayout* value)
{
    __this->Layout(value);
}

// public bool Measure(Fuse.Controls.TextControl Control, Fuse.Android.TextPaint Paint, float wrapWidthPoints, bool useMin) :200
...
// public void UpdatePaint(Fuse.Controls.TextControl Control, Fuse.Android.TextPaint paint) :271
...
// public generated TextControlLayout() [instance] :181
void TextControlLayout::ctor_()
{
}

// public void Dispose() [instance] :186
void TextControlLayout::Dispose()
{
    Layout(NULL);
}

// public void Invalidate() [instance] :195
void TextControlLayout::Invalidate()
{
    _cacheValid = false;
}

// public generated Fuse.Android.StaticLayout get_Layout() [instance] :183
::g::Fuse::Android::StaticLayout* TextControlLayout::Layout()
{
    return _Layout;
}

// private generated void set_Layout(Fuse.Android.StaticLayout value) [instance] :183
void TextControlLayout::Layout(::g::Fuse::Android::StaticLayout* value)
{
    _Layout = value;
}

// public bool Measure(Fuse.Controls.TextControl Control, Fuse.Android.TextPaint Paint, float wrapWidthPoints, bool useMin) [instance] :200
bool TextControlLayout::Measure(::g::Fuse::Controls::TextControl* Control, ::g::Fuse::Android::TextPaint* Paint, float wrapWidthPoints, bool useMin)
{
    ...
    if (wrapWidthPoints < 0.0f)
        U_THROW(::g::Uno::ArgumentOutOfRangeException::New6(::STRINGS[8/*"wrapWidth"*/]));
...
// public generated Uno.Recti get_PixelBounds() [instance] :184
::g::Uno::Recti TextControlLayout::PixelBounds()
{
    return _PixelBounds;
}

// private generated void set_PixelBounds(Uno.Recti value) [instance] :184
void TextControlLayout::PixelBounds(::g::Uno::Recti value)
{
    _PixelBounds = value;
}

// private Fuse.Android.StaticLayout.Alignment TextAlignmentToAndroidLayoutAlignment(Fuse.Controls.TextAlignment textAlignment) [instance] :259
...
// public void UpdatePaint(Fuse.Controls.TextControl Control, Fuse.Android.TextPaint paint) [instance] :271
...
// public generated TextControlLayout New() [static] :181
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Create330", "()Ljava/lang/Object;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        ::g::Java::Object* __result = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(__jresult, false);
        ::g::Android::Base::JNI::CheckException();
        return __result;
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetTextBounds331", "(Ljava/lang/Object;Ljava/lang/String;IILcom/uno/IntArray;)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        uString* _utext=text;
        jstring _text = JniHelper::UnoToJavaString(_utext);
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetAntiAlias332", "(Ljava/lang/Object;Z)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        bool _uvalue=value;
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetColor333", "(Ljava/lang/Object;I)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
        int _ucolor=color;
        jint _color = (jint)_ucolor;
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetTextSize334", "(Ljava/lang/Object;F)V");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "SetTypeface335", "(Ljava/lang/Object;Ljava/lang/Object;)V");
        ::g::Java::Object* _upaintHandle=paintHandle;
        jobject _paintHandle = (_upaintHandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_upaintHandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));
...
// internal sealed extern class TextRenderer :283
// {
...
// public Uno.Rect GetRenderBounds() :362
...
// private TextRenderer New(Fuse.Controls.TextControl Control) :291
void TextRenderer__New1_fn(::g::Fuse::Controls::TextControl* Control, TextRenderer** __retval)
{
    *__retval = TextRenderer::New1(Control);
}

// private void OnBitmapDraw(Fuse.DrawContext dc, Fuse.Visual where, float2 dposition, float2 size) :485
...
// private TextRenderer(Fuse.Controls.TextControl Control) [instance] :291
...
// public void Arrange(float2 position, float2 size) [instance] :310
...
// private void DisposeTexture() [instance] :385
...
// public void Draw(Fuse.DrawContext dc, Fuse.Visual where) [instance] :510
...
// public float2 GetContentSize(Fuse.LayoutParams lp) [instance] :342
...
// public Uno.Rect GetRenderBounds() [instance] :362
...
// private void OnBitmapDraw(Fuse.DrawContext dc, Fuse.Visual where, float2 dposition, float2 size) [instance] :485
...
// private void PrepareDraw() [instance] :393
void TextRenderer::PrepareDraw()
{
    ...
    if (_renderThreaded)
    {
        ...
        ::g::Fuse::GraphicsWorker::Dispatch(uDelegate::New(::TYPES[2/*Uno.Action*/], (void*)TextRenderer__BackgroundRender__UpdateTextureAsync_fn, backgroundRender));
    }
    else
    {
...
// private void SetTexture(texture2D newTexture) [instance] :376
...
// public void SoftDispose() [instance] :336
...
// private void UpdateLayout() [instance] :317
...
// private void UpdatePaint() [instance] :297
...
// private texture2D UpdateTexture(Fuse.Android.StaticLayout layout, Uno.Recti pixelBounds) [instance] :427
...
// public static Fuse.Controls.ITextRenderer Create(Fuse.Controls.TextControl control) [static] :285
...
// private TextRenderer New(Fuse.Controls.TextControl Control) [static] :291

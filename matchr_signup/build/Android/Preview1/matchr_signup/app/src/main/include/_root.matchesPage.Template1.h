...
namespace g{struct matchesPage__Template1;}
...
struct matchesPage__Template1 : ::g::Uno::UX::Template
{
    uWeak< ::g::matchesPage*> __parent1;
    uWeak< ::g::matchesPage*> __parentInstance1;
    static ::g::Uno::UX::Selector __selector0_;
    static ::g::Uno::UX::Selector& __selector0() { return matchesPage__Template1_typeof()->Init(), __selector0_; }

    void ctor_1(::g::matchesPage* parent, ::g::matchesPage* parentInstance);
    static matchesPage__Template1* New2(::g::matchesPage* parent, ::g::matchesPage* parentInstance);
};
// }

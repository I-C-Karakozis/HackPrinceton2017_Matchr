...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Controls.Native/0.46.1/ios/$.uno
// -----------------------------------------------------------------------------------------------
...
// public sealed extern class Slider :2383
// {
...
// public Slider(Fuse.Controls.Native.IRangeViewHost host) :2388
void Slider__ctor__fn(Slider* __this, uObject* host)
{
    __this->ctor_(host);
}

// public Slider New(Fuse.Controls.Native.IRangeViewHost host) :2388
void Slider__New1_fn(uObject* host, Slider** __retval)
{
    *__retval = Slider::New1(host);
}

// public void set_Progress(double value) :2385
void Slider__set_Progress_fn(Slider* __this, double* value)
{
    __this->Progress(*value);
}

// public Slider(Fuse.Controls.Native.IRangeViewHost host) [instance] :2388
void Slider::ctor_(uObject* host)
{
}

// public void set_Progress(double value) [instance] :2385
void Slider::Progress(double value)
{
}

// public Slider New(Fuse.Controls.Native.IRangeViewHost host) [static] :2388
...
// public sealed extern class Switch :2463
// {
...
// public Switch(Fuse.Controls.Native.IToggleViewHost host) :2469
void Switch__ctor__fn(Switch* __this, uObject* host)
{
    __this->ctor_(host);
}

// public void set_Host(Fuse.Controls.Native.IToggleViewHost value) :2466
void Switch__set_Host_fn(Switch* __this, uObject* value)
{
    __this->Host(value);
}

// public Switch New(Fuse.Controls.Native.IToggleViewHost host) :2469
void Switch__New1_fn(uObject* host, Switch** __retval)
{
    *__retval = Switch::New1(host);
}

// public void set_Value(bool value) :2465
void Switch__set_Value_fn(Switch* __this, bool* value)
{
    __this->Value(*value);
}

// public Switch(Fuse.Controls.Native.IToggleViewHost host) [instance] :2469
void Switch::ctor_(uObject* host)
{
}

// public void set_Host(Fuse.Controls.Native.IToggleViewHost value) [instance] :2466
void Switch::Host(uObject* value)
{
}

// public void set_Value(bool value) [instance] :2465
void Switch::Value(bool value)
{
}

// public Switch New(Fuse.Controls.Native.IToggleViewHost host) [static] :2469

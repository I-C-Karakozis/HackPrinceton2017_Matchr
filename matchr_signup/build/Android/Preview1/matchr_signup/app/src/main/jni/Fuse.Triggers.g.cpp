...
// public generated AddingAnimation() [instance] :46
...
// public bool get_DelayFrame() [instance] :51
bool AddingAnimation::DelayFrame()
{
    return _delayFrame;
}

// public void set_DelayFrame(bool value) [instance] :52
void AddingAnimation::DelayFrame(bool value)
{
    _delayFrame = value;
}

// public generated AddingAnimation New() [static] :46
...
static void Busy_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Triggers/0.46.1/$.uno");
...
// public generated Busy New() :137
void Busy__New2_fn(Busy** __retval)
{
    *__retval = Busy::New2();
}

// public Fuse.Triggers.BusyOn get_On() :183
void Busy__get_On_fn(Busy* __this, int* __retval)
{
    *__retval = __this->On();
}

// public void set_On(Fuse.Triggers.BusyOn value) :184
...
// public generated Busy() [instance] :137
void Busy::ctor_3()
{
    _isActive = true;
    _activity = 4;
...
// public Fuse.Triggers.BusyOn get_On() [instance] :183
int Busy::On()
{
    return _on;
}

// public void set_On(Fuse.Triggers.BusyOn value) [instance] :184
...
void Busy::UpdateState()
{
    ...
    if ((_rootOn & 1) == 1)
    {
        ...
        {
            _rootOn = (_rootOn & -2);
            ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"On='Paramet...*/], this, ::STRINGS[3/*"/Users/hdc/...*/], 203, ::STRINGS[7/*"UpdateState"*/]);
        }
        else
...
void Busy::activate(::g::Fuse::Scripting::Context* c, Busy* b, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[2/*"Busy.activa...*/], b, ::STRINGS[3/*"/Users/hdc/...*/], 264, ::STRINGS[0/*"activate"*/]);
        return;
    }
...
void Busy::deactivate(::g::Fuse::Scripting::Context* c, Busy* b, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[4/*"Busy.deacti...*/], b, ::STRINGS[3/*"/Users/hdc/...*/], 282, ::STRINGS[1/*"deactivate"*/]);
        return;
    }
...
// public generated Busy New() [static] :137
Busy* Busy::New2()
{
...
{
    BusyTask::_tasks_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[7/*Uno.Collections.List<Fuse.Triggers.BusyTask>*/]));
    BusyTask::_listeners_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[8/*Uno.Collections.Dictionary<Fuse.Node, Uno.Collections.List<Uno.Action>>*/]));
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[2/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[9/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.BusyTask>*/], ::STRINGS[8/*"done"*/], uDelegate::New(::TYPES[10/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.BusyTask, object[]>*/], (void*)BusyTask__done_fn), 2)));
}

static void BusyTask_build(uType* type)
{
    ::STRINGS[8] = uString::Const("done");
    ::TYPES[7] = ::g::Uno::Collections::List_typeof()->MakeType(type, NULL);
    ::TYPES[8] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Node_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof(), NULL), NULL);
    ::TYPES[1] = ::g::Uno::Type_typeof();
    ::TYPES[2] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[9] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(type, NULL);
    ::TYPES[10] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), type, uObject_typeof()->Array(), NULL);
    ::TYPES[0] = ::g::Uno::Action_typeof();
    ::TYPES[11] = ::g::Uno::Collections::List_typeof()->MakeType(::TYPES[0/*Uno.Action*/], NULL);
    ::TYPES[5] = ::g::Fuse::Visual_typeof();
    ...
    type->SetFields(0,
        ...
        ::TYPES[8/*Uno.Collections.Dictionary<Fuse.Node, Uno.Collections.List<Uno.Action>>*/], (uintptr_t)&::g::Fuse::Triggers::BusyTask::_listeners_, uFieldFlagsStatic,
        ::TYPES[7/*Uno.Collections.List<Fuse.Triggers.BusyTask>*/], (uintptr_t)&::g::Fuse::Triggers::BusyTask::_tasks_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(3,
...
// public static bool IsBusy(Fuse.Node n, [Fuse.Triggers.BusyTaskMatch match]) :397
...
// public static bool IsBusy(Fuse.Node n, [Fuse.Triggers.BusyTaskMatch match]) [static] :397
...
// public generated Completed() :644
...
// public generated Completed New() :644
...
// public generated Completed() [instance] :644
...
void Completed::Setup()
{
    ...
    if (!_listening)
    {
        ...
        _listening = true;
        ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[0/*Uno.Action*/], (void*)Completed__Update_fn, this), -1, 0);
    }
}
...
// public generated Completed New() [static] :644
...
void Completed::reset(::g::Fuse::Scripting::Context* c, Completed* cp, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[11/*"Completed.r...*/], cp, ::STRINGS[3/*"/Users/hdc/...*/], 824, ::STRINGS[10/*"reset"*/]);
        return;
    }
...
static void BusyTaskModule__ConstructorClosure_build(uType* type)
{
    ...
    ::TYPES[19] = ::g::Fuse::Scripting::Marshal_typeof()->MakeMethod(0/*ToType<Fuse.Triggers.BusyTaskActivity>*/, ::g::Fuse::Triggers::BusyTaskActivity_typeof(), NULL);
    type->SetFields(0,
...
uObject* BusyTaskModule__ConstructorClosure::Construct(uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[12/*"Use the `Bu...*/], this, ::STRINGS[3/*"/Users/hdc/...*/], 580, ::STRINGS[13/*"Construct"*/]);
    ...
    ::g::Fuse::Node* n = uAs< ::g::Fuse::Node*>(::g::Fuse::Scripting::Context::Wrap(uPtr(args)->Strong<uObject*>(0)), ::TYPES[18/*Fuse.Node*/]);
    ...
    if (args->Length() == 2)
        act = (::g::Fuse::Scripting::Marshal__ToType_fn(::TYPES[19/*Fuse.Scripting.Marshal.ToType<Fuse.Triggers.BusyTaskActivity>*/], uPtr(args)->Strong<uObject*>(1), &ret2), ret2);
...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/0.46.1/triggers/$.uno
// --------------------------------------------------------------------------------------------------------
...
static void ContainingText_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/0.46.1/triggers/$.uno");
...
{
    ctor_6();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[16/*"Use the tri...*/], this, ::STRINGS[17/*"/Users/hdc/...*/], 79, ::STRINGS[18/*".ctor"*/]);
}
...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Controls.ScrollView/0.46.1/triggers/$.uno
// --------------------------------------------------------------------------------------------------------
...
// private sealed class Trigger.DeferredItem :2819
// {
...
// public generated DeferredItem New() [static] :2819
...
{
    ::TYPES[20] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Triggers::State_typeof(), NULL);
    ::TYPES[21] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[22] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Triggers::State_typeof(), NULL);
    type->SetFields(0,
...
void StateGroup__GotoImpl::Go()
{
    ...
    switch (uPtr(Group)->Transition())
    {
        case 0:
        {
            for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(Group)->_states), ::TYPES[20/*Uno.Collections.IEnumerable<Fuse.Triggers.State>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[21/*Uno.Collections.IEnumerator*/])); )
            {
                ::g::Fuse::Triggers::State* state = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[22/*Uno.Collections.IEnumerator<Fuse.Triggers.State>*/]), &ret4), ret4);
        ...
        case 1:
        {
            for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(Group)->_states), ::TYPES[20/*Uno.Collections.IEnumerable<Fuse.Triggers.State>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[21/*Uno.Collections.IEnumerator*/])); )
            {
                ::g::Fuse::Triggers::State* state1 = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[22/*Uno.Collections.IEnumerator<Fuse.Triggers.State>*/]), &ret5), ret5);
...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Triggers/0.46.1/actions/$.uno
// --------------------------------------------------------------------------------------------
...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Controls/0.46.1/triggers/$.uno
// ---------------------------------------------------------------------------------------------
...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.46.1/triggers/$.uno
// ---------------------------------------------------------------------------------------------
...
static void LayoutAnimation_build(uType* type)
{
    ...
    ::STRINGS[20] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.46.1/triggers/$.uno");
    ::STRINGS[21] = uString::Const("OnRooted");
    ::TYPES[23] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[24] = ::g::Fuse::PlacedHandler_typeof();
    ::TYPES[25] = ::g::Fuse::Elements::PreplacementHandler_typeof();
    ::TYPES[26] = ::g::Fuse::Triggers::LayoutTransitionedHandler_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
        ...
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface5));
    type->SetFields(29,
        ::TYPES[23/*Fuse.Elements.Element*/], offsetof(::g::Fuse::Triggers::LayoutAnimation, _element), 0,
...
void LayoutAnimation__OnRooted_fn(LayoutAnimation* __this)
{
    ...
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    __this->_element = uAs< ::g::Fuse::Elements::Element*>(__this->Parent(), ::TYPES[23/*Fuse.Elements.Element*/]);

    if (__this->_element == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[19/*"LayoutAnima...*/], __this, ::STRINGS[20/*"/Users/hdc/...*/], 228, ::STRINGS[21/*"OnRooted"*/]);
        return;
    }

    uPtr(__this->_element)->add_Placed(uDelegate::New(::TYPES[24/*Fuse.PlacedHandler*/], (void*)LayoutAnimation__OnPlaced_fn, __this));
    uPtr(__this->_element)->add_Preplacement(uDelegate::New(::TYPES[25/*Fuse.Elements.PreplacementHandler*/], (void*)LayoutAnimation__OnPreplacement_fn, __this));
    uPtr(__this->_element)->ignoreTempArrange = true;
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Triggers::LayoutTransition::Transitioned()), __this->_element, uDelegate::New(::TYPES[26/*Fuse.Triggers.LayoutTransitionedHandler*/], (void*)LayoutAnimation__OnTransitioned_fn, __this));
}
...
void LayoutAnimation__OnUnrooted_fn(LayoutAnimation* __this)
{
    ...
    if (__this->_element != NULL)
    {
        ...
        uPtr(__this->_element)->remove_Placed(uDelegate::New(::TYPES[24/*Fuse.PlacedHandler*/], (void*)LayoutAnimation__OnPlaced_fn, __this));
        uPtr(__this->_element)->remove_Preplacement(uDelegate::New(::TYPES[25/*Fuse.Elements.PreplacementHandler*/], (void*)LayoutAnimation__OnPreplacement_fn, __this));
        ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Triggers::LayoutTransition::Transitioned()), __this->_element, uDelegate::New(::TYPES[26/*Fuse.Triggers.LayoutTransitionedHandler*/], (void*)LayoutAnimation__OnTransitioned_fn, __this));
    }
...
{
    ::TYPES[27] = ::g::Fuse::Input::KeyPressedHandler_typeof();
    ::TYPES[28] = ::g::Fuse::Triggers::KeyPressHandler_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
    ...
    type->SetFields(29,
        ...
        ::TYPES[28/*Fuse.Triggers.KeyPressHandler*/], offsetof(::g::Fuse::Triggers::OnKeyPress, Handler1), 0);
    type->Reflection.SetFunctions(5,
        new uFunction("add_Handler", NULL, (void*)OnKeyPress__add_Handler_fn, 0, false, uVoid_typeof(), 1, ::TYPES[28/*Fuse.Triggers.KeyPressHandler*/]),
        new uFunction("remove_Handler", NULL, (void*)OnKeyPress__remove_Handler_fn, 0, false, uVoid_typeof(), 1, ::TYPES[28/*Fuse.Triggers.KeyPressHandler*/]),
...
void OnKeyPress__OnRooted_fn(OnKeyPress* __this)
{
    ...
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    ::g::Fuse::VisualEvent__AddGlobalHandler_fn(uPtr(::g::Fuse::Input::Keyboard::KeyPressed()), uDelegate::New(::TYPES[27/*Fuse.Input.KeyPressedHandler*/], (void*)OnKeyPress__OnKeyPressed_fn, __this));
}
...
void OnKeyPress__OnUnrooted_fn(OnKeyPress* __this)
{
    ...
    ::g::Fuse::VisualEvent__RemoveGlobalHandler_fn(uPtr(::g::Fuse::Input::Keyboard::KeyPressed()), uDelegate::New(::TYPES[27/*Fuse.Input.KeyPressedHandler*/], (void*)OnKeyPress__OnKeyPressed_fn, __this));
    ::g::Fuse::Triggers::Trigger__OnUnrooted_fn(__this);
}
...
void OnKeyPress::add_Handler(uDelegate* value)
{
    ...
    Handler1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Handler1, value), ::TYPES[28/*Fuse.Triggers.KeyPressHandler*/]);
}
...
void OnKeyPress::remove_Handler(uDelegate* value)
{
    ...
    Handler1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Handler1, value), ::TYPES[28/*Fuse.Triggers.KeyPressHandler*/]);
}
...
static void OnUserEvent_build(uType* type)
{
    ...
    ::STRINGS[23] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.UserEvents/0.46.1/$.uno");
    ::STRINGS[21] = uString::Const("OnRooted");
    ::TYPES[29] = ::g::Fuse::UserEventHandler_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
    ...
    type->SetFields(29,
        ...
        ::TYPES[29/*Fuse.UserEventHandler*/], offsetof(::g::Fuse::Triggers::OnUserEvent, Handler1), 0);
    type->Reflection.SetFunctions(7,
        ...
        new uFunction("add_Handler", NULL, (void*)OnUserEvent__add_Handler_fn, 0, false, uVoid_typeof(), 1, ::TYPES[29/*Fuse.UserEventHandler*/]),
        new uFunction("remove_Handler", NULL, (void*)OnUserEvent__remove_Handler_fn, 0, false, uVoid_typeof(), 1, ::TYPES[29/*Fuse.UserEventHandler*/]),
...
void OnUserEvent__OnRooted_fn(OnUserEvent* __this)
{
    ...
    if (::g::Uno::String::op_Equality(::g::Uno::UX::Selector__op_Implicit1(__this->EventName()), NULL))
        ::g::Fuse::Diagnostics::UserError(::STRINGS[22/*"OnUserEvent...*/], __this, ::STRINGS[23/*"/Users/hdc/...*/], 99, ::STRINGS[21/*"OnRooted"*/]);
    else
    {
        __this->_rootedEvent = ::g::Fuse::UserEventDispatch::GetByName(__this->EventName());
        uPtr(__this->_rootedEvent)->add_Raised(uDelegate::New(::TYPES[29/*Fuse.UserEventHandler*/], (void*)OnUserEvent__OnRaised_fn, __this));
    }
...
void OnUserEvent__OnUnrooted_fn(OnUserEvent* __this)
{
    ...
    {
        uPtr(__this->_rootedEvent)->remove_Raised(uDelegate::New(::TYPES[29/*Fuse.UserEventHandler*/], (void*)OnUserEvent__OnRaised_fn, __this));
...
void OnUserEvent::add_Handler(uDelegate* value)
{
    ...
    Handler1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Handler1, value), ::TYPES[29/*Fuse.UserEventHandler*/]);
}
...
void OnUserEvent::remove_Handler(uDelegate* value)
{
    ...
    Handler1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Handler1, value), ::TYPES[29/*Fuse.UserEventHandler*/]);
}
...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Controls.WebView/0.46.1/$.uno
// --------------------------------------------------------------------------------------------
...
static void PageBeginLoading_build(uType* type)
{
    ...
    ::STRINGS[25] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Controls.WebView/0.46.1/$.uno");
    ::STRINGS[21] = uString::Const("OnRooted");
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface5));
    type->SetFields(29,
        ::TYPES[30/*Fuse.Controls.IWebView*/], offsetof(::g::Fuse::Triggers::PageBeginLoading, _webView), 0);
    type->Reflection.SetFunctions(1,
...
void PageBeginLoading__OnRooted_fn(PageBeginLoading* __this)
{
    ...
    if (uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[30/*Fuse.Controls.IWebView*/]))
    {
        __this->_webView = uAs<uObject*>(__this->Parent(), ::TYPES[30/*Fuse.Controls.IWebView*/]);
        ::g::Fuse::Controls::IWebView::add_BeginLoading(uInterface(uPtr(__this->_webView), ::TYPES[30/*Fuse.Controls.IWebView*/]), uDelegate::New(::TYPES[6/*Uno.EventHandler*/], (void*)PageBeginLoading__OnPageBeginLoading_fn, __this));
    }
    else
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[24/*"WebView"*/], __this->Parent(), __this, ::STRINGS[25/*"/Users/hdc/...*/], 1058, ::STRINGS[21/*"OnRooted"*/]);
}
...
void PageBeginLoading__OnUnrooted_fn(PageBeginLoading* __this)
{
    ...
    {
        ::g::Fuse::Controls::IWebView::remove_BeginLoading(uInterface(uPtr(__this->_webView), ::TYPES[30/*Fuse.Controls.IWebView*/]), uDelegate::New(::TYPES[6/*Uno.EventHandler*/], (void*)PageBeginLoading__OnPageBeginLoading_fn, __this));
...
static void PageLoaded_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface5));
    type->SetFields(29,
        ::TYPES[30/*Fuse.Controls.IWebView*/], offsetof(::g::Fuse::Triggers::PageLoaded, _webView), 0);
    type->Reflection.SetFunctions(1,
...
void PageLoaded__OnRooted_fn(PageLoaded* __this)
{
    ...
    {
        __this->_webView = uAs<uObject*>(__this->Parent(), ::TYPES[30/*Fuse.Controls.IWebView*/]);
        ::g::Fuse::Controls::IWebView::add_PageLoaded(uInterface(uPtr(__this->_webView), ::TYPES[30/*Fuse.Controls.IWebView*/]), uDelegate::New(::TYPES[6/*Uno.EventHandler*/], (void*)PageLoaded__OnPageLoaded_fn, __this));
    }
    else
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[24/*"WebView"*/], __this->Parent(), __this, ::STRINGS[25/*"/Users/hdc/...*/], 1117, ::STRINGS[21/*"OnRooted"*/]);
}
...
void PageLoaded__OnUnrooted_fn(PageLoaded* __this)
{
    ...
    if (__this->_webView != NULL)
    {
        ::g::Fuse::Controls::IWebView::remove_PageLoaded(uInterface(uPtr(__this->_webView), ::TYPES[30/*Fuse.Controls.IWebView*/]), uDelegate::New(::TYPES[6/*Uno.EventHandler*/], (void*)PageLoaded__OnPageLoaded_fn, __this));
        __this->_webView = NULL;
    }
...
{
    ::TYPES[31] = ::g::Fuse::Triggers::IProgress_typeof();
    ...
    type->SetFields(29,
        ...
        ::TYPES[31/*Fuse.Triggers.IProgress*/], offsetof(::g::Fuse::Triggers::ProgressAnimation, _progress), 0,
        ::TYPES[31/*Fuse.Triggers.IProgress*/], offsetof(::g::Fuse::Triggers::ProgressAnimation, _source), 0);
    type->Reflection.SetFunctions(3,
        new uFunction(".ctor", NULL, (void*)ProgressAnimation__New2_fn, 0, true, type, 0),
        new uFunction("get_Source", NULL, (void*)ProgressAnimation__get_Source_fn, 0, false, ::TYPES[31/*Fuse.Triggers.IProgress*/], 0),
        new uFunction("set_Source", NULL, (void*)ProgressAnimation__set_Source_fn, 0, false, uVoid_typeof(), 1, ::TYPES[31/*Fuse.Triggers.IProgress*/]));
}
...
void ProgressAnimation::DeinitProgress()
{
    ...
    if (_progress != NULL)
    {
        ::g::Fuse::Triggers::IProgress::remove_ProgressChanged(uInterface(uPtr(_progress), ::TYPES[31/*Fuse.Triggers.IProgress*/]), uDelegate::New(::TYPES[32/*Uno.UX.ValueChangedHandler<double>*/], (void*)ProgressAnimation__OnChanged_fn, this));
        _progress = NULL;
    }
}
...
uObject* ProgressAnimation::FindIProgress()
{
    ...
    while ((p != NULL) && !uIs(p, ::TYPES[31/*Fuse.Triggers.IProgress*/]))
        p = uPtr(p)->Parent();

    return uAs<uObject*>(p, ::TYPES[31/*Fuse.Triggers.IProgress*/]);
}
...
void ProgressAnimation::InitProgress()
{
    ...
    if (_progress != NULL)
    {
        ::g::Fuse::Triggers::IProgress::add_ProgressChanged(uInterface(uPtr(_progress), ::TYPES[31/*Fuse.Triggers.IProgress*/]), uDelegate::New(::TYPES[32/*Uno.UX.ValueChangedHandler<double>*/], (void*)ProgressAnimation__OnChanged_fn, this));
        _prevValue = ::g::Fuse::Triggers::IProgress::Progress(uInterface(uPtr(_progress), ::TYPES[31/*Fuse.Triggers.IProgress*/]));
...
void ProgressAnimation::OnChanged(uObject* s, uObject* a)
{
    ...
    double p = ::g::Fuse::Triggers::IProgress::Progress(uInterface(uPtr(_progress), ::TYPES[31/*Fuse.Triggers.IProgress*/]));
...
{
    ::TYPES[33] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Triggers::State_typeof(), NULL);
    ::TYPES[34] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Triggers::State_typeof(), NULL);
    ::TYPES[0] = ::g::Uno::Action_typeof();
    ::TYPES[35] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Animations::Animator_typeof(), NULL);
    ::TYPES[36] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Triggers::Actions::TriggerAction_typeof(), NULL);
    ::TYPES[37] = ::g::Fuse::VisualEventHandler_typeof();
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IUnwrappedPlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::ScrollingAnimation_type, interface4),
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::ScrollingAnimation_type, interface5),
        ::g::Uno::UX::IPropertyListener_typeof(), offsetof(::g::Fuse::Triggers::ScrollingAnimation_type, interface6));
    type->SetFields(38,
        ...
        ::TYPES[37/*Fuse.VisualEventHandler*/], offsetof(::g::Fuse::Triggers::PullToReload, ReloadHandler1), 0);
    type->Reflection.SetFunctions(13,
        ...
        new uFunction("add_ReloadHandler", NULL, (void*)PullToReload__add_ReloadHandler_fn, 0, false, uVoid_typeof(), 1, ::TYPES[37/*Fuse.VisualEventHandler*/]),
        new uFunction("remove_ReloadHandler", NULL, (void*)PullToReload__remove_ReloadHandler_fn, 0, false, uVoid_typeof(), 1, ::TYPES[37/*Fuse.VisualEventHandler*/]),
...
::g::Fuse::Triggers::ScrollingAnimation_type* PullToReload_typeof()
{
    ...
    type->interface6.fp_OnPropertyChanged = (void(*)(uObject*, ::g::Uno::UX::PropertyObject*, ::g::Uno::UX::Selector*))::g::Fuse::Triggers::ScrollingAnimation__UnoUXIPropertyListenerOnPropertyChanged_fn;
    type->interface5.fp_OnPlaybackDone = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn;
    type->interface5.fp_OnStable = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnStable_fn;
    type->interface4.fp_OnProgressUpdated = (void(*)(uObject*, uObject*, double*, double*, int*))::g::Fuse::Triggers::Trigger__FuseAnimationsIUnwrappedPlayerFeedbackOnProgressUpdated_fn;
    type->interface2.fp_Clear = (void(*)(uObject*))::g::Fuse::Node__UnoCollectionsICollectionFuseBindingClear_fn;
...
void PullToReload::Ensure(::g::Fuse::Triggers::State* s)
{
    ...
    if (!(::g::Uno::Collections::ICollection::Contains_ex(uInterface(uPtr(uPtr(StateGroup)->States()), ::TYPES[33/*Uno.Collections.ICollection<Fuse.Triggers.State>*/]), s, &ret5), ret5))
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(StateGroup)->States()), ::TYPES[33/*Uno.Collections.ICollection<Fuse.Triggers.State>*/]), s);
}
...
void PullToReload::EnsureStates()
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(StateGroup)->States()), ::TYPES[33/*Uno.Collections.ICollection<Fuse.Triggers.State>*/])); i++)
        if (!IsState((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(StateGroup)->States()), ::TYPES[34/*Uno.Collections.IList<Fuse.Triggers.State>*/]), uCRef<int>(i), &ret6), ret6)))
            ::g::Uno::Collections::IList::RemoveAt(uInterface(uPtr(uPtr(StateGroup)->States()), ::TYPES[34/*Uno.Collections.IList<Fuse.Triggers.State>*/]), i--);
...
void PullToReload::InitializeUX()
{
    ...
    temp3->Duration(1.0);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Animators()), ::TYPES[35/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp3);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Actions()), ::TYPES[36/*Uno.Collections.ICollection<Fuse.Triggers.Actions.TriggerAction>*/]), temp);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Actions()), ::TYPES[36/*Uno.Collections.ICollection<Fuse.Triggers.Actions.TriggerAction>*/]), temp1);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Actions()), ::TYPES[36/*Uno.Collections.ICollection<Fuse.Triggers.Actions.TriggerAction>*/]), temp2);
}
...
void PullToReload::add_ReloadHandler(uDelegate* value)
{
    ...
    ReloadHandler1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(ReloadHandler1, value), ::TYPES[37/*Fuse.VisualEventHandler*/]);
}
...
void PullToReload::remove_ReloadHandler(uDelegate* value)
{
    ...
    ReloadHandler1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(ReloadHandler1, value), ::TYPES[37/*Fuse.VisualEventHandler*/]);
}
...
static void PulseTrigger_build(uType* type)
{
    ::TYPES[5] = ::g::Fuse::Visual_typeof();
    ::TYPES[12] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[38] = PulseTrigger__PulseHandler_typeof();
    type->SetPrecalc(
        PulseTrigger__PulseHandler_typeof()->MakeType(type->T(0), NULL));
    type->MethodTypes[0]->SetPrecalc(
        ::TYPES[5/*Fuse.Visual*/]->MakeMethod(3/*FirstChild<T>*/, type->MethodTypes[0]->U(0), NULL));
    type->MethodTypes[1]->SetPrecalc(
        ::TYPES[5/*Fuse.Visual*/]->MakeMethod(3/*FirstChild<T>*/, type->MethodTypes[1]->U(0), NULL));
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
        ...
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface5));
    type->SetFields(29,
        ::TYPES[38/*Fuse.Triggers.PulseTrigger`1.PulseHandler*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Triggers::PulseTrigger, Handler1), 0);
    type->Reflection.SetFunctions(2,
        new uFunction("add_Handler", NULL, (void*)PulseTrigger__add_Handler_fn, 0, false, uVoid_typeof(), 1, ::TYPES[38/*Fuse.Triggers.PulseTrigger`1.PulseHandler*/]->MakeType(type->T(0), NULL)),
        new uFunction("remove_Handler", NULL, (void*)PulseTrigger__remove_Handler_fn, 0, false, uVoid_typeof(), 1, ::TYPES[38/*Fuse.Triggers.PulseTrigger`1.PulseHandler*/]->MakeType(type->T(0), NULL)));
}
...
void PulseTrigger::AddHandlerImpl(uType* __type, ::g::Fuse::Visual* visual, uDelegate* handler)
{
    ...
    if (r == NULL)
    {
        ...
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(visual)->Children()), ::TYPES[12/*Uno.Collections.ICollection<Fuse.Node>*/]), r);
    }
...
// private enum WhileFloat.Range :3574
...
void RemovingAnimation__FuseIBeginRemoveVisualListenerOnBeginRemoveVisual_fn(RemovingAnimation* __this, ::g::Fuse::PendingRemoveVisual* pr)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[26/*"Double remo...*/], __this, ::STRINGS[3/*"/Users/hdc/...*/], 1729, ::STRINGS[27/*"Fuse.IBegin...*/]);
        return;
    }
...
void RemovingAnimation::OnDone()
{
    ...
    if (_args == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[28/*"Unexpected ...*/], this, ::STRINGS[3/*"/Users/hdc/...*/], 1742, ::STRINGS[29/*"OnDone"*/]);
        return;
    }
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[2/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[39/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Scrolled>*/], ::STRINGS[30/*"check"*/], uDelegate::New(::TYPES[40/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Scrolled, object[]>*/], (void*)Scrolled__check_fn), 2)));
}
...
static void Scrolled_build(uType* type)
{
    ...
    ::STRINGS[32] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Controls.ScrollView/0.46.1/triggers/$.uno");
    ...
    ::TYPES[0] = ::g::Uno::Action_typeof();
    ::TYPES[41] = ::g::Fuse::Visual_typeof()->MakeMethod(2/*FindByType<Fuse.Controls.ScrollViewBase>*/, ::g::Fuse::Controls::ScrollViewBase_typeof(), NULL);
    ::TYPES[42] = ::g::Fuse::Controls::ScrollPositionChangedHandler_typeof();
...
void Scrolled__OnRooted_fn(Scrolled* __this)
{
    ...
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    __this->_scrollable = ((::g::Fuse::Controls::ScrollViewBase*)uPtr(__this->Parent())->FindByType(::TYPES[41/*Fuse.Visual.FindByType<Fuse.Controls.ScrollViewBase>*/]));

    if (__this->_scrollable == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Scrolled co...*/], __this, ::STRINGS[32/*"/Users/hdc/...*/], 288, ::STRINGS[21/*"OnRooted"*/]);
        return;
    }

    uPtr(__this->_scrollable)->add_ScrollPositionChanged(uDelegate::New(::TYPES[42/*Fuse.Controls.ScrollPositionChangedHandler*/], (void*)Scrolled__OnScrollPositionChanged_fn, __this));
...
void Scrolled__OnUnrooted_fn(Scrolled* __this)
{
    ...
    if (__this->_scrollable != NULL)
    {
        uPtr(__this->_scrollable)->remove_ScrollPositionChanged(uDelegate::New(::TYPES[42/*Fuse.Controls.ScrollPositionChangedHandler*/], (void*)Scrolled__OnScrollPositionChanged_fn, __this));
...
void Scrolled::check(::g::Fuse::Scripting::Context* c, Scrolled* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[31/*"reset takes...*/], s, ::STRINGS[32/*"/Users/hdc/...*/], 242, ::STRINGS[30/*"check"*/]);
        return;
    }
...
static void ScrollingAnimation_build(uType* type)
{
    ...
    ::TYPES[43] = ::g::Fuse::Visual_typeof()->MakeMethod(2/*FindByType<Fuse.Controls.ScrollView>*/, ::g::Fuse::Controls::ScrollView_typeof(), NULL);
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IUnwrappedPlayerFeedback_typeof(), offsetof(ScrollingAnimation_type, interface4),
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(ScrollingAnimation_type, interface5),
        ::g::Uno::UX::IPropertyListener_typeof(), offsetof(ScrollingAnimation_type, interface6));
    type->SetFields(29,
...
ScrollingAnimation_type* ScrollingAnimation_typeof()
{
    ...
    type->interface6.fp_OnPropertyChanged = (void(*)(uObject*, ::g::Uno::UX::PropertyObject*, ::g::Uno::UX::Selector*))ScrollingAnimation__UnoUXIPropertyListenerOnPropertyChanged_fn;
    type->interface5.fp_OnPlaybackDone = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn;
    type->interface5.fp_OnStable = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnStable_fn;
    type->interface4.fp_OnProgressUpdated = (void(*)(uObject*, uObject*, double*, double*, int*))::g::Fuse::Triggers::Trigger__FuseAnimationsIUnwrappedPlayerFeedbackOnProgressUpdated_fn;
    type->interface2.fp_Clear = (void(*)(uObject*))::g::Fuse::Node__UnoCollectionsICollectionFuseBindingClear_fn;
...
void ScrollingAnimation__OnRooted_fn(ScrollingAnimation* __this)
{
    ...
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    __this->_scrollable = ((::g::Fuse::Controls::ScrollView*)uPtr(__this->Parent())->FindByType(::TYPES[43/*Fuse.Visual.FindByType<Fuse.Controls.ScrollView>*/]));
...
{
    ::TYPES[44] = ::g::Fuse::Triggers::IScrolledLength_typeof();
    type->SetFields(0,
        ::TYPES[44/*Fuse.Triggers.IScrolledLength*/], offsetof(::g::Fuse::Triggers::ScrollRegion, RelativeTo), 0,
...
::g::Uno::Float2 ScrollRegion::CalcWithin(::g::Fuse::Controls::ScrollViewBase* scrollable)
{
    ...
    return ::g::Fuse::Triggers::IScrolledLength::GetPoints(uInterface(uPtr(RelativeTo), ::TYPES[44/*Fuse.Triggers.IScrolledLength*/]), Within, scrollable);
}
...
// private enum Timeline.State :2250
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[2/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[45/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.State>*/], ::STRINGS[35/*"goto"*/], uDelegate::New(::TYPES[46/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.State, object[]>*/], (void*)State__goto__fn), 2)));
}
...
static void State_build(uType* type)
{
    ...
    ::TYPES[1] = ::g::Uno::Type_typeof();
    ::TYPES[2] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[45] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(type, NULL);
    ::TYPES[46] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), type, uObject_typeof()->Array(), NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
...
void State::Goto()
{
    ...
    if (_stateGroup == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[36/*"Cannot call...*/], NULL, ::STRINGS[3/*"/Users/hdc/...*/], 2148, ::STRINGS[37/*"Goto"*/]);
        return;
    }
...
{
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[2/*Fuse.Scripting.ScriptMember[]*/], 2, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[47/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.StateGroup>*/], ::STRINGS[35/*"goto"*/], uDelegate::New(::TYPES[48/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.StateGroup, object[]>*/], (void*)StateGroup__goto__fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[47/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.StateGroup>*/], ::STRINGS[38/*"gotoNext"*/], uDelegate::New(::TYPES[48/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.StateGroup, object[]>*/], (void*)StateGroup__gotoNext_fn), 2)));
}
...
static void StateGroup_build(uType* type)
{
    ...
    ::TYPES[49] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Triggers::State_typeof(), NULL);
    ::TYPES[20] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Triggers::State_typeof(), NULL);
    ::TYPES[21] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[22] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Triggers::State_typeof(), NULL);
    ::TYPES[0] = ::g::Uno::Action_typeof();
    ::TYPES[50] = ::g::Uno::String_typeof();
    ::TYPES[51] = ::g::Fuse::Triggers::State_typeof();
    ::TYPES[52] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[33] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[51/*Fuse.Triggers.State*/], NULL);
    ::TYPES[34] = ::g::Uno::Collections::IList_typeof()->MakeType(::TYPES[51/*Fuse.Triggers.State*/], NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Node_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Node_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Node_type, interface2),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Node_type, interface3));
    type->SetFields(13,
        ::TYPES[51/*Fuse.Triggers.State*/], offsetof(::g::Fuse::Triggers::StateGroup, _active), 0,
        ::TYPES[51/*Fuse.Triggers.State*/], offsetof(::g::Fuse::Triggers::StateGroup, _rest), 0,
        ::TYPES[34/*Uno.Collections.IList<Fuse.Triggers.State>*/], offsetof(::g::Fuse::Triggers::StateGroup, _states), 0,
        ::g::Fuse::Triggers::StateTransition_typeof(), offsetof(::g::Fuse::Triggers::StateGroup, _transition), 0);
    type->Reflection.SetFunctions(10,
        new uFunction("get_Active", NULL, (void*)StateGroup__get_Active_fn, 0, false, ::TYPES[51/*Fuse.Triggers.State*/], 0),
        new uFunction("set_Active", NULL, (void*)StateGroup__set_Active_fn, 0, false, uVoid_typeof(), 1, ::TYPES[51/*Fuse.Triggers.State*/]),
        new uFunction("FindObjectByName", NULL, (void*)StateGroup__FindObjectByName_fn, 0, false, uObject_typeof(), 2, ::g::Uno::UX::Selector_typeof(), ::TYPES[52/*Uno.Predicate<object>*/]),
        ...
        new uFunction("get_Rest", NULL, (void*)StateGroup__get_Rest_fn, 0, false, ::TYPES[51/*Fuse.Triggers.State*/], 0),
        new uFunction("set_Rest", NULL, (void*)StateGroup__set_Rest_fn, 0, false, uVoid_typeof(), 1, ::TYPES[51/*Fuse.Triggers.State*/]),
        new uFunction("get_States", NULL, (void*)StateGroup__get_States_fn, 0, false, ::TYPES[34/*Uno.Collections.IList<Fuse.Triggers.State>*/], 0),
...
void StateGroup__OnRooted_fn(StateGroup* __this)
{
    ...
    if ((__this->_active == NULL) && (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->_states), ::TYPES[33/*Uno.Collections.ICollection<Fuse.Triggers.State>*/])) > 0))
        __this->_active = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->_states), ::TYPES[34/*Uno.Collections.IList<Fuse.Triggers.State>*/]), uCRef<int>(0), &ret10), ret10);

    for (uObject* enum3 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->_states), ::TYPES[20/*Uno.Collections.IEnumerable<Fuse.Triggers.State>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum3), ::TYPES[21/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Triggers::State* state = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum3), ::TYPES[22/*Uno.Collections.IEnumerator<Fuse.Triggers.State>*/]), &ret11), ret11);
...
void StateGroup__OnUnrooted_fn(StateGroup* __this)
{
    ...
    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->_states), ::TYPES[20/*Uno.Collections.IEnumerable<Fuse.Triggers.State>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[21/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Triggers::State* state = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[22/*Uno.Collections.IEnumerator<Fuse.Triggers.State>*/]), &ret12), ret12);
...
void StateGroup::ctor_3()
{
    ...
    _states = (uObject*)((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[49/*Uno.Collections.List<Fuse.Triggers.State>*/]));
    ctor_2();
}
...
int StateGroup::ActiveIndex()
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(States()), ::TYPES[33/*Uno.Collections.ICollection<Fuse.Triggers.State>*/])); ++i)
        if (_active == (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(States()), ::TYPES[34/*Uno.Collections.IList<Fuse.Triggers.State>*/]), uCRef<int>(i), &ret13), ret13))
            return i;
...
void StateGroup::ActiveIndex(int value)
{
    ...
    Active((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(_states), ::TYPES[34/*Uno.Collections.IList<Fuse.Triggers.State>*/]), uCRef<int>(value), &ret14), ret14));
}
...
void StateGroup::CheckAllDone()
{
    ...
    for (uObject* enum5 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(_states), ::TYPES[20/*Uno.Collections.IEnumerable<Fuse.Triggers.State>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum5), ::TYPES[21/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Triggers::State* state = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum5), ::TYPES[22/*Uno.Collections.IEnumerator<Fuse.Triggers.State>*/]), &ret7), ret7);
...
uObject* StateGroup::FindObjectByName(::g::Uno::UX::Selector name, uDelegate* acceptor)
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(States()), ::TYPES[20/*Uno.Collections.IEnumerable<Fuse.Triggers.State>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[21/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Triggers::State* s = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[22/*Uno.Collections.IEnumerator<Fuse.Triggers.State>*/]), &ret8), ret8);
...
void StateGroup::GotoNextState()
{
    ...
    ActiveIndex((ActiveIndex() + 1) % ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(_states), ::TYPES[33/*Uno.Collections.ICollection<Fuse.Triggers.State>*/])));
}
...
::g::Fuse::Triggers::State* StateGroup::Rest()
{
    ...
    if (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(_states), ::TYPES[33/*Uno.Collections.ICollection<Fuse.Triggers.State>*/])) > 0)
        return (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(_states), ::TYPES[34/*Uno.Collections.IList<Fuse.Triggers.State>*/]), uCRef<int>(0), &ret15), ret15);
...
void StateGroup::goto_(::g::Fuse::Scripting::Context* c, StateGroup* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[39/*"StateGroup....*/], n, ::STRINGS[3/*"/Users/hdc/...*/], 1812, ::STRINGS[40/*"goto_"*/]);
        return;
    }

    if (uIs((uObject*)uPtr(args)->Strong<uObject*>(0), ::TYPES[50/*string*/]))
        StateGroup::gotoName(c, n, uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[50/*string*/]));
    else
        uPtr(n)->Goto(uAs< ::g::Fuse::Triggers::State*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[51/*Fuse.Triggers.State*/]));
}
...
void StateGroup::gotoName(::g::Fuse::Scripting::Context* c, StateGroup* n, uString* name)
{
    ...
    StateGroup_typeof()->Init();
    ::g::Fuse::Triggers::State* state = uAs< ::g::Fuse::Triggers::State*>(uPtr(n)->FindObjectByName(::g::Uno::UX::Selector__op_Implicit(name), uDelegate::New(::TYPES[52/*Uno.Predicate<object>*/], (void*)StateGroup__StateAcceptor_fn)), ::TYPES[51/*Fuse.Triggers.State*/]);

    if (state == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[41/*"Unable to f...*/], name), n, ::STRINGS[3/*"/Users/hdc/...*/], 1792, ::STRINGS[42/*"gotoName"*/]);
        return;
    }
...
{
    StateGroup_typeof()->Init();
    return uIs(o, ::TYPES[51/*Fuse.Triggers.State*/]);
}
// }
...
static void TextInputActionTriggered_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/0.46.1/triggers/$.uno");
    ::STRINGS[21] = uString::Const("OnRooted");
    ::TYPES[53] = ::g::Fuse::Controls::ITextEditControl_typeof();
    ::TYPES[54] = ::g::Fuse::Controls::TextInputActionHandler_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
        ...
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface5));
    type->SetFields(29,
        ::TYPES[53/*Fuse.Controls.ITextEditControl*/], offsetof(::g::Fuse::Triggers::TextInputActionTriggered, _textEdit), 0,
...
void TextInputActionTriggered__OnRooted_fn(TextInputActionTriggered* __this)
{
    ...
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    __this->_textEdit = uAs<uObject*>(__this->Parent(), ::TYPES[53/*Fuse.Controls.ITextEditControl*/]);

    if (__this->_textEdit == NULL)
        ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"TextInputAc...*/], __this, ::STRINGS[17/*"/Users/hdc/...*/], 126, ::STRINGS[21/*"OnRooted"*/]);
    else
        ::g::Fuse::Controls::ITextEditControl::add_ActionTriggered(uInterface(uPtr(__this->_textEdit), ::TYPES[53/*Fuse.Controls.ITextEditControl*/]), uDelegate::New(::TYPES[54/*Fuse.Controls.TextInputActionHandler*/], (void*)TextInputActionTriggered__OnActionTriggered_fn, __this));
}
...
void TextInputActionTriggered__OnUnrooted_fn(TextInputActionTriggered* __this)
{
    ...
    if (__this->_textEdit != NULL)
    {
        ::g::Fuse::Controls::ITextEditControl::remove_ActionTriggered(uInterface(uPtr(__this->_textEdit), ::TYPES[53/*Fuse.Controls.ITextEditControl*/]), uDelegate::New(::TYPES[54/*Fuse.Controls.TextInputActionHandler*/], (void*)TextInputActionTriggered__OnActionTriggered_fn, __this));
...
// {
// static Timeline() :2445
static void Timeline__cctor_1_fn(uType* __type)
{
    Timeline::_progressName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[44/*"Progress"*/]);
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[2/*Fuse.Scripting.ScriptMember[]*/], 9, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[55/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[45/*"pause"*/], uDelegate::New(::TYPES[56/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__pause_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[55/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[46/*"pulse"*/], uDelegate::New(::TYPES[56/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__pulse_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[55/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[47/*"pulseBackward"*/], uDelegate::New(::TYPES[56/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__pulseBackward_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[55/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[48/*"pulseForward"*/], uDelegate::New(::TYPES[56/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__pulseForward_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[55/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[49/*"play"*/], uDelegate::New(::TYPES[56/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__resume_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[55/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[50/*"playTo"*/], uDelegate::New(::TYPES[56/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__playTo_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[55/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[51/*"resume"*/], uDelegate::New(::TYPES[56/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__resume_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[55/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[52/*"seek"*/], uDelegate::New(::TYPES[56/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__seek_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[55/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Timeline>*/], ::STRINGS[53/*"stop"*/], uDelegate::New(::TYPES[56/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Timeline, object[]>*/], (void*)Timeline__stop_fn), 2)));
}

static void Timeline_build(uType* type)
{
    ::STRINGS[44] = uString::Const("Progress");
    ::STRINGS[45] = uString::Const("pause");
    ::STRINGS[46] = uString::Const("pulse");
    ::STRINGS[47] = uString::Const("pulseBackward");
    ::STRINGS[48] = uString::Const("pulseForward");
    ::STRINGS[49] = uString::Const("play");
    ::STRINGS[50] = uString::Const("playTo");
    ::STRINGS[51] = uString::Const("resume");
    ...
    ::TYPES[57] = ::g::Uno::UX::IPropertyListener_typeof();
    ::TYPES[58] = ::g::Uno::UX::ValueChangedArgs_typeof()->MakeType(::g::Uno::Double_typeof(), NULL);
    ::TYPES[0] = ::g::Uno::Action_typeof();
    ::TYPES[32] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Uno::Double_typeof(), NULL);
    type->SetInterfaces(
    ...
    type->SetFields(29,
        ...
        ::TYPES[57/*Uno.UX.IPropertyListener*/], offsetof(::g::Fuse::Triggers::Timeline, _progressOrigin), 0,
    ...
    type->Reflection.SetFunctions(25,
        ...
        new uFunction("add_ProgressChanged", NULL, (void*)Timeline__add_ProgressChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[32/*Uno.UX.ValueChangedHandler<double>*/]),
        new uFunction("remove_ProgressChanged", NULL, (void*)Timeline__remove_ProgressChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[32/*Uno.UX.ValueChangedHandler<double>*/]),
        ...
        new uFunction("SetProgress", NULL, (void*)Timeline__SetProgress_fn, 0, false, uVoid_typeof(), 2, ::g::Uno::Double_typeof(), ::TYPES[57/*Uno.UX.IPropertyListener*/]),
...
Timeline_type* Timeline_typeof()
{
    ...
    type->interface6.fp_Stop = (void(*)(uObject*))Timeline__Stop1_fn;
    type->interface6.fp_PlayTo = (void(*)(uObject*, double*))Timeline__PlayTo1_fn;
    type->interface6.fp_Pause = (void(*)(uObject*))Timeline__Pause_fn;
    type->interface6.fp_Resume = (void(*)(uObject*))Timeline__Resume_fn;
    ...
    type->interface6.fp_get_CanPlayTo = (void(*)(uObject*, bool*))Timeline__get_CanPlayTo_fn;
    type->interface6.fp_get_CanStop = (void(*)(uObject*, bool*))Timeline__get_CanStop_fn;
    type->interface6.fp_get_CanPause = (void(*)(uObject*, bool*))Timeline__get_CanPause_fn;
    type->interface6.fp_get_CanResume = (void(*)(uObject*, bool*))Timeline__get_CanResume_fn;
...
void Timeline__OnProgressChanged_fn(Timeline* __this)
{
    ...
    uObject* sender = (ind1 != NULL) ? ind1 : uAs<uObject*>(__this, ::TYPES[57/*Uno.UX.IPropertyListener*/]);
    __this->OnPropertyChanged1(Timeline::_progressName(), sender);

    if (::g::Uno::Delegate::op_Inequality(__this->ProgressChanged1, NULL))
        uPtr(__this->ProgressChanged1)->Invoke(2, sender, (::g::Uno::UX::ValueChangedArgs__New2_fn(::TYPES[58/*Uno.UX.ValueChangedArgs<double>*/], uCRef(__this->Progress1()), &ret3), ret3));
}
...
// private void BypassOff() [instance] :2418
...
// public bool get_CanPause() [instance] :2365
bool Timeline::CanPause()
{
    return true;
}

// public bool get_CanPlayTo() [instance] :2361
bool Timeline::CanPlayTo()
{
    return true;
}

// public bool get_CanResume() [instance] :2367
bool Timeline::CanResume()
{
    return true;
}

// public bool get_CanStop() [instance] :2363
bool Timeline::CanStop()
{
    return true;
}

// public double get_InitialProgress() [instance] :2261
double Timeline::InitialProgress()
{
    return _initialProgress;
}

// public void set_InitialProgress(double value) [instance] :2262
...
// public bool get_OnAtZero() [instance] :2245
bool Timeline::OnAtZero()
{
    return _startAtZero;
}

// public void set_OnAtZero(bool value) [instance] :2246
void Timeline::OnAtZero(bool value)
{
    _startAtZero = value;
}

// public void Pause() [instance] :2343
void Timeline::Pause()
{
    if (IsRootingCompleted())
    {
...
// private void Play(double progress) [instance] :2335
...
// public Fuse.Animations.PlayMode get_PlayMode() [instance] :2285
...
// public void set_PlayMode(Fuse.Animations.PlayMode value) [instance] :2286
...
// public void PlayTo(double progress) [instance] :2329
...
// public new void set_Progress(double value) [instance] :2373
...
// public generated void add_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) [instance] :2317
...
// public generated void remove_ProgressChanged(Uno.UX.ValueChangedHandler<double> value) [instance] :2317
...
// public new void Pulse() [instance] :2407
void Timeline::Pulse1()
{
    Pulse();
}

// public new void PulseBackward() [instance] :2424
...
// public void PulseForward() [instance] :2412
...
// public void Resume() [instance] :2352
...
// public void SetProgress(double value, Uno.UX.IPropertyListener origin) [instance] :2385
...
// public void Stop() [instance] :2319
void Timeline::Stop1()
{
    if (IsRootingCompleted())
    {
...
// public double get_TargetProgress() [instance] :2273
double Timeline::TargetProgress()
{
    return _targetProgress;
}

// public void set_TargetProgress(double value) [instance] :2274
...
// private static void pause(Fuse.Scripting.Context c, Fuse.Triggers.Timeline n, object[] args) [static] :2536
...
// private static void playTo(Fuse.Scripting.Context c, Fuse.Triggers.Timeline n, object[] args) [static] :2498
void Timeline::playTo(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[54/*"Timeline.se...*/], n, ::STRINGS[3/*"/Users/hdc/...*/], 2502, ::STRINGS[50/*"playTo"*/]);
        return;
    }
...
// private static void pulse(Fuse.Scripting.Context c, Fuse.Triggers.Timeline n, object[] args) [static] :2465
...
// private static void pulseBackward(Fuse.Scripting.Context c, Fuse.Triggers.Timeline n, object[] args) [static] :2485
...
// private static void pulseForward(Fuse.Scripting.Context c, Fuse.Triggers.Timeline n, object[] args) [static] :2475
...
// private static void resume(Fuse.Scripting.Context c, Fuse.Triggers.Timeline n, object[] args) [static] :2526
...
// private static void seek(Fuse.Scripting.Context c, Fuse.Triggers.Timeline n, object[] args) [static] :2547
void Timeline::seek(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[54/*"Timeline.se...*/], n, ::STRINGS[3/*"/Users/hdc/...*/], 2551, ::STRINGS[52/*"seek"*/]);
        return;
    }
...
// private static void stop(Fuse.Scripting.Context c, Fuse.Triggers.Timeline n, object[] args) [static] :2515
...
static void Transition_build(uType* type)
{
    ...
    ::TYPES[35] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Animations::Animator_typeof(), NULL);
    ::TYPES[59] = ::g::Fuse::Internal::MiniList_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[60] = ::g::Fuse::Navigation::INavigation_typeof();
    ::TYPES[0] = ::g::Uno::Action_typeof();
    ::TYPES[61] = ::g::Fuse::Navigation::NavigationHandler_typeof();
    ::TYPES[62] = ::g::Uno::Char_typeof()->Array();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
    ...
    type->SetFields(29,
        ...
        ::TYPES[59/*Fuse.Internal.MiniList<string>*/], offsetof(::g::Fuse::Triggers::Transition, _from), 0,
        ...
        ::TYPES[59/*Fuse.Internal.MiniList<string>*/], offsetof(::g::Fuse::Triggers::Transition, _to), 0,
...
// protected override sealed void OnPlayStateChanged(Fuse.Triggers.TriggerPlayState state) :3082
...
// protected override sealed void OnProgressChanged() :3072
...
// protected override sealed void OnRooted() :2921
void Transition__OnRooted_fn(Transition* __this)
{
    ...
    if (__this->_group != NULL)
    {
        ...
        uPtr(uPtr(__this->_group)->Navigator())->add_PageProgressChanged(uDelegate::New(::TYPES[61/*Fuse.Navigation.NavigationHandler*/], (void*)Transition__OnPageProgressChanged_fn, __this));
    }
}

// protected override sealed void OnUnrooted() :2965
void Transition__OnUnrooted_fn(Transition* __this)
{
    ...
    if (__this->_useAnimator != NULL)
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(__this->Animators()), ::TYPES[35/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), __this->_useAnimator, &ret2);

    if (__this->_group != NULL)
    {
        uPtr(uPtr(__this->_group)->Navigator())->remove_PageProgressChanged(uDelegate::New(::TYPES[61/*Fuse.Navigation.NavigationHandler*/], (void*)Transition__OnPageProgressChanged_fn, __this));
        uPtr(uPtr(__this->_group)->Navigator())->SetTransitionState(__this, false);
...
// private static void Parse(Fuse.Internal.MiniList<string>& list, string src) :2837
void Transition__Parse_fn(::g::Fuse::Internal::MiniList* list, uString* src)
{
    Transition::Parse(list, src);
}

// internal int Priority(bool isActive, bool isBackward, string newPath, string oldPath, Fuse.Navigation.NavigationGotoMode mode, string operationStyle) :2979
...
// private void AddUseTransition() [instance] :2936
void Transition::AddUseTransition()
{
    ...
    if (_useAnimator != NULL)
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Animators()), ::TYPES[35/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), _useAnimator);
}

// public bool get_AutoRelease() [instance] :2889
bool Transition::AutoRelease()
{
    return _autoRelease;
}

// public void set_AutoRelease(bool value) [instance] :2890
void Transition::AutoRelease(bool value)
{
    _autoRelease = value;
}

// public Fuse.Triggers.TransitionDirection get_Direction() [instance] :2877
int Transition::Direction()
{
    return _direction;
}

// public void set_Direction(Fuse.Triggers.TransitionDirection value) [instance] :2878
void Transition::Direction(int value)
{
    _direction = value;
}

// public string get_From() [instance] :2865
...
// public void set_From(string value) [instance] :2866
...
// public Fuse.Triggers.TransitionMode get_Mode() [instance] :2896
int Transition::Mode()
{
    return _mode;
}

// public void set_Mode(Fuse.Triggers.TransitionMode value) [instance] :2897
void Transition::Mode(int value)
{
    _mode = value;
}

// private void OnPageProgressChanged(object sender, Fuse.Navigation.NavigationArgs args) [instance] :3105
void Transition::OnPageProgressChanged(uObject* sender, ::g::Fuse::Navigation::NavigationArgs* args)
{
    ...
    ::g::Fuse::Navigation::NavigationPageState ps = ::g::Fuse::Navigation::INavigation::GetPageState(uInterface(uPtr(uAs<uObject*>(uPtr(_group)->Navigator(), ::TYPES[60/*Fuse.Navigation.INavigation*/])), ::TYPES[60/*Fuse.Navigation.INavigation*/]), uPtr(_group)->Page());
...
// internal int Priority(bool isActive, bool isBackward, string newPath, string oldPath, Fuse.Navigation.NavigationGotoMode mode, string operationStyle) [instance] :2979
int Transition::Priority(bool isActive, bool isBackward, uString* newPath, uString* oldPath, int mode, uString* operationStyle)
{
    ...
    if (_to.Count(::TYPES[59/*Fuse.Internal.MiniList<string>*/]) > 0)
    {
        if (!normActive && _to.Contains(::TYPES[59/*Fuse.Internal.MiniList<string>*/], toPath))
            return priority + 20;

        return -1;
    }

    if (_from.Count(::TYPES[59/*Fuse.Internal.MiniList<string>*/]) > 0)
    {
        if (normActive && _from.Contains(::TYPES[59/*Fuse.Internal.MiniList<string>*/], fromPath))
            return priority + 10;
...
// internal void QuickDeactivate() [instance] :3090
...
// public string get_Style() [instance] :2904
uString* Transition::Style()
{
    return _style;
}

// public void set_Style(string value) [instance] :2905
void Transition::Style(uString* value)
{
    _style = value;
}

// public string get_To() [instance] :2853
...
// public void set_To(string value) [instance] :2854
...
// public Fuse.Controls.NavigationControlTransition get_UseTransition() [instance] :2916
int Transition::UseTransition()
{
    return _useTransition;
}

// public void set_UseTransition(Fuse.Controls.NavigationControlTransition value) [instance] :2917
void Transition::UseTransition(int value)
{
    _useTransition = value;
}

// private static string Join(Fuse.Internal.MiniList<string>& list) [static] :2825
uString* Transition::Join(::g::Fuse::Internal::MiniList* list)
{
    ...
    for (int i = 0; i < (*list).Count(::TYPES[59/*Fuse.Internal.MiniList<string>*/]); ++i)
    {
        if (i != 0)
            o = ::g::Uno::String::op_Addition2(o, ::STRINGS[55/*","*/]);

        o = ::g::Uno::String::op_Addition2(o, (uString*)(*list).Item(::TYPES[59/*Fuse.Internal.MiniList<string>*/], i));
    }

    return o;
}

// public generated Transition New() [static] :2823
...
// private static void Parse(Fuse.Internal.MiniList<string>& list, string src) [static] :2837
void Transition::Parse(::g::Fuse::Internal::MiniList* list, uString* src)
{
    ...
    (*list).Clear(::TYPES[59/*Fuse.Internal.MiniList<string>*/]);
    uArray* s = ::g::Uno::String::Split(uPtr(src), uArray::Init<int>(::TYPES[62/*char[]*/], 1, ','));

    for (int i = 0; i < uPtr(s)->Length(); ++i)
        (*list).Add(::TYPES[59/*Fuse.Internal.MiniList<string>*/], ::g::Uno::String::Trim(uPtr(uPtr(s)->Strong<uString*>(i))));
}
// }
...
// public enum TransitionDirection :2769
...
// internal sealed class TransitionGroup :2634
// {
// static TransitionGroup() :2634
static void TransitionGroup__cctor__fn(uType* __type)
{
    TransitionGroup::_groupMap_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[63/*Uno.Collections.Dictionary<Fuse.Node, Fuse.Triggers.TransitionGroup>*/]));
}

static void TransitionGroup_build(uType* type)
{
    ::STRINGS[56] = uString::Const("Transition must have a Navigator ancestor");
    ::STRINGS[57] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Controls.Navigation/0.46.1/$.uno");
    ::STRINGS[58] = uString::Const("Root");
    ::STRINGS[59] = uString::Const("Transition must have a Visual parent");
    ::TYPES[63] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Node_typeof(), type, NULL);
    ::TYPES[64] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Triggers::Transition_typeof(), NULL);
    ::TYPES[65] = ::g::Fuse::Controls::NavigationSwitchedHandler_typeof();
    ::TYPES[12] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[66] = ::g::Fuse::Controls::Navigator_typeof();
    ::TYPES[5] = ::g::Fuse::Visual_typeof();
    type->SetFields(0,
        ::TYPES[66/*Fuse.Controls.Navigator*/], offsetof(::g::Fuse::Triggers::TransitionGroup, _navigator), 0,
        ::TYPES[5/*Fuse.Visual*/], offsetof(::g::Fuse::Triggers::TransitionGroup, _parent), 0,
        ::g::Fuse::Triggers::Transition_typeof(), offsetof(::g::Fuse::Triggers::TransitionGroup, _selected), 0,
        ::TYPES[64/*Uno.Collections.List<Fuse.Triggers.Transition>*/], offsetof(::g::Fuse::Triggers::TransitionGroup, _states), 0,
        ::TYPES[63/*Uno.Collections.Dictionary<Fuse.Node, Fuse.Triggers.TransitionGroup>*/], (uintptr_t)&::g::Fuse::Triggers::TransitionGroup::_groupMap_, uFieldFlagsStatic);
}
...
// public TransitionGroup(Fuse.Controls.Navigator navigator, Fuse.Visual parent) :2673
...
// public TransitionGroup New(Fuse.Controls.Navigator navigator, Fuse.Visual parent) :2673
...
// private void OnSwitched(object sender, Fuse.Controls.NavigatorSwitchedArgs args) :2712
...
// public void Unroot(Fuse.Triggers.Transition t) :2700
...
// public TransitionGroup(Fuse.Controls.Navigator navigator, Fuse.Visual parent) [instance] :2673
void TransitionGroup::ctor_(::g::Fuse::Controls::Navigator* navigator, ::g::Fuse::Visual* parent)
{
    ...
    _states = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[64/*Uno.Collections.List<Fuse.Triggers.Transition>*/]));
    _parent = parent;
    _navigator = navigator;
    uPtr(_navigator)->add_Switched(uDelegate::New(::TYPES[65/*Fuse.Controls.NavigationSwitchedHandler*/], (void*)TransitionGroup__OnSwitched_fn, this));
}

// public void Add(Fuse.Triggers.Transition t) [instance] :2695
...
// private void Cleanup() [instance] :2689
void TransitionGroup::Cleanup()
{
    uStackFrame __("Fuse.Triggers.TransitionGroup", "Cleanup()");
    uPtr(_navigator)->remove_Switched(uDelegate::New(::TYPES[65/*Fuse.Controls.NavigationSwitchedHandler*/], (void*)TransitionGroup__OnSwitched_fn, this));
}

// public Fuse.Controls.Navigator get_Navigator() [instance] :2680
::g::Fuse::Controls::Navigator* TransitionGroup::Navigator()
{
    return _navigator;
}

// private void OnSwitched(object sender, Fuse.Controls.NavigatorSwitchedArgs args) [instance] :2712
...
// public Fuse.Visual get_Page() [instance] :2682
::g::Fuse::Visual* TransitionGroup::Page()
{
    return _parent;
}

// public void ReleasePage() [instance] :2684
...
// private void SelectTransition(Fuse.Triggers.Transition which) [instance] :2757
...
// public void Unroot(Fuse.Triggers.Transition t) [instance] :2700
...
// public TransitionGroup New(Fuse.Controls.Navigator navigator, Fuse.Visual parent) [static] :2673
...
// public static Fuse.Triggers.TransitionGroup Root(Fuse.Triggers.Transition t) [static] :2638
TransitionGroup* TransitionGroup::Root(::g::Fuse::Triggers::Transition* t)
{
    ...
    {
        nav = uAs< ::g::Fuse::Controls::Navigator*>(q, ::TYPES[66/*Fuse.Controls.Navigator*/]);
        q = uPtr(q)->ContextParent();
    }

    if (nav == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[56/*"Transition ...*/], t, ::STRINGS[57/*"/Users/hdc/...*/], 2649, ::STRINGS[58/*"Root"*/]);
        return NULL;
    }
    ...
    if (vis == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[59/*"Transition ...*/], t, ::STRINGS[57/*"/Users/hdc/...*/], 2656, ::STRINGS[58/*"Root"*/]);
        return NULL;
    }
...
// public enum TransitionMode :2804
...
// public abstract class Trigger :2633
// {
static void Trigger_build(uType* type)
{
    ...
    ::TYPES[0] = ::g::Uno::Action_typeof();
    ::TYPES[35] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Animations::Animator_typeof(), NULL);
    ::TYPES[67] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Triggers::Actions::TriggerAction_typeof(), NULL);
    type->SetInterfaces(
    ...
    type->SetFields(17,
        ::TYPES[67/*Uno.Collections.List<Fuse.Triggers.Actions.TriggerAction>*/], offsetof(::g::Fuse::Triggers::Trigger, _actions), 0,
...
// public void set_BackwardAnimation(Fuse.Animations.TriggerAnimation value) :2721
...
void Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn(Trigger* __this, uObject* s)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[60/*"Trigger.OnP...*/], __this, ::STRINGS[3/*"/Users/hdc/...*/], 2848, ::STRINGS[61/*"Fuse.Animat...*/]);
        return;
    }
...
// private void Fuse.Animations.IBasePlayerFeedback.OnStable(object s) :2872
...
// private void Fuse.Animations.IUnwrappedPlayerFeedback.OnProgressUpdated(object s, double prev, double cur, Fuse.Animations.PlayerFeedbackFlags flags) :3175
...
// protected virtual void OnProgressChanged() :3154
void Trigger__OnProgressChanged_fn(Trigger* __this)
{
}

// protected override void OnRooted() :3264
...
// protected override void OnUnrooted() :3296
...
// protected generated Trigger() [instance] :2633
void Trigger::ctor_4()
{
    ctor_3();
}

// public Uno.Collections.IList<Fuse.Triggers.Actions.TriggerAction> get_Actions() [instance] :2757
uObject* Trigger::Actions()
{
    uStackFrame __("Fuse.Triggers.Trigger", "get_Actions()");

    if (_actions == NULL)
        _actions = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[67/*Uno.Collections.List<Fuse.Triggers.Actions.TriggerAction>*/]));

    return (uObject*)_actions;
}

// protected void Activate([Uno.Action done]) [instance] :2960
...
// private void AddDeferredAction(Fuse.Triggers.Actions.TriggerAction i) [instance] :2829
...
// public Fuse.Animations.TriggerAnimation get_Animation() [instance] :2668
...
// public void set_Animation(Fuse.Animations.TriggerAnimation value) [instance] :2673
void Trigger::Animation(::g::Fuse::Animations::TriggerAnimation* value)
{
    _animation = value;
}

// public Uno.Collections.IList<Fuse.Animations.Animator> get_Animators() [instance] :2743
...
// public Fuse.Animations.TriggerAnimation get_BackwardAnimation() [instance] :2720
...
// public void set_BackwardAnimation(Fuse.Animations.TriggerAnimation value) [instance] :2721
...
// public generated Fuse.Triggers.TriggerBypassMode get_Bypass() [instance] :2657
int Trigger::Bypass()
{
    return _Bypass;
}

// public generated void set_Bypass(Fuse.Triggers.TriggerBypassMode value) [instance] :2657
void Trigger::Bypass(int value)
{
    _Bypass = value;
}

// protected void BypassActivate() [instance] :2971
...
// protected void BypassDeactivate() [instance] :3005
...
// protected void BypassSeek(double progress, [Fuse.Animations.AnimationVariant direction]) [instance] :3244
...
// private void CleanupStableState() [instance] :2877
...
// private void CleanupState() [instance] :3082
...
// private void CreateState() [instance] :3092
...
// public double get_CrossFadeDuration() [instance] :2738
...
// public void set_CrossFadeDuration(double value) [instance] :2739
...
// protected void Deactivate() [instance] :2988
...
// protected void DirectActivate([Uno.Action done]) [instance] :2978
...
// protected void DirectDeactivate() [instance] :2999
...
// protected void DirectSeek(double progress, [Fuse.Animations.AnimationVariant direction]) [instance] :3239
...
// private void EnsureAnimationLength() [instance] :3111
void Trigger::EnsureAnimationLength()
{
    ...
    n->Delay(actFore);
    n->DelayBack(actBack);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Animators()), ::TYPES[35/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), n);

    if (HasBackwardAnimation())
    {
        n = ::g::Fuse::Animations::Nothing::New2();
        n->Delay(actBack);
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(BackwardAnimation())->Animators()), ::TYPES[35/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), n);
    }
}

// private bool EnsureState(double progress) [instance] :3101
...
// public bool get_HasActions() [instance] :2766
...
// public bool get_HasAnimators() [instance] :2747
...
// public bool get_HasBackwardAnimation() [instance] :2729
...
// protected void InversePulse() [instance] :3042
...
// private bool IsForward(Fuse.Triggers.TriggerPlayState ps) [instance] :3165
bool Trigger::IsForward(int ps)
{
    return (ps == 2) || (ps == 4);
}

// private void PlayActions(Fuse.Triggers.Actions.TriggerWhen when) [instance] :2897
...
// protected void PlayEnd(bool on, [Uno.Action done]) [instance] :3058
...
// private void PlayOn() [instance] :3047
void Trigger::PlayOn()
{
...
// protected Fuse.Triggers.TriggerPlayState get_PlayState() [instance] :2839
int Trigger::PlayState()
{
    return _lastPlayState;
}

// protected void PlayTo(double progress, [Fuse.Animations.AnimationVariant variant]) [instance] :3209
...
// protected double get_Progress() [instance] :2783
...
// protected void Pulse() [instance] :3018
void Trigger::Pulse()
{
...
// protected void Seek(double progress, [Fuse.Animations.AnimationVariant direction]) [instance] :3228
...
// private void SeekImpl(double progress, Fuse.Animations.AnimationVariant direction, Fuse.Animations.TriggerAnimationState.SeekFlags flags) [instance] :3250
...
// private void SetDone(Uno.Action done, bool on) [instance] :2769
...
// private void SetPlayState(Fuse.Triggers.TriggerPlayState next) [instance] :2796
...
// private bool get_ShouldBypass() [instance] :2937
...
// private bool get_ShouldIgnore() [instance] :2928
bool Trigger::ShouldIgnore()
{
    return !IsRootingStarted();
}

// protected void Start() [instance] :2885
void Trigger::Start()
{
    ...
    {
        if (!IsRootingStarted())
            U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::STRINGS[62/*"Trigger sta...*/], this)));
...
// protected void Stop([bool force]) [instance] :2913
...
// private void StopAction() [instance] :3011
...
// public double get_StretchDuration() [instance] :2693
...
// public void set_StretchDuration(double value) [instance] :2694
...
// public double get_TimeMultiplier() [instance] :2684
...
// public void set_TimeMultiplier(double value) [instance] :2685
...
// private Fuse.Triggers.TriggerPlayState WhatDirection(double diff, bool animating) [instance] :3158
...
// public enum TriggerBypassMode :2572
...
// public enum TriggerPlayState :2582
...
// public abstract class WhileBool :3316
// {
...
// public new void set_Value(bool value) [instance] :3321
...
// public generated WhileBusy() :3455
void WhileBusy__ctor_6_fn(WhileBusy* __this)
{
    __this->ctor_6();
}

// public Fuse.Triggers.BusyTaskActivity get_Activity() :3490
void WhileBusy__get_Activity_fn(WhileBusy* __this, int* __retval)
{
    *__retval = __this->Activity();
}

// public void set_Activity(Fuse.Triggers.BusyTaskActivity value) :3491
void WhileBusy__set_Activity_fn(WhileBusy* __this, int* value)
{
    __this->Activity(*value);
}

// private Fuse.Triggers.BusyTaskActivity Fuse.Triggers.IBusyHandler.get_BusyActivityHandled() :3523
...
// protected override sealed void OnUnrooted() :3464
...
// private void Update() :3511
void WhileBusy__Update_fn(WhileBusy* __this)
{
    __this->Update();
}

// public generated WhileBusy() [instance] :3455
...
// public Fuse.Triggers.BusyTaskActivity get_Activity() [instance] :3490
int WhileBusy::Activity()
{
    return _activity;
}

// public void set_Activity(Fuse.Triggers.BusyTaskActivity value) [instance] :3491
...
// public generated bool get_IsHandled() [instance] :3480
bool WhileBusy::IsHandled()
{
    return _IsHandled;
}

// public generated void set_IsHandled(bool value) [instance] :3480
void WhileBusy::IsHandled(bool value)
{
    _IsHandled = value;
}

// public Fuse.Triggers.BusyTaskMatch get_Match() [instance] :3502
int WhileBusy::Match()
{
    return _match;
}

// public void set_Match(Fuse.Triggers.BusyTaskMatch value) [instance] :3503
...
// private void Update() [instance] :3511
...
// public generated WhileBusy New() [static] :3455
...
// public sealed class WhileCompleted :3908
// {
// static WhileCompleted() :3908
...
static void WhileCompleted_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(2,
        ...
        new uFunction("SetState", NULL, (void*)WhileCompleted__SetState_fn, 0, true, uVoid_typeof(), 2, ::g::Fuse::Visual_typeof(), ::TYPES[68/*bool*/]));
}
...
// public static void SetState(Fuse.Visual n, bool paused) :3919
...
// public generated WhileCompleted() [instance] :3908
void WhileCompleted::ctor_6()
{
    ctor_5();
}

// private static bool IsCompleted(Fuse.Visual n) [static] :3912
...
// public generated WhileCompleted New() [static] :3908
...
// public static void SetState(Fuse.Visual n, bool paused) [static] :3919
...
static void WhileContainsText_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/0.46.1/triggers/$.uno");
    ::STRINGS[21] = uString::Const("OnRooted");
    ::TYPES[69] = ::g::Fuse::Triggers::IValue_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[70] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
        ...
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface5));
    type->SetFields(30,
        ::TYPES[69/*Fuse.Triggers.IValue<string>*/], offsetof(::g::Fuse::Triggers::WhileContainsText, _source), 0,
        ::TYPES[69/*Fuse.Triggers.IValue<string>*/], offsetof(::g::Fuse::Triggers::WhileContainsText, _value), 0);
    type->Reflection.SetFunctions(3,
        new uFunction(".ctor", NULL, (void*)WhileContainsText__New2_fn, 0, true, type, 0),
        new uFunction("get_Source", NULL, (void*)WhileContainsText__get_Source_fn, 0, false, ::TYPES[69/*Fuse.Triggers.IValue<string>*/], 0),
        new uFunction("set_Source", NULL, (void*)WhileContainsText__set_Source_fn, 0, false, uVoid_typeof(), 1, ::TYPES[69/*Fuse.Triggers.IValue<string>*/]));
}
...
void WhileContainsText__OnRooted_fn(WhileContainsText* __this)
{
    ...
    if (__this->_value != NULL)
    {
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[63/*"No TextInpu...*/], __this, ::STRINGS[17/*"/Users/hdc/...*/], 51, ::STRINGS[21/*"OnRooted"*/]);
}
...
static void WhileDisabled_build(uType* type)
{
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IUnwrappedPlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::WhileEnabledDisabledTrigger_type, interface4),
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::WhileEnabledDisabledTrigger_type, interface5));
    type->SetFields(30);
    type->Reflection.SetFunctions(1,
...
static void WhileEnabledDisabledTrigger_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IUnwrappedPlayerFeedback_typeof(), offsetof(WhileEnabledDisabledTrigger_type, interface4),
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(WhileEnabledDisabledTrigger_type, interface5));
    type->SetFields(30);
}
...
// public sealed class WhileFailed :3546
// {
static void WhileFailed_build(uType* type)
{
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IUnwrappedPlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::WhileBusy_type, interface4),
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::WhileBusy_type, interface5),
        ::g::Fuse::Triggers::IBusyHandler_typeof(), offsetof(::g::Fuse::Triggers::WhileBusy_type, interface6));
    type->SetFields(33);
    type->Reflection.SetFunctions(1,
...
::g::Fuse::Triggers::WhileBusy_type* WhileFailed_typeof()
{
    ...
    type->interface6.fp_get_BusyActivityHandled = (void(*)(uObject*, int*))::g::Fuse::Triggers::WhileBusy__FuseTriggersIBusyHandlerget_BusyActivityHandled_fn;
    type->interface5.fp_OnPlaybackDone = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn;
    type->interface5.fp_OnStable = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnStable_fn;
    type->interface4.fp_OnProgressUpdated = (void(*)(uObject*, uObject*, double*, double*, int*))::g::Fuse::Triggers::Trigger__FuseAnimationsIUnwrappedPlayerFeedbackOnProgressUpdated_fn;
    type->interface2.fp_Clear = (void(*)(uObject*))::g::Fuse::Node__UnoCollectionsICollectionFuseBindingClear_fn;
...
// public WhileFailed New() [static] :3548
...
// public generated WhileFalse() :3406
void WhileFalse__ctor_8_fn(WhileFalse* __this)
{
    __this->ctor_8();
}

// protected override sealed bool get_IsOn() :3408
...
// public generated WhileFalse New() :3406
void WhileFalse__New2_fn(WhileFalse** __retval)
{
    *__retval = WhileFalse::New2();
}

// public generated WhileFalse() [instance] :3406
void WhileFalse::ctor_8()
{
    ctor_7();
}

// public generated WhileFalse New() [static] :3406
...
// public sealed class WhileFloat :3565
// {
...
// public float get_GreaterThanEqual() [instance] :3623
float WhileFloat::GreaterThanEqual()
{
    return _compare.X;
}

// public void set_GreaterThanEqual(float value) [instance] :3624
...
// public float get_LessThan() [instance] :3587
float WhileFloat::LessThan()
{
    return _compare.Y;
}

// public void set_LessThan(float value) [instance] :3588
...
// public float get_LessThanEqual() [instance] :3599
float WhileFloat::LessThanEqual()
{
    return _compare.Y;
}

// public void set_LessThanEqual(float value) [instance] :3600
...
// public new float get_Value() [instance] :3570
...
// public new void set_Value(float value) [instance] :3571
void WhileFloat::Value1(float value)
{
    ::g::Fuse::Triggers::WhileValue__set_Value_fn(this, uCRef(value));
}

// public generated WhileFloat New() [static] :3565
...
// public sealed class WhileFocused :3662
// {
...
// protected override sealed void OnUnrooted() :3672
...
// public generated WhileFocused() [instance] :3662
void WhileFocused::ctor_6()
{
    ctor_5();
}

// private void OnGotFocus(object sender, Uno.EventArgs args) [instance] :3679
void WhileFocused::OnGotFocus(uObject* sender, ::g::Uno::EventArgs* args)
{
    SetActive(true);
}

// private void OnLostFocus(object sender, Uno.EventArgs args) [instance] :3684
void WhileFocused::OnLostFocus(uObject* sender, ::g::Uno::EventArgs* args)
{
    SetActive(false);
}

// public generated WhileFocused New() [static] :3662
...
// public sealed class WhileFocusWithin :3740
// {
...
// protected override sealed void OnRooted() :3742
...
// protected override sealed void OnUnrooted() :3751
...
// public generated WhileFocusWithin() [instance] :3740
void WhileFocusWithin::ctor_6()
{
    ctor_5();
}

// private bool get_IsOn() [instance] :3765
...
// private void OnFocusChange(object sender, Uno.EventArgs args) [instance] :3758
void WhileFocusWithin::OnFocusChange(uObject* sender, ::g::Uno::EventArgs* args)
{
    SetActive(IsOn());
}

// public generated WhileFocusWithin New() [static] :3740
...
static void WhileKeyboardVisible_build(uType* type)
{
    ...
    ::TYPES[74] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Fuse::Platform::SystemUIWillResizeEventArgs_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
...
void WhileKeyboardVisible__OnRooted_fn(WhileKeyboardVisible* __this)
{
    ...
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    ::g::Fuse::Platform::SystemUI::add_BottomFrameWillResize(uDelegate::New(::TYPES[74/*Uno.EventHandler<Fuse.Platform.SystemUIWillResizeEventArgs>*/], (void*)WhileKeyboardVisible__OnBottomBarResize_fn, __this));
...
void WhileKeyboardVisible__OnUnrooted_fn(WhileKeyboardVisible* __this)
{
    ...
    ::g::Fuse::Platform::SystemUI::remove_BottomFrameWillResize(uDelegate::New(::TYPES[74/*Uno.EventHandler<Fuse.Platform.SystemUIWillResizeEventArgs>*/], (void*)WhileKeyboardVisible__OnBottomBarResize_fn, __this));
    ::g::Fuse::Triggers::Trigger__OnUnrooted_fn(__this);
}
...
// public sealed class WhileLoading :3804
// {
...
// public WhileLoading New() [static] :3806
...
// public sealed class WhileNotFocused :3695
// {
...
// public generated WhileNotFocused() [instance] :3695
void WhileNotFocused::ctor_6()
{
    ctor_5();
}

// private void OnGotFocus(object sender, Uno.EventArgs args) [instance] :3712
void WhileNotFocused::OnGotFocus(uObject* sender, ::g::Uno::EventArgs* args)
{
    SetActive(false);
}

// private void OnLostFocus(object sender, Uno.EventArgs args) [instance] :3717
void WhileNotFocused::OnLostFocus(uObject* sender, ::g::Uno::EventArgs* args)
{
    SetActive(true);
}

// public generated WhileNotFocused New() [static] :3695
...
static void WhilePageLoading_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface5));
    type->SetFields(30,
        ::TYPES[75/*Fuse.Controls.WebView*/], offsetof(::g::Fuse::Triggers::WhilePageLoading, _webView), 0);
    type->Reflection.SetFunctions(1,
...
void WhilePageLoading__OnRooted_fn(WhilePageLoading* __this)
{
    ...
    if (uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[30/*Fuse.Controls.IWebView*/]))
    {
        ...
        uPtr(__this->_webView)->add_ProgressChanged(uDelegate::New(::TYPES[32/*Uno.UX.ValueChangedHandler<double>*/], (void*)WhilePageLoading__OnProgressChanged1_fn, __this));
        __this->SetActive(uPtr(__this->_webView)->Progress() != 1.0);
    }
    else
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[24/*"WebView"*/], __this->Parent(), __this, ::STRINGS[25/*"/Users/hdc/...*/], 836, ::STRINGS[21/*"OnRooted"*/]);
}
...
void WhilePageLoading__OnUnrooted_fn(WhilePageLoading* __this)
{
    ...
    if (__this->_webView != NULL)
    {
        uPtr(__this->_webView)->remove_ProgressChanged(uDelegate::New(::TYPES[32/*Uno.UX.ValueChangedHandler<double>*/], (void*)WhilePageLoading__OnProgressChanged1_fn, __this));
        __this->_webView = NULL;
    }
...
// public sealed class WhilePaused :3869
// {
// static WhilePaused() :3869
...
static void WhilePaused_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(2,
        ...
        new uFunction("SetState", NULL, (void*)WhilePaused__SetState_fn, 0, true, uVoid_typeof(), 2, ::g::Fuse::Visual_typeof(), ::TYPES[68/*bool*/]));
}
...
// public static void SetState(Fuse.Visual n, bool paused) :3880
...
// public generated WhilePaused() [instance] :3869
void WhilePaused::ctor_6()
{
    ctor_5();
}

// private static bool IsPaused(Fuse.Visual n) [static] :3873
...
// public generated WhilePaused New() [static] :3869
...
// public static void SetState(Fuse.Visual n, bool paused) [static] :3880
...
static void WhilePlaying_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(2,
        ...
        new uFunction("SetState", NULL, (void*)WhilePlaying__SetState_fn, 0, true, uVoid_typeof(), 2, ::g::Fuse::Visual_typeof(), ::TYPES[68/*bool*/]));
}
...
// public static void SetState(Fuse.Visual n, bool playing) :3841
...
// public generated WhilePlaying() [instance] :3830
void WhilePlaying::ctor_6()
{
    ctor_5();
}

// private static bool IsPlaying(Fuse.Visual n) [static] :3834
...
// public generated WhilePlaying New() [static] :3830
...
// public static void SetState(Fuse.Visual n, bool playing) [static] :3841
...
static void WhileScrollable_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IUnwrappedPlayerFeedback_typeof(), offsetof(WhileScrollable_type, interface4),
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(WhileScrollable_type, interface5),
        ::g::Uno::UX::IPropertyListener_typeof(), offsetof(WhileScrollable_type, interface6));
    type->SetFields(30,
        ::TYPES[76/*Fuse.Controls.ScrollView*/], offsetof(::g::Fuse::Triggers::WhileScrollable, _scrollable), 0,
        ::TYPES[76/*Fuse.Controls.ScrollView*/], offsetof(::g::Fuse::Triggers::WhileScrollable, _source), 0,
    ...
    type->Reflection.SetFunctions(5,
        ...
        new uFunction("get_ScrollView", NULL, (void*)WhileScrollable__get_ScrollView_fn, 0, false, ::TYPES[76/*Fuse.Controls.ScrollView*/], 0),
        new uFunction("set_ScrollView", NULL, (void*)WhileScrollable__set_ScrollView_fn, 0, false, uVoid_typeof(), 1, ::TYPES[76/*Fuse.Controls.ScrollView*/]));
}
...
WhileScrollable_type* WhileScrollable_typeof()
{
    ...
    type->interface6.fp_OnPropertyChanged = (void(*)(uObject*, ::g::Uno::UX::PropertyObject*, ::g::Uno::UX::Selector*))WhileScrollable__UnoUXIPropertyListenerOnPropertyChanged_fn;
    type->interface5.fp_OnPlaybackDone = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn;
    type->interface5.fp_OnStable = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnStable_fn;
    type->interface4.fp_OnProgressUpdated = (void(*)(uObject*, uObject*, double*, double*, int*))::g::Fuse::Triggers::Trigger__FuseAnimationsIUnwrappedPlayerFeedbackOnProgressUpdated_fn;
    type->interface2.fp_Clear = (void(*)(uObject*))::g::Fuse::Node__UnoCollectionsICollectionFuseBindingClear_fn;
...
void WhileScrolled__OnRooted_fn(WhileScrolled* __this)
{
    ...
    if (__this->_scrollable == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Scrolled co...*/], __this, ::STRINGS[32/*"/Users/hdc/...*/], 802, ::STRINGS[21/*"OnRooted"*/]);
        return;
    }

    uPtr(__this->_scrollable)->add_ScrollPositionChanged(uDelegate::New(::TYPES[42/*Fuse.Controls.ScrollPositionChangedHandler*/], (void*)WhileScrolled__OnScrollPositionChanged_fn, __this));
    __this->Update();
}
...
void WhileScrolled__OnUnrooted_fn(WhileScrolled* __this)
{
    ...
    if (__this->_scrollable != NULL)
    {
        uPtr(__this->_scrollable)->remove_ScrollPositionChanged(uDelegate::New(::TYPES[42/*Fuse.Controls.ScrollPositionChangedHandler*/], (void*)WhileScrolled__OnScrollPositionChanged_fn, __this));
        __this->_scrollable = NULL;
    }
...
// public sealed class WhileString :3965
// {
...
// public bool get_CaseSensitive() [instance] :4008
bool WhileString::CaseSensitive()
{
    return _caseSensitive;
}

// public void set_CaseSensitive(bool value) [instance] :4009
...
// public string get_Compare() [instance] :3989
uString* WhileString::Compare()
{
    return _compare;
}

// public void set_Compare(string value) [instance] :3990
...
// public string get_Contains() [instance] :4033
uString* WhileString::Contains()
{
    return Compare();
}

// public void set_Contains(string value) [instance] :4034
...
// public new string get_Equals() [instance] :4022
uString* WhileString::Equals2()
{
    return Compare();
}

// public new void set_Equals(string value) [instance] :4023
...
// public int get_MaxLength() [instance] :4059
int WhileString::MaxLength()
{
    return _maxLength;
}

// public void set_MaxLength(int value) [instance] :4060
...
// public int get_MinLength() [instance] :4045
int WhileString::MinLength()
{
    return _minLength;
}

// public void set_MinLength(int value) [instance] :4046
...
// public Fuse.Triggers.WhileStringTest get_Test() [instance] :3970
int WhileString::Test()
{
    return _test;
}

// public void set_Test(Fuse.Triggers.WhileStringTest value) [instance] :3971
...
// public generated WhileString New() [static] :3965
...
// public enum WhileStringTest :3950
...
// public abstract class WhileTrigger :4137
// {
...
// public generated bool get_Invert() [instance] :4141
bool WhileTrigger::Invert()
{
    return _Invert;
}

// public generated void set_Invert(bool value) [instance] :4141
void WhileTrigger::Invert(bool value)
{
    _Invert = value;
}

// protected void SetActive(bool on) [instance] :4143
...
// public generated WhileTrue() :3393
void WhileTrue__ctor_8_fn(WhileTrue* __this)
{
    __this->ctor_8();
}

// protected override sealed bool get_IsOn() :3395
...
// public generated WhileTrue New() :3393
void WhileTrue__New2_fn(WhileTrue** __retval)
{
    *__retval = WhileTrue::New2();
}

// public generated WhileTrue() [instance] :3393
void WhileTrue::ctor_8()
{
    ctor_7();
}

// public generated WhileTrue New() [static] :3393
...
// public abstract class WhileValue<T> :4175
// {
static void WhileValue_build(uType* type)
{
    ...
    type->SetFields(30,
        ...
        ::TYPES[77/*Fuse.Triggers.IValue`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Triggers::WhileValue, _obj), 0,
        ::TYPES[77/*Fuse.Triggers.IValue`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Triggers::WhileValue, _source), 0,
        type->T(0), (uintptr_t)0, uFieldFlagsConstrained,
        ::TYPES[78/*Uno.UX.ValueChangedHandler`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Triggers::WhileValue, ValueChanged1), 0);
    type->Reflection.SetFunctions(7,
        new uFunction("Pulse", NULL, (void*)WhileValue__Pulse1_fn, 0, false, uVoid_typeof(), 0),
        new uFunction("get_Source", NULL, (void*)WhileValue__get_Source_fn, 0, false, ::TYPES[77/*Fuse.Triggers.IValue`1*/]->MakeType(type->T(0), NULL), 0),
        new uFunction("set_Source", NULL, (void*)WhileValue__set_Source_fn, 0, false, uVoid_typeof(), 1, ::TYPES[77/*Fuse.Triggers.IValue`1*/]->MakeType(type->T(0), NULL)),
        ...
        new uFunction("add_ValueChanged", NULL, (void*)WhileValue__add_ValueChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[78/*Uno.UX.ValueChangedHandler`1*/]->MakeType(type->T(0), NULL)),
        new uFunction("remove_ValueChanged", NULL, (void*)WhileValue__remove_ValueChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[78/*Uno.UX.ValueChangedHandler`1*/]->MakeType(type->T(0), NULL)));
}
...
// protected override sealed void OnUnrooted() :4239
...
// public void set_Value(T value) :4187
...
// public generated void add_ValueChanged(Uno.UX.ValueChangedHandler<T> value) :4205
void WhileValue__add_ValueChanged_fn(WhileValue* __this, uDelegate* value)
{
    __this->add_ValueChanged(value);
}

// public generated void remove_ValueChanged(Uno.UX.ValueChangedHandler<T> value) :4205
void WhileValue__remove_ValueChanged_fn(WhileValue* __this, uDelegate* value)
{
    __this->remove_ValueChanged(value);
}

// protected generated WhileValue() [instance] :4175
void WhileValue::ctor_6()
{
    ctor_5();
}

// private void OnValueChanged(object s, Uno.UX.ValueChangedArgs<T> a) [instance] :4249
...
// public new void Pulse() [instance] :4207
void WhileValue::Pulse1()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[64/*"`Pulse` on ...*/], this, ::STRINGS[3/*"/Users/hdc/...*/], 4211, ::STRINGS[65/*"Pulse"*/]);
...
// public Fuse.Triggers.IValue<T> get_Source() [instance] :4201
uObject* WhileValue::Source()
{
    return _source;
}

// public void set_Source(Fuse.Triggers.IValue<T> value) [instance] :4202
void WhileValue::Source(uObject* value)
{
    _source = value;
}

// protected void UpdateState() [instance] :4256
...
// public generated void add_ValueChanged(Uno.UX.ValueChangedHandler<T> value) [instance] :4205
...
// public generated void remove_ValueChanged(Uno.UX.ValueChangedHandler<T> value) [instance] :4205
...
// private static Fuse.Triggers.IValue<T> FindValueNode(Fuse.Node n) [static] :4223
...
// internal static class WhileValueStatic :4170
// {
...
// public sealed class WhileVisible :4278
// {
...
// public generated WhileVisible() :4278
void WhileVisible__ctor_6_fn(WhileVisible* __this)
{
    __this->ctor_6();
}

// public generated WhileVisible New() :4278
void WhileVisible__New2_fn(WhileVisible** __retval)
{
    *__retval = WhileVisible::New2();
}

// private void OnIsVisibleChanged(object sender, Uno.EventArgs args) :4294
...
// protected override sealed void OnRooted() :4280
...
// protected override sealed void OnUnrooted() :4288
...
// public generated WhileVisible() [instance] :4278
void WhileVisible::ctor_6()
{
    ctor_5();
}

// private void OnIsVisibleChanged(object sender, Uno.EventArgs args) [instance] :4294
...
// public generated WhileVisible New() [static] :4278
...
static void WhileVisibleInScrollView_build(uType* type)
{
    ...
    type->SetFields(30,
        ...
        ::TYPES[23/*Fuse.Elements.Element*/], offsetof(::g::Fuse::Triggers::WhileVisibleInScrollView, _element), 0,
        ::TYPES[44/*Fuse.Triggers.IScrolledLength*/], offsetof(::g::Fuse::Triggers::WhileVisibleInScrollView, _relativeTo), 0,
    ...
    type->Reflection.SetFunctions(5,
        ...
        new uFunction("get_RelativeTo", NULL, (void*)WhileVisibleInScrollView__get_RelativeTo_fn, 0, false, ::TYPES[44/*Fuse.Triggers.IScrolledLength*/], 0),
        new uFunction("set_RelativeTo", NULL, (void*)WhileVisibleInScrollView__set_RelativeTo_fn, 0, false, uVoid_typeof(), 1, ::TYPES[44/*Fuse.Triggers.IScrolledLength*/]));
}
...
void WhileVisibleInScrollView__OnRooted_fn(WhileVisibleInScrollView* __this)
{
    ...
    if (__this->_scrollable == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[66/*"Could not f...*/], __this, ::STRINGS[32/*"/Users/hdc/...*/], 907, ::STRINGS[21/*"OnRooted"*/]);
        return;
    }
    ...
    if (__this->_element == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[67/*"Parent must...*/], __this, ::STRINGS[32/*"/Users/hdc/...*/], 914, ::STRINGS[21/*"OnRooted"*/]);
        return;
    }

    if (!uPtr(__this->_element)->HasLayoutIn(__this->_scrollable))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[68/*"Must have a...*/], __this, ::STRINGS[32/*"/Users/hdc/...*/], 920, ::STRINGS[21/*"OnRooted"*/]);
        return;
    }

    uPtr(__this->_scrollable)->add_ScrollPositionChanged(uDelegate::New(::TYPES[42/*Fuse.Controls.ScrollPositionChangedHandler*/], (void*)WhileVisibleInScrollView__OnScrollPositionChanged_fn, __this));
    __this->Update();
}
...
void WhileVisibleInScrollView__OnUnrooted_fn(WhileVisibleInScrollView* __this)
{
    ...
    if (__this->_scrollable != NULL)
    {
        uPtr(__this->_scrollable)->remove_ScrollPositionChanged(uDelegate::New(::TYPES[42/*Fuse.Controls.ScrollPositionChangedHandler*/], (void*)WhileVisibleInScrollView__OnScrollPositionChanged_fn, __this));
        __this->_scrollable = NULL;
    }
...
void WhileVisibleInScrollView::Update()
{
    ...
    float maxDist = uPtr(_scrollable)->ToScalarPosition(::g::Fuse::Triggers::IScrolledLength::GetPoints(uInterface(uPtr(RelativeTo()), ::TYPES[44/*Fuse.Triggers.IScrolledLength*/]), Distance(), _scrollable));
...
static void WhileWindowAspect_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IUnwrappedPlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::WindowSizeTrigger_type, interface4),
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::WindowSizeTrigger_type, interface5));
    type->SetFields(31);
}
...
// public generated WhileWindowLandscape() :4453
void WhileWindowLandscape__ctor_8_fn(WhileWindowLandscape* __this)
{
    __this->ctor_8();
}

// protected override sealed bool get_IsActive() :4455
...
// public generated WhileWindowLandscape New() :4453
void WhileWindowLandscape__New2_fn(WhileWindowLandscape** __retval)
{
    *__retval = WhileWindowLandscape::New2();
}

// public generated WhileWindowLandscape() [instance] :4453
void WhileWindowLandscape::ctor_8()
{
    ctor_7();
}

// public generated WhileWindowLandscape New() [static] :4453
...
// public generated WhileWindowPortrait() :4469
void WhileWindowPortrait__ctor_8_fn(WhileWindowPortrait* __this)
{
    __this->ctor_8();
}

// protected override sealed bool get_IsActive() :4471
...
// public generated WhileWindowPortrait New() :4469
void WhileWindowPortrait__New2_fn(WhileWindowPortrait** __retval)
{
    *__retval = WhileWindowPortrait::New2();
}

// public generated WhileWindowPortrait() [instance] :4469
void WhileWindowPortrait::ctor_8()
{
    ctor_7();
}

// public generated WhileWindowPortrait New() [static] :4469
...
// public sealed class WhileWindowSize :4388
// {
...
// public generated float2 get_LessThan() :4394
void WhileWindowSize__get_LessThan_fn(WhileWindowSize* __this, ::g::Uno::Float2* __retval)
{
    *__retval = __this->LessThan();
}

// public generated void set_LessThan(float2 value) :4394
void WhileWindowSize__set_LessThan_fn(WhileWindowSize* __this, ::g::Uno::Float2* value)
{
    __this->LessThan(*value);
}

// public generated WhileWindowSize New() :4388
void WhileWindowSize__New2_fn(WhileWindowSize** __retval)
{
    *__retval = WhileWindowSize::New2();
}

// public generated WhileWindowSize() [instance] :4388
void WhileWindowSize::ctor_7()
{
    ctor_6();
}

// public generated float2 get_EqualTo() [instance] :4396
::g::Uno::Float2 WhileWindowSize::EqualTo()
{
    return _EqualTo;
}

// public generated void set_EqualTo(float2 value) [instance] :4396
void WhileWindowSize::EqualTo(::g::Uno::Float2 value)
{
    _EqualTo = value;
}

// public generated float2 get_GreaterThan() [instance] :4392
::g::Uno::Float2 WhileWindowSize::GreaterThan()
{
    return _GreaterThan;
}

// public generated void set_GreaterThan(float2 value) [instance] :4392
void WhileWindowSize::GreaterThan(::g::Uno::Float2 value)
{
    _GreaterThan = value;
}

// public generated float2 get_LessThan() [instance] :4394
::g::Uno::Float2 WhileWindowSize::LessThan()
{
    return _LessThan;
}

// public generated void set_LessThan(float2 value) [instance] :4394
void WhileWindowSize::LessThan(::g::Uno::Float2 value)
{
    _LessThan = value;
}

// public generated WhileWindowSize New() [static] :4388
...
// public abstract class WindowSizeTrigger :4308
// {
static void WindowSizeTrigger_build(uType* type)
{
    ::TYPES[79] = ::g::Fuse::IViewport_typeof();
    ::TYPES[80] = ::g::Fuse::Visual_typeof()->MakeMethod(2/*FindByType<Fuse.RootViewport>*/, ::g::Fuse::RootViewport_typeof(), NULL);
    ::TYPES[6] = ::g::Uno::EventHandler_typeof();
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IUnwrappedPlayerFeedback_typeof(), offsetof(WindowSizeTrigger_type, interface4),
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(WindowSizeTrigger_type, interface5));
    type->SetFields(30,
        ::TYPES[79/*Fuse.IViewport*/], offsetof(::g::Fuse::Triggers::WindowSizeTrigger, _Viewport), 0);
}
...
// protected generated WindowSizeTrigger() :4308
void WindowSizeTrigger__ctor_6_fn(WindowSizeTrigger* __this)
{
    __this->ctor_6();
}

// private void OnResize(object sender, Uno.EventArgs args) :4340
...
// protected override sealed void OnRooted() :4313
...
// protected generated Fuse.IViewport get_Viewport() [instance] :4311
uObject* WindowSizeTrigger::Viewport()
{
    return _Viewport;
}

// private generated void set_Viewport(Fuse.IViewport value) [instance] :4311

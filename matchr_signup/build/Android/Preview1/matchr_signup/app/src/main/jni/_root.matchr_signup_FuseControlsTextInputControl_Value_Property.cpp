// This file was generated based on /Users/hdc/matchr/matchrapp/matchr_signup/build/Android/Preview1/cache/ux11/matchr_signup.unoproj.g.uno.
...
static void matchr_signup_FuseControlsTextInputControl_Value_Property_build(uType* type)
{
    ...
    type->SetFields(1,
        ::g::Fuse::Controls::TextInputControl_typeof(), offsetof(::g::matchr_signup_FuseControlsTextInputControl_Value_Property, _obj), uFieldFlagsWeak);
}
...
::g::Uno::UX::Property1_type* matchr_signup_FuseControlsTextInputControl_Value_Property_typeof()
{
    ...
    options.ObjectSize = sizeof(matchr_signup_FuseControlsTextInputControl_Value_Property);
    options.TypeSize = sizeof(::g::Uno::UX::Property1_type);
    type = (::g::Uno::UX::Property1_type*)uClassType::New("matchr_signup_FuseControlsTextInputControl_Value_Property", options);
    type->fp_build_ = matchr_signup_FuseControlsTextInputControl_Value_Property_build;
    type->fp_Get = (void(*)(::g::Uno::UX::Property1*, uTRef))matchr_signup_FuseControlsTextInputControl_Value_Property__Get_fn;
    type->fp_get_Object = (void(*)(::g::Uno::UX::Property*, ::g::Uno::UX::PropertyObject**))matchr_signup_FuseControlsTextInputControl_Value_Property__get_Object_fn;
    type->fp_Set = (void(*)(::g::Uno::UX::Property1*, void*, uObject*))matchr_signup_FuseControlsTextInputControl_Value_Property__Set_fn;
    type->fp_get_SupportsOriginSetter = (void(*)(::g::Uno::UX::Property*, bool*))matchr_signup_FuseControlsTextInputControl_Value_Property__get_SupportsOriginSetter_fn;
    return type;
}

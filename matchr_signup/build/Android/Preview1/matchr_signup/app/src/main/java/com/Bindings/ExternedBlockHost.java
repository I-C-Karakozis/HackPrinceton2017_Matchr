...
public class ExternedBlockHost
{
    ...
    public static String GetGUID351()
    {
        return (String) com.foreign.Outracks.Simulator.DeviceInfo.GetGUID351();
    }
    
    public static String GetName352()
    {
        return (String) com.foreign.Outracks.Simulator.DeviceInfo.GetName352();
    }

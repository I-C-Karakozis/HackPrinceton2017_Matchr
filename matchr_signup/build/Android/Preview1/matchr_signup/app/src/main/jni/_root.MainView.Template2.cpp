...
{
    MainView__Template2::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"signinpage"*/]);
}

static void MainView__Template2_build(uType* type)
{
    ::STRINGS[0] = uString::Const("signinpage");
    type->SetFields(2,
...
void MainView__Template2__New1_fn(MainView__Template2* __this, uObject** __retval)
{
    ...
    ::g::SignInPage* self = ::g::SignInPage::New5(uPtr(__this->__parent1)->router);
...
{
    ctor_(::STRINGS[0/*"signinpage"*/], false);
    __parent1 = parent;

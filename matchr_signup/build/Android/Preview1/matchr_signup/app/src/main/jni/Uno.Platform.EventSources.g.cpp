...
// public static class HardwareKeys :1178
// {
...
// public static generated void add_KeyDown(Uno.EventHandler<Uno.Platform.KeyEventArgs> value) :1180
void HardwareKeys__add_KeyDown_fn(uDelegate* value)
{
    HardwareKeys::add_KeyDown(value);
}

// public static generated void remove_KeyDown(Uno.EventHandler<Uno.Platform.KeyEventArgs> value) :1180
void HardwareKeys__remove_KeyDown_fn(uDelegate* value)
{
    HardwareKeys::remove_KeyDown(value);
}

// public static generated void add_KeyUp(Uno.EventHandler<Uno.Platform.KeyEventArgs> value) :1181
void HardwareKeys__add_KeyUp_fn(uDelegate* value)
{
    HardwareKeys::add_KeyUp(value);
}

// public static generated void remove_KeyUp(Uno.EventHandler<Uno.Platform.KeyEventArgs> value) :1181
void HardwareKeys__remove_KeyUp_fn(uDelegate* value)
{
    HardwareKeys::remove_KeyUp(value);
}

// internal static bool OnKeyDown(Uno.Platform.Key key, Uno.Platform.EventModifiers modifiers) :1183
void HardwareKeys__OnKeyDown_fn(int* key, int* modifiers, bool* __retval)
{
    *__retval = HardwareKeys::OnKeyDown(*key, *modifiers);
}

// internal static bool OnKeyUp(Uno.Platform.Key key, Uno.Platform.EventModifiers modifiers) :1193
...
// internal static bool OnKeyDown(Uno.Platform.Key key, Uno.Platform.EventModifiers modifiers) [static] :1183
...
// internal static bool OnKeyUp(Uno.Platform.Key key, Uno.Platform.EventModifiers modifiers) [static] :1193
...
// public static generated void add_KeyDown(Uno.EventHandler<Uno.Platform.KeyEventArgs> value) [static] :1180
...
// public static generated void remove_KeyDown(Uno.EventHandler<Uno.Platform.KeyEventArgs> value) [static] :1180
...
// public static generated void add_KeyUp(Uno.EventHandler<Uno.Platform.KeyEventArgs> value) [static] :1181
...
// public static generated void remove_KeyUp(Uno.EventHandler<Uno.Platform.KeyEventArgs> value) [static] :1181
...
// public static class InterAppInvoke :1145
// {
// static InterAppInvoke() :1145
...
// private static void DispatchDelayedUri(Uno.Platform.ApplicationState state) :1163
void InterAppInvoke__DispatchDelayedUri_fn(int* state)
{
    InterAppInvoke::DispatchDelayedUri(*state);
}

// internal static void OnReceivedURI(string Uri) :1149
void InterAppInvoke__OnReceivedURI_fn(uString* Uri)
{
    InterAppInvoke::OnReceivedURI(Uri);
}

// public static generated void add_ReceivedURI(Uno.EventHandler<string> value) :1147
void InterAppInvoke__add_ReceivedURI_fn(uDelegate* value)
{
    InterAppInvoke::add_ReceivedURI(value);
}

// public static generated void remove_ReceivedURI(Uno.EventHandler<string> value) :1147
...
// private static void DispatchDelayedUri(Uno.Platform.ApplicationState state) [static] :1163
...
// internal static void OnReceivedURI(string Uri) [static] :1149
...
// public static generated void add_ReceivedURI(Uno.EventHandler<string> value) [static] :1147
...
// public static generated void remove_ReceivedURI(Uno.EventHandler<string> value) [static] :1147
...
// public static bool get_IsTextInputActive() :1226
void TextSource__get_IsTextInputActive_fn(bool* __retval)
{
    *__retval = TextSource::IsTextInputActive();
}

// public static bool get_IsTextInputActive() [static] :1226

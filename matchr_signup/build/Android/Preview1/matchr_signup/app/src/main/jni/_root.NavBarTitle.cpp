// This file was generated based on /Users/hdc/matchr/matchrapp/HackPrinceton2017_Matchr/matchr_signup/build/Android/Preview1/cache/ux11/NavBarTitle.g.uno.
...
// {
// static NavBarTitle() :5
static void NavBarTitle__cctor_4_fn(uType* __type)
{
    NavBarTitle::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Opacity"*/]);
}
...
static void NavBarTitle_build(uType* type)
{
    ...
    type->SetFields(101,
        ::g::Uno::UX::Property1_typeof()->MakeType(::g::Uno::Float_typeof(), NULL), offsetof(::g::NavBarTitle, this_Opacity_inst), 0,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&::g::NavBarTitle::__selector0_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)NavBarTitle__New4_fn, 0, true, type, 0));
}
...
::g::Fuse::Controls::TextControl_type* NavBarTitle_typeof()
{
    ...
    type = (::g::Fuse::Controls::TextControl_type*)uClassType::New("NavBarTitle", options);
    type->fp_build_ = NavBarTitle_build;
    type->fp_ctor_ = (void*)NavBarTitle__New4_fn;
...
// public NavBarTitle New() :9
void NavBarTitle__New4_fn(NavBarTitle** __retval)
{
    *__retval = NavBarTitle::New4();
}

::g::Uno::UX::Selector NavBarTitle::__selector0_;

// public NavBarTitle() [instance] :9
void NavBarTitle::ctor_8()
{
    uStackFrame __("NavBarTitle", ".ctor()");
    ctor_7();
    InitializeUX();
}
...
{
    uStackFrame __("NavBarTitle", "InitializeUX()");
    this_Opacity_inst = ::g::matchr_signup_FuseElementsElement_Opacity_Property::New1(this, NavBarTitle::__selector0());
...
// public NavBarTitle New() [static] :9
NavBarTitle* NavBarTitle::New4()
{

// This file was generated based on /Users/hdc/matchr/matchrapp/HackPrinceton2017_Matchr/matchr_signup/build/Android/Preview1/cache/ux11/TitleText.g.uno.
...
// {
// static TitleText() :4
static void TitleText__cctor_4_fn(uType* __type)
{
}
...
static void TitleText_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)TitleText__New4_fn, 0, true, type, 0));
}
...
::g::Fuse::Controls::TextControl_type* TitleText_typeof()
{
    ...
    type->fp_ctor_ = (void*)TitleText__New4_fn;
    type->fp_cctor_ = TitleText__cctor_4_fn;
...
// public TitleText() :8
void TitleText__ctor_8_fn(TitleText* __this)
{
    __this->ctor_8();
}

// private void InitializeUX() :12
void TitleText__InitializeUX_fn(TitleText* __this)
{
    __this->InitializeUX();
}

// public TitleText New() :8
void TitleText__New4_fn(TitleText** __retval)
{
    *__retval = TitleText::New4();
}

// public TitleText() [instance] :8
void TitleText::ctor_8()
{
    ctor_7();
    InitializeUX();
}

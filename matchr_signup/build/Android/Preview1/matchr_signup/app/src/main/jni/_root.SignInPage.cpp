// This file was generated based on /Users/hdc/matchr/matchrapp/HackPrinceton2017_Matchr/matchr_signup/build/Android/Preview1/cache/ux11/SignInPage.g.uno.
...
void SignInPage::InitializeUX()
{
    ...
    temp3->Opacity(0.9f);
    temp3->Layer(1);
    temp3->File(::g::Uno::UX::BundleFileSource::New1(::g::matchr_signup_bundle::balloonf86f5a8f()));
    temp4->LineNumber(6);
    temp4->FileName(::STRINGS[8/*"Pages/SignI...*/]);
    temp4->File(::g::Uno::UX::BundleFileSource::New1(::g::matchr_signup_bundle::SignInPage53c4bc09()));

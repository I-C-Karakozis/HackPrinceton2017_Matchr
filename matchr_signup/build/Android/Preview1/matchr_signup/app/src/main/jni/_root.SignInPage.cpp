// This file was generated based on /Users/hdc/matchr/matchrapp/matchr_signup/build/Android/Preview1/cache/ux11/SignInPage.g.uno.
...
void SignInPage::InitializeUX()
{
    ...
    temp_eb2 = ::g::Fuse::Reactive::EventBinding::New1(::STRINGS[6/*"signin"*/]);
    ...
    temp_eb3 = ::g::Fuse::Reactive::EventBinding::New1(::STRINGS[7/*"goBack"*/]);
    temp3->LineNumber(4);
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(temp11, uDelegate::New(::TYPES[4/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Fuse::Reactive::EventBinding__OnEvent_fn, uPtr(temp_eb2)));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp11->Bindings()), ::TYPES[3/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp_eb2);

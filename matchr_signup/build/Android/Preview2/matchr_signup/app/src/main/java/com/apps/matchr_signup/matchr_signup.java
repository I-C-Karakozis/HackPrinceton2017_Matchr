...
//#else
public class matchr_signup extends android.app.Activity implements ActivityCompat.OnRequestPermissionsResultCallback
//#endif
{
    // state
    ...
    {
        return fuseApp.RootActivity;
    }
    public static int ShowMessageBox(CharSequence caption, CharSequence message, int buttons, int hints)
    {
        return com.fuse.deprecated.MessageBoxHelper.ShowMessageBox(fuseApp.RootActivity, caption, message, buttons, hints);
    }
    public static AssetManager GetAssetManager()
    {
        return fuseApp.RootActivity.getAssets();
    }
}

...
#include <Fuse.Text.Implementation.JavaLineBreaks.h>
...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Text/0.46.1/$.uno
// --------------------------------------------------------------------------------

// internal struct Batch :1487
// {
// public void Dispose() [adapter] :1501
...
// public Batch(int textureIndex, Uno.Graphics.VertexBuffer vbo, int quadCount) :1493
...
// public void Dispose() :1501
void Batch__Dispose_fn(Batch* __this)
{
    __this->Dispose();
}

// public Batch New(int textureIndex, Uno.Graphics.VertexBuffer vbo, int quadCount) :1493
...
// public Batch(int textureIndex, Uno.Graphics.VertexBuffer vbo, int quadCount) [instance] :1493
...
// public void Dispose() [instance] :1501
void Batch::Dispose()
{
...
// public Batch New(int textureIndex, Uno.Graphics.VertexBuffer vbo, int quadCount) [static] :1493
...
// private sealed class Substring.CharEnumerator :2156
// {
...
// public void Reset() :2167
void Substring__CharEnumerator__Reset_fn(Substring__CharEnumerator* __this)
{
    __this->Reset();
}

// public CharEnumerator(Fuse.Text.Substring text) [instance] :2161
...
// public char get_Current() [instance] :2180
...
// public void Dispose() [instance] :2186
void Substring__CharEnumerator::Dispose()
{
}

// public bool MoveNext() [instance] :2172
...
// public void Reset() [instance] :2167
void Substring__CharEnumerator::Reset()
{
    _index = -1;
}

// public CharEnumerator New(Fuse.Text.Substring text) [static] :2161
...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Text/0.46.1/implementation/$.uno
// -----------------------------------------------------------------------------------------------
...
// public void Reset() :1320
void SinglyLinkedList__Enumerator__Reset_fn(SinglyLinkedList__Enumerator* __this)
{
    __this->Reset();
}

// public Enumerator(Fuse.Text.SinglyLinkedList<T> list) [instance] :1306
...
// public bool MoveNext() [instance] :1325
...
// public void Reset() [instance] :1320
void SinglyLinkedList__Enumerator::Reset()
{
    _current = _beforeHead;
}

// public Enumerator New(Fuse.Text.SinglyLinkedList<T> list) [static] :1306
...
static void FallingBackFont_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Text/0.46.1/$.uno");
...
void FallingBackFont__Shape_fn(FallingBackFont* __this, ::g::Fuse::Text::Substring* text, int* fontIndex, int* dir, uArray** __retval)
{
    ...
    int dir_ = *dir;
    ::g::Uno::Diagnostics::Debug::Assert(fontIndex_ == 0, ::STRINGS[2/*"fontIndex =...*/], ::STRINGS[1/*"/Users/hdc/...*/], 911, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), fontIndex_), uBox<int>(::g::Uno::Int_typeof(), 0)));
...
void FallingBackFont::ctor_1(uArray* fonts)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 > 0, ::STRINGS[0/*"fonts.Lengt...*/], ::STRINGS[1/*"/Users/hdc/...*/], 880, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), assert1), uBox<int>(::g::Uno::Int_typeof(), 0)));
    Fonts = fonts;
}
...
void FallingBackFontFace::ctor_1(uArray* fontFaces)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 > 0, ::STRINGS[3/*"fontFaces.L...*/], ::STRINGS[1/*"/Users/hdc/...*/], 848, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), assert1), uBox<int>(::g::Uno::Int_typeof(), 0)));
    FontFaces = fontFaces;
}
...
void Font__GetCachedGlyphTexture_fn(Font* __this, ::g::Fuse::Text::Glyph* glyph, ::g::Fuse::Text::GlyphAtlas* atlas, int* currentVersion, ::g::Fuse::Text::GlyphTexture* __retval)
{
    ...
    catch (const uThrowable& __t)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[5/*"Error loadi...*/], uBox<uint32_t>(::g::Uno::UInt_typeof(), glyph_.Index)), ::STRINGS[6/*" "*/]), uPtr(e)->Message()), NULL, ::STRINGS[1/*"/Users/hdc/...*/], 1166, ::STRINGS[7/*"GetCachedGl...*/]);
    }
...
::g::Fuse::Text::SubTexture GlyphAtlas::Add(::g::Uno::Content::Images::Bitmap* bitmap)
{
    ...
    assert1 = format == 1;
    assert2 = format == 3;
    ::g::Uno::Diagnostics::Debug::Assert(assert1 || assert2, ::STRINGS[8/*"(format == ...*/], ::STRINGS[1/*"/Users/hdc/...*/], 1223, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox(::g::Uno::Bool_typeof(), assert1), uBox(::g::Uno::Bool_typeof(), assert2)));
...
// public struct GlyphTexture :1430
// {
...
// internal GlyphTexture(Fuse.Text.SubTexture subTexture, float2 offset, float scale) :1436
...
// internal bool get_IsValid() :1445
void GlyphTexture__get_IsValid_fn(GlyphTexture* __this, bool* __retval)
{
    *__retval = __this->IsValid();
}

// internal GlyphTexture New(Fuse.Text.SubTexture subTexture, float2 offset, float scale) :1436
...
// public generated Fuse.Text.SubTexture get_SubTexture() :1432
void GlyphTexture__get_SubTexture_fn(GlyphTexture* __this, ::g::Fuse::Text::SubTexture* __retval)
{
    *__retval = __this->SubTexture();
}

// private generated void set_SubTexture(Fuse.Text.SubTexture value) :1432
...
// internal GlyphTexture(Fuse.Text.SubTexture subTexture, float2 offset, float scale) [instance] :1436
...
// internal bool get_IsValid() [instance] :1445
bool GlyphTexture::IsValid()
{
    return Scale != 0.0f;
}

// public generated Fuse.Text.SubTexture get_SubTexture() [instance] :1432
::g::Fuse::Text::SubTexture GlyphTexture::SubTexture()
{
    return _SubTexture;
}

// private generated void set_SubTexture(Fuse.Text.SubTexture value) [instance] :1432
void GlyphTexture::SubTexture(::g::Fuse::Text::SubTexture value)
{
    _SubTexture = value;
}

// internal GlyphTexture New(Fuse.Text.SubTexture subTexture, float2 offset, float scale) [static] :1436
...
static void LazyFont_build(uType* type)
{
    ...
    type->SetFields(4,
        ...
        uObject_typeof(), offsetof(::g::Fuse::Text::LazyFont, _loadedFontMutex), 0,
...
static void LazyFontFace_build(uType* type)
{
    ...
    type->SetFields(1,
        ...
        uObject_typeof(), offsetof(::g::Fuse::Text::LazyFontFace, _loadedFontFaceMutex), 0);
}
...
// public static Fuse.Text.Implementation.BitArray Get(Fuse.Text.Substring text) :1365
...
// public static Fuse.Text.Implementation.BitArray Get(Fuse.Text.Substring text) [static] :1365
...
// private sealed class Substring.LineEnumerable :2200
// {
...
// public LineEnumerable(Fuse.Text.Substring text) [instance] :2204
void Substring__LineEnumerable::ctor_(::g::Fuse::Text::Substring* text)
{
    _text = text;
}

// public Uno.Collections.IEnumerator<Fuse.Text.Substring> GetEnumerator() [instance] :2209
...
// public LineEnumerable New(Fuse.Text.Substring text) [static] :2204
...
// private sealed class Substring.LineEnumerator :2215
// {
...
// public void Reset() :2229
void Substring__LineEnumerator__Reset_fn(Substring__LineEnumerator* __this)
{
    __this->Reset();
}

// public LineEnumerator(Fuse.Text.Substring text) [instance] :2223
...
// public Fuse.Text.Substring get_Current() [instance] :2276
...
// public void Dispose() [instance] :2284
void Substring__LineEnumerator::Dispose()
{
}

// public bool MoveNext() [instance] :2236
...
// public void Reset() [instance] :2229
...
// public LineEnumerator New(Fuse.Text.Substring text) [static] :2223
...
// public static class Measure :1385
// {
...
// public static Uno.Rect AlignedRectForSize(float2 size, float pixelWidth, float alignment) :1406
...
// public static float2 Lines(Fuse.Text.Font font, float lineSpacing, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> lines) :1387
...
// public static Uno.Rect AlignedRectForSize(float2 size, float pixelWidth, float alignment) [static] :1406
...
// public static float2 Lines(Fuse.Text.Font font, float lineSpacing, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> lines) [static] :1387
::g::Uno::Float2 Measure::Lines(::g::Fuse::Text::Font* font, float lineSpacing, ::g::Uno::Collections::List* lines)
{
    ...
    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Uno::Collections::List*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(lines), &ret3), ret3); enum1.MoveNext(::TYPES[14/*Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>>.Enumerator*/]); )
    {
        ...
        for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Text::ShapedRun*> > enum2 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(line), &ret4), ret4); enum2.MoveNext(::TYPES[15/*Uno.Collections.List<Fuse.Text.ShapedRun>.Enumerator*/]); )
        {
...
// private sealed class ShapedRun.PGEnumerator :1998
// {
...
// public PGEnumerator(Fuse.Text.ShapedRun shapedRun) :2003
...
// public void Reset() :2009
void ShapedRun__PGEnumerator__Reset_fn(ShapedRun__PGEnumerator* __this)
{
    __this->Reset();
}

// public PGEnumerator(Fuse.Text.ShapedRun shapedRun) [instance] :2003
...
// public Fuse.Text.PositionedGlyph get_Current() [instance] :2022
...
// public void Dispose() [instance] :2028
void ShapedRun__PGEnumerator::Dispose()
{
}

// public bool MoveNext() [instance] :2014
...
// public void Reset() [instance] :2009
void ShapedRun__PGEnumerator::Reset()
{
    _index = -1;
}

// public PGEnumerator New(Fuse.Text.ShapedRun shapedRun) [static] :2003
...
// internal sealed class PositionedRun :1448
// {
...
// public PositionedRun(Fuse.Text.ShapedRun shapedRun, float2 position, float2 measurements) :1455
...
// public PositionedRun New(Fuse.Text.ShapedRun shapedRun, float2 position, float2 measurements) :1455
...
// public Fuse.Text.Bidirectional.Run get_Run() :1451
void PositionedRun__get_Run_fn(PositionedRun* __this, ::g::Fuse::Text::Bidirectional::Run* __retval)
{
    *__retval = __this->Run();
}

// public static Fuse.Text.PositionedRun Translate(Fuse.Text.PositionedRun positionedRun, float2 translation) :1462
...
// public PositionedRun(Fuse.Text.ShapedRun shapedRun, float2 position, float2 measurements) [instance] :1455
...
// public Fuse.Text.Bidirectional.Run get_Run() [instance] :1451
...
// public PositionedRun New(Fuse.Text.ShapedRun shapedRun, float2 position, float2 measurements) [static] :1455
...
// public static Fuse.Text.PositionedRun Translate(Fuse.Text.PositionedRun positionedRun, float2 translation) [static] :1462
...
// public Quad(float2 position, Uno.Recti texCoords, float scale) :1478
...
// public Quad New(float2 position, Uno.Recti texCoords, float scale) :1478
...
// public Quad(float2 position, Uno.Recti texCoords, float scale) [instance] :1478
...
// public Quad New(float2 position, Uno.Recti texCoords, float scale) [static] :1478
...
// public sealed class Renderer :1507
// {
// static Renderer() :1507
...
static void Renderer_build(uType* type)
{
    ...
    ::TYPES[17] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Text::Batch_typeof(), NULL);
    ::TYPES[18] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Text::Batch_typeof(), NULL);
    ::TYPES[19] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Text::Quad_typeof(), NULL), NULL);
    ::TYPES[20] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Text::Quad_typeof(), NULL);
    ::TYPES[21] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Text::PositionedRun_typeof(), NULL);
    type->SetInterfaces(
    ...
    type->SetFields(0,
        ...
        ::TYPES[18/*Uno.Collections.List<Fuse.Text.Batch>*/], offsetof(::g::Fuse::Text::Renderer, _batches), 0,
        ...
        ::TYPES[19/*Uno.Collections.List<Uno.Collections.List<Fuse.Text.Quad>>*/], offsetof(::g::Fuse::Text::Renderer, _texturedQuads), 0,
        ...
        uObject_typeof(), (uintptr_t)&::g::Fuse::Text::Renderer::_glyphAtlasMutex_, uFieldFlagsStatic,
...
// public Renderer(Fuse.Text.Font font, Uno.Collections.List<Fuse.Text.PositionedRun> positionedRuns, int approximateGlyphCount) :1535
...
// private static Uno.Buffer CreateIndexBufferData(int length) :1719
void Renderer__CreateIndexBufferData_fn(int* length, ::g::Uno::Buffer** __retval)
{
    *__retval = Renderer::CreateIndexBufferData(*length);
}

// private static Uno.Buffer CreateVertexBufferData(Uno.Collections.List<Fuse.Text.Quad> quads, int2 texSize) :1737
...
// public void Dispose() :1544
void Renderer__Dispose_fn(Renderer* __this)
{
    __this->Dispose();
}

// private void DisposeBatches() :1551
void Renderer__DisposeBatches_fn(Renderer* __this)
{
    __this->DisposeBatches();
}

// public void Draw(float4 color, float4x4 pixelToClipSpaceMatrix) :1561
...
// private Uno.Collections.List<Fuse.Text.Batch> GetBatches() :1606
void Renderer__GetBatches_fn(Renderer* __this, ::g::Uno::Collections::List** __retval)
{
    *__retval = __this->GetBatches();
}

// private Uno.Collections.List<Uno.Collections.List<Fuse.Text.Quad>> GetTexturedQuads() :1631
void Renderer__GetTexturedQuads_fn(Renderer* __this, ::g::Uno::Collections::List** __retval)
{
    *__retval = __this->GetTexturedQuads();
}

// private generated void init_DrawCalls() :1507
void Renderer__init_DrawCalls_fn(Renderer* __this)
{
    __this->init_DrawCalls();
}

// public Renderer New(Fuse.Text.Font font, Uno.Collections.List<Fuse.Text.PositionedRun> positionedRuns, int approximateGlyphCount) :1535
...
// internal static void RecreateGlyphAtlas(int version) :1514
void Renderer__RecreateGlyphAtlas_fn(int* version)
{
    Renderer::RecreateGlyphAtlas(*version);
}

// private static Uno.Collections.List<Uno.Collections.List<Fuse.Text.Quad>> TexturedQuads(Fuse.Text.Font font, Uno.Collections.List<Fuse.Text.PositionedRun> positionedRuns, int approximateGlyphCount) :1642
...
// public Renderer(Fuse.Text.Font font, Uno.Collections.List<Fuse.Text.PositionedRun> positionedRuns, int approximateGlyphCount) [instance] :1535
...
// public void Dispose() [instance] :1544
...
// private void DisposeBatches() [instance] :1551
void Renderer::DisposeBatches()
{
    ...
    if (_batches != NULL)
    {
        for (::g::Uno::Collections::List__Enumerator< ::g::Fuse::Text::Batch> enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_batches), &ret8), ret8); enum1.MoveNext(::TYPES[17/*Uno.Collections.List<Fuse.Text.Batch>.Enumerator*/]); )
        {
            ::g::Fuse::Text::Batch batch = enum1.Current(::TYPES[17/*Uno.Collections.List<Fuse.Text.Batch>.Enumerator*/]);
            batch.Dispose();
        }
...
// public void Draw(float4 color, float4x4 pixelToClipSpaceMatrix) [instance] :1561
void Renderer::Draw(::g::Uno::Float4 color, ::g::Uno::Float4x4 pixelToClipSpaceMatrix)
{
    ...
    ::g::Uno::Threading::Monitor::Enter(Renderer::_glyphAtlasMutex());

    {
        const auto __finally_fun = [&]()
        {
            ::g::Uno::Threading::Monitor::Exit(Renderer::_glyphAtlasMutex());
        };
        ...
        for (::g::Uno::Collections::List__Enumerator< ::g::Fuse::Text::Batch> enum2 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(batches), &ret9), ret9); enum2.MoveNext(::TYPES[17/*Uno.Collections.List<Fuse.Text.Batch>.Enumerator*/]); )
        {
            ::g::Fuse::Text::Batch batch = enum2.Current(::TYPES[17/*Uno.Collections.List<Fuse.Text.Batch>.Enumerator*/]);
...
// private Uno.Collections.List<Fuse.Text.Batch> GetBatches() [instance] :1606
::g::Uno::Collections::List* Renderer::GetBatches()
{
    ...
    _batches = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New2(::TYPES[18/*Uno.Collections.List<Fuse.Text.Batch>*/], len));
    ::g::Uno::Collections::List* textures = uPtr(Renderer::_glyphAtlas())->Textures;
...
// private Uno.Collections.List<Uno.Collections.List<Fuse.Text.Quad>> GetTexturedQuads() [instance] :1631
...
// private generated void init_DrawCalls() [instance] :1507
...
// private static Uno.Buffer CreateIndexBufferData(int length) [static] :1719
...
// private static Uno.Buffer CreateVertexBufferData(Uno.Collections.List<Fuse.Text.Quad> quads, int2 texSize) [static] :1737
::g::Uno::Buffer* Renderer::CreateVertexBufferData(::g::Uno::Collections::List* quads, ::g::Uno::Int2 texSize)
{
    ...
    uArray* buffer = uArray::New(::TYPES[16/*byte[]*/], quadStride * length);
...
// public Renderer New(Fuse.Text.Font font, Uno.Collections.List<Fuse.Text.PositionedRun> positionedRuns, int approximateGlyphCount) [static] :1535
...
// internal static void RecreateGlyphAtlas(int version) [static] :1514
...
// private static Uno.Collections.List<Uno.Collections.List<Fuse.Text.Quad>> TexturedQuads(Fuse.Text.Font font, Uno.Collections.List<Fuse.Text.PositionedRun> positionedRuns, int approximateGlyphCount) [static] :1642
::g::Uno::Collections::List* Renderer::TexturedQuads(::g::Fuse::Text::Font* font, ::g::Uno::Collections::List* positionedRuns, int approximateGlyphCount)
{
...

    {
        ...
        ::g::Uno::Collections::List* textureBatches = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New2(::TYPES[19/*Uno.Collections.List<Uno.Collections.List<Fuse.Text.Quad>>*/], textureCount + 1);

        for (int i = 0; i < textureCount; ++i)
            ::g::Uno::Collections::List__Add_fn(uPtr(textureBatches), (::g::Uno::Collections::List*)::g::Uno::Collections::List::New2(::TYPES[20/*Uno.Collections.List<Fuse.Text.Quad>*/], approximateGlyphCount));

        for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Text::PositionedRun*> > enum3 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(positionedRuns), &ret13), ret13); enum3.MoveNext(::TYPES[21/*Uno.Collections.List<Fuse.Text.PositionedRun>.Enumerator*/]); )
        {
            ::g::Fuse::Text::PositionedRun* positionedRun = enum3.Current(::TYPES[21/*Uno.Collections.List<Fuse.Text.PositionedRun>.Enumerator*/]);
...
// public static class Shape :1818
// {
static void Shape_build(uType* type)
{
    ::TYPES[22] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Text::PositionedRun_typeof(), NULL);
    ::TYPES[14] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Text::ShapedRun_typeof(), NULL), NULL);
    ::TYPES[15] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Text::ShapedRun_typeof(), NULL);
    ::TYPES[21] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Text::PositionedRun_typeof(), NULL);
    ::TYPES[23] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Text::ShapedRun_typeof(), NULL), NULL);
    ::TYPES[24] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Text::Bidirectional::Run_typeof(), NULL), NULL);
    ::TYPES[25] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Text::ShapedRun_typeof(), NULL);
    ::TYPES[26] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Text::Bidirectional::Run_typeof(), NULL);
    type->Reflection.SetFunctions(2,
        new uFunction("PositionLines", NULL, (void*)Shape__PositionLines_fn, 0, true, ::TYPES[22/*Uno.Collections.List<Fuse.Text.PositionedRun>*/], 5, ::g::Fuse::Text::Font_typeof(), ::g::Uno::Float_typeof(), ::g::Uno::Float_typeof(), ::g::Uno::Float_typeof(), ::TYPES[23/*Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>>*/]),
        new uFunction("ShapeLines", NULL, (void*)Shape__ShapeLines_fn, 0, true, ::TYPES[23/*Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>>*/], 2, ::g::Fuse::Text::Font_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Text::Bidirectional::Run_typeof(), NULL), NULL)));
}
...
// public static Uno.Collections.List<Fuse.Text.PositionedRun> PositionLines(Fuse.Text.Font font, float pixelWidth, float lineSpacing, float alignment, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> lines) :1843
...
// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> ShapeLines(Fuse.Text.Font font, Uno.Collections.List<Uno.Collections.List<Fuse.Text.Bidirectional.Run>> lines) :1820
...
// public static Uno.Collections.List<Fuse.Text.PositionedRun> PositionLines(Fuse.Text.Font font, float pixelWidth, float lineSpacing, float alignment, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> lines) [static] :1843
::g::Uno::Collections::List* Shape::PositionLines(::g::Fuse::Text::Font* font, float pixelWidth, float lineSpacing, float alignment, ::g::Uno::Collections::List* lines)
{
    ...
    ::g::Uno::Collections::List* result = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[22/*Uno.Collections.List<Fuse.Text.PositionedRun>*/]);
    float y = 0.0f;

    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Uno::Collections::List*> > enum3 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(lines), &ret6), ret6); enum3.MoveNext(::TYPES[14/*Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>>.Enumerator*/]); )
    {
        ...
        ::g::Uno::Collections::List* positionedRuns = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New2(::TYPES[22/*Uno.Collections.List<Fuse.Text.PositionedRun>*/], uPtr(line)->Count());
        ::g::Uno::Float2 lineMeasure = ::g::Uno::Float2__New1(0.0f);

        for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Text::ShapedRun*> > enum4 = (::g::Uno::Collections::List__GetEnumerator_fn(line, &ret7), ret7); enum4.MoveNext(::TYPES[15/*Uno.Collections.List<Fuse.Text.ShapedRun>.Enumerator*/]); )
        {
        ...
        for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Text::PositionedRun*> > enum5 = (::g::Uno::Collections::List__GetEnumerator_fn(positionedRuns, &ret8), ret8); enum5.MoveNext(::TYPES[21/*Uno.Collections.List<Fuse.Text.PositionedRun>.Enumerator*/]); )
        {
            ::g::Fuse::Text::PositionedRun* prun = enum5.Current(::TYPES[21/*Uno.Collections.List<Fuse.Text.PositionedRun>.Enumerator*/]);
...
// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> ShapeLines(Fuse.Text.Font font, Uno.Collections.List<Uno.Collections.List<Fuse.Text.Bidirectional.Run>> lines) [static] :1820
::g::Uno::Collections::List* Shape::ShapeLines(::g::Fuse::Text::Font* font, ::g::Uno::Collections::List* lines)
{
    ...
    ::g::Uno::Collections::List* result = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New2(::TYPES[23/*Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>>*/], uPtr(lines)->Count());

    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Uno::Collections::List*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(lines, &ret9), ret9); enum1.MoveNext(::TYPES[24/*Uno.Collections.List<Uno.Collections.List<Fuse.Text.Bidirectional.Run>>.Enumerator*/]); )
    {
        ::g::Uno::Collections::List* line = enum1.Current(::TYPES[24/*Uno.Collections.List<Uno.Collections.List<Fuse.Text.Bidirectional.Run>>.Enumerator*/]);
        ::g::Uno::Collections::List* sline = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New2(::TYPES[25/*Uno.Collections.List<Fuse.Text.ShapedRun>*/], uPtr(line)->Count());

        for (::g::Uno::Collections::List__Enumerator< ::g::Fuse::Text::Bidirectional::Run> enum2 = (::g::Uno::Collections::List__GetEnumerator_fn(line, &ret10), ret10); enum2.MoveNext(::TYPES[26/*Uno.Collections.List<Fuse.Text.Bidirectional.Run>.Enumerator*/]); )
        {
            ::g::Fuse::Text::Bidirectional::Run run = enum2.Current(::TYPES[26/*Uno.Collections.List<Fuse.Text.Bidirectional.Run>.Enumerator*/]);
...
// public sealed class ShapedRun :1882
// {
static void ShapedRun_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::g::Uno::Int_typeof(), offsetof(::g::Fuse::Text::ShapedRun, _lineBreakClusterOffset), 0,
        ::g::Fuse::Text::Implementation::BitArray_typeof(), offsetof(::g::Fuse::Text::ShapedRun, _lineBreakClusters), 0,
...
// public ShapedRun(Fuse.Text.Bidirectional.Run run, Fuse.Text.PositionedGlyph[] parent) :1893
void ShapedRun__ctor__fn(ShapedRun* __this, ::g::Fuse::Text::Bidirectional::Run* run, uArray* parent)
{
    __this->ctor_(*run, parent);
}

// private ShapedRun(Fuse.Text.Bidirectional.Run run, Fuse.Text.PositionedGlyph[] parent, int start, int count, int clusterOffset, Fuse.Text.Implementation.BitArray lineBreakClusters, int lineBreakClusterOffset) :1898
...
// private ShapedRun New(Fuse.Text.Bidirectional.Run run, Fuse.Text.PositionedGlyph[] parent, int start, int count, int clusterOffset, Fuse.Text.Implementation.BitArray lineBreakClusters, int lineBreakClusterOffset) :1898
...
// public ShapedRun(Fuse.Text.Bidirectional.Run run, Fuse.Text.PositionedGlyph[] parent) [instance] :1893
...
// private ShapedRun(Fuse.Text.Bidirectional.Run run, Fuse.Text.PositionedGlyph[] parent, int start, int count, int clusterOffset, Fuse.Text.Implementation.BitArray lineBreakClusters, int lineBreakClusterOffset) [instance] :1898
...
// public void CacheLineBreaks() [instance] :1982
...
// public bool CanLineBreak(int cluster) [instance] :1988
...
// public Uno.Collections.IEnumerator<Fuse.Text.PositionedGlyph> GetEnumerator() [instance] :1993
...
// public Fuse.Text.PositionedGlyph get_Item(int index) [instance] :1973
...
// public float2 Measure() [instance] :1952
...
// public Fuse.Text.Bidirectional.Run get_Run() [instance] :1885
::g::Fuse::Text::Bidirectional::Run ShapedRun::Run()
{
    return _run;
}

// public Fuse.Text.ShapedRun SubShapedRun(int start) [instance] :1945
...
// public Fuse.Text.ShapedRun SubShapedRun(int start, int count) [instance] :1918
...
// public ShapedRun New(Fuse.Text.Bidirectional.Run run, Fuse.Text.PositionedGlyph[] parent) [static] :1893
...
// private ShapedRun New(Fuse.Text.Bidirectional.Run run, Fuse.Text.PositionedGlyph[] parent, int start, int count, int clusterOffset, Fuse.Text.Implementation.BitArray lineBreakClusters, int lineBreakClusterOffset) [static] :1898
...
// internal static class Renderer.SharedIndexBuffer :1685
// {
...
// public static void EnsureSize(int length) [static] :1698
...
// public static void Release() [static] :1707
...
// public static void Retain() [static] :1691
...
{
    ::TYPES[27] = ::g::Uno::Collections::IEnumerable_typeof();
    ::TYPES[28] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[29] = ::g::Uno::Collections::IEnumerator1_typeof();
    ::TYPES[30] = SinglyLinkedList__Enumerator_typeof();
    type->SetPrecalc(
        type->T(0),
    ...
    type->SetInterfaces(
        ::TYPES[27/*Uno.Collections.IEnumerable`1*/]->MakeType(type->T(0), NULL), offsetof(SinglyLinkedList_type, interface0));
    type->SetFields(0,
...
// public SinglyLinkedList(T value, [Fuse.Text.SinglyLinkedList<T> next]) :1278
...
// public static Fuse.Text.SinglyLinkedList<T> FromEnumerable(Uno.Collections.IEnumerable<T> xs) :1289
...
// public Uno.Collections.IEnumerator<T> GetEnumerator() :1284
void SinglyLinkedList__GetEnumerator_fn(SinglyLinkedList* __this, uObject** __retval)
{
    *__retval = __this->GetEnumerator();
}

// public SinglyLinkedList New(T value, [Fuse.Text.SinglyLinkedList<T> next]) :1278
...
// public static Fuse.Text.SinglyLinkedList<T> FromEnumerable(Uno.Collections.IEnumerable<T> xs) [static] :1289
SinglyLinkedList* SinglyLinkedList::FromEnumerable(uType* __type, uObject* xs)
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(xs), __types[1])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[28/*Uno.Collections.IEnumerator*/])); )
    {
...
// public sealed class Substring :2046
// {
static void Substring_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("index");
    ::TYPES[31] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(10/*SequenceEqual<char>*/, ::g::Uno::Char_typeof(), NULL);
    ::TYPES[28] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[32] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Char_typeof(), NULL);
    type->SetInterfaces(
    ...
    type->Reflection.SetFunctions(11,
        ...
        new uFunction("GetEnumerator", NULL, (void*)Substring__GetEnumerator_fn, 0, false, ::TYPES[32/*Uno.Collections.IEnumerator<char>*/], 0),
...
// public Uno.Collections.IEnumerator<char> GetEnumerator() :2151
void Substring__GetEnumerator_fn(Substring* __this, uObject** __retval)
{
    *__retval = __this->GetEnumerator();
}

// public override sealed int GetHashCode() :2095
void Substring__GetHashCode_fn(Substring* __this, int* __retval)
{
    ...
    for (uObject* enum1 = __this->GetEnumerator(); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[28/*Uno.Collections.IEnumerator*/])); )
    {
        uChar c = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[32/*Uno.Collections.IEnumerator<char>*/]), &ret5), ret5);
...
// public Fuse.Text.Substring GetSubstring(int start) :2122
void Substring__GetSubstring_fn(Substring* __this, int* start, Substring** __retval)
{
    *__retval = __this->GetSubstring(*start);
}

// public Fuse.Text.Substring GetSubstring(int start, int length) :2113
...
// public override sealed string ToString() :2073
...
// public Substring(string parent, int start) [instance] :2057
...
// public Substring(string parent, int start, int length) [instance] :2062
...
// public bool Equals(Fuse.Text.Substring s) [instance] :2086
bool Substring::Equals2(Substring* s)
{
    ...
    return (Length == uPtr(s)->Length) && ::g::Uno::Collections::EnumerableExtensions::SequenceEqual(::TYPES[31/*Uno.Collections.EnumerableExtensions.SequenceEqual<char>*/], (uObject*)this, (uObject*)s);
}

// public Uno.Collections.IEnumerator<char> GetEnumerator() [instance] :2151
...
// public Fuse.Text.Substring GetSubstring(int start) [instance] :2122
...
// public Fuse.Text.Substring GetSubstring(int start, int length) [instance] :2113
...
// public char get_Item(int index) [instance] :2105
...
// public Uno.Collections.IEnumerable<Fuse.Text.Substring> get_Lines() [instance] :2194
...
// public Fuse.Text.Substring TrimLeadingNewline() [instance] :2129
...
// public Fuse.Text.Substring TrimTrailingNewline() [instance] :2139
...
// public Substring New(string parent) [static] :2052
...
// public Substring New(string parent, int start) [static] :2057
...
// public Substring New(string parent, int start, int length) [static] :2062
...
// internal static class SubstringExtensions :2291
// {
static void SubstringExtensions_build(uType* type)
{
    ...
    ::TYPES[1] = uObject_typeof()->Array();
    ::TYPES[33] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(9/*Select<Fuse.Text.Substring, Fuse.Text.Substring>*/, ::g::Fuse::Text::Substring_typeof(), ::g::Fuse::Text::Substring_typeof(), NULL);
    ::TYPES[34] = ::g::Uno::Func1_typeof()->MakeType(::g::Fuse::Text::Substring_typeof(), ::g::Fuse::Text::Substring_typeof(), NULL);
}
...
// public static int CharStart(Fuse.Text.Substring s, int i) :2305
...
// public static Fuse.Text.Substring InclusiveRange(Fuse.Text.Substring s, int start, int end) :2331
...
// public static string SafeSubstring(string s, int start, int length) :2365
...
// private static Fuse.Text.Substring TrimLine(Fuse.Text.Substring line) :2409
...
// public static Uno.Collections.IEnumerable<Fuse.Text.Substring> TrimmedLines(Fuse.Text.Substring str) :2404
...
// public static int CharStart(Fuse.Text.Substring s, int i) [static] :2305
...
// public static int CharStart(string s, int i) [static] :2318
...
// public static string DeleteAt(string s, int& index) [static] :2379
...
// public static string DeleteSpan(string s, int start, int end) [static] :2394
...
// public static Fuse.Text.Substring InclusiveRange(Fuse.Text.Substring s, int start, int end) [static] :2331
::g::Fuse::Text::Substring* SubstringExtensions::InclusiveRange(::g::Fuse::Text::Substring* s, int start, int end)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(!assert1, ::STRINGS[16/*"!Fuse.Text....*/], ::STRINGS[1/*"/Users/hdc/...*/], 2333, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 1, uBox(::g::Uno::Bool_typeof(), assert1)));

    if (SubstringExtensions::IsLeadingSurrogate(s->Item(end)))
        ++end;

    ::g::Uno::Diagnostics::Debug::Assert(end < s->Length, ::STRINGS[17/*"end < s.Len...*/], ::STRINGS[1/*"/Users/hdc/...*/], 2336, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), end), uBox<int>(::g::Uno::Int_typeof(), s->Length)));
    return s->GetSubstring1(start, (end - start) + 1);
}

// private static bool IsLeadingSurrogate(char c) [static] :2293
...
// private static bool IsTrailingSurrogate(char c) [static] :2299
...
// public static int NextCharIndex(string s, int i) [static] :2341
...
// public static int PrevCharIndex(string s, int i) [static] :2353
...
// public static string SafeSubstring(string s, int start) [static] :2373
...
// public static string SafeSubstring(string s, int start, int length) [static] :2365
...
// private static Fuse.Text.Substring TrimLine(Fuse.Text.Substring line) [static] :2409
...
// public static Uno.Collections.IEnumerable<Fuse.Text.Substring> TrimmedLines(Fuse.Text.Substring str) [static] :2404
uObject* SubstringExtensions::TrimmedLines(::g::Fuse::Text::Substring* str)
{
    ...
    return (uObject*)::g::Uno::Collections::EnumerableExtensions::Select(::TYPES[33/*Uno.Collections.EnumerableExtensions.Select<Fuse.Text.Substring, Fuse.Text.Substring>*/], uPtr(str)->Lines(), uDelegate::New(::TYPES[34/*Uno.Func<Fuse.Text.Substring, Fuse.Text.Substring>*/], (void*)SubstringExtensions__TrimLine_fn));
}
// }
...
// public SubTexture(int textureIndex, Uno.Recti rect) :2436
void SubTexture__ctor__fn(SubTexture* __this, int* textureIndex, ::g::Uno::Recti* rect)
{
    __this->ctor_(*textureIndex, *rect);
}

// public SubTexture New(int textureIndex, Uno.Recti rect) :2436
...
// public SubTexture(int textureIndex, Uno.Recti rect) [instance] :2436
...
// public SubTexture New(int textureIndex, Uno.Recti rect) [static] :2436
...
// public sealed class TextureAtlas :2443
// {
...
// public TextureAtlas(int2 minimumTextureSize, Uno.Graphics.Format format, Uno.Collections.List<texture2D> textures) :2455
...
// public Fuse.Text.SubTexture Add(Uno.Content.Images.Bitmap bitmap) :2469
void TextureAtlas__Add_fn(TextureAtlas* __this, ::g::Uno::Content::Images::Bitmap* bitmap, ::g::Fuse::Text::SubTexture* __retval)
{
    *__retval = __this->Add(bitmap);
}

// private static void Blit(Uno.Content.Images.Bitmap dst, Uno.Content.Images.Bitmap src, int2 dstPos) :2515
...
// public void Commit() :2496
void TextureAtlas__Commit_fn(TextureAtlas* __this)
{
    __this->Commit();
}

// public TextureAtlas New(int2 minimumTextureSize, Uno.Graphics.Format format, Uno.Collections.List<texture2D> textures) :2455
...
// private void NewTexture(int2 size) :2506
void TextureAtlas__NewTexture_fn(TextureAtlas* __this, ::g::Uno::Int2* size)
{
    __this->NewTexture(*size);
}

// public TextureAtlas(int2 minimumTextureSize, Uno.Graphics.Format format, Uno.Collections.List<texture2D> textures) [instance] :2455
...
// public Fuse.Text.SubTexture Add(Uno.Content.Images.Bitmap bitmap) [instance] :2469
::g::Fuse::Text::SubTexture TextureAtlas::Add(::g::Uno::Content::Images::Bitmap* bitmap)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 == _format, ::STRINGS[19/*"bitmap.Form...*/], ::STRINGS[1/*"/Users/hdc/...*/], 2471, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Graphics::Format_typeof(), assert1), uBox<int>(::g::Uno::Graphics::Format_typeof(), _format)));
...
// public void Commit() [instance] :2496
...
// private void NewTexture(int2 size) [instance] :2506
...
// private static void Blit(Uno.Content.Images.Bitmap dst, Uno.Content.Images.Bitmap src, int2 dstPos) [static] :2515
void TextureAtlas::Blit(::g::Uno::Content::Images::Bitmap* dst, ::g::Uno::Content::Images::Bitmap* src, ::g::Uno::Int2 dstPos)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(::g::Uno::Recti__New2(::g::Uno::Int2__New1(0), uPtr(dst)->Size()).Contains1(assert2), ::STRINGS[21/*"(&new Uno.R...*/], ::STRINGS[1/*"/Users/hdc/...*/], 2517, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 1, uBox(::g::Uno::Recti_typeof(), assert2)));
    assert3 = src->Format();
    assert4 = dst->Format();
    ::g::Uno::Diagnostics::Debug::Assert(assert3 == assert4, ::STRINGS[22/*"src.Format ...*/], ::STRINGS[1/*"/Users/hdc/...*/], 2518, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Graphics::Format_typeof(), assert3), uBox<int>(::g::Uno::Graphics::Format_typeof(), assert4)));
...
// public TextureAtlas New(int2 minimumTextureSize, Uno.Graphics.Format format, Uno.Collections.List<texture2D> textures) [static] :2455
...
// public static class Truncate :2548
// {
static void Truncate_build(uType* type)
{
    ...
    ::TYPES[25] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Text::ShapedRun_typeof(), NULL);
    type->Reflection.SetFunctions(2,
        new uFunction("Line", NULL, (void*)Truncate__Line_fn, 0, true, ::TYPES[25/*Uno.Collections.List<Fuse.Text.ShapedRun>*/], 5, ::g::Fuse::Text::Font_typeof(), ::TYPES[25/*Uno.Collections.List<Fuse.Text.ShapedRun>*/], ::g::Uno::Float_typeof(), ::g::Uno::Float_typeof()->ByRef(), ::g::Uno::Float_typeof()->ByRef()),
        new uFunction("Lines", NULL, (void*)Truncate__Lines_fn, 0, true, ::TYPES[23/*Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>>*/], 5, ::g::Fuse::Text::Font_typeof(), ::TYPES[23/*Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>>*/], ::g::Uno::Float_typeof(), ::g::Uno::Float_typeof()->ByRef(), ::g::Uno::Float_typeof()->ByRef()));
}
...
// public static Uno.Collections.List<Fuse.Text.ShapedRun> Line(Fuse.Text.Font font, Uno.Collections.List<Fuse.Text.ShapedRun> lineRuns, float maxPixelWidth, float& minTolerance, float& maxTolerance) :2565
...
// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> Lines(Fuse.Text.Font font, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> lines, float maxPixelWidth, float& minTolerance, float& maxTolerance) :2550
...
// private static Uno.Collections.List<Fuse.Text.ShapedRun> TruncatedLine(Fuse.Text.Font font, Uno.Collections.List<Fuse.Text.ShapedRun> lineRuns, float maxPixelWidth, float& minTolerance, float& maxTolerance, float2 pos, int runIndex, int i) :2612
...
// public static Uno.Collections.List<Fuse.Text.ShapedRun> Line(Fuse.Text.Font font, Uno.Collections.List<Fuse.Text.ShapedRun> lineRuns, float maxPixelWidth, float& minTolerance, float& maxTolerance) [static] :2565
...
// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> Lines(Fuse.Text.Font font, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> lines, float maxPixelWidth, float& minTolerance, float& maxTolerance) [static] :2550
::g::Uno::Collections::List* Truncate::Lines(::g::Fuse::Text::Font* font, ::g::Uno::Collections::List* lines, float maxPixelWidth, float* minTolerance, float* maxTolerance)
{
    ...
    *maxTolerance = FLT_INF;
    ::g::Uno::Collections::List* result = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[23/*Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>>*/]);
...
// private static Uno.Collections.List<Fuse.Text.ShapedRun> TruncatedLine(Fuse.Text.Font font, Uno.Collections.List<Fuse.Text.ShapedRun> lineRuns, float maxPixelWidth, float& minTolerance, float& maxTolerance, float2 pos, int runIndex, int i) [static] :2612
::g::Uno::Collections::List* Truncate::TruncatedLine(::g::Fuse::Text::Font* font, ::g::Uno::Collections::List* lineRuns, float maxPixelWidth, float* minTolerance, float* maxTolerance, ::g::Uno::Float2 pos, int runIndex, int i)
{
        ...
        for (; (0 <= i) && (i < srun->Count); i = i + step)
        {
            if (pos.X <= truncationBoundary)
            {
                ...
                *maxTolerance = ::g::Uno::Math::Min1(*maxTolerance, truncStart + lastAdvance.X);
                ::g::Uno::Collections::List* result = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[25/*Uno.Collections.List<Fuse.Text.ShapedRun>*/]);
    ...
    *maxTolerance = ::g::Uno::Math::Min1(*maxTolerance, lastAdvance.X);
    ...
    ::g::Uno::Collections::List* result1 = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New2(::TYPES[25/*Uno.Collections.List<Fuse.Text.ShapedRun>*/], 1);
...
// public static class Wrap :2687
// {
static void Wrap_build(uType* type)
{
    ::TYPES[35] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Text::Bidirectional::Run_typeof(), NULL), NULL);
    ::TYPES[36] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Text::Bidirectional::Run_typeof(), NULL);
    ::TYPES[26] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Text::Bidirectional::Run_typeof(), NULL);
    ::TYPES[37] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Text::Substring_typeof(), NULL);
    ::TYPES[28] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[38] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Text::Substring_typeof(), NULL);
    ::TYPES[23] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Text::ShapedRun_typeof(), NULL), NULL);
    ::TYPES[14] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Text::ShapedRun_typeof(), NULL), NULL);
    ::TYPES[25] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Text::ShapedRun_typeof(), NULL);
    ::TYPES[15] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Text::ShapedRun_typeof(), NULL);
    type->Reflection.SetFunctions(2,
        new uFunction("ActualLineBreaks", NULL, (void*)Wrap__ActualLineBreaks_fn, 0, true, ::TYPES[35/*Uno.Collections.List<Uno.Collections.List<Fuse.Text.Bidirectional.Run>>*/], 1, ::TYPES[36/*Uno.Collections.List<Fuse.Text.Bidirectional.Run>*/]),
        new uFunction("Lines", NULL, (void*)Wrap__Lines_fn, 0, true, ::TYPES[23/*Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>>*/], 5, ::g::Fuse::Text::Font_typeof(), ::TYPES[23/*Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>>*/], ::g::Uno::Float_typeof(), ::g::Uno::Float_typeof()->ByRef(), ::g::Uno::Float_typeof()->ByRef()));
}
...
// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.Bidirectional.Run>> ActualLineBreaks(Uno.Collections.List<Fuse.Text.Bidirectional.Run> logicalRuns) :2689
...
// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> Lines(Fuse.Text.Font font, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> logicalLineRuns, float maxPixelWidth, float& minTolerance, float& maxTolerance) :2711
...
// private static void WrapLine(Fuse.Text.Font font, float maxPixelWidth, float& minTolerance, float& maxTolerance, Uno.Collections.List<Fuse.Text.ShapedRun> line, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> result) :2727
...
// private static void WrapRun(Fuse.Text.Font font, float maxPixelWidth, float& minTolerance, float& maxTolerance, Fuse.Text.ShapedRun srun, float2& pos, Uno.Collections.List<Fuse.Text.ShapedRun>& currentLine, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> result) :2765
...
// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.Bidirectional.Run>> ActualLineBreaks(Uno.Collections.List<Fuse.Text.Bidirectional.Run> logicalRuns) [static] :2689
::g::Uno::Collections::List* Wrap::ActualLineBreaks(::g::Uno::Collections::List* logicalRuns)
{
    ...
    ::g::Uno::Collections::List* result = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[35/*Uno.Collections.List<Uno.Collections.List<Fuse.Text.Bidirectional.Run>>*/]);
    ::g::Uno::Collections::List* currentLine = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[36/*Uno.Collections.List<Fuse.Text.Bidirectional.Run>*/]);

    for (::g::Uno::Collections::List__Enumerator< ::g::Fuse::Text::Bidirectional::Run> enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(logicalRuns), &ret5), ret5); enum1.MoveNext(::TYPES[26/*Uno.Collections.List<Fuse.Text.Bidirectional.Run>.Enumerator*/]); )
    {
        ::g::Fuse::Text::Bidirectional::Run run = enum1.Current(::TYPES[26/*Uno.Collections.List<Fuse.Text.Bidirectional.Run>.Enumerator*/]);
        bool first = true;

        for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(::g::Fuse::Text::SubstringExtensions::TrimmedLines(run.String)), ::TYPES[37/*Uno.Collections.IEnumerable<Fuse.Text.Substring>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[28/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Fuse::Text::Substring* line = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[38/*Uno.Collections.IEnumerator<Fuse.Text.Substring>*/]), &ret6), ret6);

            if (!first)
            {
                ::g::Uno::Collections::List__Add_fn(uPtr(result), currentLine);
                currentLine = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[36/*Uno.Collections.List<Fuse.Text.Bidirectional.Run>*/]);
            }
...
// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> Lines(Fuse.Text.Font font, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> logicalLineRuns, float maxPixelWidth, float& minTolerance, float& maxTolerance) [static] :2711
::g::Uno::Collections::List* Wrap::Lines(::g::Fuse::Text::Font* font, ::g::Uno::Collections::List* logicalLineRuns, float maxPixelWidth, float* minTolerance, float* maxTolerance)
{
    ...
    *minTolerance = 0.0f;
    *maxTolerance = FLT_INF;
    ::g::Uno::Collections::List* result = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New2(::TYPES[23/*Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>>*/], uPtr(logicalLineRuns)->Count());

    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Uno::Collections::List*> > enum3 = (::g::Uno::Collections::List__GetEnumerator_fn(logicalLineRuns, &ret7), ret7); enum3.MoveNext(::TYPES[14/*Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>>.Enumerator*/]); )
    {
        ::g::Uno::Collections::List* line = enum3.Current(::TYPES[14/*Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>>.Enumerator*/]);
        Wrap::WrapLine(font, maxPixelWidth, minTolerance, maxTolerance, line, result);
    }
...
// private static void WrapLine(Fuse.Text.Font font, float maxPixelWidth, float& minTolerance, float& maxTolerance, Uno.Collections.List<Fuse.Text.ShapedRun> line, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> result) [static] :2727
void Wrap::WrapLine(::g::Fuse::Text::Font* font, float maxPixelWidth, float* minTolerance, float* maxTolerance, ::g::Uno::Collections::List* line, ::g::Uno::Collections::List* result)
{
    ...
    ::g::Uno::Collections::List* currentLine = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New2(::TYPES[25/*Uno.Collections.List<Fuse.Text.ShapedRun>*/], uPtr(line)->Count());
    ::g::Uno::Float2 pos = ::g::Uno::Float2__New1(0.0f);

    for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Text::ShapedRun*> > enum4 = (::g::Uno::Collections::List__GetEnumerator_fn(line, &ret8), ret8); enum4.MoveNext(::TYPES[15/*Uno.Collections.List<Fuse.Text.ShapedRun>.Enumerator*/]); )
    {
        ::g::Fuse::Text::ShapedRun* srun = enum4.Current(::TYPES[15/*Uno.Collections.List<Fuse.Text.ShapedRun>.Enumerator*/]);
...
// private static void WrapRun(Fuse.Text.Font font, float maxPixelWidth, float& minTolerance, float& maxTolerance, Fuse.Text.ShapedRun srun, float2& pos, Uno.Collections.List<Fuse.Text.ShapedRun>& currentLine, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> result) [static] :2765
        ...
        if ((((*pos).X > maxPixelWidth) && clusterInBounds) && !::g::Uno::Char::IsWhiteSpace(uPtr(text)->Item(pg.Cluster)))
        {
            ...
            *maxTolerance = ::g::Uno::Math::Min1(*maxTolerance, (*pos).X);
            ...
            if (wrapIndex == -1)
            {
                ...
                {
                    ::g::Uno::Collections::List__Add_fn(uPtr(result), *currentLine);
                    *currentLine = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[25/*Uno.Collections.List<Fuse.Text.ShapedRun>*/]);
                    *pos = localPos;
                }
            }
            else

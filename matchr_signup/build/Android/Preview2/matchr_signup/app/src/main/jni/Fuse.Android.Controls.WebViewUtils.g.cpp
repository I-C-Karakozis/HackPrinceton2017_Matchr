...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Controls.WebView/0.46.1/android/$.uno
// ----------------------------------------------------------------------------------------------------
...
static void WebViewForeign_build(uType* type)
{
    type->Reflection.SetFunctions(15,
        ...
        new uFunction("CreateAndSetWebViewClient", NULL, (void*)WebViewForeign__CreateAndSetWebViewClient_fn, 0, true, ::g::Java::Object_typeof(), 6, ::g::Java::Object_typeof(), ::g::Uno::Action_typeof(), ::g::Uno::Action_typeof(), ::g::Uno::Action_typeof(), ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), ::g::Uno::String_typeof()->Array()),
        new uFunction("CreateWebView", NULL, (void*)WebViewForeign__CreateWebView_fn, 0, true, ::g::Java::Object_typeof(), 1, ::g::Uno::Bool_typeof()),
...
// public static extern string GetTitle(Java.Object handle) :346
...
// public static extern string GetTitle(Java.Object handle) [static] :346
uString* WebViewForeign::GetTitle(::g::Java::Object* handle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetTitle295", "(Ljava/lang/Object;)Ljava/lang/String;");
        ::g::Java::Object* _uhandle=handle;
        jobject _handle = (_uhandle==NULL ? NULL : U_JNIVAR->NewLocalRef(::g::Android::Base::Wrappers::IJWrapper::_GetJavaObject(uInterface((uObject*)_uhandle, ::g::Android::Base::Wrappers::IJWrapper_typeof()))));

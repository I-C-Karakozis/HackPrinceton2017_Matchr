...
void Builtins::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    ::g::Fuse::Scripting::Function* setTimout = uCast< ::g::Fuse::Scripting::Function*>(uPtr(context)->Evaluate(::STRINGS[1/*"fuse-builti...*/], uPtr(::g::FuseReactive_bundle::setTimeout7ea80b59())->ReadAllText()), ::TYPES[2/*Fuse.Scripting.Function*/]);
    ...
    context->Evaluate(::STRINGS[3/*"fuse-builti...*/], uPtr(::g::FuseReactive_bundle::es6promiseminf0025fd1())->ReadAllText());
    context->Evaluate(::STRINGS[3/*"fuse-builti...*/], ::STRINGS[4/*"ES6Promise....*/]);
    ::g::Fuse::Reactive::FuseJS::DiagnosticsImplModule::New2();
    ::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseReactive_bundle::Diagnostics2b2f7c48()))->EvaluateExports(context, ::STRINGS[5/*"FuseJS/Diag...*/]);
    Observable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseReactive_bundle::Observablec39c8969()))->EvaluateExports(context, ::STRINGS[6/*"FuseJS/Obse...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
// private sealed class TimerModule.CallbackClosure :834
// {
...
// public CallbackClosure(Fuse.Scripting.Context context, Fuse.Scripting.Function func, object[] args) :840
...
// public void Callback() :850
void TimerModule__CallbackClosure__Callback_fn(TimerModule__CallbackClosure* __this)
{
    __this->Callback();
}

// public CallbackClosure New(Fuse.Scripting.Context context, Fuse.Scripting.Function func, object[] args) :840
...
// public CallbackClosure(Fuse.Scripting.Context context, Fuse.Scripting.Function func, object[] args) [instance] :840
...
// public void Callback() [instance] :850
...
// public CallbackClosure New(Fuse.Scripting.Context context, Fuse.Scripting.Function func, object[] args) [static] :840
...
static void DiagnosticsImplModule_build(uType* type)
{
    ...
    ::STRINGS[13] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Reactive/0.46.1/fusejs/$.uno");
    ::STRINGS[14] = uString::Const("Report");
    ::TYPES[5] = ::g::Fuse::Scripting::NativeCallback_typeof();
    ::TYPES[6] = ::g::Fuse::Scripting::Marshal_typeof()->MakeMethod(0/*ToType<Fuse.DiagnosticType>*/, ::g::Fuse::DiagnosticType_typeof(), NULL);
...
uObject* DiagnosticsImplModule::Report(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[12/*"Report requ...*/], this, ::STRINGS[13/*"/Users/hdc/...*/], 249, ::STRINGS[14/*"Report"*/]);
        return NULL;
    }

    int type = (::g::Fuse::Scripting::Marshal__ToType_fn(::TYPES[6/*Fuse.Scripting.Marshal.ToType<Fuse.DiagnosticType>*/], uPtr(args)->Strong<uObject*>(0), &ret2), ret2);
    uString* msg = (::g::Fuse::Scripting::Marshal__ToType_fn(::TYPES[7/*Fuse.Scripting.Marshal.ToType<string>*/], args->Strong<uObject*>(1), &ret3), ret3);
    ::g::Fuse::Diagnostics::JavaScriptReport(type, msg);
    return NULL;
}
...
// private sealed class TimerManager.Timer :932
// {
...
// public Timer(double ms, Uno.Action callback, bool repeat) :947
...
// public Timer(double ms, Uno.Action callback, bool repeat) [instance] :947
...
// private void Start() [instance] :956
...
// internal void Update() [instance] :969
...
// public static double GetMilliseconds() [static] :992
double TimerManager__Timer::GetMilliseconds()
{
    return (double)(::g::Uno::Diagnostics::Clock::GetTicks() / 10000LL);
}

// public Timer New(double ms, Uno.Action callback, bool repeat) [static] :947
...
// internal sealed class TimerManager :857
// {
...
// public generated TimerManager() :857
void TimerManager__ctor__fn(TimerManager* __this)
{
    __this->ctor_();
}

// public int AddTimer(double ms, Uno.Action callback, [bool repeat]) :878
...
// public int AddTimer(double ms, Uno.Action callback, [bool repeat]) [instance] :878
...
// public void DeleteAllTimers() [instance] :886
...
// public bool DeleteTimer(int id) [instance] :894
...
// public double GetMinTimeout() [instance] :860
...
// private Fuse.Reactive.FuseJS.TimerManager.Timer GetTimer(int id) [instance] :914
...
// private void RemoveTimer(int id) [instance] :905
...
// public generated TimerManager New() [static] :857
...
// internal void UpdateModule() :827
...
// internal void UpdateModule() [instance] :827

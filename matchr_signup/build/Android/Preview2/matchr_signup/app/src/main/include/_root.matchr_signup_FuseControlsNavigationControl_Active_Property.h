...
namespace g{struct matchr_signup_FuseControlsNavigationControl_Active_Property;}
...
struct matchr_signup_FuseControlsNavigationControl_Active_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Controls::NavigationControl*> _obj;

    void ctor_2(::g::Fuse::Controls::NavigationControl* obj, ::g::Uno::UX::Selector name);
    static matchr_signup_FuseControlsNavigationControl_Active_Property* New1(::g::Fuse::Controls::NavigationControl* obj, ::g::Uno::UX::Selector name);
};
// }

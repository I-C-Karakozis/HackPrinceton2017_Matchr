...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Reactive/0.46.1/subscription/$.uno
// -------------------------------------------------------------------------------------------------
...
{
    uStackFrame __("Fuse.Reactive.AnyChangeObserver", "OnFailed(string)");
    OnClear();
}
...
// /Users/hdc/Library/Application Support/Fusetools/Packages/FuseCore/0.46.1/reactive/$.uno
// ----------------------------------------------------------------------------------------
...
static void BindingTypes_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/FuseCore/0.46.1/reactive/$.uno");
...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Reactive/0.46.1/$.uno
// ------------------------------------------------------------------------------------

// private sealed class EventBinding.CallClosure :799
// {
static void EventBinding__CallClosure_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Reactive/0.46.1/$.uno");
...
// public CallClosure(Fuse.Scripting.IScriptEvent args, object sender) :808
...
// public void AddBool(string key, bool value) :864
...
// public void AddDouble(string key, double value) :859
...
// public void AddString(string key, string value) :849
...
// public void Call() :823
void EventBinding__CallClosure__Call_fn(EventBinding__CallClosure* __this)
{
    __this->Call();
}

// public CallClosure New(Fuse.Scripting.IScriptEvent args, object sender) :808
...
// public CallClosure(Fuse.Scripting.IScriptEvent args, object sender) [instance] :808
...
// public void AddBool(string key, bool value) [instance] :864
...
// public void AddDouble(string key, double value) [instance] :859
...
// public void AddInt(string key, int value) [instance] :854
...
// public void AddObject(string key, object value) [instance] :843
...
// public void AddString(string key, string value) [instance] :849
...
void EventBinding__CallClosure::Call()
{
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[11/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Diagnostics::UserScriptError(::STRINGS[9/*"JavaScript ...*/], ex, this, ::STRINGS[10/*"/Users/hdc/...*/], 839, ::STRINGS[11/*"Call"*/]);
        }
        else throw __t;
    }
}

// public CallClosure New(Fuse.Scripting.IScriptEvent args, object sender) [static] :808
...
// public void set_Bool(bool value) [instance] :2029
void Case::Bool(bool value)
{
    Value(uBox(::TYPES[13/*bool*/], value));
}

// public Uno.Collections.IList<Uno.UX.Template> get_Factories() [instance] :2048
...
// private void Invalidate() [instance] :2059
...
// public generated bool get_IsDefault() [instance] :2036
bool Case::IsDefault()
{
    return _IsDefault;
}

// public generated void set_IsDefault(bool value) [instance] :2037
void Case::IsDefault(bool value)
{
    _IsDefault = value;
}

// public double get_Number() [instance] :2020
double Case::Number()
{
...
// public void set_Number(double value) [instance] :2021
void Case::Number(double value)
{
    Value(uBox(::TYPES[16/*double*/], value));
}

// private void OnFactoriesChanged(Uno.UX.Template f) [instance] :2054
...
// public string get_String() [instance] :2012
uString* Case::String()
{
    return uAs<uString*>(_value, ::TYPES[17/*string*/]);
}

// public void set_String(string value) [instance] :2013
void Case::String(uString* value)
{
    Value(value);
}

// public object get_Value() [instance] :1997
uObject* Case::Value()
{
    return _value;
}

// public void set_Value(object value) [instance] :1998
...
// public generated Case New() [static] :1987
Case* Case::New1()
{
...
// public sealed class ClearDataBinding<T> :449
// {
...
// public ClearDataBinding(Uno.UX.Property<T> target, string key) [instance] :452
void ClearDataBinding::ctor_3(::g::Uno::UX::Property1* target, uString* key)
{
    uStackFrame __("Fuse.Reactive.ClearDataBinding`1", ".ctor(Uno.UX.Property<T>,string)");
    ctor_2(target, key);
}

// public ClearDataBinding New(Uno.UX.Property<T> target, string key) [static] :452
...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Reactive/0.46.1/fusejs/$.uno
// -------------------------------------------------------------------------------------------
...
{
    ::STRINGS[12] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Reactive/0.46.1/fusejs/$.uno");
...
uObject* Console::Dir(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(builder->ToString(), 1, ::STRINGS[12/*"/Users/hdc/...*/], 135);
    return NULL;
}
...
uObject* Console::Log(uArray* args)
{
    ...
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[13/*"null"*/], 1, ::STRINGS[12/*"/Users/hdc/...*/], 121);
...
// private sealed class Instantiator.CountItem :1118
// {
...
// public class DataBinding<T> :180
// {
static void DataBinding_build(uType* type)
{
    ...
    ::STRINGS[30] = uString::Const("unable to convert value");
    ...
    type->SetFields(3,
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::Reactive::DataBinding, _allowMarshal), 0,
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::Reactive::DataBinding, _allowNodeName), 0,
        ...
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::Reactive::DataBinding, _nameListening), 0,
...
// public DataBinding(Uno.UX.Property<T> target, string key) :186
void DataBinding__ctor_2_fn(DataBinding* __this, ::g::Uno::UX::Property1* target, uString* key)
{
    __this->ctor_2(target, key);
}

// private static bool Acceptor(object obj) :422
void DataBinding__Acceptor_fn(uType* __type, uObject* obj, bool* __retval)
{
    *__retval = DataBinding::Acceptor(__type, obj);
}

// private void AddNameListener(string name) :356
void DataBinding__AddNameListener_fn(DataBinding* __this, uString* name)
{
    __this->AddNameListener(name);
}

// private void CleanupNameListener() :347
void DataBinding__CleanupNameListener_fn(DataBinding* __this)
{
    __this->CleanupNameListener();
}

// protected internal virtual bool get_Clear() :199
void DataBinding__get_Clear_fn(DataBinding* __this, bool* __retval)
{
    return *__retval = false, void();
}

// private void ClearFailed() :268
void DataBinding__ClearFailed_fn(DataBinding* __this)
{
    __this->ClearFailed();
}

// private void ClearValue() :297
void DataBinding__ClearValue_fn(DataBinding* __this)
{
    __this->ClearValue();
}

// private void Fuse.INameListener.OnNameChanged(Fuse.Node obj, Uno.UX.Selector name) :302
...
{
    uStackFrame __("Fuse.Reactive.DataBinding`1", "Fuse.Scripting.IObserver.OnClear()");
    __this->ClearValue();
}
...
// private void Fuse.Scripting.IObserver.OnInsertAt(int index, object value) :250
...
// private void Fuse.Scripting.IObserver.OnNewAll(Fuse.Scripting.ListMirror values) :239
...
// private void Fuse.Scripting.IObserver.OnRemoveAt(int index) :245
...
// private void MarkFailed(string message) :263
void DataBinding__MarkFailed_fn(DataBinding* __this, uString* message)
{
    __this->MarkFailed(message);
}

// public DataBinding New(Uno.UX.Property<T> target, string key) :186
...
// internal override sealed void NewValue(object value) :317
...
// protected override sealed void OnRooted() :255
...
// protected override sealed void OnUnrooted() :274
...
// protected virtual void PushValue(object newValue) :362
void DataBinding__PushValue_fn(DataBinding* __this, uObject* newValue)
{
    ...
    if (__this->TryPushAsValue(newValue))
        return;
    else if (__this->_allowMarshal && __this->TryPushAsMarshalledValue(newValue))
        return;
    else if (__this->_allowNodeName && __this->TryPushAsNodeName(newValue))
        return;
    else
    {
        __this->ClearValue();
        ...
        if (newValue != NULL)
            __this->MarkFailed(::STRINGS[30/*"unable to c...*/]);
    }
}

// protected internal virtual bool get_Read() :197
void DataBinding__get_Read_fn(DataBinding* __this, bool* __retval)
{
    return *__retval = true, void();
}

// internal void SetTarget(T value) :291
void DataBinding__SetTarget_fn(DataBinding* __this, void* value)
{
    uStackFrame __("Fuse.Reactive.DataBinding`1", "SetTarget(T)");
    __this->ClearFailed();
...
// private static Uno.UX.Selector ToSelector(object newValue) :415
...
// private bool TryPushAsMarshalledValue(object newValue) :427
void DataBinding__TryPushAsMarshalledValue_fn(DataBinding* __this, uObject* newValue, bool* __retval)
{
    *__retval = __this->TryPushAsMarshalledValue(newValue);
}

// private bool TryPushAsNodeName(object newValue) :393
void DataBinding__TryPushAsNodeName_fn(DataBinding* __this, uObject* newValue, bool* __retval)
{
    *__retval = __this->TryPushAsNodeName(newValue);
}

// private bool TryPushAsValue(object newValue) :382
...
// private void Uno.UX.IPropertyListener.OnPropertyChanged(Uno.UX.PropertyObject obj, Uno.UX.Selector prop) :307
...
// protected internal virtual bool get_Write() :198
void DataBinding__get_Write_fn(DataBinding* __this, bool* __retval)
{
    return *__retval = true, void();
}

// public DataBinding(Uno.UX.Property<T> target, string key) [instance] :186
void DataBinding::ctor_2(::g::Uno::UX::Property1* target, uString* key)
{
    ...
    ctor_1(key);
    Target(target);
    _allowNodeName = (::g::Uno::Type::IsSubclassOf(uPtr(__type->GetBase(DataBinding_typeof())->T(0)), ::TYPES[6/*Fuse.Node*/]) || ::g::Uno::Type::op_Equality(__type->GetBase(DataBinding_typeof())->T(0), ::TYPES[6/*Fuse.Node*/]));
    _allowMarshal = ::g::Fuse::Scripting::Marshal::CanConvertTo(__type->GetBase(DataBinding_typeof())->T(0));
}

// private void AddNameListener(string name) [instance] :356
void DataBinding::AddNameListener(uString* name)
{
    uStackFrame __("Fuse.Reactive.DataBinding`1", "AddNameListener(string)");
    ::g::Fuse::NameRegistry::AddListener(::g::Uno::UX::Selector__op_Implicit(name), (uObject*)this);
    _nameListening = true;
}

// private void CleanupNameListener() [instance] :347
void DataBinding::CleanupNameListener()
{
    uStackFrame __("Fuse.Reactive.DataBinding`1", "CleanupNameListener()");

    if (_nameListening)
    {
        ::g::Fuse::NameRegistry::RemoveListener((uObject*)this);
        _nameListening = false;
    }
}

// private void ClearFailed() [instance] :268
void DataBinding::ClearFailed()
{
    uStackFrame __("Fuse.Reactive.DataBinding`1", "ClearFailed()");

    if (Parent() != NULL)
        ::g::Fuse::Triggers::BusyTask::SetBusy(Parent(), &_busyTask, 0, ::STRINGS[17/*""*/]);
}

// private void ClearValue() [instance] :297
void DataBinding::ClearValue()
{
    uStackFrame __("Fuse.Reactive.DataBinding`1", "ClearValue()");

    if (Clear())
        DataBinding__SetTarget_fn(this, uT(__type->GetBase(DataBinding_typeof())->T(0), U_ALLOCA(__type->GetBase(DataBinding_typeof())->T(0)->ValueSize)));
}
...
// private bool TryPushAsMarshalledValue(object newValue) [instance] :427
bool DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    uType* __types[] = {
    ...
    if ((::g::Fuse::Scripting::Marshal__TryConvertTo1_fn(__types[1], newValue, &value, &ret2), ret2))
    {
        try
        {
            DataBinding__SetTarget_fn(this, value);
        }
        catch (const uThrowable& __t)
        {
            ::g::Uno::Exception* e = __t.Exception;
            MarkFailed(uPtr(e)->ToString());
            ::g::Fuse::Diagnostics::UserError(e->ToString(), Target(), ::STRINGS[10/*"/Users/hdc/...*/], 439, ::STRINGS[31/*"TryPushAsMa...*/]);
        }
...
// private bool TryPushAsNodeName(object newValue) [instance] :393
bool DataBinding::TryPushAsNodeName(uObject* newValue)
{
    uStackFrame __("Fuse.Reactive.DataBinding`1", "TryPushAsNodeName(object)");
    ::g::Uno::UX::Selector name = DataBinding::ToSelector(__type->GetBase(DataBinding_typeof()), newValue);

    if (!name.IsNull())
    {
        AddNameListener(::g::Uno::UX::Selector__op_Implicit1(name));
        ...
        if (k != NULL)
        {
            DataBinding__SetTarget_fn(this, uUnboxAny(__type->GetBase(DataBinding_typeof())->T(0), k));
            return true;
        }
...
// private bool TryPushAsValue(object newValue) [instance] :382
bool DataBinding::TryPushAsValue(uObject* newValue)
{
    ...
    {
        DataBinding__SetTarget_fn(this, uUnboxAny(__types[0], newValue));
        return true;
    }
...
// private static bool Acceptor(object obj) [static] :422
...
// public DataBinding New(Uno.UX.Property<T> target, string key) [static] :186
...
// private static Uno.UX.Selector ToSelector(object newValue) [static] :415
...
// public sealed class DataToResourceBinding<T> :520
// {
...
// public DataToResourceBinding(Uno.UX.Property<T> target, string key) :523
void DataToResourceBinding__ctor_3_fn(DataToResourceBinding* __this, ::g::Uno::UX::Property1* target, uString* key)
{
    __this->ctor_3(target, key);
}

// private bool AcceptFunction(object obj) :555
...
// public DataToResourceBinding New(Uno.UX.Property<T> target, string key) :523
...
// private void OnChanged() :544
void DataToResourceBinding__OnChanged_fn(DataToResourceBinding* __this)
{
    __this->OnChanged();
}

// protected override sealed void PushValue(object value) :530
...
// public DataToResourceBinding(Uno.UX.Property<T> target, string key) [instance] :523
...
// private bool AcceptFunction(object obj) [instance] :555
...
// private void OnChanged() [instance] :544
void DataToResourceBinding::OnChanged()
{
    ...
    if (uPtr(Parent())->TryGetResource(_key, uDelegate::New(::TYPES[34/*Uno.Predicate<object>*/], (void*)DataToResourceBinding__AcceptFunction_fn, this), &v))
        ::g::Fuse::Reactive::DataBinding__SetTarget_fn(this, uUnboxAny(__type->T(0), v));
}

// public DataToResourceBinding New(Uno.UX.Property<T> target, string key) [static] :523
...
{
    ::STRINGS[35] = uString::Const("debug_log");
    ::STRINGS[13] = uString::Const("null");
    ::STRINGS[12] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Reactive/0.46.1/fusejs/$.uno");
    ::TYPES[27] = ::g::Fuse::Scripting::Callback_typeof();
}
...
void DebugLog::Init(::g::Fuse::Scripting::Context* c)
{
    ...
    uPtr(uPtr(c)->GlobalObject())->Item(::STRINGS[35/*"debug_log"*/], uDelegate::New(::TYPES[27/*Fuse.Scripting.Callback*/], (void*)DebugLog__Log_fn));
}
...
uObject* DebugLog::Log(uArray* args)
{
    ...
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[13/*"null"*/], 1, ::STRINGS[12/*"/Users/hdc/...*/], 99);
...
// public Each() [instance] :677
void Each::ctor_5()
{
    ctor_3();
}

// private Each(Uno.Collections.IList<Uno.UX.Template> templates) [instance] :676
void Each::ctor_6(uObject* templates)
{
    ctor_4(templates);
}

// public new int get_Count() [instance] :699
int Each::Count1()
{
    return Count();
}

// public new void set_Count(int value) [instance] :700
...
// public object get_Items() [instance] :685
uObject* Each::Items()
{
    return _items;
}

// public void set_Items(object value) [instance] :686
...
// public new int get_Limit() [instance] :725
int Each::Limit1()
{
    return Limit();
}

// public new void set_Limit(int value) [instance] :726
void Each::Limit1(int value)
{
    Limit(value);
}

// public new int get_Offset() [instance] :712
int Each::Offset1()
{
    return Offset();
}

// public new void set_Offset(int value) [instance] :713
void Each::Offset1(int value)
{
    Offset(value);
}

// private static Fuse.Reactive.Each GetEach(Fuse.Visual container) [static] :630
...
// public static object GetItems(Fuse.Visual container) [static] :658
...
// public static string GetMatchKey(Fuse.Visual container) [static] :671
...
// private Each New(Uno.Collections.IList<Uno.UX.Template> templates) [static] :676
...
// public static void SetItems(Fuse.Visual container, object items) [static] :652
...
// public static void SetMatchKey(Fuse.Visual container, string key) [static] :665
...
// private sealed class JavaScript.EvaluateDataContext :1601
// {
...
// public EvaluateDataContext(Fuse.Reactive.ThreadWorker worker, Fuse.Reactive.JavaScript js) :1607
...
// private void Evaluate() :1615
void JavaScript__EvaluateDataContext__Evaluate_fn(JavaScript__EvaluateDataContext* __this)
{
    __this->Evaluate();
}

// public EvaluateDataContext New(Fuse.Reactive.ThreadWorker worker, Fuse.Reactive.JavaScript js) :1607
...
// private void SetDataContext() :1624
void JavaScript__EvaluateDataContext__SetDataContext_fn(JavaScript__EvaluateDataContext* __this)
{
    __this->SetDataContext();
}

// public EvaluateDataContext(Fuse.Reactive.ThreadWorker worker, Fuse.Reactive.JavaScript js) [instance] :1607
...
// private void Evaluate() [instance] :1615
...
// private void SetDataContext() [instance] :1624
...
// public EvaluateDataContext New(Fuse.Reactive.ThreadWorker worker, Fuse.Reactive.JavaScript js) [static] :1607
...
// public sealed class EventBinding :760
// {
...
// private void ProcessQueuedEvents() :771
void EventBinding__ProcessQueuedEvents_fn(EventBinding* __this)
{
    __this->ProcessQueuedEvents();
}

// public EventBinding(string key) [instance] :763
void EventBinding::ctor_2(uString* key)
{
    ctor_1(key);
}

// public void OnEvent(object sender, Uno.EventArgs args) [instance] :870
...
// private void ProcessQueuedEvents() [instance] :771
...
// public EventBinding New(string key) [static] :763
...
// public sealed class ThreadWorker.Flag :2347
// {
...
// public sealed class Instance :1499
// {
...
// public Instance New() [static] :1501
...
// public class Instantiator :909
// {
static void Instantiator_build(uType* type)
{
    ::STRINGS[36] = uString::Const("Template contains a non-Node");
    ::STRINGS[10] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Reactive/0.46.1/$.uno");
    ::STRINGS[37] = uString::Const("AddTemplate");
    ::STRINGS[17] = uString::Const("");
    ::STRINGS[38] = uString::Const("Limit cannot be less than 0");
    ::STRINGS[39] = uString::Const("set_Limit");
    ::STRINGS[40] = uString::Const("Offset cannot be less than 0");
    ::STRINGS[41] = uString::Const("set_Offset");
...
// protected internal Instantiator() :918
void Instantiator__ctor_3_fn(Instantiator* __this)
{
    __this->ctor_3();
}

// protected internal Instantiator(Uno.Collections.IList<Uno.UX.Template> templates) :913
void Instantiator__ctor_4_fn(Instantiator* __this, uObject* templates)
{
    __this->ctor_4(templates);
}

// private void AddTemplate(object data, Uno.UX.Template f, Uno.Collections.List<Fuse.Node> newElements) :1460
...
// protected internal int get_Count() :1123
void Instantiator__get_Count_fn(Instantiator* __this, int* __retval)
{
    *__retval = __this->Count();
}

// protected internal void set_Count(int value) :1124
void Instantiator__set_Count_fn(Instantiator* __this, int* value)
{
    __this->Count(*value);
}

// private void Fuse.ITemplateObserver.OnTemplatesChangedWileRooted() :990
...
// private void Fuse.Scripting.IObserver.OnAdd(object addedValue) :1260
...
// private void Fuse.Scripting.IObserver.OnClear() :1317
...
// private void Fuse.Scripting.IObserver.OnFailed(string message) :1252
...
// private void Fuse.Scripting.IObserver.OnInsertAt(int index, object value) :1290
...
// private void Fuse.Scripting.IObserver.OnNewAll(Fuse.Scripting.ListMirror values) :1308
...
// private void Fuse.Scripting.IObserver.OnNewAt(int index, object value) :1299
...
// private void Fuse.Scripting.IObserver.OnRemoveAt(int index) :1268
...
// private void Fuse.Scripting.IObserver.OnSet(object newValue) :1243
...
// private Fuse.Node GetLastNodeFromIndex(int windowIndex) :1479
...
// internal override sealed Fuse.Node GetLastNodeInGroup() :1474
...
// protected internal Instantiator(Uno.Collections.IList<Uno.UX.Template> templates) [instance] :913
...
// private void AddTemplate(object data, Uno.UX.Template f, Uno.Collections.List<Fuse.Node> newElements) [instance] :1460
void Instantiator::AddTemplate(uObject* data, ::g::Uno::UX::Template* f, ::g::Uno::Collections::List* newElements)
{
    ...
    if (elm == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[36/*"Template co...*/], this, ::STRINGS[10/*"/Users/hdc/...*/], 1465, ::STRINGS[37/*"AddTemplate"*/]);
        return;
    }
...
// protected internal int get_Count() [instance] :1123
int Instantiator::Count()
{
    return _count;
}

// protected internal void set_Count(int value) [instance] :1124
...
// private object GetData(int dataIndex) [instance] :1175
...
// private int GetDataCount() [instance] :1186
...
// private Fuse.Node GetLastNodeFromIndex(int windowIndex) [instance] :1479
...
// private string GetMatchKey(object data) [instance] :1386
...
// internal bool get_HasLimit() [instance] :1114
bool Instantiator::HasLimit()
{
    return _hasLimit;
}

// private void InsertNew(int dataIndex) [instance] :1399
...
// internal int get_Limit() [instance] :1072
int Instantiator::Limit()
{
    return _limit;
}

// internal void set_Limit(int value) [instance] :1073
void Instantiator::Limit(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[38/*"Limit canno...*/], this, ::STRINGS[10/*"/Users/hdc/...*/], 1080, ::STRINGS[39/*"set_Limit"*/]);
        value = 0;
    }
...
// public string get_MatchKey() [instance] :1375
uString* Instantiator::MatchKey()
{
    return _matchKey;
}

// public void set_MatchKey(string value) [instance] :1376
...
// internal int get_Offset() [instance] :1024
int Instantiator::Offset()
{
    return _offset;
}

// internal void set_Offset(int value) [instance] :1025
void Instantiator::Offset(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[40/*"Offset cann...*/], this, ::STRINGS[10/*"/Users/hdc/...*/], 1032, ::STRINGS[41/*"set_Offset"*/]);
        value = 0;
    }
...
// protected internal void OnItemsChanged() [instance] :1140
...
// private void OnTemplatesChanged(Uno.UX.Template factory) [instance] :995
...
// private void RemoveAll() [instance] :1333
...
// private void RemoveAt(int dataIndex) [instance] :1277
...
// private void ReplaceAll(object[] dcs) [instance] :1326
...
// private void Repopulate() [instance] :1211
...
// private void SetFailed(string message) [instance] :1235
...
// private void SetValid() [instance] :1229
...
// public generated string get_TemplateKey() [instance] :987
uString* Instantiator::TemplateKey()
{
    return _TemplateKey;
}

// public generated void set_TemplateKey(string value) [instance] :987
void Instantiator::TemplateKey(uString* value)
{
    _TemplateKey = value;
}

// public Uno.Collections.IList<Uno.UX.Template> get_Templates() [instance] :930
...
// public generated Fuse.Visual get_TemplateSource() [instance] :976
::g::Fuse::Visual* Instantiator::TemplateSource()
{
    return _TemplateSource;
}

// public generated void set_TemplateSource(Fuse.Visual value) [instance] :976
void Instantiator::TemplateSource(::g::Fuse::Visual* value)
{
    _TemplateSource = value;
}

// private void TrimAndPad() [instance] :1091
...
// protected internal Instantiator New() [static] :918
...
// protected internal Instantiator New(Uno.Collections.IList<Uno.UX.Template> templates) [static] :913
...
// public sealed class JavaScript :1526
// {
// static JavaScript() :1526
...
static void JavaScript_build(uType* type)
{
    ...
    ::STRINGS[44] = uString::Const(" fixed!");
    ::STRINGS[10] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Reactive/0.46.1/$.uno");
    ::STRINGS[45] = uString::Const("EvaluateModule");
    ::STRINGS[46] = uString::Const("JavaScript error");
    ::STRINGS[47] = uString::Const("Cannot require() a rooted module");
    ::TYPES[4] = ::g::Uno::Action_typeof();
...
// public JavaScript(Uno.UX.NameTable nameTable) :1535
...
// protected override sealed void OnUnrooted() :1552
...
// private void SetDataContext(object newDc) :1593
void JavaScript__SetDataContext_fn(JavaScript* __this, uObject* newDc)
{
    __this->SetDataContext(newDc);
}

// internal static Fuse.Reactive.ThreadWorker get_Worker() :1530
...
// public JavaScript(Uno.UX.NameTable nameTable) [instance] :1535
...
// private object EvaluateExports() [instance] :1632
uObject* JavaScript::EvaluateExports()
{
    ...
    if (_moduleResult != NULL)
        return uPtr(uPtr(_moduleResult)->Object)->Item(::STRINGS[42/*"exports"*/]);

    return NULL;
}

// private void EvaluateModule() [instance] :1644
void JavaScript::EvaluateModule()
{
...

    {
        ...
        if (newModuleResult->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[43/*"JavaScript ...*/], FileName()), ::STRINGS[44/*" fixed!"*/]), this, ::STRINGS[10/*"/Users/hdc/...*/], 1659, ::STRINGS[45/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserScriptError(::STRINGS[46/*"JavaScript ...*/], se, this, ::STRINGS[10/*"/Users/hdc/...*/], 1670, ::STRINGS[45/*"EvaluateMod...*/]);
...
// public Uno.UX.FileSource get_File() [instance] :1702
...
// public void set_File(Uno.UX.FileSource value) [instance] :1703
...
// public string get_FileName() [instance] :1710
...
// public void set_FileName(string value) [instance] :1711
...
// public int get_LineNumber() [instance] :1695
...
// public void set_LineNumber(int value) [instance] :1696
...
// private void SetDataContext(object newDc) [instance] :1593
...
// public JavaScript New(Uno.UX.NameTable nameTable) [static] :1535
...
// internal static Fuse.Reactive.ThreadWorker get_Worker() [static] :1530
...
// public sealed class Match :1748
// {
static void Match_build(uType* type)
{
    ::STRINGS[48] = uString::Const("Not handled: OnAdd");
    ::STRINGS[49] = uString::Const("Not handled: InsertAt");
    ::STRINGS[50] = uString::Const("<Match> can not be used on lists (received OnNewAll)");
    ::STRINGS[51] = uString::Const("Not handled: OnNewAt");
    ::STRINGS[52] = uString::Const("<Match> can not be used on lists (received OnRemoveAt)");
    ::STRINGS[53] = uString::Const("Case already has a Match");
    ::TYPES[1] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ...
    ::TYPES[44] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    ::TYPES[6] = ::g::Fuse::Node_typeof();
    ::TYPES[50] = ::g::Fuse::Scripting::IObserver_typeof();
    ::TYPES[46] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[6/*Fuse.Node*/], NULL);
    ::TYPES[51] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Reactive::Case_typeof(), NULL);
    ::TYPES[52] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Reactive::Case_typeof(), NULL);
    ::TYPES[13] = ::g::Uno::Bool_typeof();
    ::TYPES[53] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Fuse::Reactive::Case_typeof(), NULL);
    ::TYPES[54] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Reactive::Case_typeof(), NULL);
    ::TYPES[22] = ::g::Uno::Int_typeof();
    ::TYPES[16] = ::g::Uno::Double_typeof();
    ::TYPES[17] = ::g::Uno::String_typeof();
    ::TYPES[29] = ::g::Fuse::Scripting::Observable_typeof();
    type->SetInterfaces(
        ...
        ::TYPES[50/*Fuse.Scripting.IObserver*/], offsetof(Match_type, interface4));
    type->SetFields(13,
...
// private void Fuse.Scripting.IObserver.OnClear() :1782
void Match__FuseScriptingIObserverOnClear_fn(Match* __this)
{
}

// private void Fuse.Scripting.IObserver.OnFailed(string message) :1802
void Match__FuseScriptingIObserverOnFailed_fn(Match* __this, uString* message)
{
    uStackFrame __("Fuse.Reactive.Match", "Fuse.Scripting.IObserver.OnFailed(string)");
    ::g::Fuse::Scripting::IObserver::OnClear(uInterface(uPtr(uAs<uObject*>(__this, ::TYPES[50/*Fuse.Scripting.IObserver*/])), ::TYPES[50/*Fuse.Scripting.IObserver*/]));
}

// private void Fuse.Scripting.IObserver.OnInsertAt(int index, object value) :1797
void Match__FuseScriptingIObserverOnInsertAt_fn(Match* __this, int* index, uObject* value)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::STRINGS[49/*"Not handled...*/]));
}

// private void Fuse.Scripting.IObserver.OnNewAll(Fuse.Scripting.ListMirror values) :1808
void Match__FuseScriptingIObserverOnNewAll_fn(Match* __this, ::g::Fuse::Scripting::ListMirror* values)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::STRINGS[50/*"<Match> can...*/]));
}

// private void Fuse.Scripting.IObserver.OnNewAt(int index, object value) :1792
void Match__FuseScriptingIObserverOnNewAt_fn(Match* __this, int* index, uObject* value)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::STRINGS[51/*"Not handled...*/]));
}

// private void Fuse.Scripting.IObserver.OnRemoveAt(int index) :1820
void Match__FuseScriptingIObserverOnRemoveAt_fn(Match* __this, int* index)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::STRINGS[52/*"<Match> can...*/]));
}

// private void Fuse.Scripting.IObserver.OnSet(object newValue) :1776
...
// internal override sealed Fuse.Node GetLastNodeInGroup() :1974
...
// private void AddElements(Fuse.Reactive.Case c) [instance] :1951
...
// public bool get_Bool() [instance] :1890
bool Match::Bool()
{
...
// public void set_Bool(bool value) [instance] :1891
...
// public Uno.Collections.IList<Fuse.Reactive.Case> get_Cases() [instance] :1757
uObject* Match::Cases()
{
    uStackFrame __("Fuse.Reactive.Match", "get_Cases()");
    uObject* ind5 = _cases;
    return (ind5 != NULL) ? ind5 : (uObject*)(_cases = (uObject*)((::g::Uno::Collections::ObservableList*)::g::Uno::Collections::ObservableList::New1(::TYPES[53/*Uno.Collections.ObservableList<Fuse.Reactive.Case>*/], uDelegate::New(::TYPES[54/*Uno.Action<Fuse.Reactive.Case>*/], (void*)Match__OnCaseAdded_fn, this), uDelegate::New(::TYPES[54/*Uno.Action<Fuse.Reactive.Case>*/], (void*)Match__OnCaseRemoved_fn, this))));
}

// public int get_Integer() [instance] :1882
int Match::Integer()
{
...
// public void set_Integer(int value) [instance] :1883
...
// internal void Invalidate() [instance] :1910
...
// public double get_Number() [instance] :1874
double Match::Number()
{
...
// public void set_Number(double value) [instance] :1875
...
// private void OnCaseAdded(Fuse.Reactive.Case c) [instance] :1763
void Match::OnCaseAdded(::g::Fuse::Reactive::Case* c)
{
    ...
    if (uPtr(c)->_match != NULL)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[53/*"Case alread...*/]));

    uPtr(c)->_match = this;
    Invalidate();
}

// private void OnCaseRemoved(Fuse.Reactive.Case c) [instance] :1770
...
// private void RemoveElements() [instance] :1939
...
// private Fuse.Reactive.Case SelectCase() [instance] :1928
::g::Fuse::Reactive::Case* Match::SelectCase()
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(_cases), ::TYPES[51/*Uno.Collections.IEnumerable<Fuse.Reactive.Case>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[43/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Reactive::Case* c = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[52/*Uno.Collections.IEnumerator<Fuse.Reactive.Case>*/]), &ret12), ret12);
...
// public string get_String() [instance] :1866
uString* Match::String()
{
    return uAs<uString*>(Value(), ::TYPES[17/*string*/]);
}

// public void set_String(string value) [instance] :1867
...
// private void Update() [instance] :1917
void Match::Update()
{
...
// public object get_Value() [instance] :1833
uObject* Match::Value()
{
    return _value;
}

// public void set_Value(object value) [instance] :1834
...
// public generated Match New() [static] :1748
Match* Match::New2()
{
...
// private enum WhileCount.Range :2516
...
// public sealed class ReadClearDataBinding<T> :467
// {
...
// public ReadClearDataBinding(Uno.UX.Property<T> target, string key) :470
...
// protected internal override sealed bool get_Clear() :471
void ReadClearDataBinding__get_Clear_fn(ReadClearDataBinding* __this, bool* __retval)
{
    return *__retval = true, void();
}

// public ReadClearDataBinding New(Uno.UX.Property<T> target, string key) :470
...
// public ReadClearDataBinding(Uno.UX.Property<T> target, string key) [instance] :470
void ReadClearDataBinding::ctor_4(::g::Uno::UX::Property1* target, uString* key)
{
    ctor_3(target, key);
}

// public ReadClearDataBinding New(Uno.UX.Property<T> target, string key) [static] :470
...
// public class ReadDataBinding<T> :458
// {
...
// public ReadDataBinding(Uno.UX.Property<T> target, string key) :461
void ReadDataBinding__ctor_3_fn(ReadDataBinding* __this, ::g::Uno::UX::Property1* target, uString* key)
{
    __this->ctor_3(target, key);
}

// public ReadDataBinding New(Uno.UX.Property<T> target, string key) :461
...
// protected internal override sealed bool get_Write() :462
void ReadDataBinding__get_Write_fn(ReadDataBinding* __this, bool* __retval)
{
    return *__retval = false, void();
}

// public ReadDataBinding(Uno.UX.Property<T> target, string key) [instance] :461
...
// public ReadDataBinding New(Uno.UX.Property<T> target, string key) [static] :461
...
// internal sealed class RootableScriptModule :2078
// {
...
// public RootableScriptModule(Fuse.Reactive.ThreadWorker worker, Uno.UX.NameTable names) :2084
...
// protected override sealed void CallModuleFunc(Fuse.Scripting.Function moduleFunc, object[] args) :2121
...
// private void EnsureClassInstanceRooted() :2096
void RootableScriptModule__EnsureClassInstanceRooted_fn(RootableScriptModule* __this)
{
    __this->EnsureClassInstanceRooted();
}

// public override sealed void Evaluate(Fuse.Scripting.Context c, Fuse.Scripting.ModuleResult result) :2090
...
// protected override sealed string GenerateArgs(Fuse.Scripting.Context c, Fuse.Scripting.ModuleResult result, Uno.Collections.List<object> args) :2102
void RootableScriptModule__GenerateArgs_fn(RootableScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    while (nt != NULL)
    {
        for (int e = uPtr(uPtr(nt)->Entries)->Length(); (e--) > 0; )
        {
            argsString = ::g::Uno::String::op_Addition2(argsString, ::g::Uno::String::op_Addition2(::STRINGS[54/*", "*/], uPtr(uPtr(nt)->Entries)->Strong<uString*>(e)));
...
// public RootableScriptModule New(Fuse.Reactive.ThreadWorker worker, Uno.UX.NameTable names) :2084
...
// public RootableScriptModule(Fuse.Reactive.ThreadWorker worker, Uno.UX.NameTable names) [instance] :2084
...
// private void EnsureClassInstanceRooted() [instance] :2096
...
// public RootableScriptModule New(Fuse.Reactive.ThreadWorker worker, Uno.UX.NameTable names) [static] :2084
...
void SegmentObserver::OnNewAll(::g::Fuse::Scripting::ListMirror* values)
{
    ...
    if (uPtr(values)->Length() > 0)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[56/*"Data bindin...*/], _key), ::STRINGS[58/*"': expected...*/]), uBox<int>(::TYPES[22/*int*/], uPtr(values)->Length()))));
}
...
// public sealed class Select :2768
// {
static void Select_build(uType* type)
{
    ::STRINGS[59] = uString::Const("'Select' is deprecated, use 'With' instead (works the same way). ");
    ::STRINGS[10] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Reactive/0.46.1/$.uno");
    ::STRINGS[60] = uString::Const(".ctor");
    type->SetInterfaces(
...
// public Select New() :2770
void Select__New3_fn(Select** __retval)
{
    *__retval = Select::New3();
}

// public Select() [instance] :2770
void Select::ctor_6()
{
    ctor_5();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[59/*"'Select' is...*/], this, ::STRINGS[10/*"/Users/hdc/...*/], 2772, ::STRINGS[60/*".ctor"*/]);
}

// public Select New() [static] :2770
Select* Select::New3()
{
...
// internal partial sealed class ThreadWorker :2140
// {
static void ThreadWorker_build(uType* type)
{
    ::STRINGS[61] = uString::Const("Skipped Exception");
    ::STRINGS[10] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Reactive/0.46.1/$.uno");
    ::STRINGS[62] = uString::Const("CheckAndThrow");
    ::STRINGS[63] = uString::Const("ThreadWorked failed");
    ::STRINGS[64] = uString::Const("Run");
    ::STRINGS[65] = uString::Const("Could not create script context");
    ::TYPES[55] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::g::Uno::Action_typeof(), NULL);
    ::TYPES[56] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::g::Uno::Exception_typeof(), NULL);
    ::TYPES[57] = ::g::Uno::Threading::ThreadStart_typeof();
    ::TYPES[58] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Platform::ApplicationState_typeof(), NULL);
    ::TYPES[4] = ::g::Uno::Action_typeof();
    ::TYPES[32] = ::g::Uno::Exception_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(0,
        ::TYPES[56/*Uno.Threading.ConcurrentQueue<Uno.Exception>*/], offsetof(::g::Fuse::Reactive::ThreadWorker, _exceptionQueue), 0,
        ::TYPES[55/*Uno.Threading.ConcurrentQueue<Uno.Action>*/], offsetof(::g::Fuse::Reactive::ThreadWorker, _queue), 0,
        ...
        uObject_typeof(), offsetof(::g::Fuse::Reactive::ThreadWorker, _terminateMutex), 0,
...
// public void Dispose() :2190
void ThreadWorker__Dispose_fn(ThreadWorker* __this)
{
    __this->Dispose();
}

// private Uno.Threading.IDispatcher Fuse.Scripting.IThreadWorker.get_Dispatcher() :2142
...
// private Fuse.Scripting.Function Fuse.Scripting.IThreadWorker.get_Observable() :2143
...
// public ThreadWorker() [instance] :2169
void ThreadWorker::ctor_()
{
    ...
    _terminateMutex = ::g::Uno::Object::New();
    _queue = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[55/*Uno.Threading.ConcurrentQueue<Uno.Action>*/]));
    _exceptionQueue = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[56/*Uno.Threading.ConcurrentQueue<Uno.Exception>*/]));
    _thread = ::g::Uno::Threading::Thread::New2(uDelegate::New(::TYPES[57/*Uno.Threading.ThreadStart*/], (void*)ThreadWorker__Run_fn, this));
    uPtr(_thread)->Start();
    uPtr(_ready)->WaitOne();
}

// public void CheckAndThrow() [instance] :2328
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[61/*"Skipped Exc...*/], next, this, ::STRINGS[10/*"/Users/hdc/...*/], 2334, ::STRINGS[62/*"CheckAndThrow"*/]);
...
// public Fuse.Scripting.Context get_Context() [instance] :2154
::g::Fuse::Scripting::Context* ThreadWorker::Context()
{
    return ThreadWorker::_context_;
}

// public void Dispose() [instance] :2190
void ThreadWorker::Dispose()
{
    uStackFrame __("Fuse.Reactive.ThreadWorker", "Dispose()");
    ::g::Fuse::Platform::Lifecycle::remove_Terminating(uDelegate::New(::TYPES[58/*Uno.Action<Fuse.Platform.ApplicationState>*/], (void*)ThreadWorker__OnTerminating_fn, this));
    ::g::Uno::Threading::Monitor::Enter(_terminateMutex);

    {
        const auto __finally_fun = [&]()
        {
            ::g::Uno::Threading::Monitor::Exit(_terminateMutex);
        };
...
// public Fuse.Reactive.FuseJS.Builtins get_FuseJS() [instance] :2157
::g::Fuse::Reactive::FuseJS::Builtins* ThreadWorker::FuseJS()
{
    return ThreadWorker::_fuseJS_;
}

// public void Invoke(Uno.Action action) [instance] :2342
...
// private void OnTerminating(Fuse.Platform.ApplicationState newState) [instance] :2185
...
// public Fuse.Reactive.ThreadWorker.Flag PostFlag() [instance] :2359
...
// private void Run() [instance] :2202
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[63/*"ThreadWorke...*/], e, this, ::STRINGS[10/*"/Users/hdc/...*/], 2210, ::STRINGS[64/*"Run"*/]);
...
// private void RunInner() [instance] :2218
void ThreadWorker::RunInner()
{
    ...
    while (true)
    {
        ...
        if (!_subscribedForClosing)
        {
            ...
            {
                ::g::Fuse::Platform::Lifecycle::add_Terminating(uDelegate::New(::TYPES[58/*Uno.Action<Fuse.Platform.ApplicationState>*/], (void*)ThreadWorker__OnTerminating_fn, this));
...
// internal static Fuse.Scripting.Context CreateContext(Fuse.Scripting.IThreadWorker worker) [static] :2145
::g::Fuse::Scripting::Context* ThreadWorker::CreateContext(uObject* worker)
{
    return ::g::Fuse::Scripting::V8::Context::New1(worker);
}

// public ThreadWorker New() [static] :2169
...
static void WhileCount_build(uType* type)
{
    ...
    ::TYPES[29] = ::g::Fuse::Scripting::Observable_typeof();
    ::TYPES[12] = uObject_typeof()->Array();
    ::TYPES[59] = ::g::Fuse::Scripting::ArrayMirror_typeof();
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IUnwrappedPlayerFeedback_typeof(), offsetof(WhileCount_type, interface4),
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(WhileCount_type, interface5),
        ::g::Fuse::Scripting::IObserver_typeof(), offsetof(WhileCount_type, interface6));
    type->SetFields(30,
...
WhileCount_type* WhileCount_typeof()
{
    ...
    type->interface6.fp_OnSet = (void(*)(uObject*, uObject*))WhileCount__FuseScriptingIObserverOnSet_fn;
    type->interface6.fp_OnFailed = (void(*)(uObject*, uString*))WhileCount__FuseScriptingIObserverOnFailed_fn;
    type->interface6.fp_OnAdd = (void(*)(uObject*, uObject*))WhileCount__FuseScriptingIObserverOnAdd_fn;
    type->interface6.fp_OnRemoveAt = (void(*)(uObject*, int*))WhileCount__FuseScriptingIObserverOnRemoveAt_fn;
    type->interface6.fp_OnNewAt = (void(*)(uObject*, int*, uObject*))WhileCount__FuseScriptingIObserverOnNewAt_fn;
    type->interface6.fp_OnInsertAt = (void(*)(uObject*, int*, uObject*))WhileCount__FuseScriptingIObserverOnInsertAt_fn;
    type->interface6.fp_OnClear = (void(*)(uObject*))WhileCount__FuseScriptingIObserverOnClear_fn;
    type->interface6.fp_OnNewAll = (void(*)(uObject*, ::g::Fuse::Scripting::ListMirror*))WhileCount__FuseScriptingIObserverOnNewAll_fn;
    type->interface5.fp_OnPlaybackDone = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn;
    type->interface5.fp_OnStable = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnStable_fn;
    type->interface4.fp_OnProgressUpdated = (void(*)(uObject*, uObject*, double*, double*, int*))::g::Fuse::Triggers::Trigger__FuseAnimationsIUnwrappedPlayerFeedbackOnProgressUpdated_fn;
    type->interface2.fp_Clear = (void(*)(uObject*))::g::Fuse::Node__UnoCollectionsICollectionFuseBindingClear_fn;
...
// protected override sealed void OnUnrooted() :2423
...
// private void UpdateState() :2465
void WhileCount__UpdateState_fn(WhileCount* __this)
{
    __this->UpdateState();
}

// public generated WhileCount() [instance] :2415
void WhileCount::ctor_6()
{
    ctor_5();
}

// private void Assess(int count) [instance] :2496
...
// public int get_EqualTo() [instance] :2577
int WhileCount::EqualTo()
{
    return _compare.X;
}

// public void set_EqualTo(int value) [instance] :2578
...
// public int get_GreaterThan() [instance] :2553
int WhileCount::GreaterThan()
{
    return _compare.X;
}

// public void set_GreaterThan(int value) [instance] :2554
...
// public int get_GreaterThanEqual() [instance] :2565
int WhileCount::GreaterThanEqual()
{
    return _compare.X;
}

// public void set_GreaterThanEqual(int value) [instance] :2566
...
// private bool IsOn(int count) [instance] :2502
...
// public object get_Items() [instance] :2440
uObject* WhileCount::Items()
{
    return _items;
}

// public void set_Items(object value) [instance] :2441
...
// public int get_LessThan() [instance] :2529
int WhileCount::LessThan()
{
    return _compare.Y;
}

// public void set_LessThan(int value) [instance] :2530
...
// public int get_LessThanEqual() [instance] :2541
int WhileCount::LessThanEqual()
{
    return _compare.Y;
}

// public void set_LessThanEqual(int value) [instance] :2542
...
// private void OnItemsChanged() [instance] :2451
...
// private void UpdateState() [instance] :2465
void WhileCount::UpdateState()
{
    ...
    ::g::Fuse::Scripting::ArrayMirror* arr = uAs< ::g::Fuse::Scripting::ArrayMirror*>(_items, ::TYPES[59/*Fuse.Scripting.ArrayMirror*/]);
...
// public generated WhileCount New() [static] :2415
...
// public sealed class WhileEmpty :2663
// {
static void WhileEmpty_build(uType* type)
{
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IUnwrappedPlayerFeedback_typeof(), offsetof(::g::Fuse::Reactive::WhileCount_type, interface4),
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Reactive::WhileCount_type, interface5),
        ::g::Fuse::Scripting::IObserver_typeof(), offsetof(::g::Fuse::Reactive::WhileCount_type, interface6));
    type->SetFields(36);
    type->Reflection.SetFunctions(1,
...
::g::Fuse::Reactive::WhileCount_type* WhileEmpty_typeof()
{
    ...
    type->interface6.fp_OnSet = (void(*)(uObject*, uObject*))::g::Fuse::Reactive::WhileCount__FuseScriptingIObserverOnSet_fn;
    type->interface6.fp_OnFailed = (void(*)(uObject*, uString*))::g::Fuse::Reactive::WhileCount__FuseScriptingIObserverOnFailed_fn;
    type->interface6.fp_OnAdd = (void(*)(uObject*, uObject*))::g::Fuse::Reactive::WhileCount__FuseScriptingIObserverOnAdd_fn;
    type->interface6.fp_OnRemoveAt = (void(*)(uObject*, int*))::g::Fuse::Reactive::WhileCount__FuseScriptingIObserverOnRemoveAt_fn;
    type->interface6.fp_OnNewAt = (void(*)(uObject*, int*, uObject*))::g::Fuse::Reactive::WhileCount__FuseScriptingIObserverOnNewAt_fn;
    type->interface6.fp_OnInsertAt = (void(*)(uObject*, int*, uObject*))::g::Fuse::Reactive::WhileCount__FuseScriptingIObserverOnInsertAt_fn;
    type->interface6.fp_OnClear = (void(*)(uObject*))::g::Fuse::Reactive::WhileCount__FuseScriptingIObserverOnClear_fn;
    type->interface6.fp_OnNewAll = (void(*)(uObject*, ::g::Fuse::Scripting::ListMirror*))::g::Fuse::Reactive::WhileCount__FuseScriptingIObserverOnNewAll_fn;
    type->interface5.fp_OnPlaybackDone = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn;
    type->interface5.fp_OnStable = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnStable_fn;
    type->interface4.fp_OnProgressUpdated = (void(*)(uObject*, uObject*, double*, double*, int*))::g::Fuse::Triggers::Trigger__FuseAnimationsIUnwrappedPlayerFeedbackOnProgressUpdated_fn;
    type->interface2.fp_Clear = (void(*)(uObject*))::g::Fuse::Node__UnoCollectionsICollectionFuseBindingClear_fn;
...
// public WhileEmpty New() [static] :2665
...
// public sealed class WhileNotEmpty :2691
// {
...
// public WhileNotEmpty New() [static] :2693
...
{
    ::TYPES[60] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[43] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[61] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
...
// public generated With() :2729
void With__ctor_5_fn(With* __this)
{
    __this->ctor_5();
}

// public object get_Data() :2741
void With__get_Data_fn(With* __this, uObject** __retval)
{
    *__retval = __this->Data();
}

// public void set_Data(object value) :2742
void With__set_Data_fn(With* __this, uObject* value)
{
    __this->Data(value);
}

// protected internal override sealed void GetImplicitDataForChild(Fuse.Node child, Uno.Collections.List<object> result) :2758
...
// public generated With New() :2729
void With__New2_fn(With** __retval)
{
    *__retval = With::New2();
}

// private void OnChanged() :2752
void With__OnChanged_fn(With* __this)
{
    __this->OnChanged();
}

// protected override sealed void OnRooted() :2731
...
// public generated With() [instance] :2729
void With::ctor_5()
{
    ctor_4();
}

// public object get_Data() [instance] :2741
uObject* With::Data()
{
    return _data;
}

// public void set_Data(object value) [instance] :2742
...
// private void OnChanged() [instance] :2752
void With::OnChanged()
{
    uStackFrame __("Fuse.Reactive.With", "OnChanged()");
    ::g::Fuse::Node* ret3;

    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Nodes()), ::TYPES[60/*Uno.Collections.IEnumerable<Fuse.Node>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[43/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Node* n = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[61/*Uno.Collections.IEnumerator<Fuse.Node>*/]), &ret3), ret3);
        uPtr(n)->OnDataContextChanged();
    }
}

// public generated With New() [static] :2729
With* With::New2()
{
...
// public sealed class WriteClearDataBinding<T> :485
// {
...
// public WriteClearDataBinding(Uno.UX.Property<T> target, string key) :488
void WriteClearDataBinding__ctor_4_fn(WriteClearDataBinding* __this, ::g::Uno::UX::Property1* target, uString* key)
{
    __this->ctor_4(target, key);
}

// protected internal override sealed bool get_Clear() :489
void WriteClearDataBinding__get_Clear_fn(WriteClearDataBinding* __this, bool* __retval)
{
    return *__retval = true, void();
}

// public WriteClearDataBinding New(Uno.UX.Property<T> target, string key) :488
...
// public WriteClearDataBinding(Uno.UX.Property<T> target, string key) [instance] :488
void WriteClearDataBinding::ctor_4(::g::Uno::UX::Property1* target, uString* key)
{
    ctor_3(target, key);
}

// public WriteClearDataBinding New(Uno.UX.Property<T> target, string key) [static] :488
...
// public class WriteDataBinding<T> :476
// {
...
// public WriteDataBinding(Uno.UX.Property<T> target, string key) :479
void WriteDataBinding__ctor_3_fn(WriteDataBinding* __this, ::g::Uno::UX::Property1* target, uString* key)
{
    __this->ctor_3(target, key);
}

// public WriteDataBinding New(Uno.UX.Property<T> target, string key) :479
...
// protected internal override sealed bool get_Read() :480
void WriteDataBinding__get_Read_fn(WriteDataBinding* __this, bool* __retval)
{
    return *__retval = false, void();
}

// public WriteDataBinding(Uno.UX.Property<T> target, string key) [instance] :479
...
// public WriteDataBinding New(Uno.UX.Property<T> target, string key) [static] :479

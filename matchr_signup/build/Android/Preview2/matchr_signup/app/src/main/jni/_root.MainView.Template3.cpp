...
{
    MainView__Template3::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"mainpage"*/]);
}

static void MainView__Template3_build(uType* type)
{
    ::STRINGS[0] = uString::Const("mainpage");
    type->SetFields(2,
...
void MainView__Template3__New1_fn(MainView__Template3* __this, uObject** __retval)
{
    ...
    ::g::MainPage* self = ::g::MainPage::New5(uPtr(__this->__parent1)->router);
...
{
    ctor_(::STRINGS[0/*"mainpage"*/], false);
    __parent1 = parent;

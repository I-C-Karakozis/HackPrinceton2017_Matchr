...
// /Users/hdc/Library/Application Support/Fusetools/Packages/UnoCore/0.46.1/source/uno/runtime/implementation/shaderbackends/opengl/$.uno
// --------------------------------------------------------------------------------------------------------------------------------------
...
void GLDrawCall::Sampler1(int index, int target, uint32_t handle, ::g::Uno::Graphics::SamplerState state, bool isMipmap, bool isPow2)
{
    ...
    if (isPow2 || ::g::Uno::Graphics::Texture2D::HaveNonPow2Support())
    {

...
#include <Fuse.Scripting.Observable.Failed.h>
...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Scripting/0.46.1/$.uno
// -------------------------------------------------------------------------------------
...
// /Users/hdc/Library/Application Support/Fusetools/Packages/FuseCore/0.46.1/scripting/$.uno
// -----------------------------------------------------------------------------------------
...
// public Add(Fuse.Scripting.Observable obs, object value) :1943
...
// public Add New(Fuse.Scripting.Observable obs, object value) :1943
...
// protected override sealed void OnPerform(Uno.Collections.IList<Fuse.Scripting.Observable.Subscription> sub) :1948
...
// public Add(Fuse.Scripting.Observable obs, object value) [instance] :1943
...
// public Add New(Fuse.Scripting.Observable obs, object value) [static] :1943
...
// public abstract class Array :2508
// {
...
// protected generated Array() :2508
void Array__ctor__fn(Array* __this)
{
    __this->ctor_();
}

// public override sealed bool Equals(object o) :2515
...
// public override int GetHashCode() :2521
...
// protected generated Array() [instance] :2508
void Array::ctor_()
{
}
// }
...
// public sealed class BoolChangedArgs :810
// {
...
// public BoolChangedArgs(bool value) :812
void BoolChangedArgs__ctor_2_fn(BoolChangedArgs* __this, bool* value)
{
    __this->ctor_2(*value);
}

// private void Fuse.Scripting.IScriptEvent.Serialize(Fuse.Scripting.IEventSerializer s) :816
...
// public delegate object Callback(object[] args) :2625
...
// private sealed class ScriptMethod<T>.CallClosure :2349
// {
...
// public CallClosure(Uno.Action<Fuse.Scripting.Context, T, object[]> method, Fuse.Scripting.Context c, object obj, object[] args) :2356
...
// public CallClosure New(Uno.Action<Fuse.Scripting.Context, T, object[]> method, Fuse.Scripting.Context c, object obj, object[] args) :2356
...
// public void Run() :2364
void ScriptMethod1__CallClosure__Run_fn(ScriptMethod1__CallClosure* __this)
{
    __this->Run();
}

// public CallClosure(Uno.Action<Fuse.Scripting.Context, T, object[]> method, Fuse.Scripting.Context c, object obj, object[] args) [instance] :2356
...
// public CallClosure New(Uno.Action<Fuse.Scripting.Context, T, object[]> method, Fuse.Scripting.Context c, object obj, object[] args) [static] :2356
...
// private sealed class Observable.Clear :1834
// {
...
// public Clear(Fuse.Scripting.Observable obs, int origin) :1838
...
// public Clear New(Fuse.Scripting.Observable obs, int origin) :1838
...
// protected override sealed void OnPerform(Uno.Collections.IList<Fuse.Scripting.Observable.Subscription> sub) :1843
...
// public Clear(Fuse.Scripting.Observable obs, int origin) [instance] :1838
...
// public Clear New(Fuse.Scripting.Observable obs, int origin) [static] :1838
...
static void Context_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/FuseCore/0.46.1/scripting/$.uno");
    ...
    type->SetFields(0,
        ...
        ::TYPES[22/*Fuse.Scripting.Function*/], offsetof(::g::Fuse::Scripting::Context, _newError), 0,
    ...
    type->Reflection.SetFunctions(21,
        new uFunction("CallbackToFunction", NULL, (void*)Context__CallbackToFunction_fn, 0, false, ::TYPES[22/*Fuse.Scripting.Function*/], 1, ::g::Fuse::Scripting::Callback_typeof()),
        new uFunction("get_Dispatcher", NULL, (void*)Context__get_Dispatcher_fn, 0, false, ::TYPES[5/*Uno.Threading.IDispatcher*/], 0),
        new uFunction("Dispose", NULL, NULL, offsetof(Context_type, fp_Dispose), false, uVoid_typeof(), 0),
        new uFunction("Evaluate", NULL, NULL, offsetof(Context_type, fp_Evaluate), false, uObject_typeof(), 2, ::TYPES[31/*string*/], ::TYPES[31/*string*/]),
        new uFunction("get_GlobalObject", NULL, NULL, offsetof(Context_type, fp_get_GlobalObject), false, ::TYPES[12/*Fuse.Scripting.Object*/], 0),
        new uFunction("Invoke", NULL, (void*)Context__Invoke_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Action_typeof()),
        new uFunction("NewArray", NULL, (void*)Context__NewArray_fn, 0, false, ::TYPES[23/*Fuse.Scripting.Array*/], 1, ::TYPES[7/*object[]*/]),
        new uFunction("NewError", NULL, (void*)Context__NewError_fn, 0, false, ::TYPES[12/*Fuse.Scripting.Object*/], 1, ::TYPES[7/*object[]*/]),
        new uFunction("NewObject", NULL, (void*)Context__NewObject_fn, 0, false, ::TYPES[12/*Fuse.Scripting.Object*/], 0),
        new uFunction("ObjectCreate", NULL, (void*)Context__ObjectCreate_fn, 0, false, ::TYPES[12/*Fuse.Scripting.Object*/], 1, ::TYPES[7/*object[]*/]),
        new uFunction("ObjectDefineProperty", NULL, (void*)Context__ObjectDefineProperty_fn, 0, false, uVoid_typeof(), 6, ::TYPES[12/*Fuse.Scripting.Object*/], ::TYPES[31/*string*/], ::g::Fuse::Scripting::Callback_typeof(), ::g::Fuse::Scripting::Callback_typeof(), ::g::Uno::Bool_typeof(), ::g::Uno::Bool_typeof()),
        new uFunction("ObjectDefineProperty", NULL, (void*)Context__ObjectDefineProperty1_fn, 0, false, uVoid_typeof(), 5, ::TYPES[12/*Fuse.Scripting.Object*/], ::TYPES[31/*string*/], uObject_typeof(), ::g::Uno::Bool_typeof(), ::g::Uno::Bool_typeof()),
        new uFunction("get_Observable", NULL, (void*)Context__get_Observable_fn, 0, false, ::TYPES[22/*Fuse.Scripting.Function*/], 0),
        new uFunction("ParseJson", NULL, (void*)Context__ParseJson_fn, 0, false, uObject_typeof(), 1, ::TYPES[31/*string*/]),
        ...
        new uFunction("get_ThreadWorker", NULL, (void*)Context__get_ThreadWorker_fn, 0, false, ::TYPES[26/*Fuse.Scripting.IThreadWorker*/], 0),
        new uFunction("TryGetGlobalModuleResult", NULL, (void*)Context__TryGetGlobalModuleResult_fn, 0, false, ::g::Fuse::Scripting::ModuleResult_typeof(), 1, ::TYPES[31/*string*/]),
...
::g::Fuse::Scripting::ValueMirror* Context::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[6/*"JavaScript ...*/], this, ::STRINGS[7/*"/Users/hdc/...*/], 228, ::STRINGS[8/*"CreateMirror"*/]);
        return NULL;
    }
...
::g::Fuse::Scripting::Object* Context::NewError(uArray* args)
{
    ...
    _newError = uAs< ::g::Fuse::Scripting::Function*>(uPtr(GlobalObject())->Item(::STRINGS[12/*"Error"*/]), ::TYPES[22/*Fuse.Scripting.Function*/]);
...
::g::Fuse::Scripting::Object* Context::NewObject()
{
    ...
    if (_newObject == NULL)
        _newObject = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[4/*"(Context)"*/], ::STRINGS[13/*"(function()...*/]), ::TYPES[22/*Fuse.Scripting.Function*/]);
...
::g::Fuse::Scripting::Object* Context::ObjectCreate(uArray* args)
{
    ...
    ::g::Fuse::Scripting::Function* objectCreate = uAs< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[4/*"(Context)"*/], ::STRINGS[14/*"Object.create"*/]), ::TYPES[22/*Fuse.Scripting.Function*/]);
...
void Context::ObjectDefineProperty(::g::Fuse::Scripting::Object* obj, uString* name, uDelegate* getProperty, uDelegate* setProperty, bool enumerable, bool configurable)
{
    ...
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(Evaluate(name, ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[15/*"(function(o...*/], ::g::Uno::Delegate::op_Inequality(setProperty, NULL) ? ::STRINGS[16/*" set: setCa...*/] : ::STRINGS[17/*""*/]), ::STRINGS[18/*" enumerable...*/])), ::TYPES[22/*Fuse.Scripting.Function*/]);
    uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[7/*object[]*/], 6, obj, name, getProperty, setProperty, uBox(::TYPES[58/*bool*/], enumerable), uBox(::TYPES[58/*bool*/], configurable)));
}
...
void Context::ObjectDefineProperty1(::g::Fuse::Scripting::Object* obj, uString* name, uObject* value, bool enumerable, bool configurable)
{
    ...
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(Evaluate(name, ::STRINGS[19/*"(function(o...*/]), ::TYPES[22/*Fuse.Scripting.Function*/]);
    uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[7/*object[]*/], 5, obj, name, value, uBox(::TYPES[58/*bool*/], enumerable), uBox(::TYPES[58/*bool*/], configurable)));
}
...
uObject* Context::ParseJson(uString* json)
{
    ...
    if (_parseJson == NULL)
        _parseJson = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[4/*"(Context)"*/], ::STRINGS[20/*"JSON.parse"*/]), ::TYPES[22/*Fuse.Scripting.Function*/]);
...
uObject* Context::Reflect(uObject* obj)
{
    ...
    if (sobj != NULL)
    {
        ...
        {
            ::g::Fuse::Scripting::External* ext = uAs< ::g::Fuse::Scripting::External*>(uPtr(sobj)->Item(::STRINGS[21/*"external_ob...*/]), ::TYPES[27/*Fuse.Scripting.External*/]);
...
::g::Fuse::Scripting::Function* Context::RegisterClass(::g::Fuse::Scripting::ScriptClass* sc)
{
    ...
    ::g::Fuse::Scripting::Function* cl = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::g::Uno::String::op_Addition2(::g::Uno::Type::FullName(uPtr(uPtr(sc)->Type())), ::STRINGS[22/*" (ScriptCla...*/]), ::STRINGS[23/*"(function(e...*/]), ::TYPES[22/*Fuse.Scripting.Function*/]);
    ...
    if (sc->SuperType() != NULL)
    {
        ...
        if (_setSuperclass == NULL)
            _setSuperclass = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[24/*"(set-superc...*/], ::STRINGS[25/*"(function(c...*/]), ::TYPES[22/*Fuse.Scripting.Function*/]);
...
// private Fuse.Scripting.Array ToArray(float2 v) [instance] :686
::g::Fuse::Scripting::Array* Context::ToArray(::g::Uno::Float2 v)
{
    uStackFrame __("Fuse.Scripting.Context", "ToArray(float2)");
    return NewArray(uArray::Init<uObject*>(::TYPES[7/*object[]*/], 2, uBox(::TYPES[57/*double*/], (double)v.X), uBox(::TYPES[57/*double*/], (double)v.Y)));
}

// private Fuse.Scripting.Array ToArray(float3 v) [instance] :691
::g::Fuse::Scripting::Array* Context::ToArray1(::g::Uno::Float3 v)
{
    uStackFrame __("Fuse.Scripting.Context", "ToArray(float3)");
    return NewArray(uArray::Init<uObject*>(::TYPES[7/*object[]*/], 3, uBox(::TYPES[57/*double*/], (double)v.X), uBox(::TYPES[57/*double*/], (double)v.Y), uBox(::TYPES[57/*double*/], (double)v.Z)));
}

// private Fuse.Scripting.Array ToArray(float4 v) [instance] :696
::g::Fuse::Scripting::Array* Context::ToArray2(::g::Uno::Float4 v)
{
    uStackFrame __("Fuse.Scripting.Context", "ToArray(float4)");
    return NewArray(uArray::Init<uObject*>(::TYPES[7/*object[]*/], 4, uBox(::TYPES[57/*double*/], (double)v.X), uBox(::TYPES[57/*double*/], (double)v.Y), uBox(::TYPES[57/*double*/], (double)v.Z), uBox(::TYPES[57/*double*/], (double)v.W)));
}

// private Fuse.Scripting.Array ToArray(int2 v) [instance] :701
...
// private Fuse.Scripting.Array ToArray(int3 v) [instance] :706
...
// private Fuse.Scripting.Array ToArray(int4 v) [instance] :711
...
// public object Unwrap(object dc) [instance] :669
...
// public static object Wrap(object obj) [static] :648
uObject* Context::Wrap(uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[38/*float*/]))
        return uBox(::TYPES[57/*double*/], (double)uUnbox<float>(::TYPES[38/*float*/], obj));

    if (uIs(obj, ::TYPES[39/*int*/]))
        return uBox(::TYPES[57/*double*/], (double)uUnbox<int>(::TYPES[39/*int*/], obj));

    if (uIs(obj, ::TYPES[40/*uint*/]))
        return uBox(::TYPES[57/*double*/], (double)uUnbox<uint32_t>(::TYPES[40/*uint*/], obj));
...
uObject* NativePromise__ContextClosure::CreatePromise(uArray* args)
{
    ...
    ::g::Fuse::Scripting::Function* promise = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(_c)->GlobalObject())->Item(::STRINGS[31/*"Promise"*/]), ::TYPES[22/*Fuse.Scripting.Function*/]);
...
// public sealed class DoubleChangedArgs :798
// {
...
// public DoubleChangedArgs(double value) :800
...
void DoubleChangedArgs__FuseScriptingIScriptEventSerialize_fn(DoubleChangedArgs* __this, uObject* s)
{
    ...
    double ret2;
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(uPtr(s), ::TYPES[9/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[2/*"value"*/], (::g::Uno::UX::ValueChangedArgs__get_Value_fn(__this, &ret2), ret2));
}

// public DoubleChangedArgs New(double value) :800
void DoubleChangedArgs__New3_fn(double* value, DoubleChangedArgs** __retval)
{
    *__retval = DoubleChangedArgs::New3(*value);
}

// public DoubleChangedArgs(double value) [instance] :800
void DoubleChangedArgs::ctor_2(double value)
{
    ::g::Uno::UX::ValueChangedArgs__ctor_1_fn(this, uCRef(value));
}

// public DoubleChangedArgs New(double value) [static] :800
...
// public enum ExecutionThread :2241
...
// public sealed class External :2600
// {
...
// public External(object o) :2604
void External__ctor__fn(External* __this, uObject* o)
{
    __this->ctor_(o);
}

// public override sealed bool Equals(object o) :2609
...
// public override sealed int GetHashCode() :2615
...
// public External New(object o) :2604
void External__New1_fn(uObject* o, External** __retval)
{
    *__retval = External::New1(o);
}

// public External(object o) [instance] :2604
void External::ctor_(uObject* o)
{
    Object = o;
}

// public External New(object o) [static] :2604
...
// private sealed class Observable.Failed :1856
// {
static void Observable__Failed_build(uType* type)
{
    ...
    ::TYPES[4] = ::g::Fuse::Scripting::IObserver_typeof();
    type->SetFields(2,
        ::g::Uno::String_typeof(), offsetof(::g::Fuse::Scripting::Observable__Failed, _message), 0);
}
...
// public Failed(Fuse.Scripting.Observable obs, string message) :1860
...
// public Failed New(Fuse.Scripting.Observable obs, string message) :1860
...
// protected override sealed void OnPerform(Uno.Collections.IList<Fuse.Scripting.Observable.Subscription> sub) :1865
void Observable__Failed__OnPerform_fn(Observable__Failed* __this, uObject* sub)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(sub), ::TYPES[2/*Uno.Collections.ICollection<Fuse.Scripting.Observable.Subscription>*/])); ++i)
        if (uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(sub), ::TYPES[3/*Uno.Collections.IList<Fuse.Scripting.Observable.Subscription>*/]), uCRef<int>(i), &ret2), ret2))->ShouldSend(-1))
            ::g::Fuse::Scripting::IObserver::OnFailed(uInterface(uPtr(uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(sub), ::TYPES[3/*Uno.Collections.IList<Fuse.Scripting.Observable.Subscription>*/]), uCRef<int>(i), &ret3), ret3))->Observer()), ::TYPES[4/*Fuse.Scripting.IObserver*/]), __this->_message);
}

// public Failed(Fuse.Scripting.Observable obs, string message) [instance] :1860
...
// public Failed New(Fuse.Scripting.Observable obs, string message) [static] :1860
...
// internal sealed class FileSourceConverter :971
// {
...
// public generated FileSourceConverter() [instance] :971
void FileSourceConverter::ctor_()
{
}

// public bool CanConvert(Uno.Type t) [instance] :973
...
// public object TryConvert(Uno.Type t, object obj) [instance] :974
uObject* FileSourceConverter::TryConvert(uType* t, uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[31/*string*/]))
    {
        ...
        return ::g::Fuse::Scripting::JSFileSource::New1(uAs<uString*>(::g::Fuse::Scripting::IObject::Item(uInterface(uPtr((uObject*)obj), ::TYPES[48/*Fuse.Scripting.IObject*/]), ::STRINGS[37/*"path"*/]), ::TYPES[31/*string*/]));

    return NULL;
}

// public generated FileSourceConverter New() [static] :971
...
// private sealed class JSCallback.FuncClosure<TArg, TArg1, TResult> :1215
// {
...
// public FuncClosure(Uno.Func<TArg, TArg1, TResult> method) :1219
void JSCallback__FuncClosure2__ctor__fn(JSCallback__FuncClosure2* __this, uDelegate* method)
{
    __this->ctor_(method);
}

// public FuncClosure New(Uno.Func<TArg, TArg1, TResult> method) :1219
...
// public FuncClosure New(Uno.Func<TArg, TArg1, TResult> method) [static] :1219
...
// public abstract class Function :2557
// {
...
// protected generated Function() :2557
void Function__ctor__fn(Function* __this)
{
    __this->ctor_();
}

// public override sealed bool Equals(object o) :2563
...
// public override int GetHashCode() :2569
...
// protected generated Function() [instance] :2557
void Function::ctor_()
{
}
// }
...
// public abstract interface Marshal.IConverter :1164
// {
...
// public abstract interface IEventSerializer :751
// {
...
// private sealed class Observable.InsertAll :2038
// {
...
// public InsertAll(Fuse.Scripting.Observable obs, int index, Fuse.Scripting.ArrayMirror items) :2043
...
// public InsertAll New(Fuse.Scripting.Observable obs, int index, Fuse.Scripting.ArrayMirror items) :2043
...
// protected override sealed void OnPerform(Uno.Collections.IList<Fuse.Scripting.Observable.Subscription> sub) :2054
...
// protected override sealed void Unsubscribe() :2049
...
// public InsertAll(Fuse.Scripting.Observable obs, int index, Fuse.Scripting.ArrayMirror items) [instance] :2043
...
// public InsertAll New(Fuse.Scripting.Observable obs, int index, Fuse.Scripting.ArrayMirror items) [static] :2043
...
// private sealed class Observable.InsertAt :2010
// {
...
// public InsertAt(Fuse.Scripting.Observable obs, int index, object value) :2015
...
// public InsertAt New(Fuse.Scripting.Observable obs, int index, object value) :2015
...
// protected override sealed void OnPerform(Uno.Collections.IList<Fuse.Scripting.Observable.Subscription> sub) :2026
...
// protected override sealed void Unsubscribe() :2021
...
// public InsertAt(Fuse.Scripting.Observable obs, int index, object value) [instance] :2015
...
// public InsertAt New(Fuse.Scripting.Observable obs, int index, object value) [static] :2015
...
// public abstract interface IScriptObject :761
// {
...
static void JSCallback_build(uType* type)
{
    ...
    ::TYPES[53] = JSCallback__FuncClosure2_typeof();
    ::TYPES[54] = JSCallback__NumberConverter_typeof();
    ...
    type->MethodTypes[4]->SetPrecalc(
        ::TYPES[53/*Fuse.Scripting.JSCallback.FuncClosure`3*/]->MakeType(type->MethodTypes[4]->U(0), type->MethodTypes[4]->U(1), type->MethodTypes[4]->U(2), NULL));
    type->MethodTypes[5]->SetPrecalc(
        ::TYPES[54/*Fuse.Scripting.JSCallback.NumberConverter*/]->MakeMethod(1/*TryConvert<T>*/, type->MethodTypes[5]->U(0), NULL));
    type->Reflection.SetFunctions(6,
        new uFunction("FromAction", NULL, (void*)JSCallback__FromAction_fn, 0, true, ::TYPES[42/*Fuse.Scripting.Callback*/], 1, ::g::Uno::Action_typeof()),
        new uFunction("FromAction`1", type->MethodTypes[0], (void*)JSCallback__FromAction1_fn, 0, true, ::TYPES[42/*Fuse.Scripting.Callback*/], 1, ::g::Uno::Action1_typeof()->MakeType(type->MethodTypes[0]->U(0), NULL)),
        new uFunction("FromAction`2", type->MethodTypes[1], (void*)JSCallback__FromAction2_fn, 0, true, ::TYPES[42/*Fuse.Scripting.Callback*/], 1, ::g::Uno::Action2_typeof()->MakeType(type->MethodTypes[1]->U(0), type->MethodTypes[1]->U(1), NULL)),
        new uFunction("FromFunc`1", type->MethodTypes[2], (void*)JSCallback__FromFunc_fn, 0, true, ::TYPES[42/*Fuse.Scripting.Callback*/], 1, ::g::Uno::Func_typeof()->MakeType(type->MethodTypes[2]->U(0), NULL)),
        new uFunction("FromFunc`2", type->MethodTypes[3], (void*)JSCallback__FromFunc1_fn, 0, true, ::TYPES[42/*Fuse.Scripting.Callback*/], 1, ::g::Uno::Func1_typeof()->MakeType(type->MethodTypes[3]->U(0), type->MethodTypes[3]->U(1), NULL)),
        new uFunction("FromFunc`3", type->MethodTypes[4], (void*)JSCallback__FromFunc2_fn, 0, true, ::TYPES[42/*Fuse.Scripting.Callback*/], 1, ::g::Uno::Func2_typeof()->MakeType(type->MethodTypes[4]->U(0), type->MethodTypes[4]->U(1), type->MethodTypes[4]->U(2), NULL)));
}
...
// public static Fuse.Scripting.Callback FromFunc<T1, T2, TResult>(Uno.Func<T1, T2, TResult> func) :1115
...
// public static Fuse.Scripting.Callback FromFunc<T1, T2, TResult>(Uno.Func<T1, T2, TResult> func) [static] :1115
uDelegate* JSCallback::FromFunc2(uType* __type, uDelegate* func)
{
    ...
    return uDelegate::New(::TYPES[42/*Fuse.Scripting.Callback*/], (void*)JSCallback__FuncClosure2__Run_fn, (JSCallback__FuncClosure2*)JSCallback__FuncClosure2::New1(__types[0], func));
}
// }
...
// internal sealed class JSFileSource :994
// {
...
// public JSFileSource(string path) [instance] :998
...
// public JSFileSource New(string path) [static] :998
...
// public static class JSObjectUtils :1327
// {
static void JSObjectUtils_build(uType* type)
{
    ...
    ::TYPES[22] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[7] = uObject_typeof()->Array();
    ::TYPES[55] = ::g::Fuse::Scripting::Marshal_typeof();
    type->MethodTypes[0]->SetPrecalc(
        ::TYPES[55/*Fuse.Scripting.Marshal*/]->MakeMethod(0/*ToType<T>*/, type->MethodTypes[0]->U(0), NULL));
    type->MethodTypes[1]->SetPrecalc(
        ::TYPES[55/*Fuse.Scripting.Marshal*/]->MakeMethod(0/*ToType<T>*/, type->MethodTypes[1]->U(0), NULL));
    type->MethodTypes[2]->SetPrecalc(
        ::TYPES[55/*Fuse.Scripting.Marshal*/]->MakeMethod(0/*ToType<T>*/, type->MethodTypes[2]->U(0), NULL));
    type->MethodTypes[3]->SetPrecalc(
        ::TYPES[55/*Fuse.Scripting.Marshal*/]->MakeMethod(0/*ToType<T>*/, type->MethodTypes[3]->U(0), NULL));
    type->Reflection.SetFunctions(5,
        ...
        new uFunction("Value`1", type->MethodTypes[1], (void*)JSObjectUtils__Value1_fn, 0, true, type->MethodTypes[1]->U(0), 2, ::TYPES[7/*object[]*/], ::g::Uno::Int_typeof()),
        ...
        new uFunction("ValueOrDefault`1", type->MethodTypes[3], (void*)JSObjectUtils__ValueOrDefault1_fn, 0, true, type->MethodTypes[3]->U(0), 3, ::TYPES[7/*object[]*/], ::g::Uno::Int_typeof(), type->MethodTypes[3]->U(0)));
}
...
// public static void Freeze(Fuse.Scripting.Object ob, Fuse.Scripting.Context c) :1354
void JSObjectUtils__Freeze_fn(::g::Fuse::Scripting::Object* ob, ::g::Fuse::Scripting::Context* c)
{
    JSObjectUtils::Freeze(ob, c);
}

// public static T Value<T>(Fuse.Scripting.Object obj, string name) :1342
...
// public static T Value<T>(object[] args, int index) :1349
...
// public static T ValueOrDefault<T>(Fuse.Scripting.Object obj, string name, T defaultValue) :1329
...
// public static T ValueOrDefault<T>(object[] args, int index, [T defaultValue]) :1336
...
// public static void Freeze(Fuse.Scripting.Object ob, Fuse.Scripting.Context c) [static] :1354
void JSObjectUtils::Freeze(::g::Fuse::Scripting::Object* ob, ::g::Fuse::Scripting::Context* c)
{
    ...
    ::g::Fuse::Scripting::Function* freeze = uCast< ::g::Fuse::Scripting::Function*>(uPtr(c)->Evaluate(::STRINGS[38/*"(Object Fre...*/], ::STRINGS[39/*"Object.freeze"*/]), ::TYPES[22/*Fuse.Scripting.Function*/]);
    uPtr(freeze)->Call(uArray::Init<uObject*>(::TYPES[7/*object[]*/], 1, ob));
}
// }
...
static void Json_build(uType* type)
{
    ...
    ::TYPES[56] = ::g::Uno::Collections::HashSet_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[31] = ::g::Uno::String_typeof();
    ::TYPES[57] = ::g::Uno::Double_typeof();
    ::TYPES[38] = ::g::Uno::Float_typeof();
    ::TYPES[39] = ::g::Uno::Int_typeof();
    ::TYPES[58] = ::g::Uno::Bool_typeof();
    ::TYPES[12] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[59] = ::TYPES[31/*string*/]->Array();
    ::TYPES[60] = ::g::Uno::Array_typeof()->MakeMethod(1/*Copy<string>*/, ::TYPES[31/*string*/], NULL);
    ::TYPES[61] = ::g::Uno::Array_typeof()->MakeMethod(3/*Sort<string>*/, ::TYPES[31/*string*/], NULL);
    ::TYPES[62] = ::g::Uno::Comparison_typeof()->MakeType(::TYPES[31/*string*/], NULL);
    ::TYPES[23] = ::g::Fuse::Scripting::Array_typeof();
    type->Reflection.SetFunctions(7,
        new uFunction("Escape", NULL, (void*)Json__Escape_fn, 0, true, ::TYPES[31/*string*/], 1, ::TYPES[31/*string*/]),
        new uFunction("Escape", NULL, (void*)Json__Escape1_fn, 0, true, uVoid_typeof(), 2, ::TYPES[31/*string*/], ::g::Uno::Text::StringBuilder_typeof()),
        new uFunction("Stringify", NULL, (void*)Json__Stringify_fn, 0, true, ::TYPES[31/*string*/], 2, uObject_typeof(), ::TYPES[58/*bool*/]),
        new uFunction("ToLiteral", NULL, (void*)Json__ToLiteral_fn, 0, true, ::TYPES[31/*string*/], 1, ::TYPES[58/*bool*/]),
        new uFunction("ToLiteral", NULL, (void*)Json__ToLiteral1_fn, 0, true, ::TYPES[31/*string*/], 1, ::TYPES[57/*double*/]),
        new uFunction("ToLiteral", NULL, (void*)Json__ToLiteral2_fn, 0, true, ::TYPES[31/*string*/], 1, ::TYPES[31/*string*/]),
        new uFunction("ToLiteral", NULL, (void*)Json__ToLiteral3_fn, 0, true, uVoid_typeof(), 2, ::TYPES[31/*string*/], ::g::Uno::Text::StringBuilder_typeof()));
}
...
// public static string Escape(string s) :896
void Json__Escape_fn(uString* s, uString** __retval)
{
    *__retval = Json::Escape(s);
}

// public static void Escape(string s, Uno.Text.StringBuilder sb) :905
void Json__Escape1_fn(uString* s, ::g::Uno::Text::StringBuilder* sb)
{
    Json::Escape1(s, sb);
}

// public static string Stringify(object value, [bool normalized]) :837
void Json__Stringify_fn(uObject* value, bool* normalized, uString** __retval)
{
    *__retval = Json::Stringify(value, *normalized);
}

// private static void Stringify(object value, bool normalized, Uno.Text.StringBuilder sb, Uno.Collections.HashSet<object> visitedSet) :844
...
// public static void Escape(string s, Uno.Text.StringBuilder sb) [static] :905
...
// public static string Stringify(object value, [bool normalized]) [static] :837
uString* Json::Stringify(uObject* value, bool normalized)
{
    uStackFrame __("Fuse.Scripting.Json", "Stringify(object,[bool])");
    ::g::Uno::Text::StringBuilder* sb = ::g::Uno::Text::StringBuilder::New1();
    Json::Stringify1(value, normalized, sb, (::g::Uno::Collections::HashSet*)::g::Uno::Collections::HashSet::New1(::TYPES[56/*Uno.Collections.HashSet<object>*/]));
    return sb->ToString();
}

// private static void Stringify(object value, bool normalized, Uno.Text.StringBuilder sb, Uno.Collections.HashSet<object> visitedSet) [static] :844
void Json::Stringify1(uObject* value, bool normalized, ::g::Uno::Text::StringBuilder* sb, ::g::Uno::Collections::HashSet* visitedSet)
{
    ...
    else if (uIs(value, ::TYPES[57/*double*/]))
        uPtr(sb)->Append2(Json::ToLiteral1(uUnbox<double>(::TYPES[57/*double*/], value)));
    ...
    else if (uIs(value, ::TYPES[58/*bool*/]))
        uPtr(sb)->Append2(Json::ToLiteral(uUnbox<bool>(::TYPES[58/*bool*/], value)));
    else if (uIs(value, ::TYPES[12/*Fuse.Scripting.Object*/]))
    {
        ...
        uArray* keys = uArray::New(::TYPES[59/*string[]*/], uPtr(uPtr(obj)->Keys())->Length());
        ::g::Uno::Array::Copy1(::TYPES[60/*Uno.Array.Copy<string>*/], obj->Keys(), keys, uPtr(obj->Keys())->Length());

        if (normalized)
            ::g::Uno::Array::Sort1(::TYPES[61/*Uno.Array.Sort<string>*/], keys, uDelegate::New(::TYPES[62/*Uno.Comparison<string>*/], (void*)::g::Uno::String__Compare_fn));
...
// public static string ToLiteral(bool b) [static] :953
...
// public static string ToLiteral(double s) [static] :946
uString* Json::ToLiteral1(double s)
{
    ...
    return ::g::Uno::Double::ToString(s, ::TYPES[57/*double*/]);
}

// public static string ToLiteral(string s) [static] :932
...
// public static void ToLiteral(string s, Uno.Text.StringBuilder sb) [static] :938
...
// internal sealed class LazyObservableProperty :2081
// {
static void LazyObservableProperty_build(uType* type)
{
    ::TYPES[63] = ::g::Uno::UX::Selector_typeof();
    ::TYPES[42] = ::g::Fuse::Scripting::Callback_typeof();
    type->SetInterfaces(
...
// public LazyObservableProperty(Fuse.Scripting.Context c, Fuse.Scripting.Object obj, Uno.UX.Property p) :2083
...
// private object Get(object[] args) :2088
void LazyObservableProperty__Get_fn(LazyObservableProperty* __this, uArray* args, uObject** __retval)
{
    *__retval = __this->Get(args);
}

// public LazyObservableProperty New(Fuse.Scripting.Context c, Fuse.Scripting.Object obj, Uno.UX.Property p) :2083
...
// public LazyObservableProperty(Fuse.Scripting.Context c, Fuse.Scripting.Object obj, Uno.UX.Property p) [instance] :2083
void LazyObservableProperty::ctor_1(::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::Object* obj, ::g::Uno::UX::Property* p)
{
    ...
    ctor_(c, obj, p);
    uPtr(c)->ObjectDefineProperty(obj, uPtr(p)->Name().ToString(::TYPES[63/*Uno.UX.Selector*/]), uDelegate::New(::TYPES[42/*Fuse.Scripting.Callback*/], (void*)LazyObservableProperty__Get_fn, this), NULL, false, false);
}

// private object Get(object[] args) [instance] :2088
...
// public LazyObservableProperty New(Fuse.Scripting.Context c, Fuse.Scripting.Object obj, Uno.UX.Property p) [static] :2083
...
// public abstract class ListMirror :2663
// {
...
// protected ListMirror(object raw) :2668
void ListMirror__ctor_1_fn(ListMirror* __this, uObject* raw)
{
    __this->ctor_1(raw);
}

// protected ListMirror(object raw) [instance] :2668
...
// public static class Marshal :1009
// {
// static Marshal() :1011
static void Marshal__cctor__fn(uType* __type)
{
    Marshal::_converters_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[64/*Uno.Collections.List<Fuse.Scripting.Marshal.IConverter>*/]));
...
static void Marshal_build(uType* type)
{
    ...
    ::TYPES[64] = ::g::Uno::Collections::List_typeof()->MakeType(Marshal__IConverter_typeof(), NULL);
    ::TYPES[65] = Marshal__IConverter_typeof();
    ::TYPES[1] = ::g::Uno::Type_typeof();
    ::TYPES[58] = ::g::Uno::Bool_typeof();
    ::TYPES[31] = ::g::Uno::String_typeof();
    ::TYPES[57] = ::g::Uno::Double_typeof();
    ::TYPES[38] = ::g::Uno::Float_typeof();
    ::TYPES[39] = ::g::Uno::Int_typeof();
    ::TYPES[66] = ::g::Fuse::Scripting::IArray_typeof();
    ::TYPES[63] = ::g::Uno::UX::Selector_typeof();
    ::TYPES[67] = ::g::Uno::UX::Size_typeof();
    ::TYPES[68] = ::g::Uno::UX::Size2_typeof();
    ::TYPES[69] = ::g::Uno::Char_typeof()->Array();
    type->MethodTypes[0]->SetPrecalc(
        type->MakeMethod(1/*TryConvertTo<T>*/, type->MethodTypes[0]->U(0), NULL));
    type->SetFields(0,
        ::TYPES[64/*Uno.Collections.List<Fuse.Scripting.Marshal.IConverter>*/], (uintptr_t)&::g::Fuse::Scripting::Marshal::_converters_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(14,
        new uFunction("AddConverter", NULL, (void*)Marshal__AddConverter_fn, 0, true, uVoid_typeof(), 1, ::TYPES[65/*Fuse.Scripting.Marshal.IConverter*/]),
        new uFunction("CanConvertClass", NULL, (void*)Marshal__CanConvertClass_fn, 0, true, ::TYPES[58/*bool*/], 1, ::TYPES[1/*Uno.Type*/]),
        new uFunction("ToBool", NULL, (void*)Marshal__ToBool_fn, 0, true, ::TYPES[58/*bool*/], 1, uObject_typeof()),
        new uFunction("ToDouble", NULL, (void*)Marshal__ToDouble_fn, 0, true, ::TYPES[57/*double*/], 1, uObject_typeof()),
        new uFunction("ToFloat", NULL, (void*)Marshal__ToFloat_fn, 0, true, ::TYPES[38/*float*/], 1, uObject_typeof()),
        new uFunction("ToFloat4", NULL, (void*)Marshal__ToFloat4_fn, 0, true, ::g::Uno::Float4_typeof(), 1, ::TYPES[66/*Fuse.Scripting.IArray*/]),
        new uFunction("ToFloat4", NULL, (void*)Marshal__ToFloat41_fn, 0, true, ::g::Uno::Float4_typeof(), 1, uObject_typeof()),
        new uFunction("ToInt", NULL, (void*)Marshal__ToInt_fn, 0, true, ::TYPES[39/*int*/], 1, uObject_typeof()),
        new uFunction("ToSelector", NULL, (void*)Marshal__ToSelector_fn, 0, true, ::TYPES[63/*Uno.UX.Selector*/], 1, uObject_typeof()),
        new uFunction("ToSize", NULL, (void*)Marshal__ToSize_fn, 0, true, ::TYPES[67/*Uno.UX.Size*/], 1, uObject_typeof()),
        new uFunction("ToSize2", NULL, (void*)Marshal__ToSize2_fn, 0, true, ::TYPES[68/*Uno.UX.Size2*/], 1, uObject_typeof()),
        ...
        new uFunction("TryConvertTo`1", type->MethodTypes[1], (void*)Marshal__TryConvertTo1_fn, 0, true, ::TYPES[58/*bool*/], 2, uObject_typeof(), type->MethodTypes[1]->U(0)->ByRef()));
}
...
// public static object TryConvertTo(Uno.Type t, object o) :1176
void Marshal__TryConvertTo_fn(uType* t, uObject* o, uObject** __retval)
{
    *__retval = Marshal::TryConvertTo(t, o);
}

// public static bool TryConvertTo<T>(object obj, T& value) :1149
...
// public static void AddConverter(Fuse.Scripting.Marshal.IConverter conv) [static] :1171
...
// public static bool CanConvertClass(Uno.Type t) [static] :1241
bool Marshal::CanConvertClass(uType* t)
{
    ...
    for (int i = 0; i < uPtr(Marshal::_converters())->Count(); i++)
        if (Marshal__IConverter::CanConvert(uInterface(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(Marshal::_converters()), uCRef<int>(i), &ret3), ret3)), ::TYPES[65/*Fuse.Scripting.Marshal.IConverter*/]), t))
            return true;

    return false;
}

// internal static bool CanConvertTo(Uno.Type t) [static] :1209
bool Marshal::CanConvertTo(uType* t)
{
    uStackFrame __("Fuse.Scripting.Marshal", "CanConvertTo(Uno.Type)");
    Marshal_typeof()->Init();
    return ((((((((((((::g::Uno::Type::op_Equality(t, ::g::Uno::UX::Value_typeof()) || ::g::Uno::Type::op_Equality(t, ::TYPES[58/*bool*/])) || ::g::Uno::Type::op_Equality(t, ::TYPES[38/*float*/])) || ::g::Uno::Type::op_Equality(t, ::TYPES[57/*double*/])) || ::g::Uno::Type::op_Equality(t, ::TYPES[39/*int*/])) || ::g::Uno::Type::op_Equality(t, ::TYPES[31/*string*/])) || ::g::Uno::Type::op_Equality(t, ::TYPES[63/*Uno.UX.Selector*/])) || ::g::Uno::Type::op_Equality(t, ::TYPES[34/*float4*/])) || ::g::Uno::Type::op_Equality(t, ::TYPES[33/*float3*/])) || ::g::Uno::Type::op_Equality(t, ::TYPES[32/*float2*/])) || ::g::Uno::Type::op_Equality(t, ::TYPES[67/*Uno.UX.Size*/])) || ::g::Uno::Type::op_Equality(t, ::TYPES[68/*Uno.UX.Size2*/])) || ::g::Uno::Type::IsEnum(uPtr(t))) || Marshal::CanConvertClass(t);
}

// public static bool ToBool(object obj) [static] :1133
bool Marshal::ToBool(uObject* obj)
{
    uStackFrame __("Fuse.Scripting.Marshal", "ToBool(object)");
    Marshal_typeof()->Init();

    if (uIs(obj, ::TYPES[58/*bool*/]))
        return uUnbox<bool>(::TYPES[58/*bool*/], obj);
...
// public static double ToDouble(object o) [static] :1016
double Marshal::ToDouble(uObject* o)
{
    uStackFrame __("Fuse.Scripting.Marshal", "ToDouble(object)");
    Marshal_typeof()->Init();

    if (uIs(o, ::TYPES[57/*double*/]))
        return uUnbox<double>(::TYPES[57/*double*/], o);
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::STRINGS[58/*"Expected nu...*/], ::g::Uno::Object::GetType(uPtr(o))), 1, ::STRINGS[7/*"/Users/hdc/...*/], 1028);
        return 0.0;
    }
}

// public static float ToFloat(object o) [static] :1038
...
// public static float4 ToFloat4(Fuse.Scripting.IArray values) [static] :1106
::g::Uno::Float4 Marshal::ToFloat4(uObject* values)
{
    uStackFrame __("Fuse.Scripting.Marshal", "ToFloat4(Fuse.Scripting.IArray)");
    Marshal_typeof()->Init();
    float r = (::g::Fuse::Scripting::IArray::Length(uInterface(uPtr(values), ::TYPES[66/*Fuse.Scripting.IArray*/])) > 0) ? Marshal::ToFloat(::g::Fuse::Scripting::IArray::Item(uInterface(uPtr(values), ::TYPES[66/*Fuse.Scripting.IArray*/]), 0)) : 0.0f;
    float g = (::g::Fuse::Scripting::IArray::Length(uInterface(values, ::TYPES[66/*Fuse.Scripting.IArray*/])) > 1) ? Marshal::ToFloat(::g::Fuse::Scripting::IArray::Item(uInterface(values, ::TYPES[66/*Fuse.Scripting.IArray*/]), 1)) : r;
    float b = (::g::Fuse::Scripting::IArray::Length(uInterface(values, ::TYPES[66/*Fuse.Scripting.IArray*/])) > 2) ? Marshal::ToFloat(::g::Fuse::Scripting::IArray::Item(uInterface(values, ::TYPES[66/*Fuse.Scripting.IArray*/]), 2)) : r;
    float a = (::g::Fuse::Scripting::IArray::Length(uInterface(values, ::TYPES[66/*Fuse.Scripting.IArray*/])) > 3) ? Marshal::ToFloat(::g::Fuse::Scripting::IArray::Item(uInterface(values, ::TYPES[66/*Fuse.Scripting.IArray*/]), 3)) : 1.0f;
    return ::g::Uno::Float4__New2(r, g, b, a);
}

// public static float4 ToFloat4(object o) [static] :1116
::g::Uno::Float4 Marshal::ToFloat41(uObject* o)
{
    uStackFrame __("Fuse.Scripting.Marshal", "ToFloat4(object)");
    Marshal_typeof()->Init();
    uObject* aa = uAs<uObject*>(o, ::TYPES[66/*Fuse.Scripting.IArray*/]);
...
// public static int ToInt(object o) [static] :1033
...
// public static Uno.UX.Selector ToSelector(object o) [static] :1043
::g::Uno::UX::Selector Marshal::ToSelector(uObject* o)
{
    uStackFrame __("Fuse.Scripting.Marshal", "ToSelector(object)");
    Marshal_typeof()->Init();

    if (uIs(o, ::TYPES[63/*Uno.UX.Selector*/]))
        return uUnbox< ::g::Uno::UX::Selector>(::TYPES[63/*Uno.UX.Selector*/], o);
    else if (uIs(o, ::TYPES[31/*string*/]))
...
// public static Uno.UX.Size ToSize(object o) [static] :1057
::g::Uno::UX::Size Marshal::ToSize(uObject* o)
{
    uStackFrame __("Fuse.Scripting.Marshal", "ToSize(object)");
    Marshal_typeof()->Init();

    if (uIs(o, ::TYPES[67/*Uno.UX.Size*/]))
        return uUnbox< ::g::Uno::UX::Size>(::TYPES[67/*Uno.UX.Size*/], o);
...
// public static Uno.UX.Size2 ToSize2(object o) [static] :1076
::g::Uno::UX::Size2 Marshal::ToSize2(uObject* o)
{
    uStackFrame __("Fuse.Scripting.Marshal", "ToSize2(object)");
    Marshal_typeof()->Init();

    if (uIs(o, ::TYPES[68/*Uno.UX.Size2*/]))
        return uUnbox< ::g::Uno::UX::Size2>(::TYPES[68/*Uno.UX.Size2*/], o);
    ...
    if (uIs(o, ::TYPES[31/*string*/]))
    {
        ...
        uArray* parts = ::g::Uno::String::Split(uPtr(s), uArray::Init<int>(::TYPES[69/*char[]*/], 1, ','));
    ...
    if (uIs(o, ::TYPES[66/*Fuse.Scripting.IArray*/]))
    {
        uObject* a = (uObject*)o;
        return ::g::Uno::UX::Size2__New1(Marshal::ToSize(::g::Fuse::Scripting::IArray::Item(uInterface(uPtr(a), ::TYPES[66/*Fuse.Scripting.IArray*/]), 0)), Marshal::ToSize(::g::Fuse::Scripting::IArray::Item(uInterface(uPtr(a), ::TYPES[66/*Fuse.Scripting.IArray*/]), 1)));
    }

    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::STRINGS[66/*"Unable to p...*/], o)));
}

// public static object TryConvertTo(Uno.Type t, object o) [static] :1176
uObject* Marshal::TryConvertTo(uType* t, uObject* o)
{
    ...
    if (o == NULL)
    ...
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[58/*bool*/]))
        return uBox(::TYPES[58/*bool*/], Marshal::ToBool(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[38/*float*/]))
        return uBox(::TYPES[38/*float*/], Marshal::ToFloat(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[57/*double*/]))
        return uBox(::TYPES[57/*double*/], Marshal::ToDouble(o));
    ...
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[63/*Uno.UX.Selector*/]))
        return uBox(::TYPES[63/*Uno.UX.Selector*/], Marshal::ToSelector(o));
    ...
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[67/*Uno.UX.Size*/]))
        return uBox(::TYPES[67/*Uno.UX.Size*/], Marshal::ToSize(o));
    else if (::g::Uno::Type::op_Equality(t, ::TYPES[68/*Uno.UX.Size2*/]))
        return uBox(::TYPES[68/*Uno.UX.Size2*/], Marshal::ToSize2(o));
        ...
        for (int i = 0; i < uPtr(Marshal::_converters())->Count(); i++)
        {
            uObject* res = Marshal__IConverter::TryConvert(uInterface(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(Marshal::_converters()), uCRef<int>(i), &ret5), ret5)), ::TYPES[65/*Fuse.Scripting.Marshal.IConverter*/]), t, o);
...
void Context__MethodClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptMethod* m, ::g::Fuse::Scripting::Context* context)
{
    ...
    _m = m;
    _context = context;
    ::g::Fuse::Scripting::Function* factory = uCast< ::g::Fuse::Scripting::Function*>(uPtr(_context)->Evaluate(::g::Uno::String::op_Addition2(uPtr(m)->Name, ::STRINGS[27/*" (ScriptMet...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[69/*"(function (...*/], uPtr(m)->Name), ::STRINGS[70/*" = function...*/])), ::TYPES[22/*Fuse.Scripting.Function*/]);
...
// public abstract class Module :1261
// {
static void Module_build(uType* type)
{
    ...
    ::TYPES[7] = uObject_typeof()->Array();
    ::TYPES[70] = ::g::Fuse::Scripting::ScriptException_typeof();
    ::TYPES[71] = ::g::Uno::EventHandler_typeof();
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(Module_type, interface0));
    type->SetFields(0,
        ::TYPES[71/*Uno.EventHandler*/], offsetof(::g::Fuse::Scripting::Module, _evaluated), 0,
    ...
    type->Reflection.SetFunctions(7,
        ...
        new uFunction("add_Evaluated", NULL, (void*)Module__add_Evaluated_fn, 0, false, uVoid_typeof(), 1, ::TYPES[71/*Uno.EventHandler*/]),
        new uFunction("remove_Evaluated", NULL, (void*)Module__remove_Evaluated_fn, 0, false, uVoid_typeof(), 1, ::TYPES[71/*Uno.EventHandler*/]),
...
// protected generated Module() :1261
void Module__ctor__fn(Module* __this)
{
    __this->ctor_();
}

// private virtual object CreateExportsObject(Fuse.Scripting.Context c) :1330
...
// public void Dispose() :1335
void Module__Dispose_fn(Module* __this)
{
    __this->Dispose();
}

// public Fuse.Scripting.ModuleResult Evaluate(Fuse.Scripting.Context c, string id) :1269
...
// public void add_Evaluated(Uno.EventHandler value) :1300
void Module__add_Evaluated_fn(Module* __this, uDelegate* value)
{
    __this->add_Evaluated(value);
}

// public void remove_Evaluated(Uno.EventHandler value) :1307
void Module__remove_Evaluated_fn(Module* __this, uDelegate* value)
{
    __this->remove_Evaluated(value);
}

// public object EvaluateExports(Fuse.Scripting.Context c, string id) :1263
...
// public virtual Uno.UX.FileSource GetFile() :1325
void Module__GetFile_fn(Module* __this, ::g::Uno::UX::FileSource** __retval)
{
    return *__retval = NULL, void();
}

// protected bool get_IsEvaluated() :1295
void Module__get_IsEvaluated_fn(Module* __this, bool* __retval)
{
    *__retval = __this->IsEvaluated();
}

// private void MarkEvaluated() :1311
void Module__MarkEvaluated_fn(Module* __this)
{
    __this->MarkEvaluated();
}

// protected generated Module() [instance] :1261
void Module::ctor_()
{
}

// public void Dispose() [instance] :1335
void Module::Dispose()
{
}

// public Fuse.Scripting.ModuleResult Evaluate(Fuse.Scripting.Context c, string id) [instance] :1269
::g::Fuse::Scripting::ModuleResult* Module::Evaluate1(::g::Fuse::Scripting::Context* c, uString* id)
{
    ...
    module->Item(::STRINGS[72/*"disposed"*/], c->NewArray(uArray::New(::TYPES[7/*object[]*/], 0)));
    ...
    {
        if (uIs(__t.Exception, ::TYPES[70/*Fuse.Scripting.ScriptException*/]))
        {
...
// public void add_Evaluated(Uno.EventHandler value) [instance] :1300
void Module::add_Evaluated(uDelegate* value)
{
    ...
    if (_isEvaluated)
        ...
        _evaluated = uCast<uDelegate*>(::g::Uno::Delegate::Combine(_evaluated, value), ::TYPES[71/*Uno.EventHandler*/]);
}

// public void remove_Evaluated(Uno.EventHandler value) [instance] :1307
void Module::remove_Evaluated(uDelegate* value)
{
    uStackFrame __("Fuse.Scripting.Module", "remove_Evaluated(Uno.EventHandler)");
    _evaluated = uCast<uDelegate*>(::g::Uno::Delegate::Remove(_evaluated, value), ::TYPES[71/*Uno.EventHandler*/]);
}

// public object EvaluateExports(Fuse.Scripting.Context c, string id) [instance] :1263
...
// protected bool get_IsEvaluated() [instance] :1295
bool Module::IsEvaluated()
{
    return _isEvaluated;
}

// private void MarkEvaluated() [instance] :1311
...
// public sealed class ModuleResult :1351
// {
static void ModuleResult_build(uType* type)
{
    ...
    ::STRINGS[71] = uString::Const("exports");
    ::TYPES[72] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof(), NULL);
    ::TYPES[73] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[74] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::EventArgs_typeof(), NULL);
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[23] = ::g::Fuse::Scripting::Array_typeof();
    ::TYPES[22] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[7] = uObject_typeof()->Array();
    type->SetFields(0,
        ...
        ::TYPES[72/*Uno.Collections.List<Uno.Action>*/], offsetof(::g::Fuse::Scripting::ModuleResult, _invalidateCallbacks), 0,
    ...
    type->Reflection.SetFields(4,
        ...
        new uField("Object", 6));
    type->Reflection.SetFunctions(6,
        new uFunction("AddDependency", NULL, (void*)ModuleResult__AddDependency_fn, 0, false, uVoid_typeof(), 1, ::TYPES[6/*Uno.Action*/]),
...
// public ModuleResult(Fuse.Scripting.Context context, string id, Fuse.Scripting.Module mod, Fuse.Scripting.Object obj) :1364
...
// public void AddDependency(Uno.Action invalidateCallback) :1396
...
// private void OnDataChanged(object sender, Uno.EventArgs args) :1401
...
// public ModuleResult(Fuse.Scripting.Context context, string id, Fuse.Scripting.Module mod, Fuse.Scripting.Object obj) [instance] :1364
void ModuleResult::ctor_(::g::Fuse::Scripting::Context* context, uString* id, ::g::Fuse::Scripting::Module* mod, ::g::Fuse::Scripting::Object* obj)
{
    ...
    _invalidateCallbacks = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[72/*Uno.Collections.List<Uno.Action>*/]));
    Context = context;
    Module = mod;
    Object = obj;
    Id = id;
    ...
    if (::g::Uno::String::op_Inequality(Id, NULL))
    {
        ...
        ::g::Uno::UX::Resource::AddGlobalKeyListener(uDelegate::New(::TYPES[73/*Uno.Action<string>*/], (void*)ModuleResult__OnGlobalKeyChanged_fn, this));
    }

    if (uPtr(Module)->GetFile() != NULL)
    {
        uPtr(uPtr(Module)->GetFile())->add_DataChanged(uDelegate::New(::TYPES[74/*Uno.EventHandler<Uno.EventArgs>*/], (void*)ModuleResult__OnDataChanged_fn, this));
        _fileListening = true;
    }
}

// public void AddDependency(Uno.Action invalidateCallback) [instance] :1396
...
// public void Dispose() [instance] :1429
void ModuleResult::Dispose()
{
    ...
    if (_fileListening)
    {
        uPtr(uPtr(Module)->GetFile())->remove_DataChanged(uDelegate::New(::TYPES[74/*Uno.EventHandler<Uno.EventArgs>*/], (void*)ModuleResult__OnDataChanged_fn, this));
        _fileListening = false;
    }

    if (_globalKeyListening)
    {
        ::g::Uno::UX::Resource::RemoveGlobalKeyListener(uDelegate::New(::TYPES[73/*Uno.Action<string>*/], (void*)ModuleResult__OnGlobalKeyChanged_fn, this));
...
// public generated Fuse.Scripting.ScriptException get_Error() [instance] :1359
::g::Fuse::Scripting::ScriptException* ModuleResult::Error()
{
    return _Error;
}

// internal generated void set_Error(Fuse.Scripting.ScriptException value) [instance] :1359
void ModuleResult::Error(::g::Fuse::Scripting::ScriptException* value)
{
    _Error = value;
}

// public object get_Exports() [instance] :1357
...
// public void Invalidate() [instance] :1416
...
// private void OnDataChanged(object sender, Uno.EventArgs args) [instance] :1401
...
// private void OnDisposed() [instance] :1448
void ModuleResult::OnDisposed()
{
    ...
    {
        ::g::Fuse::Scripting::Array* disposed = uAs< ::g::Fuse::Scripting::Array*>(uPtr(Object)->Item(::STRINGS[72/*"disposed"*/]), ::TYPES[23/*Fuse.Scripting.Array*/]);
...
// private void OnGlobalKeyChanged(string key) [instance] :1389
...
// public ModuleResult New(Fuse.Scripting.Context context, string id, Fuse.Scripting.Module mod, Fuse.Scripting.Object obj) [static] :1364
...
static void NativeEvent_build(uType* type)
{
    ...
    ::STRINGS[76] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Scripting/0.46.1/$.uno");
    ::TYPES[75] = ::g::Uno::Collections::Queue_typeof()->MakeType(uObject_typeof()->Array(), NULL);
    ::TYPES[76] = ::g::Uno::Threading::IDispatcherExtensions_typeof()->MakeMethod(1/*Invoke1<object[], object>*/, uObject_typeof()->Array(), uObject_typeof(), NULL);
    ::TYPES[77] = ::g::Uno::Func1_typeof()->MakeType(uObject_typeof()->Array(), uObject_typeof(), NULL);
    ::TYPES[7] = uObject_typeof()->Array();
    ...
    type->SetFields(8,
        ::TYPES[75/*Uno.Collections.Queue<object[]>*/], offsetof(::g::Fuse::Scripting::NativeEvent, _eventArgsQueue), 0,
    ...
    type->Reflection.SetFunctions(2,
        ...
        new uFunction("RaiseAsync", NULL, (void*)NativeEvent__RaiseAsync_fn, 0, false, uVoid_typeof(), 1, ::TYPES[7/*object[]*/]));
}
...
// public void RaiseAsync(object[] args) :993
...
{
    ctor_1(name);
    _eventArgsQueue = ((::g::Uno::Collections::Queue*)::g::Uno::Collections::Queue::New1(::TYPES[75/*Uno.Collections.Queue<object[]>*/]));
...
void NativeEvent::DispatchQueue()
{
    ...
    while ((uPtr(_eventArgsQueue)->Count() > 0) && (_jsFunction != NULL))
        ::g::Uno::Threading::IDispatcherExtensions__Invoke11_fn(::TYPES[76/*Uno.Threading.IDispatcherExtensions.Invoke1<object[], object>*/], uPtr(Context())->Dispatcher(), uDelegate::New(::TYPES[77/*Uno.Func<object[], object>*/], uPtr(_jsFunction), offsetof(::g::Fuse::Scripting::Function_type, fp_Call)), (::g::Uno::Collections::Queue__Dequeue_fn(uPtr(_eventArgsQueue), &ret2), ret2));
}

// public void RaiseAsync(object[] args) [instance] :993
...
uObject* NativeEvent::RaiseSync(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(Context() != NULL, ::STRINGS[75/*"this.Contex...*/], ::STRINGS[76/*"/Users/hdc/...*/], 1003, uArray::New(::TYPES[7/*object[]*/], 0));

    if (_jsFunction != NULL)
        ::g::Uno::Threading::IDispatcherExtensions__Invoke11_fn(::TYPES[76/*Uno.Threading.IDispatcherExtensions.Invoke1<object[], object>*/], uPtr(Context())->Dispatcher(), uDelegate::New(::TYPES[77/*Uno.Func<object[], object>*/], uPtr(_jsFunction), offsetof(::g::Fuse::Scripting::Function_type, fp_Call)), args);
...
static void NativeEventEmitterModule_build(uType* type)
{
    ...
    ::TYPES[78] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Tuple2_typeof()->MakeType(uObject_typeof(), ::g::Fuse::Scripting::Callback_typeof(), NULL), NULL);
    ::TYPES[79] = ::g::Uno::Collections::Queue_typeof()->MakeType(::g::Uno::Action2_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), ::g::Fuse::Scripting::Object_typeof(), NULL), NULL);
    ::TYPES[71] = ::g::Uno::EventHandler_typeof();
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[80] = ::g::Uno::Threading::IDispatcherExtensions_typeof()->MakeMethod(2/*Invoke2<Fuse.Scripting.Context, Fuse.Scripting.Object>*/, ::g::Fuse::Scripting::Context_typeof(), ::g::Fuse::Scripting::Object_typeof(), NULL);
    ::TYPES[81] = ::g::Uno::Action2_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), ::g::Fuse::Scripting::Object_typeof(), NULL);
    ::TYPES[82] = ::g::Uno::Tuple_typeof()->MakeMethod(0/*Create<object, Fuse.Scripting.Callback>*/, uObject_typeof(), ::g::Fuse::Scripting::Callback_typeof(), NULL);
    ::TYPES[42] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[5] = ::g::Uno::Threading::IDispatcher_typeof();
    ::TYPES[7] = uObject_typeof()->Array();
    ::TYPES[83] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Tuple2_typeof()->MakeType(uObject_typeof(), ::TYPES[42/*Fuse.Scripting.Callback*/], NULL), NULL);
    type->SetInterfaces(
    ...
    type->SetFields(4,
        ...
        ::TYPES[78/*Uno.Collections.List<Uno.Tuple<object, Fuse.Scripting.Callback>>*/], offsetof(::g::Fuse::Scripting::NativeEventEmitterModule, _listeningCallbacks), 0,
        uObject_typeof(), offsetof(::g::Fuse::Scripting::NativeEventEmitterModule, _mutex), 0,
        ::TYPES[79/*Uno.Collections.Queue<Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>>*/], offsetof(::g::Fuse::Scripting::NativeEventEmitterModule, _queuedEvents), 0,
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)NativeEventEmitterModule__New2_fn, 0, true, type, 2, ::g::Uno::Bool_typeof(), ::TYPES[7/*object[]*/]));
}
...
void NativeEventEmitterModule::ctor_2(bool queueEventsBeforeInit, uArray* eventNames)
{
    ...
    _listeningCallbacks = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[78/*Uno.Collections.List<Uno.Tuple<object, Fuse.Scripting.Callback>>*/]));
    _mutex = ::g::Uno::Object::New();
    _queuedEvents = ((::g::Uno::Collections::Queue*)::g::Uno::Collections::Queue::New1(::TYPES[79/*Uno.Collections.Queue<Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>>*/]));
    ctor_1();
    _queueEventsBeforeInit = queueEventsBeforeInit;
    _eventNames = eventNames;
    add_Reset(uDelegate::New(::TYPES[71/*Uno.EventHandler*/], (void*)NativeEventEmitterModule__ResetListeners_fn, this));
}
...
void NativeEventEmitterModule::Dispatch(uDelegate* action, bool alwaysQueueEventBeforeInit)
{
    ...
    ::g::Uno::Threading::IDispatcherExtensions__Invoke2_fn(::TYPES[80/*Uno.Threading.IDispatcherExtensions.Invoke2<Fuse.Scripting.Context, Fuse.Scripting.Object>*/], uPtr(_context)->Dispatcher(), action, _context, _this);
}
...
void NativeEventEmitterModule::Emit(uArray* args)
{
    ...
    Dispatch(uDelegate::New(::TYPES[81/*Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>*/], (void*)NativeEventEmitterModule__EmitClosure__Emit_fn, NativeEventEmitterModule__EmitClosure::New1(args)), false);
}
...
void NativeEventEmitterModule::On(uObject* eventName, uDelegate* listener)
{
...

    {
        ...
        const uFinally<decltype(__finally_fun)> __f(__finally_fun);
        ::g::Uno::Collections::List__Add_fn(uPtr(_listeningCallbacks), (::g::Uno::Tuple__Create1_fn(::TYPES[82/*Uno.Tuple.Create<object, Fuse.Scripting.Callback>*/], eventName, listener, &ret4), ret4));
    }

    Dispatch(uDelegate::New(::TYPES[81/*Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>*/], (void*)NativeEventEmitterModule__OnClosure__On_fn, NativeEventEmitterModule__OnClosure::New1(eventName, listener)), true);
}
...
void NativeEventEmitterModule::ResetListenersJS()
{
    ...
    uObject* ret7;
    uDelegate* ret8;
    uPtr(_this)->CallMethod(::STRINGS[77/*"removeAllLi...*/], uArray::New(::TYPES[7/*object[]*/], 0));
    ::g::Uno::Threading::Monitor::Enter(_mutex);

    {
        ...
        for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Uno::Tuple2*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_listeningCallbacks), &ret6), ret6); enum1.MoveNext(::TYPES[83/*Uno.Collections.List<Uno.Tuple<object, Fuse.Scripting.Callback>>.Enumerator*/]); )
        {
            ::g::Uno::Tuple2* l = enum1.Current(::TYPES[83/*Uno.Collections.List<Uno.Tuple<object, Fuse.Scripting.Callback>>.Enumerator*/]);
            Dispatch(uDelegate::New(::TYPES[81/*Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>*/], (void*)NativeEventEmitterModule__OnClosure__On_fn, NativeEventEmitterModule__OnClosure::New1((::g::Uno::Tuple2__get_Item1_fn(uPtr(l), &ret7), ret7), (::g::Uno::Tuple2__get_Item2_fn(uPtr(l), &ret8), ret8))), true);
        }
    }
...
static void NativeModule_build(uType* type)
{
    ...
    ::STRINGS[71] = uString::Const("exports");
    ::TYPES[84] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Scripting::NativeMember_typeof(), NULL);
    ::TYPES[12] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[85] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Scripting::NativeMember_typeof(), NULL);
    ::TYPES[71] = ::g::Uno::EventHandler_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(2,
        ::TYPES[84/*Uno.Collections.List<Fuse.Scripting.NativeMember>*/], offsetof(::g::Fuse::Scripting::NativeModule, _members), 0,
        ::TYPES[71/*Uno.EventHandler*/], offsetof(::g::Fuse::Scripting::NativeModule, Reset1), 0);
    type->Reflection.SetFunctions(3,
        new uFunction(".ctor", NULL, (void*)NativeModule__New1_fn, 0, true, type, 0),
        new uFunction("add_Reset", NULL, (void*)NativeModule__add_Reset_fn, 0, false, uVoid_typeof(), 1, ::TYPES[71/*Uno.EventHandler*/]),
        new uFunction("remove_Reset", NULL, (void*)NativeModule__remove_Reset_fn, 0, false, uVoid_typeof(), 1, ::TYPES[71/*Uno.EventHandler*/]));
}
...
void NativeModule__Evaluate_fn(NativeModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    if (module != NULL)
    {
        ::g::Fuse::Scripting::Object* obj = uAs< ::g::Fuse::Scripting::Object*>(uPtr(module)->Item(::STRINGS[71/*"exports"*/]), ::TYPES[12/*Fuse.Scripting.Object*/]);

        if (obj != NULL)

            for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Scripting::NativeMember*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(__this->_members), &ret3), ret3); enum1.MoveNext(::TYPES[85/*Uno.Collections.List<Fuse.Scripting.NativeMember>.Enumerator*/]); )
            {
                ::g::Fuse::Scripting::NativeMember* m = enum1.Current(::TYPES[85/*Uno.Collections.List<Fuse.Scripting.NativeMember>.Enumerator*/]);
                uPtr(m)->Create(obj, c);
            }
    }
}
...
{
    _members = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[84/*Uno.Collections.List<Fuse.Scripting.NativeMember>*/]));
    ctor_();
}
...
void NativeModule::add_Reset(uDelegate* value)
{
    ...
    Reset1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Reset1, value), ::TYPES[71/*Uno.EventHandler*/]);
}
...
void NativeModule::remove_Reset(uDelegate* value)
{
    ...
    Reset1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Reset1, value), ::TYPES[71/*Uno.EventHandler*/]);
}
...
{
    ::TYPES[86] = ::g::Fuse::Scripting::FutureFactory_typeof();
    ::TYPES[42] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[87] = NativePromise__ContextClosure_typeof();
    ::TYPES[88] = ::g::Uno::Threading::Promise_typeof();
    ::TYPES[89] = ::g::Uno::Threading::ThreadStart_typeof();
    ::TYPES[90] = ::g::Fuse::Scripting::FactoryClosure_typeof();
    type->SetPrecalc(
    ...
    type->SetFields(3,
        ...
        ::TYPES[86/*Fuse.Scripting.FutureFactory`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Scripting::NativePromise, _futureFactory), 0,
    ...
    type->Reflection.SetFunctions(2,
        new uFunction(".ctor", type, (void*)NativePromise__New1_fn, 0, true, type, 3, ::g::Uno::String_typeof(), ::TYPES[86/*Fuse.Scripting.FutureFactory`1*/]->MakeType(type->T(0), NULL), ::g::Fuse::Scripting::ResultConverter_typeof()->MakeType(type->T(0), type->T(1), NULL)),
...
::g::Uno::Threading::Future1* NativePromise::Factory(uArray* args)
{
    ...
    ::g::Uno::Threading::Thread::New2(uDelegate::New(::TYPES[89/*Uno.Threading.ThreadStart*/], (void*)::g::Fuse::Scripting::FactoryClosure__Run_fn, (::g::Fuse::Scripting::FactoryClosure*)::g::Fuse::Scripting::FactoryClosure::New1(__types[1], _func, args, future)))->Start();
    return future;
}
...
{
    ::TYPES[42] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[91] = ::g::Uno::Func_typeof();
    ::TYPES[92] = ::g::Uno::Action1_typeof();
    type->SetPrecalc(
        type->T(1),
        type->T(0),
    ...
    type->SetFields(3,
        ::TYPES[91/*Uno.Func`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Scripting::NativeProperty, _getHandler), 0,
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::Scripting::NativeProperty, _isReadonly), 0,
        type->T(1), (uintptr_t)0, uFieldFlagsConstrained,
        ::TYPES[92/*Uno.Action`1*/]->MakeType(type->T(1), NULL), offsetof(::g::Fuse::Scripting::NativeProperty, _setHandler), 0,
    ...
    type->Reflection.SetFunctions(3,
        ...
        new uFunction(".ctor", type, (void*)NativeProperty__New2_fn, 0, true, type, 4, ::g::Uno::String_typeof(), ::TYPES[91/*Uno.Func`1*/]->MakeType(type->T(0), NULL), ::TYPES[92/*Uno.Action`1*/]->MakeType(type->T(1), NULL), ::g::Fuse::Scripting::ValueConverter_typeof()->MakeType(type->T(0), type->T(1), NULL)),
...
// public NativeProperty New(string name) :1030
...
// public NativeProperty New(string name) [static] :1030
...
// private sealed class Observable.NewAll :1908
// {
static void Observable__NewAll_build(uType* type)
{
    ::TYPES[93] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[2] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Scripting::Observable__Subscription_typeof(), NULL);
    ::TYPES[3] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Scripting::Observable__Subscription_typeof(), NULL);
    ::TYPES[4] = ::g::Fuse::Scripting::IObserver_typeof();
    type->SetFields(2,
...
// public NewAll(Fuse.Scripting.Observable obs, Fuse.Scripting.ArrayMirror newValues, int origin) :1913
...
// public NewAll New(Fuse.Scripting.Observable obs, Fuse.Scripting.ArrayMirror newValues, int origin) :1913
...
// protected override sealed void OnPerform(Uno.Collections.IList<Fuse.Scripting.Observable.Subscription> sub) :1924
void Observable__NewAll__OnPerform_fn(Observable__NewAll* __this, uObject* sub)
{
    ...
    uPtr(__this->Observable())->UnsubscribeValues();
    uPtr(uPtr(__this->Observable())->_values)->Clear();
    uPtr(uPtr(__this->Observable())->_values)->AddRange((uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[93/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<object>*/], uPtr(__this->_newValues)->ItemsReadonly())));
...
// protected override sealed void Unsubscribe() :1919
...
// public NewAll(Fuse.Scripting.Observable obs, Fuse.Scripting.ArrayMirror newValues, int origin) [instance] :1913
...
// public NewAll New(Fuse.Scripting.Observable obs, Fuse.Scripting.ArrayMirror newValues, int origin) [static] :1913
...
// private sealed class Observable.NewAt :1878
// {
...
// public NewAt(Fuse.Scripting.Observable obs, int index, object newValue) :1883
...
// public NewAt New(Fuse.Scripting.Observable obs, int index, object newValue) :1883
...
// protected override sealed void OnPerform(Uno.Collections.IList<Fuse.Scripting.Observable.Subscription> sub) :1895
...
// public NewAt(Fuse.Scripting.Observable obs, int index, object newValue) [instance] :1883
...
// public NewAt New(Fuse.Scripting.Observable obs, int index, object newValue) [static] :1883
...
{
    ::TYPES[1] = ::g::Uno::Type_typeof();
    ::TYPES[94] = ::g::Uno::Short_typeof();
    ::TYPES[39] = ::g::Uno::Int_typeof();
    ::TYPES[95] = ::g::Uno::Long_typeof();
    ::TYPES[38] = ::g::Uno::Float_typeof();
    ::TYPES[57] = ::g::Uno::Double_typeof();
    ::TYPES[44] = ::g::Uno::Exception_typeof();
    type->MethodTypes[1]->SetPrecalc(
...
{
    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[94/*short*/]))
        return uBox<int16_t>(::TYPES[94/*short*/], (int16_t)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[39/*int*/]))
        return uBox<int>(::TYPES[39/*int*/], (int)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[95/*long*/]))
        return uBox<int64_t>(::TYPES[95/*long*/], (int64_t)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[38/*float*/]))
        return uBox(::TYPES[38/*float*/], (float)value);

    return uBox(::TYPES[57/*double*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert1(float value, uType* targetType)
{
    ...
    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[57/*double*/]))
        return uBox(::TYPES[57/*double*/], (double)value);
...
uObject* JSCallback__NumberConverter::Convert3(int64_t value, uType* targetType)
{
    ...
    return uBox<int64_t>(::TYPES[95/*long*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert4(int16_t value, uType* targetType)
{
    ...
    return uBox<int16_t>(::TYPES[94/*short*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert5(uType* targetType, uObject* value)
{
    ...
    if (uIs(value, ::TYPES[94/*short*/]))
        return JSCallback__NumberConverter::Convert4(uUnbox<int16_t>(::TYPES[94/*short*/], value), targetType);

    if (uIs(value, ::TYPES[39/*int*/]))
        return JSCallback__NumberConverter::Convert2(uUnbox<int>(::TYPES[39/*int*/], value), targetType);

    if (uIs(value, ::TYPES[95/*long*/]))
        return JSCallback__NumberConverter::Convert3(uUnbox<int64_t>(::TYPES[95/*long*/], value), targetType);

    if (uIs(value, ::TYPES[38/*float*/]))
        return JSCallback__NumberConverter::Convert1(uUnbox<float>(::TYPES[38/*float*/], value), targetType);

    if (uIs(value, ::TYPES[57/*double*/]))
        return JSCallback__NumberConverter::Convert(uUnbox<double>(::TYPES[57/*double*/], value), targetType);
...
// public abstract class Object :2531
// {
...
// protected generated Object() :2531
void Object__ctor__fn(Object* __this)
{
    __this->ctor_();
}

// public override sealed bool Equals(object o) :2541
...
// public override int GetHashCode() :2547
...
// protected generated Object() [instance] :2531
void Object::ctor_()
{
}
// }
...
// public sealed class ObjectMirror :1474
// {
static void ObjectMirror_build(uType* type)
{
    ...
    type->SetFields(1,
        ::TYPES[96/*Uno.Collections.Dictionary<string, object>*/], offsetof(::g::Fuse::Scripting::ObjectMirror, _props), 0);
    type->Reflection.SetFunctions(2,
...
// internal ObjectMirror(Fuse.Scripting.Context context, Fuse.Scripting.Object obj) :1478
...
// public override sealed void Unsubscribe() :1488
void ObjectMirror__Unsubscribe_fn(ObjectMirror* __this)
{
    ...
    for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong<uObject*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(__this->_props), &ret4), ret4); enum1.MoveNext(::TYPES[97/*Uno.Collections.Dictionary<string, object>.Enumerator*/]); )
    {
        ::g::Uno::Collections::KeyValuePair<uStrong<uString*>, uStrong<uObject*> > p = enum1.Current(::TYPES[97/*Uno.Collections.Dictionary<string, object>.Enumerator*/]);
        ::g::Fuse::Scripting::ValueMirror* d = uAs< ::g::Fuse::Scripting::ValueMirror*>(p.Value(::TYPES[98/*Uno.Collections.KeyValuePair<string, object>*/]), ::TYPES[8/*Fuse.Scripting.ValueMirror*/]);
...
// internal ObjectMirror(Fuse.Scripting.Context context, Fuse.Scripting.Object obj) [instance] :1478
void ObjectMirror::ctor_1(::g::Fuse::Scripting::Context* context, ::g::Fuse::Scripting::Object* obj)
{
    ...
    _props = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[96/*Uno.Collections.Dictionary<string, object>*/]));
    ctor_(obj);
...
// public bool ContainsKey(string key) [instance] :1497
...
// public object get_Item(string key) [instance] :1504
...
// internal ObjectMirror New(Fuse.Scripting.Context context, Fuse.Scripting.Object obj) [static] :1478
...
// internal sealed class Observable :1516
// {
static void Observable_build(uType* type)
{
    ...
    ::STRINGS[89] = uString::Const("failed");
    ::STRINGS[90] = uString::Const("Unhandled observable operation: ");
    ::STRINGS[91] = uString::Const("removeSubscriber");
    ::TYPES[99] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[100] = ::g::Uno::Collections::List_typeof()->MakeType(Observable__Subscription_typeof(), NULL);
    ::TYPES[42] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[7] = uObject_typeof()->Array();
    ::TYPES[12] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[31] = ::g::Uno::String_typeof();
    ::TYPES[101] = ::g::Fuse::Scripting::ArrayMirror_typeof();
    ::TYPES[102] = ::g::Fuse::Scripting::Marshal_typeof()->MakeMethod(0/*ToType<string>*/, ::TYPES[31/*string*/], NULL);
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[8] = ::g::Fuse::Scripting::ValueMirror_typeof();
    type->SetInterfaces(
        ::g::Fuse::Scripting::IArray_typeof(), offsetof(::g::Fuse::Scripting::ListMirror_type, interface0));
    type->SetFields(1,
        ...
        ::TYPES[100/*Uno.Collections.List<Fuse.Scripting.Observable.Subscription>*/], offsetof(::g::Fuse::Scripting::Observable, _observers), 0,
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::Scripting::Observable, _usingObservers), 0,
        ::TYPES[99/*Uno.Collections.List<object>*/], offsetof(::g::Fuse::Scripting::Observable, _values), 0);
}
...
// internal Observable(Fuse.Scripting.Context context, Fuse.Scripting.Object obj, bool suppressInitialCallback) :1659
void Observable__ctor_2_fn(Observable* __this, ::g::Fuse::Scripting::Context* context, ::g::Fuse::Scripting::Object* obj, bool* suppressInitialCallback)
{
    __this->ctor_2(context, obj, *suppressInitialCallback);
}

// internal static Fuse.Scripting.Observable Create(Fuse.Scripting.Context context) :1667
void Observable__Create_fn(::g::Fuse::Scripting::Context* context, Observable** __retval)
{
    *__retval = Observable::Create(context);
}

// public bool get_IsUnsubscribed() :1726
void Observable__get_IsUnsubscribed_fn(Observable* __this, bool* __retval)
{
    *__retval = __this->IsUnsubscribed();
}

// public override sealed object get_Item(int index) :1524
void Observable__get_Item_fn(Observable* __this, int* index, uObject** __retval)
{
    ...
    uObject* ret5;
    int index_ = *index;
    return *__retval = (::g::Uno::Collections::List__get_Item_fn(uPtr(__this->_values), uCRef<int>(index_), &ret5), ret5), void();
}

// public override sealed int get_Length() :1520
...
// internal Observable New(Fuse.Scripting.Context context, Fuse.Scripting.Object obj, bool suppressInitialCallback) :1659
void Observable__New1_fn(::g::Fuse::Scripting::Context* context, ::g::Fuse::Scripting::Object* obj, bool* suppressInitialCallback, Observable** __retval)
{
    *__retval = Observable::New1(context, obj, *suppressInitialCallback);
}

// internal Fuse.Scripting.Object get_Object() :1655
void Observable__get_Object_fn(Observable* __this, ::g::Fuse::Scripting::Object** __retval)
{
    *__retval = __this->Object();
}

// private object ObserveChange(object[] args) :1672
void Observable__ObserveChange_fn(Observable* __this, uArray* args, uObject** __retval)
{
    *__retval = __this->ObserveChange(args);
}

// private void ObserversCleanup() :1536
void Observable__ObserversCleanup_fn(Observable* __this)
{
    __this->ObserversCleanup();
}

// private void RemoveSubscriber() :1749
void Observable__RemoveSubscriber_fn(Observable* __this)
{
    __this->RemoveSubscriber();
}

// public void SetValue(int index, object value) :1528
void Observable__SetValue_fn(Observable* __this, int* index, uObject* value)
{
    __this->SetValue(*index, value);
}

// public Fuse.Scripting.Observable.Subscription Subscribe(Fuse.Scripting.IObserver observer) :1647
...
// public override sealed void Unsubscribe() :1729
...
// private void UnsubscribeValues() :1740
void Observable__UnsubscribeValues_fn(Observable* __this)
{
    __this->UnsubscribeValues();
}

// internal Observable(Fuse.Scripting.Context context, Fuse.Scripting.Object obj, bool suppressInitialCallback) [instance] :1659
void Observable::ctor_2(::g::Fuse::Scripting::Context* context, ::g::Fuse::Scripting::Object* obj, bool suppressInitialCallback)
{
    uStackFrame __("Fuse.Scripting.Observable", ".ctor(Fuse.Scripting.Context,Fuse.Scripting.Object,bool)");
    _values = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[99/*Uno.Collections.List<object>*/]));
    _observers = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[100/*Uno.Collections.List<Fuse.Scripting.Observable.Subscription>*/]));
    ctor_1(obj);
    _context = context;
    _observable = obj;
    ...
    uPtr(obj)->CallMethod(::STRINGS[79/*"addSubscriber"*/], uArray::Init<uObject*>(::TYPES[7/*object[]*/], 2, (::g::Fuse::Scripting::Function*)_observeChange, uBox(::TYPES[58/*bool*/], suppressInitialCallback)));
}

// public bool get_IsUnsubscribed() [instance] :1726
bool Observable::IsUnsubscribed()
{
    return _isUnsubscribed;
}

// internal Fuse.Scripting.Object get_Object() [instance] :1655
::g::Fuse::Scripting::Object* Observable::Object()
{
    return _observable;
}

// private object ObserveChange(object[] args) [instance] :1672
uObject* Observable::ObserveChange(uArray* args)
{
    ...
    int origin = ::g::Fuse::Scripting::Marshal::ToInt(args->Strong<uObject*>(2));

    if (::g::Uno::String::op_Equality(op, ::STRINGS[80/*"set"*/]))
        uPtr(_context)->Enqueue(Observable__Set::New1(this, uPtr(_context)->Reflect(uPtr(args)->Strong<uObject*>(3)), origin));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[81/*"clear"*/]))
        uPtr(_context)->Enqueue(Observable__Clear::New1(this, origin));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[82/*"newAt"*/]))
        uPtr(_context)->Enqueue(Observable__NewAt::New1(this, ::g::Fuse::Scripting::Marshal::ToInt(uPtr(args)->Strong<uObject*>(3)), uPtr(_context)->Reflect(uPtr(args)->Strong<uObject*>(4))));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[83/*"newAll"*/]))
        uPtr(_context)->Enqueue(Observable__NewAll::New1(this, uCast< ::g::Fuse::Scripting::ArrayMirror*>(uPtr(_context)->Reflect(uPtr(args)->Strong<uObject*>(3)), ::TYPES[101/*Fuse.Scripting.ArrayMirror*/]), origin));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[84/*"add"*/]))
        uPtr(_context)->Enqueue(Observable__Add::New1(this, uPtr(_context)->Reflect(uPtr(args)->Strong<uObject*>(3))));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[85/*"removeAt"*/]))
        uPtr(_context)->Enqueue(Observable__RemoveAt::New1(this, ::g::Fuse::Scripting::Marshal::ToInt(uPtr(args)->Strong<uObject*>(3))));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[86/*"insertAt"*/]))
        uPtr(_context)->Enqueue(Observable__InsertAt::New1(this, ::g::Fuse::Scripting::Marshal::ToInt(uPtr(args)->Strong<uObject*>(3)), uPtr(_context)->Reflect(uPtr(args)->Strong<uObject*>(4))));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[87/*"removeRange"*/]))
        uPtr(_context)->Enqueue(Observable__RemoveRange::New1(this, ::g::Fuse::Scripting::Marshal::ToInt(uPtr(args)->Strong<uObject*>(3)), ::g::Fuse::Scripting::Marshal::ToInt(uPtr(args)->Strong<uObject*>(4))));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[88/*"insertAll"*/]))
        uPtr(_context)->Enqueue(Observable__InsertAll::New1(this, ::g::Fuse::Scripting::Marshal::ToInt(uPtr(args)->Strong<uObject*>(3)), uCast< ::g::Fuse::Scripting::ArrayMirror*>(uPtr(_context)->Reflect(uPtr(args)->Strong<uObject*>(4)), ::TYPES[101/*Fuse.Scripting.ArrayMirror*/])));
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[89/*"failed"*/]))
        uPtr(_context)->Enqueue(Observable__Failed::New1(this, (::g::Fuse::Scripting::Marshal__ToType_fn(::TYPES[102/*Fuse.Scripting.Marshal.ToType<string>*/], uPtr(args)->Strong<uObject*>(3), &ret2), ret2)));
    else
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::STRINGS[90/*"Unhandled o...*/], op)));

    return NULL;
}

// private void ObserversCleanup() [instance] :1536
void Observable::ObserversCleanup()
{
    uStackFrame __("Fuse.Scripting.Observable", "ObserversCleanup()");
    Observable__Subscription* ret3;

    if (_usingObservers)
        return;

    for (int i = uPtr(_observers)->Count() - 1; i >= 0; --i)
        if (uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(_observers), uCRef<int>(i), &ret3), ret3))->Removed())
            uPtr(_observers)->RemoveAt(i);
}

// private void RemoveSubscriber() [instance] :1749
void Observable::RemoveSubscriber()
{
    uStackFrame __("Fuse.Scripting.Observable", "RemoveSubscriber()");
    uPtr(_observable)->CallMethod(::STRINGS[91/*"removeSubsc...*/], uArray::Init<uObject*>(::TYPES[7/*object[]*/], 1, (::g::Fuse::Scripting::Function*)_observeChange));
    _observeChange = NULL;
    _observable = NULL;
}

// public void SetValue(int index, object value) [instance] :1528
...
// public Fuse.Scripting.Observable.Subscription Subscribe(Fuse.Scripting.IObserver observer) [instance] :1647
...
// private void UnsubscribeValues() [instance] :1740
void Observable::UnsubscribeValues()
{
    ...
    {
        ::g::Fuse::Scripting::ValueMirror* vm = uAs< ::g::Fuse::Scripting::ValueMirror*>((::g::Uno::Collections::List__get_Item_fn(uPtr(_values), uCRef<int>(i), &ret4), ret4), ::TYPES[8/*Fuse.Scripting.ValueMirror*/]);
...
// internal static Fuse.Scripting.Observable Create(Fuse.Scripting.Context context) [static] :1667
...
// internal Observable New(Fuse.Scripting.Context context, Fuse.Scripting.Object obj, bool suppressInitialCallback) [static] :1659
Observable* Observable::New1(::g::Fuse::Scripting::Context* context, ::g::Fuse::Scripting::Object* obj, bool suppressInitialCallback)
{
    Observable* obj1 = (Observable*)uNew(Observable_typeof());
    obj1->ctor_2(context, obj, suppressInitialCallback);
    return obj1;
}
// }
...
// internal class ObservableProperty :2100
// {
static void ObservableProperty_build(uType* type)
{
    ::TYPES[4] = ::g::Fuse::Scripting::IObserver_typeof();
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[103] = ::g::Uno::Action1_typeof()->MakeType(uObject_typeof(), NULL);
    type->SetInterfaces(
        ::TYPES[4/*Fuse.Scripting.IObserver*/], offsetof(ObservableProperty_type, interface0),
...
// public ObservableProperty(Fuse.Scripting.Context c, Fuse.Scripting.Object obj, Uno.UX.Property p) :2106
...
// private void Fuse.Scripting.IObserver.OnAdd(object addedValue) :2169
void ObservableProperty__FuseScriptingIObserverOnAdd_fn(ObservableProperty* __this, uObject* addedValue)
{
}

// private void Fuse.Scripting.IObserver.OnClear() :2151
...
// private void Fuse.Scripting.IObserver.OnFailed(string message) :2181
void ObservableProperty__FuseScriptingIObserverOnFailed_fn(ObservableProperty* __this, uString* message)
{
    uStackFrame __("Fuse.Scripting.ObservableProperty", "Fuse.Scripting.IObserver.OnFailed(string)");
    ::g::Fuse::Scripting::IObserver::OnClear(uInterface(uPtr(uAs<uObject*>(__this, ::TYPES[4/*Fuse.Scripting.IObserver*/])), ::TYPES[4/*Fuse.Scripting.IObserver*/]));
}

// private void Fuse.Scripting.IObserver.OnInsertAt(int index, object value) :2177
...
// private void Fuse.Scripting.IObserver.OnNewAll(Fuse.Scripting.ListMirror values) :2157
...
// private void Fuse.Scripting.IObserver.OnNewAt(int index, object newValue) :2161
...
// private void Fuse.Scripting.IObserver.OnRemoveAt(int index) :2173
void ObservableProperty__FuseScriptingIObserverOnRemoveAt_fn(ObservableProperty* __this, int* index)
{
}

// private void Fuse.Scripting.IObserver.OnSet(object newValue) :2165
...
// internal Fuse.Scripting.Observable GetObservable() :2117
...
// public string get_Name() :2113
void ObservableProperty__get_Name_fn(ObservableProperty* __this, uString** __retval)
{
    *__retval = __this->Name();
}

// public ObservableProperty New(Fuse.Scripting.Context c, Fuse.Scripting.Object obj, Uno.UX.Property p) :2106
...
void ObservableProperty__UnoUXIPropertyListenerOnPropertyChanged_fn(ObservableProperty* __this, ::g::Uno::UX::PropertyObject* obj, ::g::Uno::UX::Selector* prop)
{
    ...
    uPtr(__this->_context)->Invoke(uDelegate::New(::TYPES[6/*Uno.Action*/], (void*)ObservableProperty__PushCapture__Run_fn, ObservableProperty__PushCapture::New1(uDelegate::New(::TYPES[103/*Uno.Action<object>*/], (void*)ObservableProperty__PushValue_fn, __this), uPtr(__this->_property)->GetAsObject())));
}

// public ObservableProperty(Fuse.Scripting.Context c, Fuse.Scripting.Object obj, Uno.UX.Property p) [instance] :2106
...
// internal Fuse.Scripting.Observable GetObservable() [instance] :2117
...
// public string get_Name() [instance] :2113
...
// private void PushValue(object val) [instance] :2218
...
// public void Reset() [instance] :2135
...
// private void Set(object value) [instance] :2187
...
// private void Subscribe() [instance] :2128
...
// public ObservableProperty New(Fuse.Scripting.Context c, Fuse.Scripting.Object obj, Uno.UX.Property p) [static] :2106
...
void NativeEventEmitterModule__OnClosure::On(::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::Object* o)
{
    ...
    uPtr(o)->CallMethod(::STRINGS[92/*"on"*/], uArray::Init<uObject*>(::TYPES[7/*object[]*/], 2, (uObject*)_eventName, (uDelegate*)_listener));
}
...
// public abstract class Observable.Operation :1756
// {
...
// protected Operation(Fuse.Scripting.Observable observable) :1762
...
static void NativePromise__PromiseClosure_build(uType* type)
{
    ...
    ::TYPES[22] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[92] = ::g::Uno::Action1_typeof();
    ::TYPES[104] = ::TYPES[92/*Uno.Action`1*/]->MakeType(::g::Uno::Exception_typeof(), NULL);
    type->SetPrecalc(
        type->T(1),
...
uObject* NativePromise__PromiseClosure::Run(uArray* args)
{
    ...
    uPtr(_promise)->Then1(uDelegate::New(__types[0], (void*)NativePromise__PromiseClosure__Resolve_fn, this), uDelegate::New(::TYPES[104/*Uno.Action<Uno.Exception>*/], (void*)NativePromise__PromiseClosure__Reject_fn, this));
    return NULL;
}
...
{
    ::STRINGS[93] = uString::Const("this._raw_");
    ::STRINGS[94] = uString::Const("this._");
    ::STRINGS[95] = uString::Const(" (ScriptProperty)");
    ::STRINGS[96] = uString::Const("(function(cl, getObservable) { Object.defineProperty(cl.prototype, '");
    ::STRINGS[97] = uString::Const("', ");
    ::STRINGS[46] = uString::Const("{");
    ::STRINGS[98] = uString::Const("get: function() { ");
    ::STRINGS[99] = uString::Const("var obs = getObservable(this); ");
    ::STRINGS[100] = uString::Const("if (");
    ::STRINGS[101] = uString::Const(" != obs) {");
    ::STRINGS[102] = uString::Const(" = obs;");
    ::STRINGS[103] = uString::Const(" = obs");
    ::STRINGS[104] = uString::Const(";");
    ::STRINGS[49] = uString::Const("}");
    ::STRINGS[105] = uString::Const("return ");
    ::STRINGS[106] = uString::Const("})");
    ::TYPES[22] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[7] = uObject_typeof()->Array();
    ::TYPES[42] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[105] = ::g::Uno::UX::PropertyObject_typeof();
    type->SetFields(0,
...
void Context__PropertyClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptProperty* p, ::g::Fuse::Scripting::Context* context)
{
    ...
    _context = context;
    _p = p;
    uString* rawField = ::g::Uno::String::op_Addition2(::STRINGS[93/*"this._raw_"*/], uPtr(p)->Name);
    uString* propField = ::g::Uno::String::op_Addition2(::STRINGS[94/*"this._"*/], p->Name);
    ::g::Fuse::Scripting::Function* definer = uCast< ::g::Fuse::Scripting::Function*>(uPtr(context)->Evaluate(::g::Uno::String::op_Addition2(p->Name, ::STRINGS[95/*" (ScriptPro...*/]), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[96/*"(function(c...*/], p->Name), ::STRINGS[97/*"', "*/]), ::STRINGS[46/*"{"*/]), ::STRINGS[98/*"get: functi...*/]), ::STRINGS[99/*"var obs = g...*/]), ::STRINGS[100/*"if ("*/]), rawField), ::STRINGS[101/*" != obs) {"*/]), rawField), ::STRINGS[102/*" = obs;"*/]), propField), ::STRINGS[103/*" = obs"*/]), p->Modifier), ::STRINGS[104/*";"*/]), ::STRINGS[49/*"}"*/]), ::STRINGS[105/*"return "*/]), propField), ::STRINGS[49/*"}"*/]), ::STRINGS[106/*"})"*/]), ::STRINGS[106/*"})"*/])), ::TYPES[22/*Fuse.Scripting.Function*/]);
...
uObject* Context__PropertyClosure::GetObservable(uArray* args)
{
    ...
    ::g::Uno::UX::PropertyObject* obj = uAs< ::g::Uno::UX::PropertyObject*>(::g::Fuse::Scripting::Context::Wrap(uPtr(args)->Strong<uObject*>(0)), ::TYPES[105/*Uno.UX.PropertyObject*/]);
...
// private sealed class ObservableProperty.PushCapture :2201
// {
...
// public PushCapture(Uno.Action<object> push, object arg) :2206
...
// public PushCapture New(Uno.Action<object> push, object arg) :2206
...
// public void Run() :2212
void ObservableProperty__PushCapture__Run_fn(ObservableProperty__PushCapture* __this)
{
    __this->Run();
}

// public PushCapture(Uno.Action<object> push, object arg) [instance] :2206
...
// public PushCapture New(Uno.Action<object> push, object arg) [static] :2206
...
// private sealed class Observable.RemoveAt :1960
// {
...
// public RemoveAt(Fuse.Scripting.Observable obs, int index) :1964
...
// public RemoveAt New(Fuse.Scripting.Observable obs, int index) :1964
...
// protected override sealed void OnPerform(Uno.Collections.IList<Fuse.Scripting.Observable.Subscription> sub) :1969
...
// public RemoveAt(Fuse.Scripting.Observable obs, int index) [instance] :1964
...
// public RemoveAt New(Fuse.Scripting.Observable obs, int index) [static] :1964
...
// private sealed class Observable.RemoveRange :1982
// {
...
// public RemoveRange(Fuse.Scripting.Observable obs, int index, int count) :1987
...
// public RemoveRange New(Fuse.Scripting.Observable obs, int index, int count) :1987
...
// protected override sealed void OnPerform(Uno.Collections.IList<Fuse.Scripting.Observable.Subscription> sub) :1993
...
// public RemoveRange(Fuse.Scripting.Observable obs, int index, int count) [instance] :1987
...
// public RemoveRange New(Fuse.Scripting.Observable obs, int index, int count) [static] :1987
...
{
    ::STRINGS[107] = uString::Const("require(): accepts exactly one argument, ");
    ::STRINGS[108] = uString::Const(" provided");
    ::STRINGS[109] = uString::Const("require(): argument must be a string");
    ::STRINGS[110] = uString::Const("require(): module not found: ");
    ::STRINGS[111] = uString::Const("JavaScript error in ");
    ::STRINGS[112] = uString::Const(" was fixed!");
    ::STRINGS[76] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Scripting/0.46.1/$.uno");
    ::STRINGS[113] = uString::Const("Require");
    ::STRINGS[114] = uString::Const(" line ");
...
uObject* ScriptModule__RequireContext::Require(uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[107/*"require(): ...*/], uBox<int>(::TYPES[39/*int*/], uPtr(args)->Length())), ::STRINGS[108/*" provided"*/])));

    uString* id = uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[31/*string*/]);

    if (::g::Uno::String::op_Equality(id, NULL))
        U_THROW(::g::Fuse::Scripting::Error::New4(::STRINGS[109/*"require(): ...*/]));
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (mod == NULL)
            U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::STRINGS[110/*"require(): ...*/], id)));
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[111/*"JavaScript ...*/], path), ::STRINGS[112/*" was fixed!"*/]), this, ::STRINGS[76/*"/Users/hdc/...*/], 204, ::STRINGS[113/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[111/*"JavaScript ...*/], path), ::STRINGS[114/*" line "*/]), uBox<int>(::TYPES[39/*int*/], uPtr(e)->LineNumber())), ::STRINGS[115/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[76/*"/Users/hdc/...*/], 214, ::STRINGS[113/*"Require"*/]);
...
// public sealed class ScriptClass :2372
// {
// static ScriptClass() :2372
static void ScriptClass__cctor__fn(uType* __type)
{
    ScriptClass::_unoTypeToScriptClass_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[106/*Uno.Collections.Dictionary<Uno.Type, Fuse.Scripting.ScriptClass>*/]));
}

static void ScriptClass_build(uType* type)
{
    ::TYPES[106] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Type_typeof(), type, NULL);
    type->SetFields(0,
        ...
        ::TYPES[106/*Uno.Collections.Dictionary<Uno.Type, Fuse.Scripting.ScriptClass>*/], (uintptr_t)&::g::Fuse::Scripting::ScriptClass::_unoTypeToScriptClass_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(5,
...
// private ScriptClass(Uno.Type unoType, Fuse.Scripting.ScriptMember[] members) [instance] :2401
...
// public Fuse.Scripting.ScriptMember[] get_Members() [instance] :2399
uArray* ScriptClass::Members()
{
    return _members;
}

// public Fuse.Scripting.ScriptClass get_SuperType() [instance] :2378
...
// public Uno.Type get_Type() [instance] :2375
uType* ScriptClass::Type()
{
    return _unoType;
}

// public static Fuse.Scripting.ScriptClass Get(Uno.Type t) [static] :2384
...
// private ScriptClass New(Uno.Type unoType, Fuse.Scripting.ScriptMember[] members) [static] :2401
...
// public static void Register(Uno.Type unoType, Fuse.Scripting.ScriptMember[] members) [static] :2407
...
// public sealed class ScriptEventArgs :778
// {
// static ScriptEventArgs() :778
...
// public generated ScriptEventArgs() [instance] :778
void ScriptEventArgs::ctor_1()
{
    ctor_();
}

// public void Serialize(Fuse.Scripting.IEventSerializer s) [instance] :783
void ScriptEventArgs::Serialize(uObject* s)
{
}

// public generated ScriptEventArgs New() [static] :778
...
// public static new Fuse.Scripting.ScriptEventArgs get_Empty() [static] :781
...
// public sealed class ScriptException :2419
// {
static void ScriptException_build(uType* type)
{
    ::STRINGS[116] = uString::Const("Name: ");
    ::STRINGS[117] = uString::Const("Error message: ");
    ::STRINGS[118] = uString::Const("File name: ");
    ::STRINGS[119] = uString::Const("Line number: ");
    ::STRINGS[120] = uString::Const("Source line: ");
    ::STRINGS[121] = uString::Const("JS stack trace: ");
    ::TYPES[39] = ::g::Uno::Int_typeof();
    type->SetFields(3,
    ...
    type->Reflection.SetFunctions(7,
        ...
        new uFunction("get_LineNumber", NULL, (void*)ScriptException__get_LineNumber_fn, 0, false, ::TYPES[39/*int*/], 0),
        new uFunction("get_Name", NULL, (void*)ScriptException__get_Name_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction(".ctor", NULL, (void*)ScriptException__New4_fn, 0, true, type, 6, ::g::Uno::String_typeof(), ::g::Uno::String_typeof(), ::g::Uno::String_typeof(), ::TYPES[39/*int*/], ::g::Uno::String_typeof(), ::g::Uno::String_typeof()),
...
// public ScriptException(string name, string errorMessage, string fileName, int lineNumber, string sourceLine, string stackTrace) :2428
...
void ScriptException__get_Message_fn(ScriptException* __this, uString** __retval)
{
    ...
    {
        uPtr(stringBuilder)->Append2(::STRINGS[120/*"Source line: "*/]);
        stringBuilder->AppendLine(__this->SourceLine());
    }

    if (!::g::Uno::String::IsNullOrEmpty(__this->JSStackTrace()))
    {
        uPtr(stringBuilder)->Append2(::STRINGS[121/*"JS stack tr...*/]);
...
// public generated string get_Name() :2421
void ScriptException__get_Name_fn(ScriptException* __this, uString** __retval)
{
    *__retval = __this->Name();
}

// private generated void set_Name(string value) :2421
void ScriptException__set_Name_fn(ScriptException* __this, uString* value)
{
    __this->Name(value);
}

// public ScriptException New(string name, string errorMessage, string fileName, int lineNumber, string sourceLine, string stackTrace) :2428
...
// public generated string get_SourceLine() :2425
void ScriptException__get_SourceLine_fn(ScriptException* __this, uString** __retval)
{
    *__retval = __this->SourceLine();
}

// private generated void set_SourceLine(string value) :2425
void ScriptException__set_SourceLine_fn(ScriptException* __this, uString* value)
{
    __this->SourceLine(value);
}

// public ScriptException(string name, string errorMessage, string fileName, int lineNumber, string sourceLine, string stackTrace) [instance] :2428
...
// public generated string get_ErrorMessage() [instance] :2422
uString* ScriptException::ErrorMessage()
{
    return _ErrorMessage;
}

// private generated void set_ErrorMessage(string value) [instance] :2422
void ScriptException::ErrorMessage(uString* value)
{
    _ErrorMessage = value;
}

// public generated string get_FileName() [instance] :2423
uString* ScriptException::FileName()
{
    return _FileName;
}

// private generated void set_FileName(string value) [instance] :2423
void ScriptException::FileName(uString* value)
{
    _FileName = value;
}

// public generated string get_JSStackTrace() [instance] :2426
uString* ScriptException::JSStackTrace()
{
    return _JSStackTrace;
}

// private generated void set_JSStackTrace(string value) [instance] :2426
void ScriptException::JSStackTrace(uString* value)
{
    _JSStackTrace = value;
}

// public generated int get_LineNumber() [instance] :2424
int ScriptException::LineNumber()
{
    return _LineNumber;
}

// private generated void set_LineNumber(int value) [instance] :2424
void ScriptException::LineNumber(int value)
{
    _LineNumber = value;
}

// public generated string get_Name() [instance] :2421
uString* ScriptException::Name()
{
    return _Name;
}

// private generated void set_Name(string value) [instance] :2421
void ScriptException::Name(uString* value)
{
    _Name = value;
}

// public generated string get_SourceLine() [instance] :2425
uString* ScriptException::SourceLine()
{
    return _SourceLine;
}

// private generated void set_SourceLine(string value) [instance] :2425
void ScriptException::SourceLine(uString* value)
{
    _SourceLine = value;
}

// public ScriptException New(string name, string errorMessage, string fileName, int lineNumber, string sourceLine, string stackTrace) [static] :2428
...
// public abstract class ScriptMember :2248
// {
...
// protected ScriptMember(string name) :2252
void ScriptMember__ctor__fn(ScriptMember* __this, uString* name)
{
    __this->ctor_(name);
}

// protected ScriptMember(string name) [instance] :2252
...
// public abstract class ScriptMethod :2282
// {
...
// protected ScriptMethod(string name, Fuse.Scripting.ExecutionThread thread) :2286
void ScriptMethod__ctor_1_fn(ScriptMethod* __this, uString* name, int* thread)
{
    __this->ctor_1(name, *thread);
}

// protected ScriptMethod(string name, Fuse.Scripting.ExecutionThread thread) [instance] :2286
...
// public sealed class ScriptMethod<T> :2309
// {
static void ScriptMethod1_build(uType* type)
{
    ::STRINGS[122] = uString::Const("Cannot call a non-void method asynchronously");
    ::STRINGS[7] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/FuseCore/0.46.1/scripting/$.uno");
    ::STRINGS[123] = uString::Const("Call");
    ::TYPES[6] = ::g::Uno::Action_typeof();
    ::TYPES[107] = ScriptMethod1__CallClosure_typeof();
    type->SetPrecalc(
...
// public ScriptMethod(string name, Uno.Action<Fuse.Scripting.Context, T, object[]> method, Fuse.Scripting.ExecutionThread thread) :2319
...
// public ScriptMethod(string name, Uno.Func<Fuse.Scripting.Context, T, object[], object> method, Fuse.Scripting.ExecutionThread thread) :2314
...
// public override sealed object Call(Fuse.Scripting.Context c, object obj, object[] args) :2324
void ScriptMethod1__Call_fn(ScriptMethod1* __this, ::g::Fuse::Scripting::Context* c, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[122/*"Cannot call...*/], __this, ::STRINGS[7/*"/Users/hdc/...*/], 2330, ::STRINGS[123/*"Call"*/]);
            return *__retval = NULL, void();
        }
...
// public ScriptMethod New(string name, Uno.Action<Fuse.Scripting.Context, T, object[]> method, Fuse.Scripting.ExecutionThread thread) :2319
...
// public ScriptMethod New(string name, Uno.Func<Fuse.Scripting.Context, T, object[], object> method, Fuse.Scripting.ExecutionThread thread) :2314
...
// public ScriptMethod(string name, Uno.Action<Fuse.Scripting.Context, T, object[]> method, Fuse.Scripting.ExecutionThread thread) [instance] :2319
...
// public ScriptMethod(string name, Uno.Func<Fuse.Scripting.Context, T, object[], object> method, Fuse.Scripting.ExecutionThread thread) [instance] :2314
...
// public ScriptMethod New(string name, Uno.Action<Fuse.Scripting.Context, T, object[]> method, Fuse.Scripting.ExecutionThread thread) [static] :2319
...
// public ScriptMethod New(string name, Uno.Func<Fuse.Scripting.Context, T, object[], object> method, Fuse.Scripting.ExecutionThread thread) [static] :2314
...
// public ScriptMethodInline(string name, Fuse.Scripting.ExecutionThread thread, string code) :2298
...
// public override sealed object Call(Fuse.Scripting.Context c, object obj, object[] args) :2303
...
// public ScriptMethodInline New(string name, Fuse.Scripting.ExecutionThread thread, string code) :2298
...
// public ScriptMethodInline(string name, Fuse.Scripting.ExecutionThread thread, string code) [instance] :2298
...
// public ScriptMethodInline New(string name, Fuse.Scripting.ExecutionThread thread, string code) [static] :2298
...
{
    ScriptModule::ModuleContainsAnErrorMessage_ = ::STRINGS[124/*"require(): ...*/];
}

static void ScriptModule_build(uType* type)
{
    ::STRINGS[124] = uString::Const("require(): module contains an error: ");
    ::STRINGS[125] = uString::Const(".js");
    ::STRINGS[17] = uString::Const("");
    ::STRINGS[26] = uString::Const(".");
    ::STRINGS[126] = uString::Const("/");
    ::STRINGS[127] = uString::Const("..");
    ::STRINGS[128] = uString::Const("(function(");
    ::STRINGS[129] = uString::Const(") { ");
    ::STRINGS[130] = uString::Const("\n"
        " })");
    ::STRINGS[131] = uString::Const("Could not evaluate module '");
    ::STRINGS[132] = uString::Const("': JavaScript code contains errors");
    ::STRINGS[71] = uString::Const("exports");
    ::STRINGS[133] = uString::Const("module, exports, require");
    ::STRINGS[134] = uString::Const("/index.js");
    ::TYPES[108] = ::g::Fuse::Scripting::IModuleProvider_typeof();
    ::TYPES[69] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[99] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[22] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[42] = ::g::Fuse::Scripting::Callback_typeof();
    ...
    ::TYPES[46] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[47] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof(), NULL);
    ::TYPES[109] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[110] = ::g::Uno::UX::BundleFileSource_typeof();
    type->SetInterfaces(
...
void ScriptModule__Evaluate_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    uArray* newlines = uArray::New(::TYPES[69/*char[]*/], __this->LineNumberOffset());

    for (int i = 0; i < __this->LineNumberOffset(); ++i)
        uPtr(newlines)->Item<uChar>(i) = 10;

    ::g::Uno::Collections::List* args = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[99/*Uno.Collections.List<object>*/]);
    uString* wrappedCode = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[128/*"(function("*/], __this->GenerateArgs(c, result, args)), ::STRINGS[129/*") { "*/]), uString::CharArray(newlines)), __this->Code()), ::STRINGS[130/*"\n })"*/]);
    ...
    if (moduleFunc == NULL)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[131/*"Could not e...*/], __this->FileName()), ::STRINGS[132/*"': JavaScri...*/])));
...
void ScriptModule__GenerateArgs_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    return *__retval = ::STRINGS[133/*"module, exp...*/], void();
}
...
{
    return uIs(obj, ::TYPES[108/*Fuse.Scripting.IModuleProvider*/]);
}
...
::g::Uno::IO::Bundle* ScriptModule::Bundle()
{
    ...
    ::g::Uno::UX::BundleFileSource* bfs = uAs< ::g::Uno::UX::BundleFileSource*>(File(), ::TYPES[110/*Uno.UX.BundleFileSource*/]);
...
uString* ScriptModule::ComputePath(uString* moduleId, bool* isFile)
{
    ...
    if (::g::Uno::String::EndsWith(uPtr(moduleId), ::STRINGS[125/*".js"*/]))
        moduleId = ::g::Uno::String::Replace1(uPtr(moduleId), ::STRINGS[125/*".js"*/], ::STRINGS[17/*""*/]);
    ...
    else if (::g::Uno::String::StartsWith(uPtr(moduleId), ::STRINGS[126/*"/"*/]))
    {
        *isFile = true;
...
uString* ScriptModule::GetSourcePath()
{
    ...
    if (::g::Uno::String::op_Inequality(FileName(), NULL))
        return ::g::Uno::String::Trim1(uPtr(::g::Uno::String::Replace(uPtr(::g::Uno::IO::Path::GetDirectoryName(FileName())), '\\', '/')), uArray::Init<int>(::TYPES[69/*char[]*/], 1, '/'));
    else
        return ::STRINGS[17/*""*/];
}
...
::g::Fuse::Scripting::Module* ScriptModule::TryResolve(uString* path, bool isFile)
{
    ...
    if (!isFile)
    {
        ...
        if (::g::Uno::UX::Resource::TryFindGlobal(path, uDelegate::New(::TYPES[109/*Uno.Predicate<object>*/], (void*)ScriptModule__Acceptor_fn, this), &res))
        {
            uObject* mp = (uObject*)res;
            return ::g::Fuse::Scripting::IModuleProvider::GetModule(uInterface(uPtr(mp), ::TYPES[108/*Fuse.Scripting.IModuleProvider*/]));
        }
    }
...
uString* ScriptModule::ComputePath1(uString* sourcePath, uString* moduleId)
{
    ...
    uArray* parts = ::g::Uno::String::Split(uPtr(moduleId), uArray::Init<int>(::TYPES[69/*char[]*/], 1, '/'));
    ...
    for (int i = 0; i < uPtr(parts)->Length(); i++)
        if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[17/*""*/]))
            ...
            continue;
        else if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[127/*".."*/]))
            sourcePath = ::g::Uno::String::Replace(uPtr(::g::Uno::IO::Path::GetDirectoryName(sourcePath)), '\\', '/');
        else if (uPtr(sourcePath)->Length() > 0)
            sourcePath = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(sourcePath, ::STRINGS[126/*"/"*/]), uPtr(parts)->Strong<uString*>(i));
        else
...
bool ScriptModule::IsPathEqual(uString* src, uString* path)
{
    ...
    if (::g::Uno::String::op_Equality(src, ::g::Uno::String::op_Addition2(path, ::STRINGS[125/*".js"*/])))
        return true;

    if (::g::Uno::String::op_Equality(src, ::g::Uno::String::op_Addition2(path, ::STRINGS[134/*"/index.js"*/])))
        return true;
...
// public abstract class ScriptProperty :2258
// {
...
// protected ScriptProperty(string name, [string modifier]) :2261
void ScriptProperty__ctor_1_fn(ScriptProperty* __this, uString* name, uString* modifier)
{
    __this->ctor_1(name, modifier);
}

// protected ScriptProperty(string name, [string modifier]) [instance] :2261
...
// public sealed class ScriptProperty<TOwner, TValue> :2268
// {
static void ScriptProperty1_build(uType* type)
{
    ::STRINGS[135] = uString::Const("ScriptProperty: incorrect owner type");
    type->SetPrecalc(
        type->T(0));
    type->SetFields(2,
...
// public ScriptProperty(string name, Uno.Func<TOwner, Uno.UX.Property<TValue>> getter, [string modifier]) :2276
...
// public override sealed Uno.UX.Property GetProperty(Uno.UX.PropertyObject owner) :2271
void ScriptProperty1__GetProperty_fn(ScriptProperty1* __this, ::g::Uno::UX::PropertyObject* owner, ::g::Uno::UX::Property** __retval)
{
    ...
    if (!uIs(owner, __types[0]))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[135/*"ScriptPrope...*/]));

    return *__retval = (::g::Uno::UX::Property1*)uPtr(__this->_getter)->Invoke(1, (void*)uUnboxAny(__types[0], owner)), void();
}

// public ScriptProperty New(string name, Uno.Func<TOwner, Uno.UX.Property<TValue>> getter, [string modifier]) :2276
...
// public ScriptProperty(string name, Uno.Func<TOwner, Uno.UX.Property<TValue>> getter, [string modifier]) [instance] :2276
...
// public ScriptProperty New(string name, Uno.Func<TOwner, Uno.UX.Property<TValue>> getter, [string modifier]) [static] :2276
...
// private sealed class Observable.Set :1803
// {
...
// public Set(Fuse.Scripting.Observable obs, object value, int origin) :1808
...
// public Set New(Fuse.Scripting.Observable obs, object value, int origin) :1808
...
// protected override sealed void OnPerform(Uno.Collections.IList<Fuse.Scripting.Observable.Subscription> sub) :1819
...
// protected override sealed void Unsubscribe() :1814
...
// public Set(Fuse.Scripting.Observable obs, object value, int origin) [instance] :1808
...
// public Set New(Fuse.Scripting.Observable obs, object value, int origin) [static] :1808
...
// public sealed class StringChangedArgs :788
// {
...
// public StringChangedArgs(string newValue) :790
...
// public sealed class Observable.Subscription :1562
// {
// static Subscription() :1562
...
{
    ::STRINGS[81] = uString::Const("clear");
    ::STRINGS[136] = uString::Const("replaceAllWithOrigin");
    ::STRINGS[137] = uString::Const("Unexpected null object");
    ::STRINGS[7] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/FuseCore/0.46.1/scripting/$.uno");
    ::STRINGS[138] = uString::Const("SetExclusive");
    ::STRINGS[139] = uString::Const("setValueWithOrigin");
    ::STRINGS[140] = uString::Const("Failed to set Observable value");
    ::TYPES[4] = ::g::Fuse::Scripting::IObserver_typeof();
    ::TYPES[7] = uObject_typeof()->Array();
    ::TYPES[70] = ::g::Fuse::Scripting::ScriptException_typeof();
    type->SetInterfaces(
    ...
    type->Reflection.SetFunctions(8,
        ...
        new uFunction(".ctor", NULL, (void*)Observable__Subscription__New1_fn, 0, true, type, 2, ::g::Fuse::Scripting::Observable_typeof(), ::TYPES[4/*Fuse.Scripting.IObserver*/]),
        new uFunction("get_Observer", NULL, (void*)Observable__Subscription__get_Observer_fn, 0, false, ::TYPES[4/*Fuse.Scripting.IObserver*/], 0),
...
// public void SetExclusive(object newValue) :1592
...
// public bool ShouldSend([int origin]) :1570
...
// public Subscription(Fuse.Scripting.Observable om, Fuse.Scripting.IObserver obs) [instance] :1579
...
// public void ClearExclusive() [instance] :1624
void Observable__Subscription::ClearExclusive()
{
    uStackFrame __("Fuse.Scripting.Observable.Subscription", "ClearExclusive()");
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[81/*"clear"*/], uArray::Init<uObject*>(::TYPES[7/*object[]*/], 1, uBox<int>(::TYPES[39/*int*/], _origin)));
}

// public void Dispose() [instance] :1632
...
// public Fuse.Scripting.IObserver get_Observer() [instance] :1577
uObject* Observable__Subscription::Observer()
{
    return _obs;
}

// public generated bool get_Removed() [instance] :1568
bool Observable__Subscription::Removed()
{
    return _Removed;
}

// private generated void set_Removed(bool value) [instance] :1568
void Observable__Subscription::Removed(bool value)
{
    _Removed = value;
}

// public void ReplaceAllExclusive<T>(T[] newValues) [instance] :1612
void Observable__Subscription::ReplaceAllExclusive(uType* __type, uArray* newValues)
{
    ...
    uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[136/*"replaceAllW...*/], uArray::Init<uObject*>(::TYPES[7/*object[]*/], 2, sa, uBox<int>(::TYPES[39/*int*/], _origin)));
}

// public void SetExclusive(object newValue) [instance] :1592
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[137/*"Unexpected ...*/], this, ::STRINGS[7/*"/Users/hdc/...*/], 1596, ::STRINGS[138/*"SetExclusive"*/]);
        return;
    }

    try
    {
        uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[139/*"setValueWit...*/], uArray::Init<uObject*>(::TYPES[7/*object[]*/], 2, (uObject*)uPtr(uPtr(_om)->_context)->Unwrap(newValue), uBox<int>(::TYPES[39/*int*/], _origin)));
    }
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[70/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Diagnostics::UserScriptError(::STRINGS[140/*"Failed to s...*/], ex, this, ::STRINGS[7/*"/Users/hdc/...*/], 1608, ::STRINGS[138/*"SetExclusive"*/]);
        }
        else throw __t;
    }
}

// public bool ShouldSend([int origin]) [instance] :1570
bool Observable__Subscription::ShouldSend(int origin)
{
    return !Removed() && (origin != _origin);
}

// public Subscription New(Fuse.Scripting.Observable om, Fuse.Scripting.IObserver obs) [static] :1579
...
static void Value_build(uType* type)
{
    ...
    ::TYPES[40] = ::g::Uno::UInt_typeof();
    type->Reflection.SetFunctions(1,
        new uFunction("ToNumber", NULL, (void*)Value__ToNumber_fn, 0, true, ::TYPES[57/*double*/], 1, uObject_typeof()));
}
...
// public static double ToNumber(object obj) :2586
void Value__ToNumber_fn(uObject* obj, double* __retval)
{
    *__retval = Value::ToNumber(obj);
}

// public static double ToNumber(object obj) [static] :2586
double Value::ToNumber(uObject* obj)
{
    uStackFrame __("Fuse.Scripting.Value", "ToNumber(object)");

    if (uIs(obj, ::TYPES[57/*double*/]))
        return uUnbox<double>(::TYPES[57/*double*/], obj);
...
// public static void Unsubscribe(object obj) [static] :2656

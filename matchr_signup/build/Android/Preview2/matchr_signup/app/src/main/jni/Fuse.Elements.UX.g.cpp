...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Elements/0.46.1/ux/$.uno
// ---------------------------------------------------------------------------------------
...
static void XFunction_build(uType* type)
{
    type->SetFields(5);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)XFunction__New1_fn, 0, true, type, 0));
}
...
::g::Fuse::Elements::UX::LayoutFunction_type* XFunction_typeof()
{
    ...
    type->fp_ctor_ = (void*)XFunction__New1_fn;
    type->fp_OnPlaced = (void(*)(::g::Fuse::Elements::UX::LayoutFunction*, uObject*, ::g::Fuse::PlacedArgs*))XFunction__OnPlaced_fn;
    return type;
}

// public generated XFunction() :86
void XFunction__ctor_2_fn(XFunction* __this)
{
    __this->ctor_2();
}

// public generated XFunction New() :86
void XFunction__New1_fn(XFunction** __retval)
{
    *__retval = XFunction::New1();
}
...
{
    uStackFrame __("Fuse.Elements.UX.XFunction", "OnPlaced(object,Fuse.PlacedArgs)");
    __this->SetValue(::g::Uno::UX::Value::op_Implicit2(uPtr(args)->NewPosition().X));
}

// public generated XFunction() [instance] :86
void XFunction::ctor_2()
{
    ctor_1();
}

// public generated XFunction New() [static] :86
XFunction* XFunction::New1()
{
...
static void YFunction_build(uType* type)
{
    type->SetFields(5);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)YFunction__New1_fn, 0, true, type, 0));
}
...
::g::Fuse::Elements::UX::LayoutFunction_type* YFunction_typeof()
{
    ...
    type->fp_ctor_ = (void*)YFunction__New1_fn;
    type->fp_OnPlaced = (void(*)(::g::Fuse::Elements::UX::LayoutFunction*, uObject*, ::g::Fuse::PlacedArgs*))YFunction__OnPlaced_fn;
    return type;
}

// public generated YFunction() :95
void YFunction__ctor_2_fn(YFunction* __this)
{
    __this->ctor_2();
}

// public generated YFunction New() :95
void YFunction__New1_fn(YFunction** __retval)
{
    *__retval = YFunction::New1();
}
...
{
    uStackFrame __("Fuse.Elements.UX.YFunction", "OnPlaced(object,Fuse.PlacedArgs)");
    __this->SetValue(::g::Uno::UX::Value::op_Implicit2(uPtr(args)->NewPosition().Y));
}

// public generated YFunction() [instance] :95
void YFunction::ctor_2()
{
    ctor_1();
}

// public generated YFunction New() [static] :95
YFunction* YFunction::New1()
{

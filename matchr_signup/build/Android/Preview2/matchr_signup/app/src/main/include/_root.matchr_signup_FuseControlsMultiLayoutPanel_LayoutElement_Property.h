...
namespace g{struct matchr_signup_FuseControlsMultiLayoutPanel_LayoutElement_Property;}
...
struct matchr_signup_FuseControlsMultiLayoutPanel_LayoutElement_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Controls::MultiLayoutPanel*> _obj;

    void ctor_2(::g::Fuse::Controls::MultiLayoutPanel* obj, ::g::Uno::UX::Selector name);
    static matchr_signup_FuseControlsMultiLayoutPanel_LayoutElement_Property* New1(::g::Fuse::Controls::MultiLayoutPanel* obj, ::g::Uno::UX::Selector name);
};
// }

...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.WebSockets/0.46.1/$.uno
// --------------------------------------------------------------------------------------
...
static void WebSocketClient_build(uType* type)
{
    ...
    type->Reflection.SetFields(5,
        new uField("Closed", 1),
        new uField("DataReceived", 2),
        new uField("ErrorReceived", 3),
        new uField("MessageReceived", 4),
        new uField("Opened", 5));

...
// private sealed class TwoFinger.Point :1386
// {
...
static void Swiper_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Gestures/0.46.1/internal/$.uno");
...
// private void CheckNeedUpdated([bool off]) :1000
...
// private void RestartMove(float2 currentCoord) :1120
void Swiper__RestartMove_fn(Swiper* __this, ::g::Uno::Float2* currentCoord)
{
    __this->RestartMove(*currentCoord);
}

// private Fuse.Gestures.Internal.SwipeRegion SelectRegion(float2 diff, bool force) :1207
...
// public void SetActivation(Fuse.Gestures.Internal.SwipeRegion region, bool on, [bool bypass]) :1262
...
// private void CheckNeedUpdated([bool off]) [instance] :1000
void Swiper::CheckNeedUpdated(bool off)
{
    ...
    for (int i = 0; i < uPtr(_regions)->Count(); ++i)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[0/*"incomplete ...*/], this, ::STRINGS[1/*"/Users/hdc/...*/], 1013, ::STRINGS[2/*"CheckNeedUp...*/]);
...
// private void EndInteraction() [instance] :1058
...
// private float2 FromWindow(float2 p) [instance] :1105
...
// private void MoveUser(float2 coord, double elapsed, [bool release]) [instance] :1113
...
// private void OnLostCapture() [instance] :1049
...
// private void OnPointerMoved(object sender, Fuse.Input.PointerMovedArgs args) [instance] :1127
...
// private void OnPointerPressed(object sender, Fuse.Input.PointerPressedArgs args) [instance] :1076
...
// private void OnPointerReleased(object sender, Fuse.Input.PointerReleasedArgs args) [instance] :1230
...
// private void OnRooted(Fuse.Elements.Element n) [instance] :980
...
// private void OnUnrooted() [instance] :991
...
// private void OnUpdated() [instance] :1033
...
// private void RestartMove(float2 currentCoord) [instance] :1120
...
// private Fuse.Gestures.Internal.SwipeRegion SelectRegion(float2 diff, bool force) [instance] :1207
...
// public void SetActivation(Fuse.Gestures.Internal.SwipeRegion region, bool on, [bool bypass]) [instance] :1262
...
bool SwipeRegion::SetProgress(double value, int flags)
{
    ...
    if (endProgress)
    {
        if (!((_progress == 1.0) || (_progress == 0.0)))
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[6/*"Unexpected ...*/], this, ::STRINGS[1/*"/Users/hdc/...*/], 748, ::STRINGS[7/*"SetProgress"*/]);
...
// internal sealed class TwoFinger :1310
// {
// static TwoFinger() :1310
...
// public generated void add_Rotated(Fuse.Gestures.Internal.TwoFingerRotateHandler value) :1370
void TwoFinger__add_Rotated_fn(TwoFinger* __this, uDelegate* value)
{
    __this->add_Rotated(value);
}

// public generated void remove_Rotated(Fuse.Gestures.Internal.TwoFingerRotateHandler value) :1370
void TwoFinger__remove_Rotated_fn(TwoFinger* __this, uDelegate* value)
{
    __this->remove_Rotated(value);
}

// public generated void add_Started(Fuse.Gestures.Internal.TwoFingerEventHandler value) :1367
void TwoFinger__add_Started_fn(TwoFinger* __this, uDelegate* value)
{
    __this->add_Started(value);
}

// public generated void remove_Started(Fuse.Gestures.Internal.TwoFingerEventHandler value) :1367
void TwoFinger__remove_Started_fn(TwoFinger* __this, uDelegate* value)
{
    __this->remove_Started(value);
}

// public generated void add_Translated(Fuse.Gestures.Internal.TwoFingerTranslateHandler value) :1371
void TwoFinger__add_Translated_fn(TwoFinger* __this, uDelegate* value)
{
    __this->add_Translated(value);
}

// public generated void remove_Translated(Fuse.Gestures.Internal.TwoFingerTranslateHandler value) :1371
void TwoFinger__remove_Translated_fn(TwoFinger* __this, uDelegate* value)
{
    __this->remove_Translated(value);
}

// public generated void add_Zoomed(Fuse.Gestures.Internal.TwoFingerZoomHandler value) :1369
void TwoFinger__add_Zoomed_fn(TwoFinger* __this, uDelegate* value)
{
    __this->add_Zoomed(value);
}

// public generated void remove_Zoomed(Fuse.Gestures.Internal.TwoFingerZoomHandler value) :1369
...
// private TwoFinger(Fuse.Visual n) [instance] :1319
...
// private void Begin() [instance] :1415
...
// public void Detach() [instance] :1343
...
// public generated void add_Ended(Fuse.Gestures.Internal.TwoFingerEventHandler value) [instance] :1368
...
// public generated void remove_Ended(Fuse.Gestures.Internal.TwoFingerEventHandler value) [instance] :1368
...
// private float2 FromWindow(float2 p) [instance] :1435
...
// private void OnLostCapture() [instance] :1373
...
// private void OnPointerMoved(object sender, Fuse.Input.PointerMovedArgs args) [instance] :1452
...
// private void OnPointerPressed(object sender, Fuse.Input.PointerPressedArgs args) [instance] :1394
...
// private void OnPointerReleased(object sender, Fuse.Input.PointerReleasedArgs args) [instance] :1524
...
// private void OnRooted() [instance] :1353
...
// private void OnUnrooted() [instance] :1360
...
// private Fuse.Gestures.Internal.TwoFinger.Point PointFromArgs(Fuse.Input.PointerEventArgs args) [instance] :1443
...
// public generated void add_Rotated(Fuse.Gestures.Internal.TwoFingerRotateHandler value) [instance] :1370
...
// public generated void remove_Rotated(Fuse.Gestures.Internal.TwoFingerRotateHandler value) [instance] :1370
...
// public generated void add_Started(Fuse.Gestures.Internal.TwoFingerEventHandler value) [instance] :1367
...
// public generated void remove_Started(Fuse.Gestures.Internal.TwoFingerEventHandler value) [instance] :1367
...
// public generated void add_Translated(Fuse.Gestures.Internal.TwoFingerTranslateHandler value) [instance] :1371
...
// public generated void remove_Translated(Fuse.Gestures.Internal.TwoFingerTranslateHandler value) [instance] :1371
...
// public generated void add_Zoomed(Fuse.Gestures.Internal.TwoFingerZoomHandler value) [instance] :1369
...
// public generated void remove_Zoomed(Fuse.Gestures.Internal.TwoFingerZoomHandler value) [instance] :1369
...
// public static Fuse.Gestures.Internal.TwoFinger Attach(Fuse.Visual n) [static] :1327
...
// private TwoFinger New(Fuse.Visual n) [static] :1319
...
// internal delegate void TwoFingerEventHandler() :1305
...
// internal delegate void TwoFingerRotateHandler(float angle) :1307
...
// internal delegate void TwoFingerTranslateHandler(float2 amount) :1308
...
// internal delegate void TwoFingerZoomHandler(float factor) :1306

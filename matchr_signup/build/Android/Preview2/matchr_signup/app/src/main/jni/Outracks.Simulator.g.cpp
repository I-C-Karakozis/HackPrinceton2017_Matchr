...
static void Application_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(7,
        new uFunction(".ctor", NULL, (void*)Application__New1_fn, 0, true, type, 4, ::g::Uno::Net::IPEndPoint_typeof()->Array(), ::g::Uno::String_typeof(), ::g::Uno::Func_typeof()->MakeType(::g::Uno::IO::Bundle_typeof(), NULL), ::g::Uno::String_typeof()->Array()),
...
// public sealed class ArrayStream :1071
// {
...
// public override sealed int Read(byte[] dst, int byteOffset, int byteCount) :1136
...
// private void ResizeTo(int newSize) :1180
void ArrayStream__ResizeTo_fn(ArrayStream* __this, int* newSize)
{
    __this->ResizeTo(*newSize);
}

// public override sealed long Seek(long byteOffset, Uno.IO.SeekOrigin origin) :1147
...
// public override sealed void SetLength(long value) :1193
...
// public override sealed void Write(byte[] src, int byteOffset, int byteCount) :1122
...
// public ArrayStream(byte[] buffer) [instance] :1116
...
// public int get_Capacity() [instance] :1108
...
// private void EnsureCapacity(int byteCount) [instance] :1164
...
// public byte[] GetBuffer() [instance] :1188
uArray* ArrayStream::GetBuffer()
{
    return _buffer;
}

// private void ResizeTo(int newSize) [instance] :1180
...
// public ArrayStream New(byte[] buffer) [static] :1116
...
// public static class Bundle :2163
// {
...
// public static extern void AddOrUpdateFile(string projectRelativeFilePath, byte[] data) :2166
...
// public static extern void AddOrUpdateFile(string projectRelativeFilePath, byte[] data) [static] :2166
...
// public static class BytecodeCache :1567
// {
...
// public static void TrySave(Outracks.Simulator.Protocol.Reify reify) :1570
void BytecodeCache__TrySave_fn(::g::Outracks::Simulator::Protocol::Reify* reify)
{
    BytecodeCache::TrySave(reify);
}

// private static Outracks.Simulator.Protocol.Reify Load() [static] :1606
...
// private static void Save(Outracks.Simulator.Protocol.Reify reify) [static] :1582
...
// public static Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.Protocol.Reify> TryLoad() [static] :1594
...
// public static void TrySave(Outracks.Simulator.Protocol.Reify reify) [static] :1570
...
// private static string get_CacheFileName() [static] :1628
...
// private static string get_CachePath() [static] :1618
...
// private static string get_FuseDataDirectory() [static] :1623
...
// private static uint get_ProjectHash() [static] :1633
...
// internal sealed class ChangeIp :689
// {
...
// public override sealed Outracks.Simulator.State OnException(Uno.Exception e) :710
...
// protected override sealed Outracks.Simulator.State OnOk(string input) :696
...
// public ChangeIp([string body]) [instance] :691
...
// public ChangeIp New([string body]) [static] :691
...
// public static Uno.Action Apply<T>(Uno.Action<T> action, T arg) :27
...
// public static Uno.Action<TArg1> ApplySecond<TArg1, TArg2>(Uno.Action<TArg1, TArg2> action, TArg2 arg2) :17
...
// public static Uno.Action<TArg1, TArg2> Forget<TArg1, TArg2>(Uno.Action action) :32
void Closure__Forget_fn(uType* __type, uDelegate* action, uDelegate** __retval)
{
    *__retval = Closure::Forget(__type, action);
}

// public static Uno.Func<TArg, TResult> Return<TArg, TResult>(TResult result) :22
...
// public static Uno.Platform.ApplicationStateTransitionHandler ToAppStateChangeHandler(Uno.Action action) :42
...
// public static Uno.EventHandler ToEventHandler(Uno.Action action) :37
void Closure__ToEventHandler_fn(uDelegate* action, uDelegate** __retval)
{
    *__retval = Closure::ToEventHandler(action);
}

// public static Uno.Action<TArg1, TArg2> Forget<TArg1, TArg2>(Uno.Action action) [static] :32
...
// private sealed class EnumerableHitTestExtension.CollectHitNodesClosure :2052
// {
...
// public CollectHitNodesClosure(Uno.Collections.List<Fuse.Visual> nodes) :2056
...
// public void HitTestCallback(Fuse.HitTestResult result) :2061
...
// public CollectHitNodesClosure New(Uno.Collections.List<Fuse.Visual> nodes) :2056
...
// public CollectHitNodesClosure(Uno.Collections.List<Fuse.Visual> nodes) [instance] :2056
void EnumerableHitTestExtension__CollectHitNodesClosure::ctor_(::g::Uno::Collections::List* nodes)
{
    _nodes = nodes;
}

// public void HitTestCallback(Fuse.HitTestResult result) [instance] :2061
...
// public CollectHitNodesClosure New(Uno.Collections.List<Fuse.Visual> nodes) [static] :2056
...
// public bool TryDequeue(T& data) :27
...
// internal sealed class ConnectionLost :659
// {
...
// public ConnectionLost(Outracks.Simulator.Protocol.ExceptionInfo exception) :665
...
// public ConnectionLost(Uno.Exception exception) :661
void ConnectionLost__ctor_3_fn(ConnectionLost* __this, ::g::Uno::Exception* exception)
{
    __this->ctor_3(exception);
}

// public ConnectionLost New(Outracks.Simulator.Protocol.ExceptionInfo exception) :665
...
// public ConnectionLost New(Uno.Exception exception) :661
void ConnectionLost__New3_fn(::g::Uno::Exception* exception, ConnectionLost** __retval)
{
    *__retval = ConnectionLost::New3(exception);
}

// public ConnectionLost(Outracks.Simulator.Protocol.ExceptionInfo exception) [instance] :665
...
// public ConnectionLost(Uno.Exception exception) [instance] :661
...
// public ConnectionLost New(Outracks.Simulator.Protocol.ExceptionInfo exception) [static] :665
...
// public ConnectionLost New(Uno.Exception exception) [static] :661
...
// internal sealed class ConnectToEndpointClosure :912
// {
...
// public ConnectToEndpointClosure(Uno.Net.IPEndPoint endpoint) :916
...
// public Uno.Net.Sockets.Socket Execute() :921
...
// public ConnectToEndpointClosure New(Uno.Net.IPEndPoint endpoint) :916
...
// public ConnectToEndpointClosure(Uno.Net.IPEndPoint endpoint) [instance] :916
void ConnectToEndpointClosure::ctor_(::g::Uno::Net::IPEndPoint* endpoint)
{
    _endpoint = endpoint;
}

// public Uno.Net.Sockets.Socket Execute() [instance] :921
...
// public ConnectToEndpointClosure New(Uno.Net.IPEndPoint endpoint) [static] :916
...
// public static class ConnectToFirstRespondingEndpoint :895
// {
...
// public static Outracks.Simulator.Task<Uno.Net.Sockets.Socket> Execute(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) :897
...
// private static Uno.Net.Sockets.Socket OnNoResult(Uno.Collections.IEnumerable<Uno.Exception> exceptions) :906
...
// public static Outracks.Simulator.Task<Uno.Net.Sockets.Socket> Execute(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) [static] :897
...
// private static Uno.Net.Sockets.Socket OnNoResult(Uno.Collections.IEnumerable<Uno.Exception> exceptions) [static] :906
...
// public static class Context :1744
// {
...
// public static generated Outracks.Simulator.FakeApp get_App() :1747
void Context__get_App_fn(::g::Outracks::Simulator::FakeApp** __retval)
{
    *__retval = Context::App();
}

// private static generated void set_App(Outracks.Simulator.FakeApp value) :1747
void Context__set_App_fn(::g::Outracks::Simulator::FakeApp* value)
{
    Context::App(value);
}

// public static generated string[] get_Defines() :1750
void Context__get_Defines_fn(uArray** __retval)
{
    *__retval = Context::Defines();
}

// private static generated void set_Defines(string[] value) :1750
void Context__set_Defines_fn(uArray* value)
{
    Context::Defines(value);
}

// public static generated Outracks.Simulator.InputMode get_InputMode() :1746
void Context__get_InputMode_fn(int* __retval)
{
    *__retval = Context::InputMode();
}

// private static generated void set_InputMode(Outracks.Simulator.InputMode value) :1746
void Context__set_InputMode_fn(int* value)
{
    Context::InputMode(*value);
}

// public static generated string get_Project() :1749
void Context__get_Project_fn(uString** __retval)
{
    *__retval = Context::Project();
}

// private static generated void set_Project(string value) :1749
void Context__set_Project_fn(uString* value)
{
    Context::Project(value);
}

// public static Uno.IO.Bundle get_ProjectBundle() :1755
void Context__get_ProjectBundle_fn(::g::Uno::IO::Bundle** __retval)
{
    *__retval = Context::ProjectBundle();
}

// public static generated Uno.Net.IPEndPoint[] get_ProxyEndpoints() :1748
void Context__get_ProxyEndpoints_fn(uArray** __retval)
{
    *__retval = Context::ProxyEndpoints();
}

// private static generated void set_ProxyEndpoints(Uno.Net.IPEndPoint[] value) :1748
void Context__set_ProxyEndpoints_fn(uArray* value)
{
    Context::ProxyEndpoints(value);
}

// public static generated Outracks.Simulator.Runtime.IReflection get_Reflection() :1758
void Context__get_Reflection_fn(uObject** __retval)
{
    *__retval = Context::Reflection();
}

// public static generated void set_Reflection(Outracks.Simulator.Runtime.IReflection value) :1758
void Context__set_Reflection_fn(uObject* value)
{
    Context::Reflection(value);
}

// public static void SetApp(Outracks.Simulator.FakeApp app) :1776
void Context__SetApp_fn(::g::Outracks::Simulator::FakeApp* app)
{
    Context::SetApp(app);
}

// public static void SetDesignMode() :1760
void Context__SetDesignMode_fn()
{
    Context::SetDesignMode();
}

// public static void SetGlobals(Uno.Net.IPEndPoint[] proxyEndpoints, string project, Uno.Func<Uno.IO.Bundle> projectBundle, string[] defines) :1781
...
// public static void SetInteractiveMode() :1768
...
// public static void SetApp(Outracks.Simulator.FakeApp app) [static] :1776
void Context::SetApp(::g::Outracks::Simulator::FakeApp* app)
{
    Context::App(app);
}

// public static void SetDesignMode() [static] :1760
...
// public static void SetGlobals(Uno.Net.IPEndPoint[] proxyEndpoints, string project, Uno.Func<Uno.IO.Bundle> projectBundle, string[] defines) [static] :1781
...
// public static void SetInteractiveMode() [static] :1768
...
// public static generated Outracks.Simulator.FakeApp get_App() [static] :1747
::g::Outracks::Simulator::FakeApp* Context::App()
{
    return Context::_App_;
}

// private static generated void set_App(Outracks.Simulator.FakeApp value) [static] :1747
void Context::App(::g::Outracks::Simulator::FakeApp* value)
{
    Context::_App_ = value;
}

// public static generated string[] get_Defines() [static] :1750
uArray* Context::Defines()
{
    return Context::_Defines_;
}

// private static generated void set_Defines(string[] value) [static] :1750
void Context::Defines(uArray* value)
{
    Context::_Defines_ = value;
}

// public static generated Outracks.Simulator.InputMode get_InputMode() [static] :1746
int Context::InputMode()
{
    return Context::_InputMode_;
}

// private static generated void set_InputMode(Outracks.Simulator.InputMode value) [static] :1746
void Context::InputMode(int value)
{
    Context::_InputMode_ = value;
}

// public static generated string get_Project() [static] :1749
uString* Context::Project()
{
    return Context::_Project_;
}

// private static generated void set_Project(string value) [static] :1749
void Context::Project(uString* value)
{
    Context::_Project_ = value;
}

// public static Uno.IO.Bundle get_ProjectBundle() [static] :1755
...
// public static generated Uno.Net.IPEndPoint[] get_ProxyEndpoints() [static] :1748
uArray* Context::ProxyEndpoints()
{
    return Context::_ProxyEndpoints_;
}

// private static generated void set_ProxyEndpoints(Uno.Net.IPEndPoint[] value) [static] :1748
void Context::ProxyEndpoints(uArray* value)
{
    Context::_ProxyEndpoints_ = value;
}

// public static generated Outracks.Simulator.Runtime.IReflection get_Reflection() [static] :1758
uObject* Context::Reflection()
{
    return Context::_Reflection_;
}

// public static generated void set_Reflection(Outracks.Simulator.Runtime.IReflection value) [static] :1758
...
// public partial sealed class DeveloperMenu :2216
// {
...
// private void Close(object sender, Uno.EventArgs args) :2223
void DeveloperMenu__Close_fn(DeveloperMenu* __this, uObject* sender, ::g::Uno::EventArgs* args)
{
    __this->Close(sender, args);
}

// private void GoBack(object sender, Uno.EventArgs args) :2218
...
// private void Close(object sender, Uno.EventArgs args) [instance] :2223
...
// private void GoBack(object sender, Uno.EventArgs args) [instance] :2218
...
// public static extern string GetName() [static] :1675
uString* DeviceInfo::GetName()
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetName352", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
...
// public static string get_GUID() [static] :1660
uString* DeviceInfo::GUID()
{
    return DeviceInfo::GetGUID();
}

// public static string get_Name() [static] :1658
...
// internal sealed class DiagnosticItem :2245
// {
...
// public generated DiagnosticItem New() [static] :2245
...
// internal sealed class DiagnosticShower :2264
// {
...
// public DiagnosticShower(Fuse.Diagnostic diagnosticItem, Uno.Collections.List<Outracks.Simulator.DiagnosticItem> previousDiagnosticItems) :2269
...
// private void DisplayDiagnostic(Fuse.Diagnostic d) :2305
void DiagnosticShower__DisplayDiagnostic_fn(DiagnosticShower* __this, ::g::Fuse::Diagnostic* d)
{
    __this->DisplayDiagnostic(d);
}

// public DiagnosticShower New(Fuse.Diagnostic diagnosticItem, Uno.Collections.List<Outracks.Simulator.DiagnosticItem> previousDiagnosticItems) :2269
...
// public void Show() :2275
void DiagnosticShower__Show_fn(DiagnosticShower* __this)
{
    __this->Show();
}

// public DiagnosticShower(Fuse.Diagnostic diagnosticItem, Uno.Collections.List<Outracks.Simulator.DiagnosticItem> previousDiagnosticItems) [instance] :2269
...
// private void DisplayDiagnostic(Fuse.Diagnostic d) [instance] :2305
...
// public void Show() [instance] :2275
...
// public DiagnosticShower New(Fuse.Diagnostic diagnosticItem, Uno.Collections.List<Outracks.Simulator.DiagnosticItem> previousDiagnosticItems) [static] :2269
...
// internal sealed class DialogButton :1537
// {
...
// public DialogButton(string text, Outracks.Simulator.State destination) :1542
...
// public DialogButton New(string text, Outracks.Simulator.State destination) :1542
...
// public DialogButton(string text, Outracks.Simulator.State destination) [instance] :1542
...
// public DialogButton New(string text, Outracks.Simulator.State destination) [static] :1542
...
// internal static class EnumerableHitTestExtension :2042
// {
...
// public static Uno.Collections.IList<Fuse.Visual> HitTest2(Fuse.Visual node, float2 windowPoint) :2044
...
// public static Uno.Collections.IList<Fuse.Visual> HitTest2(Fuse.Visual node, float2 windowPoint) [static] :2044
...
// public partial sealed class ErrorToast :2192
// {
...
static void ErrorToast_build(uType* type)
{
    ...
    ::TYPES[54] = ::g::Fuse::Animations::Change_typeof()->MakeType(::g::Uno::Float_typeof(), NULL);
    ::TYPES[11] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[59] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL);
    ::TYPES[55] = ::g::Fuse::Gestures::ClickedHandler_typeof();
    ::TYPES[56] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Animations::Animator_typeof(), NULL);
    ::TYPES[60] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Drawing::Stroke_typeof(), NULL);
    ::TYPES[9] = ::g::Uno::Action_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Controls::Control_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Controls::Control_type, interface1),
        ::TYPES[59/*Uno.Collections.ICollection<Fuse.Binding>*/], offsetof(::g::Fuse::Controls::Control_type, interface2),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Controls::Control_type, interface3),
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(::g::Fuse::Controls::Control_type, interface4),
        ::g::Uno::UX::IPropertyListener_typeof(), offsetof(::g::Fuse::Controls::Control_type, interface5),
        ::TYPES[11/*Uno.Collections.ICollection<Fuse.Node>*/], offsetof(::g::Fuse::Controls::Control_type, interface6),
...
// public generated void add_Dismissed(Uno.Action value) :2206
void ErrorToast__add_Dismissed_fn(ErrorToast* __this, uDelegate* value)
{
    __this->add_Dismissed(value);
}

// public generated void remove_Dismissed(Uno.Action value) :2206
...
// public generated void add_Dismissed(Uno.Action value) [instance] :2206
...
// public generated void remove_Dismissed(Uno.Action value) [instance] :2206
...
void ErrorToast::InitializeUX1()
{
    ...
    ::g::Fuse::Animations::Scale* temp10 = ::g::Fuse::Animations::Scale::New2();
    ::g::Fuse::Animations::Change* temp11 = (::g::Fuse::Animations::Change*)::g::Fuse::Animations::Change::New2(::TYPES[54/*Fuse.Animations.Change<float>*/], this_Opacity_inst);
    ...
    ::g::Fuse::Animations::Change* temp14 = (::g::Fuse::Animations::Change*)::g::Fuse::Animations::Change::New2(::TYPES[54/*Fuse.Animations.Change<float>*/], this_Opacity_inst);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Bindings()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp5);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Bindings()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp8);
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(temp7, uDelegate::New(::TYPES[55/*Fuse.Gestures.ClickedHandler*/], (void*)ErrorToast__OnClicked_fn, this));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp9->Animators()), ::TYPES[56/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp10);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp9->Animators()), ::TYPES[56/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp11);
    temp10->Factor(0.8f);
    temp10->Duration(0.2);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp12->Animators()), ::TYPES[56/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp13);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp12->Animators()), ::TYPES[56/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp14);
    temp13->Factor(0.8f);
    temp13->Duration(0.4);
    ...
    temp2->Layer(1);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp2->Strokes()), ::TYPES[60/*Uno.Collections.ICollection<Fuse.Drawing.Stroke>*/]), temp3);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp2->Bindings()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp15);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp2->Bindings()), ::TYPES[59/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp16);
    temp3->Width(2.0f);
...
// private void OnClicked(object sender, Uno.EventArgs args) [instance] :2194
...
// internal static class Exceptions :613
// {
static void Exceptions_build(uType* type)
{
    ::TYPES[38] = ::g::Outracks::Simulator::ISimulatorClient_typeof();
    ::TYPES[61] = ::g::Uno::AggregateException_typeof();
    ::TYPES[62] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Exception_typeof(), NULL);
    ::TYPES[1] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[2] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Exception_typeof(), NULL);
}
...
// public static void Send(Outracks.Simulator.ISimulatorClient client, Uno.Collections.List<Uno.Exception> exceptions) :615
void Exceptions__Send_fn(uObject* client, ::g::Uno::Collections::List* exceptions)
{
    Exceptions::Send(client, exceptions);
}

// public static Uno.Collections.List<Uno.Exception> Unpack(Uno.Exception e) :624
void Exceptions__Unpack_fn(::g::Uno::Exception* e, ::g::Uno::Collections::List** __retval)
{
    *__retval = Exceptions::Unpack(e);
}

// public static void Send(Outracks.Simulator.ISimulatorClient client, Uno.Collections.List<Uno.Exception> exceptions) [static] :615
...
// public static Uno.Collections.List<Uno.Exception> Unpack(Uno.Exception e) [static] :624
::g::Uno::Collections::List* Exceptions::Unpack(::g::Uno::Exception* e)
{
    ...
    if (uIs(e, ::TYPES[61/*Uno.AggregateException*/]))
    {
        ::g::Uno::AggregateException* aggregate = uCast< ::g::Uno::AggregateException*>(e, ::TYPES[61/*Uno.AggregateException*/]);
        ::g::Uno::Collections::List* exceptions = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[62/*Uno.Collections.List<Uno.Exception>*/]);
    ...
    {
        collection2 = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[62/*Uno.Collections.List<Uno.Exception>*/]);
...
// internal sealed class FailedToConnect :676
// {
...
// public FailedToConnect New(Uno.Exception exception) [static] :678
...
static void FailedToConnectToProxy_build(uType* type)
{
    ::STRINGS[45] = uString::Const("Failed to connect to proxy:\n"
        "");
    ::TYPES[63] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(3/*ToImmutableList<Uno.Exception>*/, ::g::Uno::Exception_typeof(), NULL);
    type->SetFields(3,
...
void FailedToConnectToProxy::ctor_3(uObject* innerExceptions)
{
    ...
    InnerExceptions = ((::g::Outracks::Simulator::ImmutableList*)::g::Outracks::Simulator::List::ToImmutableList(::TYPES[63/*Outracks.Simulator.List.ToImmutableList<Uno.Exception>*/], innerExceptions));
}
...
// public sealed class FailedToConnectToSimulator :883
// {
...
// public FailedToConnectToSimulator(Uno.Collections.IEnumerable<Uno.Exception> innerExceptions) :887
void FailedToConnectToSimulator__ctor_3_fn(FailedToConnectToSimulator* __this, uObject* innerExceptions)
{
    __this->ctor_3(innerExceptions);
}

// public FailedToConnectToSimulator New(Uno.Collections.IEnumerable<Uno.Exception> innerExceptions) :887
...
// public FailedToConnectToSimulator(Uno.Collections.IEnumerable<Uno.Exception> innerExceptions) [instance] :887
...
// public FailedToConnectToSimulator New(Uno.Collections.IEnumerable<Uno.Exception> innerExceptions) [static] :887
...
// public sealed class FakeApp :1813
// {
static void FakeApp_build(uType* type)
{
    ::TYPES[64] = ::g::Outracks::Simulator::ConcurrentQueue_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[11] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[9] = ::g::Uno::Action_typeof();
    ::TYPES[65] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(4/*FirstOrDefault<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Controls::Control_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Controls::Control_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Controls::Control_type, interface2),
    ...
    type->SetFields(100,
        ...
        ::TYPES[64/*Outracks.Simulator.ConcurrentQueue<string>*/], offsetof(::g::Outracks::Simulator::FakeApp, _flashes), 0,
...
// protected override sealed void OnRooted() :1841
...
// protected override sealed void OnUnrooted() :1847
...
void FakeApp::ctor_7(::g::Fuse::App* app)
{
    ...
    _flashes = ((::g::Outracks::Simulator::ConcurrentQueue*)::g::Outracks::Simulator::ConcurrentQueue::New1(::TYPES[64/*Outracks.Simulator.ConcurrentQueue<string>*/]));
    ctor_6();
    _app = app;
...
// private void AddNewFlashes() [instance] :1886
...
// public new float4 get_Background() [instance] :1900
...
// public new void set_Background(float4 value) [instance] :1901
...
// public new Uno.Collections.IList<Fuse.Node> get_Children() [instance] :1906
...
// public float4 get_ClearColor() [instance] :1934
...
// public void set_ClearColor(float4 value) [instance] :1935
...
// public void Flash(string message) [instance] :1860
...
// private bool get_HasFlash() [instance] :1874
bool FakeApp::HasFlash()
{
    return _currentFlash != NULL;
}

// private void OnUpdate() [instance] :1853
void FakeApp::OnUpdate()
{
    UpdateFlashes();
}

// public Fuse.Node get_Overlay() [instance] :1918
::g::Fuse::Node* FakeApp::Overlay()
{
    uStackFrame __("Outracks.Simulator.FakeApp", "get_Overlay()");
    ::g::Fuse::Node* ret3;
    return (::g::Uno::Collections::EnumerableExtensions__FirstOrDefault_fn(::TYPES[65/*Uno.Collections.EnumerableExtensions.FirstOrDefault<Fuse.Node>*/], uPtr(_overlayPlaceholde)->Children(), &ret3), ret3);
}

// public void set_Overlay(Fuse.Node value) [instance] :1919
...
// private bool get_OverlayVisible() [instance] :1825
...
// private void set_OverlayVisible(bool value) [instance] :1826
...
// private void RemoveExpiredFlashes() [instance] :1877
...
// public new Uno.Collections.IList<Uno.UX.Resource> get_Resources() [instance] :1913
...
// private void UpdateFlashes() [instance] :1865
...
// public FakeApp New(Fuse.App app) [static] :1833
...
// internal sealed class Faulted :648
// {
...
// public Faulted(bool isOnline, Uno.Exception exception, Outracks.Simulator.DialogButton[] buttons) :650
...
// public Faulted New(bool isOnline, Uno.Exception exception, Outracks.Simulator.DialogButton[] buttons) :650
...
// public Faulted(bool isOnline, Uno.Exception exception, Outracks.Simulator.DialogButton[] buttons) [instance] :650
...
// public Faulted New(bool isOnline, Uno.Exception exception, Outracks.Simulator.DialogButton[] buttons) [static] :650
...
// internal sealed class Flasher :1967
// {
static void Flasher_build(uType* type)
{
    ::STRINGS[49] = uString::Const("#222");
    ::TYPES[66] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Drawing::GradientStop_typeof(), NULL);
    ::TYPES[11] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[9] = ::g::Uno::Action_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Controls::Control_type, interface0),
...
// protected override sealed void OnUnrooted() :1997
...
// private void OnUpdate() :2003
void Flasher__OnUpdate_fn(Flasher* __this)
{
    __this->OnUpdate();
}

// public Flasher(string text) [instance] :1971
void Flasher::ctor_7(uString* text)
{
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(linearGradient->Stops()), ::TYPES[66/*Uno.Collections.ICollection<Fuse.Drawing.GradientStop>*/]), ::g::Fuse::Drawing::GradientStop::New3(::g::Uno::Float4__New8((ind2 = ::g::Uno::Color::FromHex(::STRINGS[49/*"#222"*/]), ::g::Uno::Float3__New2(ind2.X, ind2.Y, ind2.Z)), 0.9f), 0.0f));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(linearGradient->Stops()), ::TYPES[66/*Uno.Collections.ICollection<Fuse.Drawing.GradientStop>*/]), ::g::Fuse::Drawing::GradientStop::New3(::g::Uno::Float4__New8((ind3 = ::g::Uno::Color::FromHex(::STRINGS[49/*"#222"*/]), ::g::Uno::Float3__New2(ind3.X, ind3.Y, ind3.Z)), 0.9f), 1.0f));
...
// public Flasher New(string text) [static] :1971
...
// public ForgetAction(Uno.Action action) :67
void ForgetAction__ctor__fn(ForgetAction* __this, uDelegate* action)
{
    __this->ctor_(action);
}

// public void Execute(TArg1 arg1) :72
...
{
    type->SetFields(0,
        ::g::Uno::Action_typeof(), offsetof(::g::Outracks::Simulator::ForgetAction1, _action), 0);
    type->Reflection.SetFunctions(2,
...
// internal static class GoOffline :716
// {
static void GoOffline_build(uType* type)
{
    ::STRINGS[51] = uString::Const("Go offline");
    ::TYPES[22] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Outracks::Simulator::Protocol::Reify_typeof(), NULL);
    ::TYPES[67] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(11/*ToArray<Outracks.Simulator.DialogButton>*/, ::g::Outracks::Simulator::DialogButton_typeof(), NULL);
    ::TYPES[68] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(13/*Union<Outracks.Simulator.DialogButton>*/, ::g::Outracks::Simulator::DialogButton_typeof(), NULL);
    ::TYPES[69] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1/*AsEnumerable<Outracks.Simulator.DialogButton>*/, ::g::Outracks::Simulator::DialogButton_typeof(), NULL);
    ::TYPES[46] = ::g::Outracks::Simulator::DialogButton_typeof()->Array();
    ::TYPES[70] = ::g::Outracks::Simulator::Protocol::MessageToClient_typeof()->Array();
    ::TYPES[71] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Outracks::Simulator::DialogButton_typeof(), NULL);
}
...
// public static Outracks.Simulator.DialogButton[] PrependOption(Outracks.Simulator.DialogButton[] otherButtons) :718
void GoOffline__PrependOption_fn(uArray* otherButtons, uArray** __retval)
{
    *__retval = GoOffline::PrependOption(otherButtons);
}

// public static Outracks.Simulator.DialogButton[] PrependOption(Outracks.Simulator.DialogButton[] otherButtons) [static] :718
uArray* GoOffline::PrependOption(uArray* otherButtons)
{
    ...
    return oldReify.HasValue(::TYPES[22/*Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.Protocol.Reify>*/]) ? (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[67/*Uno.Collections.EnumerableExtensions.ToArray<Outracks.Simulator.DialogButton>*/], (uObject*)::g::Uno::Collections::EnumerableExtensions::Union(::TYPES[68/*Uno.Collections.EnumerableExtensions.Union<Outracks.Simulator.DialogButton>*/], (uObject*)::g::Uno::Collections::EnumerableExtensions::AsEnumerable(::TYPES[69/*Uno.Collections.EnumerableExtensions.AsEnumerable<Outracks.Simulator.DialogButton>*/], uArray::Init< ::g::Outracks::Simulator::DialogButton*>(::TYPES[46/*Outracks.Simulator.DialogButton[]*/], 1, (::g::Outracks::Simulator::DialogButton*)::g::Outracks::Simulator::DialogButton::New1(::STRINGS[51/*"Go offline"*/], ::g::Outracks::Simulator::Idle::New1((uObject*)::g::Outracks::Simulator::OfflineSimulatorClient::New1(uArray::Init< ::g::Outracks::Simulator::Protocol::MessageToClient*>(::TYPES[70/*Outracks.Simulator.Protocol.MessageToClient[]*/], 1, (::g::Outracks::Simulator::Protocol::Reify*)oldReify.Value(::TYPES[22/*Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.Protocol.Reify>*/]))))))), (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[71/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Outracks.Simulator.DialogButton>*/], otherButtons)))) : otherButtons;
}
// }
...
static void Idle_build(uType* type)
{
    ...
    ::STRINGS[43] = uString::Const("Try again");
    ::TYPES[72] = ::g::Uno::Diagnostics::LogHandler_typeof();
    ::TYPES[38] = ::g::Outracks::Simulator::ISimulatorClient_typeof();
    ::TYPES[13] = ::g::Fuse::DiagnosticHandler_typeof();
    ::TYPES[46] = ::g::Outracks::Simulator::DialogButton_typeof()->Array();
    type->SetFields(1);
...
void Idle__OnEnterState_fn(Idle* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ::g::Uno::Diagnostics::Debug::SetLogHandler(uDelegate::New(::TYPES[72/*Uno.Diagnostics.LogHandler*/], (void*)Idle__SendDebugLog_fn, __this));
...
{
    ::TYPES[37] = uObject_typeof()->Array();
    ::TYPES[73] = ::g::Uno::Array_typeof();
    ::TYPES[74] = ::g::Uno::Collections::IEnumerable_typeof();
    ::TYPES[75] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof();
    ::TYPES[76] = ::g::Uno::Collections::EnumerableExtensions_typeof();
    type->SetPrecalc(
        type->T(0)->Array(),
    ...
    type->SetInterfaces(
        ::TYPES[74/*Uno.Collections.IEnumerable`1*/]->MakeType(type->T(0), NULL), offsetof(ImmutableList_type, interface0));
    type->SetFields(0,
    ...
    type->Reflection.SetFunctions(8,
        ...
        new uFunction("InsertRange", NULL, (void*)ImmutableList__InsertRange_fn, 0, false, type, 2, ::g::Uno::Int_typeof(), ::TYPES[74/*Uno.Collections.IEnumerable`1*/]->MakeType(type->T(0), NULL)),
...
static void IndentString_build(uType* type)
{
    ...
    ::TYPES[77] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(9/*Select<string, string>*/, ::g::Uno::String_typeof(), ::g::Uno::String_typeof(), NULL);
    ::TYPES[45] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[78] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[79] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof(), NULL);
    type->Reflection.SetFunctions(1,
...
uString* IndentString::Indent(uString* str)
{
    ...
    return ::g::Outracks::Simulator::StringSplitting::Join((uObject*)::g::Uno::Collections::EnumerableExtensions::Select(::TYPES[77/*Uno.Collections.EnumerableExtensions.Select<string, string>*/], (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[45/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<string>*/], ::g::Uno::String::Split(uPtr(str), uArray::Init<int>(::TYPES[78/*char[]*/], 1, 10)))), uDelegate::New(::TYPES[79/*Uno.Func<string, string>*/], (void*)IndentString__PrefixWithTab_fn)), ::STRINGS[2/*"\n"*/]);
}
...
// public abstract interface ISimulatorClient :839
// {
...
{
    ::TYPES[80] = ::g::Outracks::Simulator::ImmutableList_typeof();
    ::TYPES[37] = uObject_typeof()->Array();
    ::TYPES[76] = ::g::Uno::Collections::EnumerableExtensions_typeof();
    ::TYPES[1] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[81] = ::g::Uno::Collections::IEnumerator1_typeof();
    type->MethodTypes[0]->SetPrecalc(
        ::TYPES[80/*Outracks.Simulator.ImmutableList`1*/]->MakeType(type->MethodTypes[0]->U(0), NULL));
    type->MethodTypes[1]->SetPrecalc(
        type->MakeMethod(2/*ReadImmutableList<T>*/, type->MethodTypes[1]->U(0), NULL));
    type->MethodTypes[2]->SetPrecalc(
        type->MethodTypes[2]->U(0)->Array(),
        ::TYPES[80/*Outracks.Simulator.ImmutableList`1*/]->MakeType(type->MethodTypes[2]->U(0), NULL));
    type->MethodTypes[3]->SetPrecalc(
        ::TYPES[80/*Outracks.Simulator.ImmutableList`1*/]->MakeType(type->MethodTypes[3]->U(0), NULL),
        ::TYPES[76/*Uno.Collections.EnumerableExtensions*/]->MakeMethod(11/*ToArray<T>*/, type->MethodTypes[3]->U(0), NULL));
    type->MethodTypes[4]->SetPrecalc(
        type->MakeMethod(5/*Write<T>*/, type->MethodTypes[4]->U(0), NULL));
    type->MethodTypes[5]->SetPrecalc(
        ::TYPES[81/*Uno.Collections.IEnumerator`1*/]->MakeType(type->MethodTypes[5]->U(0), NULL));
    type->Reflection.SetFunctions(6,
        new uFunction("Create`1", type->MethodTypes[0], (void*)List__Create_fn, 0, true, ::TYPES[80/*Outracks.Simulator.ImmutableList`1*/]->MakeType(type->MethodTypes[0]->U(0), NULL), 1, type->MethodTypes[0]->U(0)->Array()),
        new uFunction("Read`1", type->MethodTypes[1], (void*)List__Read_fn, 0, true, ::TYPES[80/*Outracks.Simulator.ImmutableList`1*/]->MakeType(type->MethodTypes[1]->U(0), NULL), 2, ::g::Uno::IO::BinaryReader_typeof(), ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), type->MethodTypes[1]->U(0), NULL)),
        new uFunction("ReadImmutableList`1", type->MethodTypes[2], (void*)List__ReadImmutableList_fn, 0, true, ::TYPES[80/*Outracks.Simulator.ImmutableList`1*/]->MakeType(type->MethodTypes[2]->U(0), NULL), 2, ::g::Uno::IO::BinaryReader_typeof(), ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), type->MethodTypes[2]->U(0), NULL)),
        new uFunction("ToImmutableList`1", type->MethodTypes[3], (void*)List__ToImmutableList_fn, 0, true, ::TYPES[80/*Outracks.Simulator.ImmutableList`1*/]->MakeType(type->MethodTypes[3]->U(0), NULL), 1, ::g::Uno::Collections::IEnumerable_typeof()->MakeType(type->MethodTypes[3]->U(0), NULL)),
        new uFunction("Write`1", type->MethodTypes[4], (void*)List__Write_fn, 0, true, uVoid_typeof(), 3, ::TYPES[80/*Outracks.Simulator.ImmutableList`1*/]->MakeType(type->MethodTypes[4]->U(0), NULL), ::g::Uno::IO::BinaryWriter_typeof(), ::g::Uno::Action2_typeof()->MakeType(type->MethodTypes[4]->U(0), ::g::Uno::IO::BinaryWriter_typeof(), NULL)),
        new uFunction("Write`1", type->MethodTypes[5], (void*)List__Write1_fn, 0, true, uVoid_typeof(), 3, ::g::Uno::IO::BinaryWriter_typeof(), ::TYPES[80/*Outracks.Simulator.ImmutableList`1*/]->MakeType(type->MethodTypes[5]->U(0), NULL), ::g::Uno::Action2_typeof()->MakeType(type->MethodTypes[5]->U(0), ::g::Uno::IO::BinaryWriter_typeof(), NULL)));
}
...
// internal sealed class LoadingScreen :1222
// {
...
// public generated LoadingScreen() :1222
void LoadingScreen__ctor__fn(LoadingScreen* __this)
{
    __this->ctor_();
}

// public generated LoadingScreen New() :1222
void LoadingScreen__New1_fn(LoadingScreen** __retval)
{
    *__retval = LoadingScreen::New1();
}

// public static void Show(Outracks.Simulator.FakeApp app, string header, string message) :1224
...
// public generated LoadingScreen() [instance] :1222
void LoadingScreen::ctor_()
{
}

// public generated LoadingScreen New() [static] :1222
...
// public static void Show(Outracks.Simulator.FakeApp app, string header, string message) [static] :1224
...
// internal sealed class ModalDialog :1253
// {
static void ModalDialog_build(uType* type)
{
    ...
    ::TYPES[11] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[82] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(11/*ToArray<Fuse.Controls.Control>*/, ::g::Fuse::Controls::Control_typeof(), NULL);
    ::TYPES[83] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Controls::Control_typeof(), NULL);
    ::TYPES[1] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[84] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Controls::Control_typeof(), NULL);
}
...
// public generated ModalDialog() :1253
void ModalDialog__ctor__fn(ModalDialog* __this)
{
    __this->ctor_();
}

// public generated ModalDialog New() :1253
void ModalDialog__New1_fn(ModalDialog** __retval)
{
    *__retval = ModalDialog::New1();
}

// public static void Show(Outracks.Simulator.FakeApp app, string header, string body, string details, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) :1299
...
// public static void ShowPrompt(Outracks.Simulator.FakeApp app, string header, string body, Fuse.Controls.Control inputControl, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) :1255
...
// public generated ModalDialog() [instance] :1253
void ModalDialog::ctor_()
{
}

// public generated ModalDialog New() [static] :1253
...
// public static void Show(Outracks.Simulator.FakeApp app, string header, string body, string details, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) [static] :1299
void ModalDialog::Show(::g::Outracks::Simulator::FakeApp* app, uString* header, uString* body, uString* details, uObject* buttons)
{
    ...
    uArray* buttonArray = (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[82/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Controls.Control>*/], buttons);
...
// public static void ShowPrompt(Outracks.Simulator.FakeApp app, string header, string body, Fuse.Controls.Control inputControl, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) [static] :1255
void ModalDialog::ShowPrompt(::g::Outracks::Simulator::FakeApp* app, uString* header, uString* body, ::g::Fuse::Controls::Control* inputControl, uObject* buttons)
{
    ...
    for (uObject* enum6 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(buttons), ::TYPES[83/*Uno.Collections.IEnumerable<Fuse.Controls.Control>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum6), ::TYPES[1/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Controls::Control* btn = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum6), ::TYPES[84/*Uno.Collections.IEnumerator<Fuse.Controls.Control>*/]), &ret43), ret43);
...
// public sealed class OfflineSimulatorClient :848
// {
static void OfflineSimulatorClient_build(uType* type)
{
    ::TYPES[85] = ::g::Outracks::Simulator::ConcurrentQueue_typeof()->MakeType(::g::Outracks::Simulator::Protocol::MessageFromClient_typeof(), NULL);
    ::TYPES[86] = ::g::Outracks::Simulator::ConcurrentQueue_typeof()->MakeType(::g::Outracks::Simulator::Protocol::MessageToClient_typeof(), NULL);
    type->SetInterfaces(
    ...
    type->SetFields(0,
        ::TYPES[85/*Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageFromClient>*/], offsetof(::g::Outracks::Simulator::OfflineSimulatorClient, _messagesFromClient), 0,
        ::TYPES[86/*Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient>*/], offsetof(::g::Outracks::Simulator::OfflineSimulatorClient, _messagesToClient), 0);
    type->Reflection.SetFunctions(5,
        new uFunction("Dispose", NULL, (void*)OfflineSimulatorClient__Dispose_fn, 0, false, uVoid_typeof(), 0),
        new uFunction("get_IncommingMessages", NULL, (void*)OfflineSimulatorClient__get_IncommingMessages_fn, 0, false, ::TYPES[86/*Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient>*/], 0),
...
// public OfflineSimulatorClient(Outracks.Simulator.Protocol.MessageToClient[] initialMessages) :853
...
// public Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient> get_IncommingMessages() :861
...
// public bool get_IsOnline() :876
void OfflineSimulatorClient__get_IsOnline_fn(OfflineSimulatorClient* __this, bool* __retval)
{
    *__retval = __this->IsOnline();
}

// public OfflineSimulatorClient New(Outracks.Simulator.Protocol.MessageToClient[] initialMessages) :853
...
// public void Send(Outracks.Simulator.Protocol.MessageFromClient message) :864
...
// public OfflineSimulatorClient(Outracks.Simulator.Protocol.MessageToClient[] initialMessages) [instance] :853
void OfflineSimulatorClient::ctor_(uArray* initialMessages)
{
    ...
    int index2;
    int length3;
    _messagesFromClient = ((::g::Outracks::Simulator::ConcurrentQueue*)::g::Outracks::Simulator::ConcurrentQueue::New1(::TYPES[85/*Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageFromClient>*/]));
    _messagesToClient = ((::g::Outracks::Simulator::ConcurrentQueue*)::g::Outracks::Simulator::ConcurrentQueue::New1(::TYPES[86/*Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient>*/]));
...
// public Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient> get_IncommingMessages() [instance] :861
::g::Outracks::Simulator::ConcurrentQueue* OfflineSimulatorClient::IncommingMessages()
{
    return _messagesToClient;
}

// public bool get_IsOnline() [instance] :876
bool OfflineSimulatorClient::IsOnline()
{
    return false;
}

// public void Send(Outracks.Simulator.Protocol.MessageFromClient message) [instance] :864
...
// public OfflineSimulatorClient New(Outracks.Simulator.Protocol.MessageToClient[] initialMessages) [static] :853
...
{
    ::TYPES[87] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Outracks::Simulator::Task_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof()->Array(), NULL), NULL);
    ::TYPES[48] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof(), NULL);
    ::TYPES[1] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[49] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof(), NULL);
    ::TYPES[88] = ::g::Outracks::Simulator::Tasks_typeof()->MakeMethod(0/*Run<Uno.Net.IPEndPoint[]>*/, ::g::Uno::Net::IPEndPoint_typeof()->Array(), NULL);
    ::TYPES[89] = ::g::Uno::Func_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof()->Array(), NULL);
    ::TYPES[90] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(11/*ToArray<string>*/, ::g::Uno::String_typeof(), NULL);
    ::TYPES[91] = ::g::Outracks::Simulator::Tasks_typeof()->MakeMethod(1/*WaitForFirstResult<Uno.Net.IPEndPoint[]>*/, ::g::Uno::Net::IPEndPoint_typeof()->Array(), NULL);
    ::TYPES[92] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Exception_typeof(), NULL), ::g::Uno::Net::IPEndPoint_typeof()->Array(), NULL);
    type->Reflection.SetFunctions(2,
...
::g::Outracks::Simulator::Task* ProxyClient::GetSimulatorEndpoint(uObject* proxyEndpoints, uString* project, uObject* defines)
{
    ...
    ::g::Uno::Collections::List* tasks = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[87/*Uno.Collections.List<Outracks.Simulator.Task<Uno.Net.IPEndPoint[]>>*/]);
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(proxyEndpoints), ::TYPES[48/*Uno.Collections.IEnumerable<Uno.Net.IPEndPoint>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[1/*Uno.Collections.IEnumerator*/])); )
    {
        ...
        ::g::Uno::Collections::List__Add_fn(uPtr(tasks), (::g::Outracks::Simulator::Task*)::g::Outracks::Simulator::Tasks::Run(::TYPES[88/*Outracks.Simulator.Tasks.Run<Uno.Net.IPEndPoint[]>*/], uDelegate::New(::TYPES[89/*Uno.Func<Uno.Net.IPEndPoint[]>*/], (void*)::g::Outracks::Simulator::GetSimulatorEndpoint__Execute_fn, ::g::Outracks::Simulator::GetSimulatorEndpoint::New1(endpoint, project, (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[90/*Uno.Collections.EnumerableExtensions.ToArray<string>*/], defines)))));
    }

    return (::g::Outracks::Simulator::Task*)::g::Outracks::Simulator::Tasks::WaitForFirstResult(::TYPES[91/*Outracks.Simulator.Tasks.WaitForFirstResult<Uno.Net.IPEndPoint[]>*/], (uObject*)tasks, uDelegate::New(::TYPES[92/*Uno.Func<Uno.Collections.IEnumerable<Uno.Exception>, Uno.Net.IPEndPoint[]>*/], (void*)ProxyClient__OnNoResult_fn));
}
...
static void Running_build(uType* type)
{
    ...
    ::TYPES[38] = ::g::Outracks::Simulator::ISimulatorClient_typeof();
    ::TYPES[46] = ::g::Outracks::Simulator::DialogButton_typeof()->Array();
    ::TYPES[93] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[94] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Visual_typeof(), NULL);
    type->SetFields(1,
...
// private static string GetTag(Fuse.Node node) :601
...
// public override sealed Outracks.Simulator.State OnPointerPressed(Fuse.Input.PointerPressedArgs args) :579
void Running__OnPointerPressed_fn(Running* __this, ::g::Fuse::Input::PointerPressedArgs* args, ::g::Outracks::Simulator::State** __retval)
{
    ...
    uString* selectedTag = (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(nodes), ::TYPES[93/*Uno.Collections.ICollection<Fuse.Visual>*/])) >= 1) ? (uString*)Running::GetTag((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(nodes), ::TYPES[94/*Uno.Collections.IList<Fuse.Visual>*/]), uCRef<int>(0), &ret2), ret2)) : ::STRINGS[20/*"N/A"*/];
...
// private static string GetTag(Fuse.Node node) [static] :601
...
{
    Serialization::ReadString_ = uDelegate::New(::TYPES[95/*Uno.Func<Uno.IO.BinaryReader, string>*/], (void*)Serialization___ReadString_fn);
}

static void Serialization_build(uType* type)
{
    ::TYPES[95] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), ::g::Uno::String_typeof(), NULL);
    type->SetFields(0,
        ::TYPES[95/*Uno.Func<Uno.IO.BinaryReader, string>*/], (uintptr_t)&::g::Outracks::Simulator::Serialization::ReadString_, uFieldFlagsStatic);
}
...
// internal class ShowingModalDialog :1475
// {
static void ShowingModalDialog_build(uType* type)
{
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno");
    ::TYPES[96] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(3/*Some<Outracks.Simulator.DialogButton>*/, ::g::Outracks::Simulator::DialogButton_typeof(), NULL);
    ::TYPES[97] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Controls::Control_typeof(), NULL);
    ::TYPES[98] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(0/*Apply<Outracks.Simulator.DialogButton>*/, ::g::Outracks::Simulator::DialogButton_typeof(), NULL);
    ::TYPES[99] = ::g::Uno::Action1_typeof()->MakeType(::g::Outracks::Simulator::DialogButton_typeof(), NULL);
    ::TYPES[55] = ::g::Fuse::Gestures::ClickedHandler_typeof();
    ::TYPES[100] = ::g::Outracks::Simulator::ForgetAction1_typeof()->MakeType(uObject_typeof(), ::g::Fuse::Gestures::ClickedArgs_typeof(), NULL);
    ::TYPES[101] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Outracks::Simulator::DialogButton_typeof(), NULL);
    type->SetFields(0,
        ...
        ::TYPES[101/*Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.DialogButton>*/], (uintptr_t)0, uFieldFlagsConstrained,
...
// public ShowingModalDialog(string header, string body, string details, Outracks.Simulator.DialogButton[] buttons) :1484
...
// public ShowingModalDialog New(string header, string body, string details, Outracks.Simulator.DialogButton[] buttons) :1484
...
// private void OnButtonClicked(Outracks.Simulator.DialogButton button) :1517
...
// public override sealed Outracks.Simulator.State OnEnterState() :1496
void ShowingModalDialog__OnEnterState_fn(ShowingModalDialog* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    uDelegate* ret8;
    ::g::Uno::Collections::List* buttons = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[97/*Uno.Collections.List<Fuse.Controls.Control>*/]);
    ...
    for (array1 = __this->_buttons, index2 = 0, length3 = uPtr(array1)->Length(); index2 < length3; ++index2)
    {
        ...
        uDelegate* action = (::g::Outracks::Simulator::Closure__Apply_fn(::TYPES[98/*Outracks.Simulator.Closure.Apply<Outracks.Simulator.DialogButton>*/], uDelegate::New(::TYPES[99/*Uno.Action<Outracks.Simulator.DialogButton>*/], (void*)ShowingModalDialog__OnButtonClicked_fn, __this), button, &ret8), ret8);
        uDelegate* handler = uDelegate::New(::TYPES[55/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Outracks::Simulator::ForgetAction1__Execute_fn, (::g::Outracks::Simulator::ForgetAction1*)::g::Outracks::Simulator::ForgetAction1::New1(::TYPES[100/*Outracks.Simulator.ForgetAction<object, Fuse.Gestures.ClickedArgs>*/], action));
...
// public override sealed Outracks.Simulator.State OnException(Uno.Exception e) :1530
void ShowingModalDialog__OnException_fn(ShowingModalDialog* __this, ::g::Uno::Exception* e, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->Message(), 1, ::STRINGS[4/*"/usr/local/...*/], 1532);
    return *__retval = __this, void();
}

// public override sealed Outracks.Simulator.State OnUpdate() :1522
void ShowingModalDialog__OnUpdate_fn(ShowingModalDialog* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    if (__this->_clickedButton().Value< ::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::DialogButton*> > >().HasValue(::TYPES[101/*Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.DialogButton>*/]))
        return *__retval = uPtr(__this->_clickedButton().Value< ::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::DialogButton*> > >().Value(::TYPES[101/*Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.DialogButton>*/]))->Destination, void();

    return *__retval = __this, void();
}

// public ShowingModalDialog(string header, string body, string details, Outracks.Simulator.DialogButton[] buttons) [instance] :1484
...
// private void OnButtonClicked(Outracks.Simulator.DialogButton button) [instance] :1517
void ShowingModalDialog::OnButtonClicked(::g::Outracks::Simulator::DialogButton* button)
{
    ...
    _clickedButton().Value< ::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::DialogButton*> > >() = (::g::Outracks::Simulator::Bytecode::Optional__Some_fn(::TYPES[96/*Outracks.Simulator.Bytecode.Optional.Some<Outracks.Simulator.DialogButton>*/], button, &ret7), ret7);
}

// public ShowingModalDialog New(string header, string body, string details, Outracks.Simulator.DialogButton[] buttons) [static] :1484
...
// internal abstract class ShowingPrompt :1404
// {
static void ShowingPrompt_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("/usr/local/share/uno/Packages/Outracks.Simulator.Client.Uno/0.1.0/$.uno");
    ::TYPES[55] = ::g::Fuse::Gestures::ClickedHandler_typeof();
    ::TYPES[102] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Fuse::Controls::Control_typeof(), NULL);
    ::TYPES[103] = ::g::Fuse::Controls::Control_typeof()->Array();
    type->SetFields(0,
...
// protected ShowingPrompt(string header, string body) :1413
void ShowingPrompt__ctor_1_fn(ShowingPrompt* __this, uString* header, uString* body)
{
    __this->ctor_1(header, body);
}

// private void OnCancelClicked(object s, Fuse.Gestures.ClickedArgs args) :1454
...
// public override sealed Outracks.Simulator.State OnEnterState() :1421
void ShowingPrompt__OnEnterState_fn(ShowingPrompt* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[62/*"# "*/], __this->_header), 1, ::STRINGS[4/*"/usr/local/...*/], 1442);
    ::g::Uno::Diagnostics::Debug::Log5(__this->_body, 1, ::STRINGS[4/*"/usr/local/...*/], 1443);
    ::g::Outracks::Simulator::ModalDialog::ShowPrompt(::g::Outracks::Simulator::Context::App(), __this->_header, __this->_body, __this->_input, (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[102/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Fuse.Controls.Control>*/], uArray::Init< ::g::Fuse::Controls::Control*>(::TYPES[103/*Fuse.Controls.Control[]*/], 2, cancel, ok))));
    return *__retval = __this, void();
}

// private void OnOkClicked(object s, Fuse.Gestures.ClickedArgs args) :1449
...
// public override sealed Outracks.Simulator.State OnUpdate() :1463
...
// protected ShowingPrompt(string header, string body) [instance] :1413
...
// private void OnCancelClicked(object s, Fuse.Gestures.ClickedArgs args) [instance] :1454
void ShowingPrompt::OnCancelClicked(uObject* s, ::g::Fuse::Gestures::ClickedArgs* args)
{
    _cancelClicked = true;
}

// private void OnOkClicked(object s, Fuse.Gestures.ClickedArgs args) [instance] :1449
...
// public sealed class SimulatorClient :937
// {
static void SimulatorClient_build(uType* type)
{
    ...
    type->SetFields(0,
        ::TYPES[85/*Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageFromClient>*/], offsetof(::g::Outracks::Simulator::SimulatorClient, _messagesFromClient), 0,
        ::TYPES[86/*Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient>*/], offsetof(::g::Outracks::Simulator::SimulatorClient, _messagesToClient), 0,
    ...
    type->Reflection.SetFunctions(5,
        ...
        new uFunction("get_IncommingMessages", NULL, (void*)SimulatorClient__get_IncommingMessages_fn, 0, false, ::TYPES[86/*Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient>*/], 0),
...
void SimulatorClient::ctor_(::g::Uno::Net::Sockets::Socket* socket)
{
    ...
    _readWorker = ::g::Uno::Threading::Thread::New2(uDelegate::New(::TYPES[104/*Uno.Threading.ThreadStart*/], (void*)SimulatorClient__ReadLoop_fn, this));
    _writeWorker = ::g::Uno::Threading::Thread::New2(uDelegate::New(::TYPES[104/*Uno.Threading.ThreadStart*/], (void*)SimulatorClient__WriteLoop_fn, this));
    uPtr(_readWorker)->Start();
    uPtr(_writeWorker)->Start();
}

// public void Dispose() [instance] :1022
void SimulatorClient::Dispose()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->Message(), 1, ::STRINGS[4/*"/usr/local/...*/], 1037);
    }
}

// public Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient> get_IncommingMessages() [instance] :950
::g::Outracks::Simulator::ConcurrentQueue* SimulatorClient::IncommingMessages()
{
    return _messagesToClient;
}

// public bool get_IsOnline() [instance] :1043
bool SimulatorClient::IsOnline()
{
    return true;
}

// private void ReadLoop() [instance] :984
...
// public void Send(Outracks.Simulator.Protocol.MessageFromClient message) [instance] :953
...
// private void WriteLoop() [instance] :1002
...
// public SimulatorClient New(Uno.Net.Sockets.Socket socket) [static] :958
...
{
    ::TYPES[105] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[1] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[106] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[74] = ::g::Uno::Collections::IEnumerable_typeof();
    ::TYPES[81] = ::g::Uno::Collections::IEnumerator1_typeof();
    type->MethodTypes[0]->SetPrecalc(
        ::TYPES[74/*Uno.Collections.IEnumerable`1*/]->MakeType(type->MethodTypes[0]->U(0), NULL),
        ::TYPES[81/*Uno.Collections.IEnumerator`1*/]->MakeType(type->MethodTypes[0]->U(0), NULL));
    type->Reflection.SetFunctions(8,
        ...
        new uFunction("Join", NULL, (void*)StringSplitting__Join_fn, 0, true, ::g::Uno::String_typeof(), 2, ::TYPES[105/*Uno.Collections.IEnumerable<string>*/], ::g::Uno::String_typeof()),
        new uFunction("JoinToString`1", type->MethodTypes[0], (void*)StringSplitting__JoinToString_fn, 0, true, ::g::Uno::String_typeof(), 2, ::TYPES[74/*Uno.Collections.IEnumerable`1*/]->MakeType(type->MethodTypes[0]->U(0), NULL), ::g::Uno::String_typeof()),
...
uString* StringSplitting::Join(uObject* si, uString* separator)
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(si), ::TYPES[105/*Uno.Collections.IEnumerable<string>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[1/*Uno.Collections.IEnumerator*/])); )
    {
        uString* part = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[106/*Uno.Collections.IEnumerator<string>*/]), &ret2), ret2);
...
// internal void set_Result(T value) :83
void Task__set_Result_fn(Task* __this, void* value)
{
    __this->_result() = value;
}

// internal Task(Uno.Action wait) [instance] :60
...
// public generated Uno.Exception get_Exception() [instance] :69
::g::Uno::Exception* Task::Exception()
{
    return _Exception;
}

// internal generated void set_Exception(Uno.Exception value) [instance] :69
void Task::Exception(::g::Uno::Exception* value)
{
    _Exception = value;
}

// public generated bool get_IsCompleted() [instance] :65
bool Task::IsCompleted()
{
    return _IsCompleted;
}

// internal generated void set_IsCompleted(bool value) [instance] :65
void Task::IsCompleted(bool value)
{
    _IsCompleted = value;
}

// public generated bool get_IsFaulted() [instance] :67
bool Task::IsFaulted()
{
    return _IsFaulted;
}

// internal generated void set_IsFaulted(bool value) [instance] :67
void Task::IsFaulted(bool value)
{
    _IsFaulted = value;
}

// internal Task New(Uno.Action wait) [static] :60
...
{
    ::TYPES[107] = ::g::Outracks::Simulator::TaskThread_typeof();
    ::TYPES[108] = ::g::Uno::Func_typeof();
    ::TYPES[109] = ::g::Outracks::Simulator::WaitForFirstResult_typeof();
    type->MethodTypes[0]->SetPrecalc(
        ::TYPES[107/*Outracks.Simulator.TaskThread`1*/]->MakeType(type->MethodTypes[0]->U(0), NULL));
    type->MethodTypes[1]->SetPrecalc(
        type->MakeMethod(0/*Run<T>*/, type->MethodTypes[1]->U(0), NULL),
        ::TYPES[108/*Uno.Func`1*/]->MakeType(type->MethodTypes[1]->U(0), NULL),
        ::TYPES[109/*Outracks.Simulator.WaitForFirstResult`1*/]->MakeType(type->MethodTypes[1]->U(0), NULL));
    type->Reflection.SetFunctions(2,
        new uFunction("Run`1", type->MethodTypes[0], (void*)Tasks__Run_fn, 0, true, ::g::Outracks::Simulator::Task_typeof()->MakeType(type->MethodTypes[0]->U(0), NULL), 1, ::TYPES[108/*Uno.Func`1*/]->MakeType(type->MethodTypes[0]->U(0), NULL)),
...
// public static Outracks.Simulator.Task<T> Run<T>(Uno.Func<T> method) :95
void Tasks__Run_fn(uType* __type, uDelegate* method, ::g::Outracks::Simulator::Task** __retval)
{
    *__retval = Tasks::Run(__type, method);
}

// public static Outracks.Simulator.Task<T> WaitForFirstResult<T>(Uno.Collections.IEnumerable<Outracks.Simulator.Task<T>> tasks, Uno.Func<Uno.Collections.IEnumerable<Uno.Exception>, T> onNoResult) :90
...
// public static Outracks.Simulator.Task<T> Run<T>(Uno.Func<T> method) [static] :95
...
// public static Outracks.Simulator.Task<T> WaitForFirstResult<T>(Uno.Collections.IEnumerable<Outracks.Simulator.Task<T>> tasks, Uno.Func<Uno.Collections.IEnumerable<Uno.Exception>, T> onNoResult) [static] :90
...
{
    ::TYPES[104] = ::g::Uno::Threading::ThreadStart_typeof();
    ::TYPES[110] = ::g::Outracks::Simulator::Task_typeof();
    ::TYPES[9] = ::g::Uno::Action_typeof();
    ::TYPES[12] = ::g::Uno::Exception_typeof();
    type->SetPrecalc(
    ...
    type->SetFields(0,
        ...
        ::TYPES[110/*Outracks.Simulator.Task`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Outracks::Simulator::TaskThread, Task), 0,
...
void TaskThread::ctor_(uDelegate* func)
{
    ...
    _func = func;
    Thread = ::g::Uno::Threading::Thread::New2(uDelegate::New(::TYPES[104/*Uno.Threading.ThreadStart*/], (void*)TaskThread__Run_fn, this));
...
// public TaskThread New(Uno.Func<T> func) [static] :118
...
// internal sealed class UserAppState :752
// {
static void UserAppState_build(uType* type)
{
    ::TYPES[111] = type->MakeMethod(1/*SetIfNotEqual<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL);
    ::TYPES[112] = type->MakeMethod(1/*SetIfNotEqual<Uno.UX.Resource>*/, ::g::Uno::UX::Resource_typeof(), NULL);
    ::TYPES[113] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(11/*ToArray<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL);
    ::TYPES[114] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(11/*ToArray<Uno.UX.Resource>*/, ::g::Uno::UX::Resource_typeof(), NULL);
    ::TYPES[115] = ::g::Uno::Collections::ICollection_typeof();
    ::TYPES[116] = ::g::Uno::Collections::IList_typeof();
    ::TYPES[117] = ::g::Uno::Collections::IListExtensions_typeof();
    ::TYPES[75] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof();
    type->MethodTypes[0]->SetPrecalc(
        ::TYPES[115/*Uno.Collections.ICollection`1*/]->MakeType(type->MethodTypes[0]->U(0), NULL),
        ::TYPES[116/*Uno.Collections.IList`1*/]->MakeType(type->MethodTypes[0]->U(0), NULL));
    type->MethodTypes[1]->SetPrecalc(
    ...
    type->MethodTypes[2]->SetPrecalc(
        ::TYPES[115/*Uno.Collections.ICollection`1*/]->MakeType(type->MethodTypes[2]->U(0), NULL),
        ::TYPES[117/*Uno.Collections.IListExtensions*/]->MakeMethod(0/*AddRange<T>*/, type->MethodTypes[2]->U(0), NULL),
        ::TYPES[75/*Uno.Runtime.Implementation.Internal.ArrayEnumerable`1*/]->MakeType(type->MethodTypes[2]->U(0), NULL));
    type->SetFields(0,
...
// public UserAppState(float4 background, Fuse.Node[] children, Uno.UX.Resource[] resources, float4 clearColor) :765
...
// public void ApplyTo(Outracks.Simulator.FakeApp app) :789
void UserAppState__ApplyTo_fn(UserAppState* __this, ::g::Outracks::Simulator::FakeApp* app)
{
    __this->ApplyTo(app);
}

// public static generated Outracks.Simulator.UserAppState get_Default() :778
void UserAppState__get_Default_fn(UserAppState** __retval)
{
    *__retval = UserAppState::Default();
}

// public static generated void set_Default(Outracks.Simulator.UserAppState value) :778
void UserAppState__set_Default_fn(UserAppState* value)
{
    UserAppState::Default(value);
}

// public UserAppState New(float4 background, Fuse.Node[] children, Uno.UX.Resource[] resources, float4 clearColor) :765
...
// public static Outracks.Simulator.UserAppState Save(Outracks.Simulator.FakeApp app) :780
void UserAppState__Save_fn(::g::Outracks::Simulator::FakeApp* app, UserAppState** __retval)
{
    *__retval = UserAppState::Save(app);
}

// private static bool SequenceEquals<T>(Uno.Collections.IList<T> left, T[] right) :809
...
// private static void SetIfNotEqual<T>(Uno.Collections.IList<T> list, T[] elements) :797
...
// private static void SetSequence<T>(Uno.Collections.IList<T> list, T[] elements) :803
...
// public UserAppState(float4 background, Fuse.Node[] children, Uno.UX.Resource[] resources, float4 clearColor) [instance] :765
...
// public void ApplyTo(Outracks.Simulator.FakeApp app) [instance] :789
void UserAppState::ApplyTo(::g::Outracks::Simulator::FakeApp* app)
{
    ...
    UserAppState::SetIfNotEqual(::TYPES[111/*Outracks.Simulator.UserAppState.SetIfNotEqual<Fuse.Node>*/], uPtr(app)->Children1(), Children);
    UserAppState::SetIfNotEqual(::TYPES[112/*Outracks.Simulator.UserAppState.SetIfNotEqual<Uno.UX.Resource>*/], app->Resources1(), Resources);

    if (::g::Uno::Float4__op_Inequality(app->ClearColor(), ClearColor))
        uPtr(app)->ClearColor(ClearColor);
}

// public UserAppState New(float4 background, Fuse.Node[] children, Uno.UX.Resource[] resources, float4 clearColor) [static] :765
...
// public static Outracks.Simulator.UserAppState Save(Outracks.Simulator.FakeApp app) [static] :780
UserAppState* UserAppState::Save(::g::Outracks::Simulator::FakeApp* app)
{
    ...
    return UserAppState::New1(uPtr(app)->Background1(), (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[113/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Node>*/], uPtr(app)->Children1()), (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[114/*Uno.Collections.EnumerableExtensions.ToArray<Uno.UX.Resource>*/], uPtr(app)->Resources1()), uPtr(app)->ClearColor());
}

// private static bool SequenceEquals<T>(Uno.Collections.IList<T> left, T[] right) [static] :809
...
// private static void SetIfNotEqual<T>(Uno.Collections.IList<T> list, T[] elements) [static] :797
...
// private static void SetSequence<T>(Uno.Collections.IList<T> list, T[] elements) [static] :803
...
// public static generated Outracks.Simulator.UserAppState get_Default() [static] :778
UserAppState* UserAppState::Default()
{
    return UserAppState::_Default_;
}

// public static generated void set_Default(Outracks.Simulator.UserAppState value) [static] :778
...
// public WaitForFirstResult(Uno.Collections.IEnumerable<Outracks.Simulator.Task<T>> pending, Uno.Func<Uno.Collections.IEnumerable<Uno.Exception>, T> onNoResult) :146
...
// public WaitForFirstResult New(Uno.Collections.IEnumerable<Outracks.Simulator.Task<T>> pending, Uno.Func<Uno.Collections.IEnumerable<Uno.Exception>, T> onNoResult) :146
...
// public WaitForFirstResult(Uno.Collections.IEnumerable<Outracks.Simulator.Task<T>> pending, Uno.Func<Uno.Collections.IEnumerable<Uno.Exception>, T> onNoResult) [instance] :146
...
// public WaitForFirstResult New(Uno.Collections.IEnumerable<Outracks.Simulator.Task<T>> pending, Uno.Func<Uno.Collections.IEnumerable<Uno.Exception>, T> onNoResult) [static] :146

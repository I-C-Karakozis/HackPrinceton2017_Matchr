...
// /Users/hdc/Library/Application Support/Fusetools/Packages/UnoCore/0.46.1/source/uno/content/fonts/$.uno
// -------------------------------------------------------------------------------------------------------
...
static void DefaultTextTransform_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/UnoCore/0.46.1/source/uno/content/fonts/$.uno");
    type->SetFields(0,
...
{
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[1/*"DefaultText...*/], 1, ::STRINGS[2/*"/Users/hdc/...*/], 321);
    return *__retval = __this->_matrix, void();
}
...
// protected generated FontFace() :338
void FontFace__ctor__fn(FontFace* __this)
{
    __this->ctor_();
}

// public static Uno.Content.Fonts.FontFace Load(string name, byte[] data, int offset, int length) :354
...
// public static Uno.Content.Fonts.FontFace Load(Uno.IO.BundleFile file) :340
void FontFace__Load1_fn(::g::Uno::IO::BundleFile* file, FontFace** __retval)
{
    *__retval = FontFace::Load1(file);
}

// protected generated FontFace() [instance] :338
void FontFace::ctor_()
{
}

// public static Uno.Content.Fonts.FontFace Load(string name, byte[] data, int offset, int length) [static] :354
...
// public static Uno.Content.Fonts.FontFace Load(Uno.IO.BundleFile file) [static] :340
...
{
    ::STRINGS[3] = uString::Const(" \300\200");
...
// public static Uno.Content.Fonts.BitmapFont RenderSpriteFont(Uno.Content.Fonts.FontFace font, float size, string charset) :403
...
// public static Uno.Content.Fonts.BitmapFont RenderSpriteFont(Uno.Content.Fonts.FontFace font, float size, string charset) [static] :403
::g::Uno::Content::Fonts::BitmapFont* FontFaceHelpers::RenderSpriteFont(::g::Uno::Content::Fonts::FontFace* font, float size, uString* charset)
{
    ...
    uString* charsetInclWs = ::g::Uno::String::op_Addition2(charset, ::STRINGS[3/*" \0"*/]);
    int maxSize = 0;
...
// public RenderedGlyph(float2 advance, float2 bearing, Uno.Content.Images.Bitmap bitmap) :542
...
// public RenderedGlyph New(float2 advance, float2 bearing, Uno.Content.Images.Bitmap bitmap) :542
...
// public RenderedGlyph(float2 advance, float2 bearing, Uno.Content.Images.Bitmap bitmap) [instance] :542
...
// public RenderedGlyph New(float2 advance, float2 bearing, Uno.Content.Images.Bitmap bitmap) [static] :542
...
// public generated SdfFontShader() :594
void SdfFontShader__ctor_1_fn(SdfFontShader* __this)
{
    __this->ctor_1();
}

// public override sealed void Draw(Uno.Content.Fonts.TextShaderData data) :596
...
// private generated void init_DrawCalls() [instance] :594
...
// public generated SdfFontShader New() [static] :594
...
// public generated SpriteFontShader() :645
void SpriteFontShader__ctor_1_fn(SpriteFontShader* __this)
{
    __this->ctor_1();
}

// public override sealed void Draw(Uno.Content.Fonts.TextShaderData data) :647
...
// private generated void init_DrawCalls() [instance] :645
...
// public generated SpriteFontShader New() [static] :645
...
// public TextRenderer(int maxCharCount, Uno.Content.Fonts.TextShader shader, [Uno.Content.Fonts.TextTransform transform]) :685
...
// public float2 MeasureString(string text, int startIndex, int length) :758
...
// public TextRenderer New(int maxCharCount, Uno.Content.Fonts.TextShader shader, [Uno.Content.Fonts.TextTransform transform]) :685
...
// public Uno.Content.Fonts.TextTransform get_Transform() :714
...
// public void set_Transform(Uno.Content.Fonts.TextTransform value) :715
void TextRenderer__set_Transform_fn(TextRenderer* __this, ::g::Uno::Content::Fonts::TextTransform* value)
{
    __this->Transform(value);
}

// private void WriteGlyph(Uno.Content.Fonts.BitmapFont.GlyphInfo ci, float2 caret) :807
...
// public void WriteString(float2 caret, string text) :802
void TextRenderer__WriteString_fn(TextRenderer* __this, ::g::Uno::Float2* caret, uString* text)
{
    __this->WriteString(*caret, text);
}

// public void WriteString(float2 caret, string text, int startIndex, int length) :849
...
// public TextRenderer(int maxCharCount, Uno.Content.Fonts.TextShader shader, [Uno.Content.Fonts.TextTransform transform]) [instance] :685
...
// public void Begin(Uno.Content.Fonts.BitmapFont font) [instance] :742
void TextRenderer::Begin(::g::Uno::Content::Fonts::BitmapFont* font)
{
    ...
    if (font == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[4/*"font"*/]));
...
// public float4 get_Color() [instance] :732
...
// public void set_Color(float4 value) [instance] :733
...
// public generated bool get_HasBegun() [instance] :668
bool TextRenderer::HasBegun()
{
    return _HasBegun;
}

// private generated void set_HasBegun(bool value) [instance] :668
void TextRenderer::HasBegun(bool value)
{
    _HasBegun = value;
}

// public float2 MeasureString(string text) [instance] :753
...
// public float2 MeasureString(string text, int startIndex, int length) [instance] :758
...
// public Uno.Content.Fonts.TextTransform get_Transform() [instance] :714
::g::Uno::Content::Fonts::TextTransform* TextRenderer::Transform()
{
    return _transform;
}

// public void set_Transform(Uno.Content.Fonts.TextTransform value) [instance] :715
void TextRenderer::Transform(::g::Uno::Content::Fonts::TextTransform* value)
{
    _transform = value;
}

// private void WriteGlyph(Uno.Content.Fonts.BitmapFont.GlyphInfo ci, float2 caret) [instance] :807
...
// public void WriteString(float2 caret, string text) [instance] :802
...
// public void WriteString(float2 caret, string text, int startIndex, int length) [instance] :849
...
// public TextRenderer New(int maxCharCount, Uno.Content.Fonts.TextShader shader, [Uno.Content.Fonts.TextTransform transform]) [static] :685
...
// protected generated TextShader() :1003
void TextShader__ctor__fn(TextShader* __this)
{
    __this->ctor_();
}

// protected generated TextShader() [instance] :1003
...
// internal TextShaderData(Uno.Graphics.IndexBuffer ibo, Uno.Graphics.VertexBuffer vbo) :977
...
// internal TextShaderData New(Uno.Graphics.IndexBuffer ibo, Uno.Graphics.VertexBuffer vbo) :977
...
// internal TextShaderData(Uno.Graphics.IndexBuffer ibo, Uno.Graphics.VertexBuffer vbo) [instance] :977
...
// internal TextShaderData New(Uno.Graphics.IndexBuffer ibo, Uno.Graphics.VertexBuffer vbo) [static] :977
...
// protected generated TextTransform() :1036
void TextTransform__ctor__fn(TextTransform* __this)
{
    __this->ctor_();
}

// public virtual Uno.Graphics.PolygonFace get_CullFace() :1046
void TextTransform__get_CullFace_fn(TextTransform* __this, int* __retval)
{
    return *__retval = 0, void();
}

// protected generated TextTransform() [instance] :1036

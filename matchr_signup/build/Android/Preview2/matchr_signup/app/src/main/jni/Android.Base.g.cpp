...
// /Users/hdc/Library/Application Support/Fusetools/Packages/UnoCore/0.46.1/targets/android/uno/base/$.uno
// -------------------------------------------------------------------------------------------------------
...
static void JNI_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/UnoCore/0.46.1/targets/android/uno/base/$.uno");
...
{
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetActivityClassInner58", "()Ljava/lang/Object;");
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetActivityObjectInner59", "()Ljava/lang/Object;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        ::g::Java::Object* __result = (::g::Java::Object*)::g::Android::Base::Wrappers::JavaObjectHelper::JObjectToJWrapper(__jresult, false);
        JNI::CheckException();
        return __result;
...
int64_t JNI::GetUnoRef(jobject obj)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(JNI::_inited_, ::STRINGS[2/*"Android.Bas...*/], ::STRINGS[3/*"/Users/hdc/...*/], 318, uArray::New(::TYPES[1/*object[]*/], 0));
...
jclass JNI::LoadClass1(JNIEnv* jni, const char* name, bool systemClass)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(JNI::_inited_, ::STRINGS[2/*"Android.Bas...*/], ::STRINGS[3/*"/Users/hdc/...*/], 131, uArray::New(::TYPES[1/*object[]*/], 0));
    jclass result;

...
//#endif
    ...
    public com.apps.matchr_signup.matchr_signup RootActivity;
    public boolean HasCreated = false;
    public final ActivityState activityState; // one per activity

    private App(com.apps.matchr_signup.matchr_signup activity)
    {
        activityState = new ActivityState(HasCreated);
        RootActivity = activity;
    }

    public static App Create(com.apps.matchr_signup.matchr_signup activity)
    {

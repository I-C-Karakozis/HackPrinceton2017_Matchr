...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Selection/0.46.1/$.uno
// -------------------------------------------------------------------------------------
...
static void Deselected_build(uType* type)
{
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IUnwrappedPlayerFeedback_typeof(), offsetof(::g::Fuse::Selection::SelectionEvent_type, interface4),
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Selection::SelectionEvent_type, interface5));
    type->SetFields(33);
...
static void Selectable_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("/Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Selection/0.46.1/$.uno");
...
void Selectable__OnRooted_fn(Selectable* __this)
{
    ...
    if (__this->_selection == NULL)
        ::g::Fuse::Diagnostics::UserError(::STRINGS[8/*"Unable to l...*/], __this, ::STRINGS[5/*"/Users/hdc/...*/], 116, ::STRINGS[9/*"OnRooted"*/]);
}
...
void Selectable::Add1()
{
    ...
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"No selectio...*/], this, ::STRINGS[5/*"/Users/hdc/...*/], 157, ::STRINGS[7/*"Add"*/]);
        return;
    }
...
void Selectable::Remove1()
{
    ...
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"No selectio...*/], this, ::STRINGS[5/*"/Users/hdc/...*/], 171, ::STRINGS[11/*"Remove"*/]);
        return;
    }
...
void Selectable::Toggle()
{
    ...
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"No selectio...*/], this, ::STRINGS[5/*"/Users/hdc/...*/], 185, ::STRINGS[13/*"Toggle"*/]);
        return;
    }
...
void Selectable::add(::g::Fuse::Scripting::Context* c, Selectable* s, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[4/*"add require...*/], s, ::STRINGS[5/*"/Users/hdc/...*/], 30, ::STRINGS[1/*"add"*/]);
        return;
    }
...
void Selectable::remove(::g::Fuse::Scripting::Context* c, Selectable* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[10/*"remove requ...*/], s, ::STRINGS[5/*"/Users/hdc/...*/], 48, ::STRINGS[2/*"remove"*/]);
        return;
    }
...
void Selectable::toggle(::g::Fuse::Scripting::Context* c, Selectable* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[12/*"toggle requ...*/], s, ::STRINGS[5/*"/Users/hdc/...*/], 64, ::STRINGS[3/*"toggle"*/]);
        return;
    }
...
static void Selection_build(uType* type)
{
    ...
    ::TYPES[8] = ::g::Fuse::Scripting::IObserver_typeof();
    ::TYPES[9] = ::g::Fuse::Scripting::Observable__Subscription_typeof()->MakeMethod(0/*ReplaceAllExclusive<string>*/, ::g::Uno::String_typeof(), NULL);
    ::TYPES[10] = ::g::Fuse::Visual_typeof();
    ::TYPES[11] = ::TYPES[10/*Fuse.Visual*/]->MakeMethod(3/*FirstChild<Fuse.Selection.Selectable>*/, ::g::Fuse::Selection::Selectable_typeof(), NULL);
    ::TYPES[12] = ::TYPES[10/*Fuse.Visual*/]->MakeMethod(3/*FirstChild<Fuse.Selection.Selection>*/, type, NULL);
    ::TYPES[13] = ::g::Fuse::Scripting::Observable_typeof();
    ...
    type->SetInterfaces(
        ...
        ::TYPES[8/*Fuse.Scripting.IObserver*/], offsetof(Selection_type, interface4));
    type->SetFields(13,
        ...
        ::TYPES[13/*Fuse.Scripting.Observable*/], offsetof(::g::Fuse::Selection::Selection, _observableValues), 0,
        ...
        ::TYPES[14/*Uno.EventHandler*/], offsetof(::g::Fuse::Selection::Selection, SelectionChanged1), 0,
    ...
    type->Reflection.SetFunctions(23,
        ...
        new uFunction("add_SelectionChanged", NULL, (void*)Selection__add_SelectionChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[14/*Uno.EventHandler*/]),
        new uFunction("remove_SelectionChanged", NULL, (void*)Selection__remove_SelectionChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[14/*Uno.EventHandler*/]),
...
void Selection__FuseScriptingIObserverOnFailed_fn(Selection* __this, uString* message)
{
    ...
    ::g::Fuse::Scripting::IObserver::OnClear(uInterface(uPtr(uAs<uObject*>(__this, ::TYPES[8/*Fuse.Scripting.IObserver*/])), ::TYPES[8/*Fuse.Scripting.IObserver*/]));
    ::g::Fuse::Diagnostics::InternalError(message, __this, ::STRINGS[5/*"/Users/hdc/...*/], 890, ::STRINGS[21/*"Fuse.Script...*/]);
}
...
void Selection__FuseScriptingIObserverOnInsertAt_fn(Selection* __this, int* index, uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"removing in...*/], __this, ::STRINGS[5/*"/Users/hdc/...*/], 880, ::STRINGS[23/*"Fuse.Script...*/]);
        return;
    }
...
void Selection__FuseScriptingIObserverOnNewAt_fn(Selection* __this, int* index, uObject* newValue)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"removing in...*/], __this, ::STRINGS[5/*"/Users/hdc/...*/], 845, ::STRINGS[24/*"Fuse.Script...*/]);
        return;
    }
...
void Selection__FuseScriptingIObserverOnRemoveAt_fn(Selection* __this, int* index)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"removing in...*/], __this, ::STRINGS[5/*"/Users/hdc/...*/], 869, ::STRINGS[25/*"Fuse.Script...*/]);
        return;
    }
...
void Selection::MaxCount(int value)
{
    ...
    if (value < 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[28/*"MaxCount mu...*/], this, ::STRINGS[5/*"/Users/hdc/...*/], 553, ::STRINGS[29/*"set_MaxCount"*/]);
        return;
    }
...
void Selection::OnSelectionChanged(int how)
{
    ...
    if ((how == 0) && (_subscription != NULL))
        uPtr(_subscription)->ReplaceAllExclusive(::TYPES[9/*Fuse.Scripting.Observable.Subscription.ReplaceAllExclusive<string>*/], (uArray*)uPtr(_values)->ToArray());
}
...
void Selection::add_SelectionChanged(uDelegate* value)
{
    ...
    SelectionChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(SelectionChanged1, value), ::TYPES[14/*Uno.EventHandler*/]);
}
...
void Selection::remove_SelectionChanged(uDelegate* value)
{
    ...
    SelectionChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(SelectionChanged1, value), ::TYPES[14/*Uno.EventHandler*/]);
}
...
void Selection::Values(uObject* value)
{
    ...
    ::g::Fuse::Scripting::Observable* q = uAs< ::g::Fuse::Scripting::Observable*>(value, ::TYPES[13/*Fuse.Scripting.Observable*/]);

    if ((value != NULL) && (q == NULL))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[31/*"`Values` mu...*/], this, ::STRINGS[5/*"/Users/hdc/...*/], 796, ::STRINGS[32/*"set_Values"*/]);
        return;
    }
...
void Selection::add(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[17/*"add require...*/], s, ::STRINGS[5/*"/Users/hdc/...*/], 342, ::STRINGS[1/*"add"*/]);
        return;
    }
...
void Selection::clear(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[18/*"clear requi...*/], s, ::STRINGS[5/*"/Users/hdc/...*/], 324, ::STRINGS[14/*"clear"*/]);
        return;
    }
...
void Selection::forceAdd(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[19/*"forceAdd re...*/], s, ::STRINGS[5/*"/Users/hdc/...*/], 374, ::STRINGS[15/*"forceAdd"*/]);
        return;
    }
...
void Selection::forceRemove(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[20/*"forceRemove...*/], s, ::STRINGS[5/*"/Users/hdc/...*/], 388, ::STRINGS[16/*"forceRemove"*/]);
        return;
    }
...
void Selection::remove(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[26/*"remove requ...*/], s, ::STRINGS[5/*"/Users/hdc/...*/], 360, ::STRINGS[2/*"remove"*/]);
        return;
    }
...
void Selection::toggle(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[27/*"toggle requ...*/], s, ::STRINGS[5/*"/Users/hdc/...*/], 404, ::STRINGS[3/*"toggle"*/]);
        return;
    }
...
bool Selection::TryFindSelectable(::g::Fuse::Node* n, ::g::Fuse::Selection::Selectable** selectable, Selection** selection)
{
    ...
    *selection = NULL;
    ...
    while (n != NULL)
    {
        ::g::Fuse::Visual* vs = uAs< ::g::Fuse::Visual*>(n, ::TYPES[10/*Fuse.Visual*/]);

        if (vs != NULL)
        {
            if (*selectable == NULL)
                *selectable = (::g::Fuse::Selection::Selectable*)uPtr(vs)->FirstChild(::TYPES[11/*Fuse.Visual.FirstChild<Fuse.Selection.Selectable>*/]);
            else
                *selection = (Selection*)uPtr(vs)->FirstChild(::TYPES[12/*Fuse.Visual.FirstChild<Fuse.Selection.Selection>*/]);
...
Selection* Selection::TryFindSelection(::g::Fuse::Node* v)
{
    ...
    while (v != NULL)
    {
        ::g::Fuse::Visual* vs = uAs< ::g::Fuse::Visual*>(v, ::TYPES[10/*Fuse.Visual*/]);

        if (vs != NULL)
        {
            Selection* l = (Selection*)uPtr(vs)->FirstChild(::TYPES[12/*Fuse.Visual.FirstChild<Fuse.Selection.Selection>*/]);
...
static void SelectionEvent_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IUnwrappedPlayerFeedback_typeof(), offsetof(SelectionEvent_type, interface4),
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(SelectionEvent_type, interface5));
    type->SetFields(30,
...
void SelectionEvent__OnRooted_fn(SelectionEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Unable to l...*/], __this, ::STRINGS[5/*"/Users/hdc/...*/], 237, ::STRINGS[9/*"OnRooted"*/]);
        return;
    }

    uPtr(__this->_selection)->add_SelectionChanged(uDelegate::New(::TYPES[14/*Uno.EventHandler*/], (void*)SelectionEvent__OnSelectionChanged_fn, __this));
...
void SelectionEvent__OnUnrooted_fn(SelectionEvent* __this)
{
    ...
    if (__this->_selection != NULL)
        uPtr(__this->_selection)->remove_SelectionChanged(uDelegate::New(::TYPES[14/*Uno.EventHandler*/], (void*)SelectionEvent__OnSelectionChanged_fn, __this));
...
void SelectionEventArgs__FuseScriptingIScriptEventSerialize_fn(SelectionEventArgs* __this, uObject* s)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[15/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[34/*"value"*/], __this->Value());
}
...
void ToggleSelection__Perform_fn(ToggleSelection* __this, ::g::Fuse::Node* target)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[35/*"Unable to l...*/], __this, ::STRINGS[5/*"/Users/hdc/...*/], 954, ::STRINGS[36/*"Perform"*/]);
        return;
    }
...
// public generated ToggleSelection() [instance] :934
void ToggleSelection::ctor_2()
{
    ctor_1();
}

// public Fuse.Selection.SelectMode get_Mode() [instance] :944
int ToggleSelection::Mode()
{
    return _mode;
}

// public void set_Mode(Fuse.Selection.SelectMode value) [instance] :945
void ToggleSelection::Mode(int value)
{
    _mode = value;
}

// public generated ToggleSelection New() [static] :934
...
// public sealed class WhileSelected :992
// {
static void WhileSelected_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IUnwrappedPlayerFeedback_typeof(), offsetof(WhileSelected_type, interface4),
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(WhileSelected_type, interface5),
        ::g::Uno::UX::IPropertyListener_typeof(), offsetof(WhileSelected_type, interface6));
    type->SetFields(30,
...
WhileSelected_type* WhileSelected_typeof()
{
    ...
    type->interface6.fp_OnPropertyChanged = (void(*)(uObject*, ::g::Uno::UX::PropertyObject*, ::g::Uno::UX::Selector*))WhileSelected__UnoUXIPropertyListenerOnPropertyChanged_fn;
    type->interface5.fp_OnPlaybackDone = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn;
    type->interface5.fp_OnStable = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnStable_fn;
    type->interface4.fp_OnProgressUpdated = (void(*)(uObject*, uObject*, double*, double*, int*))::g::Fuse::Triggers::Trigger__FuseAnimationsIUnwrappedPlayerFeedbackOnProgressUpdated_fn;
    type->interface2.fp_Clear = (void(*)(uObject*))::g::Fuse::Node__UnoCollectionsICollectionFuseBindingClear_fn;
...
void WhileSelected__OnRooted_fn(WhileSelected* __this)
{
    ...
    if (!::g::Fuse::Selection::Selection::TryFindSelectable(__this->Parent(), &__this->_selectable, &__this->_selection))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Unable to l...*/], __this, ::STRINGS[5/*"/Users/hdc/...*/], 1003, ::STRINGS[9/*"OnRooted"*/]);
        return;
    }

    __this->SetActive(uPtr(__this->_selection)->IsSelected(__this->_selectable));
    uPtr(__this->_selection)->add_SelectionChanged(uDelegate::New(::TYPES[14/*Uno.EventHandler*/], (void*)WhileSelected__OnSelectionChanged_fn, __this));
    uPtr(__this->_selectable)->AddPropertyListener((uObject*)__this);
}

// private void OnSelectionChanged(object s, object args) :1035
void WhileSelected__OnSelectionChanged_fn(WhileSelected* __this, uObject* s, uObject* args)
{
    __this->OnSelectionChanged(s, args);
}

// protected override sealed void OnUnrooted() :1012
void WhileSelected__OnUnrooted_fn(WhileSelected* __this)
{
    ...
    if (__this->_selection != NULL)
    {
        uPtr(__this->_selection)->remove_SelectionChanged(uDelegate::New(::TYPES[14/*Uno.EventHandler*/], (void*)WhileSelected__OnSelectionChanged_fn, __this));
...
// private void Uno.UX.IPropertyListener.OnPropertyChanged(Uno.UX.PropertyObject obj, Uno.UX.Selector prop) :1025
...
// public generated WhileSelected() [instance] :992
void WhileSelected::ctor_6()
{
    ctor_5();
}

// private void OnSelectionChanged(object s, object args) [instance] :1035
...
// public generated WhileSelected New() [static] :992

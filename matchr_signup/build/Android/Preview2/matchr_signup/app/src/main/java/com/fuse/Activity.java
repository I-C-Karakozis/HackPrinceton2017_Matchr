...
//    {
//        return (android.support.v7.app.AppCompatActivity)#(Activity.Package).#(Activity.Name).GetRootActivity();
//    }
//    #else
    public static android.app.Activity getRootActivity()
    {
        return com.apps.matchr_signup.matchr_signup.GetRootActivity();
    }
//    #endif

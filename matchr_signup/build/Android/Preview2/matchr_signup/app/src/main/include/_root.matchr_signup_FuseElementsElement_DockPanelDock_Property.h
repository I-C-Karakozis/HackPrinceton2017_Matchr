...
namespace g{struct matchr_signup_FuseElementsElement_DockPanelDock_Property;}
...
struct matchr_signup_FuseElementsElement_DockPanelDock_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Elements::Element*> _obj;

    void ctor_2(::g::Fuse::Elements::Element* obj, ::g::Uno::UX::Selector name);
    static matchr_signup_FuseElementsElement_DockPanelDock_Property* New1(::g::Fuse::Elements::Element* obj, ::g::Uno::UX::Selector name);
};
// }

...
// /Users/hdc/Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/0.46.1/$.uno
// -----------------------------------------------------------------------------------------------

// internal sealed class ShadowElement :755
// {
...
// public generated ShadowElement() :755
void ShadowElement__ctor_4_fn(ShadowElement* __this)
{
    __this->ctor_4();
}

// protected override sealed Fuse.VisualBounds CalcRenderBounds() :851
...
// protected override sealed void OnUnrooted() :774
...
// public generated ShadowElement() [instance] :755
...
// public float4 get_Color() [instance] :840
::g::Uno::Float4 ShadowElement::Color()
{
    return _color;
}

// public void set_Color(float4 value) [instance] :841
...
// private float4 get_CornerRadius() [instance] :813
...
// private float get_MaxSize() [instance] :826
float ShadowElement::MaxSize()
{
    return ::g::Uno::Math::Min1(ActualSize().X, ActualSize().Y);
}

// public float get_Size() [instance] :799
float ShadowElement::Size()
{
    return _size;
}

// public void set_Size(float value) [instance] :800
...
// private float get_Smoothness() [instance] :830
...
// public generated ShadowElement New() [static] :755

...
void WebView__ctor_2_fn(WebView* __this, ::g::Fuse::Controls::WebView* host, ::g::Java::Object* handle, uArray* schemes)
{
    __this->ctor_2(host, handle, schemes);
}
...
void WebView__New1_fn(::g::Fuse::Controls::WebView* host, ::g::Java::Object* handle, uArray* schemes, WebView** __retval)
{
    *__retval = WebView::New1(host, handle, schemes);
}
...
void WebView::ctor_2(::g::Fuse::Controls::WebView* host, ::g::Java::Object* handle, uArray* schemes)
{
...
WebView* WebView::Create(::g::Fuse::Controls::WebView* webViewHost, uArray* schemes)
{
    ...
    return WebView::New1(webViewHost, handle, schemes);
}

// private WebView New(Fuse.Controls.WebView host, Java.Object handle, string[] schemes) [static] :116
WebView* WebView::New1(::g::Fuse::Controls::WebView* host, ::g::Java::Object* handle, uArray* schemes)
{
    WebView* obj2 = (WebView*)uNew(WebView_typeof());
    obj2->ctor_2(host, handle, schemes);
    return obj2;
}
// }

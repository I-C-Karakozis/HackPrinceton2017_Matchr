...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("10.9.239.60"), 12124)}, "/Users/hdc/matchr/matchrapp/matchr_signup/matchr_signup.unoproj", GetBundle, new string[] { })
{

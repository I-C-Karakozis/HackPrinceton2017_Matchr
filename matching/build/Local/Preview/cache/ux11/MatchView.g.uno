...
public partial class MatchView: Fuse.Controls.Page
{
    ...
    void InitializeUX()
    {
        ...
        temp.LineNumber = 2;
        temp.FileName = "Pages/MatchView.ux";
        temp.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../../../../Pages/MatchViewPage.js"));

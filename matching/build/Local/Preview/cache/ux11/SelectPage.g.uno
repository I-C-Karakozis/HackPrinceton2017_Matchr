...
public partial class SelectPage: Fuse.Controls.Page
{
    ...
    void InitializeUX()
    {
        ...
        temp3.Text = "Match";
        global::Fuse.Gestures.Clicked.AddHandler(temp3, temp_eb12.OnEvent);
        temp3.Bindings.Add(temp_eb12);
        temp4.Text = "Matches";
        global::Fuse.Gestures.Clicked.AddHandler(temp4, temp_eb13.OnEvent);
        temp4.Bindings.Add(temp_eb13);
        temp5.Text = "Message";
        global::Fuse.Gestures.Clicked.AddHandler(temp5, temp_eb14.OnEvent);
        temp5.Bindings.Add(temp_eb14);
        temp6.Text = "Profile";
        global::Fuse.Gestures.Clicked.AddHandler(temp6, temp_eb15.OnEvent);
        temp6.Bindings.Add(temp_eb15);
        ...
        temp16.Text = "Prev";
        global::Fuse.Gestures.Clicked.AddHandler(temp16, temp_eb19.OnEvent);
        temp16.Bindings.Add(temp_eb19);
        temp17.Text = "Match";
        global::Fuse.Gestures.Clicked.AddHandler(temp17, temp_eb20.OnEvent);
        temp17.Bindings.Add(temp_eb20);
